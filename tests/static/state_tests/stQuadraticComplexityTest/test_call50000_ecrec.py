"""
Ported from:
tests/static/state_tests/stQuadraticComplexityTest/Call50000_ecrecFiller.json
...
def test_call50000_ecrec(
    ...
    contract = Address("0x1c5bef085b43f11a8a19ae08a0c20019e6d15236")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH2[0xc350] + Op.PUSH1[0x0] + Op.PUSH1[0x1] + Op.PUSH1[0x1]
        + Op.PUSH2[0x1f4] + Op.CALL + Op.PUSH1[0x0] + Op.SSTORE + Op.PUSH1[0x1]
