...
def test_callcode50000(
    ...
    post = {
        ...
        Address("0xbbbf5374fce5edbc8e2a8697c15331677e6ebf0b"): Account(
            storage={},
            nonce=0,
            code=bytes.fromhex("5b61c3506080511015603f576000600061c3506000600173<eoa:0xaaaf5374fce5edbc8e2a8697c15331677e6ebf0b>610640f26000556001608051016080526000565b60805160015500"),
        ),
    }
