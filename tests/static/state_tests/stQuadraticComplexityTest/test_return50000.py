"""
Ported from:
tests/static/state_tests/stQuadraticComplexityTest/Return50000Filler.json
...
contract code:
    ...
    push1 0x00
    push1 0x00
    push20 0xaab87d565dd96e58089e1dff410fbdac45290658
    push2 0x061c
    call
    push1 0x00
    sstore
...
@pytest.mark.parametrize(
    ...
    pytest.param(
        16000000,
        {Address("0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b"): Account(storage={}, nonce=1, code=b""), Address("0xbbbf5374fce5edbc8e2a8697c15331677e6ebf0b"): Account(storage={0: 1, 1: 50000}, nonce=0)},
        id="case1",
    ),
    ],
)
...
def test_return50000(
    ...
    callee = Address("0xaab87d565dd96e58089e1dff410fbdac45290658")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0xaab87d565dd96e58089e1dff410fbdac45290658] + Op.PUSH2[0x61c]
    ...
    pre[callee] = Account(
        balance=0xfffffffffffff,
        nonce=0,
        code=Op.PUSH1[0x1] + Op.PUSH2[0xc34f] + Op.CALLDATALOAD + Op.RETURN + Op.STOP,
    )
