"""
Ported from:
tests/static/state_tests/stQuadraticComplexityTest/Call50000_rip160Filler.json
...
def test_call50000_rip160(
    ...
    contract = Address("0xc10d84baa3a4bb4e45c856ebe1ef386bfed327db")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH2[0xc350] + Op.PUSH1[0x0] + Op.PUSH1[0x1] + Op.PUSH1[0x3]
