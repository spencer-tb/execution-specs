"""
Ported from:
tests/static/state_tests/stQuadraticComplexityTest/Call50000_identityFiller.json
...
def test_call50000_identity(
    ...
    contract = Address("0x25d58a9d3632eea7b6146cdaa0b4d323a83a814e")
    ...
    pre[contract] = Account(
        ...
        + Op.ISZERO + Op.PUSH1[0x2c] + Op.JUMPI + Op.PUSH1[0x0] + Op.PUSH1[0x0]
        + Op.PUSH2[0xc350] + Op.PUSH1[0x0] + Op.PUSH1[0x1] + Op.PUSH1[0x4]
        + Op.PUSH2[0x61c] + Op.CALL + Op.PUSH1[0x0] + Op.SSTORE + Op.PUSH1[0x1]
