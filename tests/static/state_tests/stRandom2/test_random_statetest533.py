...
def test_random_statetest533(
    ...
    pre[contract] = Account(
        ...
        + Op.DUP5 + Op.PUSH32[0x10000000000000000000000000000000000000000]
        + Op.GASPRICE + Op.SMOD + Op.PUSH2[0x5255] + Op.PUSH1[0x0] + Op.MLOAD
        + Op.SSTORE
    ),
    )
    ...
    post = {
        Address("0x095e7baea6a6c7c4c2dfeb977efac326af552d87"): Account(storage={0: 21077}, nonce=0),
