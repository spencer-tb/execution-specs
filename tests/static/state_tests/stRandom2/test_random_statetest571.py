...
def test_random_statetest571(
    ...
    pre[contract] = Account(
        ...
        + Op.EXTCODECOPY + Op.PUSH6[0x8766c8b6b40] + Op.GASPRICE + Op.PUSH1[0x0]
        + Op.MLOAD + Op.SSTORE
    ),
    )
    ...
    post = {
        Address("0x095e7baea6a6c7c4c2dfeb977efac326af552d87"): Account(storage={0: 10}, nonce=0),
