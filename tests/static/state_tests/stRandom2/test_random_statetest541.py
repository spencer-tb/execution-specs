...
def test_random_statetest541(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xc350] + Op.PUSH32[0x1] + Op.PUSH32[0x0]
        + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.NUMBER
        + Op.CALLDATALOAD + Op.PUSH10[0x6e089257368d07897d57] + Op.CALLDATALOAD
        + Op.SIGNEXTEND + Op.LT + Op.SSTORE + Op.PUSH1[0x0] + Op.MLOAD + Op.SSTORE
    ),
    )
