...
contract code:
    ...
    push32 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
    push32 0xc350
    push13 0x8ea356796d65546d3883768f55
    push1 0x00
    mload
    sstore
"""
...
def test_random_statetest514(
    ...
    contract = Address("0xbe3897120c02cf547bd00c022d454cf657a04217")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0xc350] + Op.PUSH13[0x8ea356796d65546d3883768f55] + Op.PUSH1[0x0]
        + Op.MLOAD + Op.SSTORE
    ),
    )
