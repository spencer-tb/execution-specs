...
def test_random_statetest496(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x0] + Op.CALLDATALOAD + Op.JUMPDEST + Op.PUSH32[0x1]
        + Op.PUSH32[0xc350] + Op.SIGNEXTEND + Op.SIGNEXTEND + Op.MUL + Op.SMOD
        + Op.SWAP7 + Op.SSTORE + Op.PUSH1[0x0] + Op.MLOAD + Op.SSTORE
    ),
    )
