...
contract code:
    ...
    push12 0xa218f370862059149e3cff20
    push1 0x00
    mload
    sstore
"""
...
def test_random_statetest506(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x0] + Op.TIMESTAMP + Op.CALLDATACOPY
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0x10000000000000000000000000000000000000000]
        + Op.PUSH12[0xa218f370862059149e3cff20] + Op.PUSH1[0x0] + Op.MLOAD + Op.SSTORE
    ),
    )
    ...
    post = {
        Address("0x095e7baea6a6c7c4c2dfeb977efac326af552d87"): Account(
            storage={0: 0xa218f370862059149e3cff20, 0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff: 0},
            nonce=0,
        ),
