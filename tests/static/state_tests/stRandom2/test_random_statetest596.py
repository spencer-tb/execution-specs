...
contract code:
    ...
    push32 0xffffffffffffffffffffffffffffffffffffffff
    push32 0x00
    push16 0x7066a3507f6e09065394563830652055
    push1 0x00
    mload
    sstore
"""
...
def test_random_statetest596(
    ...
    pre[contract] = Account(
        ...
        + Op.BALANCE + Op.PUSH32[0x10000000000000000000000000000000000000000]
        + Op.PUSH32[0x10000000000000000000000000000000000000000]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x0]
        + Op.PUSH16[0x7066a3507f6e09065394563830652055] + Op.PUSH1[0x0] + Op.MLOAD
        + Op.SSTORE
    ),
    )
