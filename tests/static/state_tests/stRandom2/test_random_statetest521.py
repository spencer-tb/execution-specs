...
contract code:
    ...
    push11 0x73905597946a57769a6d92
    mulmod
    caller
    sstore
    push1 0x00
...
def test_random_statetest521(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH11[0x73905597946a57769a6d92] + Op.MULMOD + Op.CALLER + Op.SSTORE
    ...
    post = {
        Address("0x095e7baea6a6c7c4c2dfeb977efac326af552d87"): Account(
            storage={0: 0x10000000000000000000000000000000000000000, 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b: 0xffffffffffffffffffffffffffffffffffffffffff8c6faa686b95a88965926d},
            nonce=0,
        ),
