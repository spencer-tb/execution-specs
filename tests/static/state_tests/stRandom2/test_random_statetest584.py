...
def test_random_statetest584(
    ...
    pre[contract] = Account(
        ...
        + Op.SWAP7 + Op.SWAP3 + Op.NOT + Op.MULMOD + Op.CALLER + Op.SSTORE
    ...
    post = {
        Address("0x095e7baea6a6c7c4c2dfeb977efac326af552d87"): Account(
            storage={0: 0xffffffffffffffffffffffffffffffffffffffff, 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b: 0xffffffffffffffffffffffff0000000000000000000000000000000000000000},
            nonce=0,
        ),
