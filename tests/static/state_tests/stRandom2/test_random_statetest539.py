...
def test_random_statetest539(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH8[0x94200bf18b0b316e] + Op.COINBASE + Op.SSTORE + Op.PUSH1[0x0]
        + Op.MLOAD + Op.SSTORE
    ),
    )
    ...
    post = {
        Address("0x095e7baea6a6c7c4c2dfeb977efac326af552d87"): Account(
            storage={0x945304eb96065b2a98b57a48a06ae28d285a71b5: 0x94200bf18b0b316e},
            nonce=0,
        ),
