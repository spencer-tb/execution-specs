"""
Ported from:
tests/static/state_tests/stNonZeroCallsTest/NonZeroValue_TransactionCALLwithData_ToOneStorageKey_ParisFiller.json
"""
...
def test_non_zero_value_transaction_cal_lwith_data_to_one_storage_key_paris(
    ...
    post = {
        Address("0x<eoa:0xb94f5374fce5edbc8e2a8697c15331677e6ebf0b>"): Account(
            storage={0: 1},
            balance=11,
        ),
    }
