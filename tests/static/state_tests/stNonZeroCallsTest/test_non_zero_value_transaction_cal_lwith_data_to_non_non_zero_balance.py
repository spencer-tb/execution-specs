"""
Ported from:
tests/static/state_tests/stNonZeroCallsTest/NonZeroValue_TransactionCALLwithData_ToNonNonZeroBalanceFiller.json
"""
...
def test_non_zero_value_transaction_cal_lwith_data_to_non_non_zero_balance(
    ...
    post = {
        Address("0x<eoa:0xb94f5374fce5edbc8e2a8697c15331677e6ebf0b>"): Account(balance=101),
    }
