...
contract code:
    ...
    push1 0x40
    push1 0x00
    push20 0x799da5a3c983a22f9c430de1bf99134ee561e856
    push3 0x0249f0
    delegatecall
    push1 0x00
    sstore
...
def test_callcodecall_10_suicide_end(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0x799da5a3c983a22f9c430de1bf99134ee561e856] + Op.PUSH3[0x249f0]
    ...
    pre[callee_1] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH20[0x703b936fd4d674f0ff5d6957f61097152f8781b8]
        + Op.PUSH2[0xc350] + Op.CALLCODE + Op.PUSH1[0x1] + Op.SSTORE
