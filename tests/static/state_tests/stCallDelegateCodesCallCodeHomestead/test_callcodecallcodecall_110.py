...
callee_1 code:
    ...
    push1 0x40
    push1 0x00
    push20 0x2f1dbd8e6a5782a1a446d6ced65d3b316c857b55
    push3 0x0493e0
    delegatecall
    push1 0x01
    sstore
...
def test_callcodecallcodecall_110(
    ...
    pre[callee_1] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x2f1dbd8e6a5782a1a446d6ced65d3b316c857b55] + Op.PUSH3[0x493e0]
    ...
    post = {
        Address("0x1000000000000000000000000000000000000000"): Account(
            storage={0: 1, 1: 1, 2: 1, 3: 1, 4: 0x1000000000000000000000000000000000000000, 5: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 6: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 7: 1, 330: 0x1000000000000000000000000000000000000000, 332: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 336: 64, 338: 39, 340: 10},
        ),
