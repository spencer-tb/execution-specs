...
contract code:
    ...
    push1 0x40
    push1 0x00
    push20 0x29f893b720e998ccd5971409fa9a8802822fdcbc
    push3 0x0c3500
    delegatecall
    push1 0x00
    sstore
...
callee code:
    ...
    push1 0x40
    push1 0x00
    push20 0x71e7e95d2dfe9f65b4522f2d3aa71fb33f49920c
    push3 0x0927c0
    delegatecall
    push1 0x01
    sstore
...
def test_callcodecallcodecallcode_111_oogm_before(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0x29f893b720e998ccd5971409fa9a8802822fdcbc] + Op.PUSH3[0xc3500]
    ...
    pre[callee] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x71e7e95d2dfe9f65b4522f2d3aa71fb33f49920c] + Op.PUSH3[0x927c0]
    ...
    post = {
        Address("0x1000000000000000000000000000000000000000"): Account(storage={0: 1, 11: 1}),
        ...
        Address("0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b"): Account(storage={2: 0}),
    }
