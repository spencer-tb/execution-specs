...
callee_1 code:
    ...
    push1 0x40
    push1 0x00
    push20 0x12bdab5af7fd144e2841e58cb6cf90d467054643
    push3 0x0493e0
    delegatecall
    push1 0x01
    sstore
...
def test_callcodecallcodecallcode_111(
    ...
    pre[callee_1] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x12bdab5af7fd144e2841e58cb6cf90d467054643] + Op.PUSH3[0x493e0]
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x66f7a765dc70598f71b119f636a53aaa43c4cca1] + Op.PUSH3[0x55730]
