...
callee code:
    ...
    push1 0x00
    push1 0x00
    push20 0x7b1ed5fa290739659102e7c47b650efd2eba625b
    push3 0x0927c0
    callcode
    push1 0x01
    sstore
...
contract code:
    ...
    push1 0x00
    push1 0x00
    push20 0x37e72dd6ff3c2ac8c1ddab092a26164a2ad5988c
    push3 0x0c3500
    callcode
    push1 0x00
    sstore
...
def test_callcallcallcode_001_oogm_after(
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0x7b1ed5fa290739659102e7c47b650efd2eba625b]
        + Op.PUSH3[0x927c0] + Op.CALLCODE + Op.PUSH1[0x1] + Op.SSTORE
        + Op.PUSH3[0x2fffff] + Op.PUSH1[0x0] + Op.SHA3 + Op.STOP
    ),
    )
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH20[0x37e72dd6ff3c2ac8c1ddab092a26164a2ad5988c]
        + Op.PUSH3[0xc3500] + Op.CALLCODE + Op.PUSH1[0x0] + Op.SSTORE + Op.PUSH1[0x1]
    ...
    post = {
        Address("0x1000000000000000000000000000000000000000"): Account(storage={0: 0, 11: 1}),
