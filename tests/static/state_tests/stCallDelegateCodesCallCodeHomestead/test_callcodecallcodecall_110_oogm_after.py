...
callee_1 code:
    ...
    push1 0x40
    push1 0x00
    push20 0x0be2d28f50cb59ffbd66d2eb6a3e8d34f3561d8b
    push3 0x0927c0
    delegatecall
    push1 0x01
    sstore
...
def test_callcodecallcodecall_110_oogm_after(
    ...
    pre[callee_1] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0xbe2d28f50cb59ffbd66d2eb6a3e8d34f3561d8b] + Op.PUSH3[0x927c0]
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x1adae71ad3aeec97978e38be04da2a1773dfc506] + Op.PUSH3[0xc3500]
