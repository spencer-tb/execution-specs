...
def test_callcallcodecall_010_ooge(
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0x1dd747f92062bb53bb8e867ec2902792435f1748]
    ...
    pre[callee_2] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x6322dc554acdcada01cbf7ac6a163d207c34ded2] + Op.PUSH3[0x927c0]
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH20[0x69a0017a51ad556682f48b32235d0b61abdf4da4]
