...
callee code:
    ...
    push1 0x00
    push1 0x00
    push20 0x926dfbcc20b2ab686fc85331883541d174ccc738
    push3 0x0927c0
    callcode
    push1 0x01
    sstore
...
def test_callcodecallcall_100_oogm_after(
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0x926dfbcc20b2ab686fc85331883541d174ccc738]
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x37e72dd6ff3c2ac8c1ddab092a26164a2ad5988c] + Op.PUSH3[0xc3500]
        + Op.DELEGATECALL + Op.PUSH1[0x0] + Op.SSTORE + Op.PUSH1[0x1] + Op.PUSH1[0xb]
        + Op.SSTORE + Op.STOP
    ),
    )
    pre[callee_1] = Account(
        ...
        + Op.PUSH3[0x61a80] + Op.CALLCODE + Op.PUSH1[0x2] + Op.SSTORE + Op.STOP
    ),
    )
