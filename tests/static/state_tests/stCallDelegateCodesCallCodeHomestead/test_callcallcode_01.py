...
contract code:
    ...
    push1 0x00
    push1 0x01
    push20 0x1ccccf19d84280c8a0e94209761296dabd87b3c9
    push3 0x055730
    callcode
    push1 0x00
    sstore
...
def test_callcallcode_01(
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x1] + Op.PUSH20[0x1ccccf19d84280c8a0e94209761296dabd87b3c9]
    ...
    post = {
        Address("0x1000000000000000000000000000000000000000"): Account(
            storage={0: 1, 1: 1, 2: 1, 4: 0x1000000000000000000000000000000000000000, 5: 1, 230: 0x1000000000000000000000000000000000000000, 232: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 236: 64, 238: 34, 240: 10},
        ),
        Address("0x<contract:0x1000000000000000000000000000000000000001>"): Account(
            storage={1: 0, 2: 0, 4: 0},
        ),
        Address("0x<contract:0x1000000000000000000000000000000000000002>"): Account(storage={4: 0}),
    }
