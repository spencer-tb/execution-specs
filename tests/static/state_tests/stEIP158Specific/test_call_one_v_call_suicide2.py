...
callee code:
    push20 0xeb201d2887816e041f6e807e804f64f3a7a226fe
    selfdestruct
    stop
...
contract code:
    ...
    push1 0x00
    push1 0x01
    push20 0x99378e0db04e57ae174ad69770e1b7a0aa805930
    push2 0xea60
    call
    pop
    gas
...
def test_call_one_v_call_suicide2(
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH20[0xeb201d2887816e041f6e807e804f64f3a7a226fe] + Op.SELFDESTRUCT
        + Op.STOP
    ),
    )
    pre[contract] = Account(
        ...
        + Op.PUSH20[0x99378e0db04e57ae174ad69770e1b7a0aa805930] + Op.PUSH2[0xea60]
    ...
    post = {
        ...
        Address("0x<eoa:0xd94f5374fce5edbc8e2a8697c15331677e6ebf0b>"): Account(balance=1),
