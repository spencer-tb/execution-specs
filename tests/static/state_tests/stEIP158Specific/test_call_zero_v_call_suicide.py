...
callee code:
    push20 0x61385ed1c4e08aa26be16da3851df1cc90ed2777
    selfdestruct
    stop
"""
...
def test_call_zero_v_call_suicide(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x64] + Op.SSTORE + Op.STOP
    ),
    )
    pre[callee] = Account(
        balance=0,
        nonce=0,
        code=(
        Op.PUSH20[0x61385ed1c4e08aa26be16da3851df1cc90ed2777] + Op.SELFDESTRUCT
        + Op.STOP
    ),
    )
    ...
    post = {
        Address("0x<contract:0xc94f5374fce5edbc8e2a8697c15331677e6ebf0b>"): Account(balance=0),
        Address("0xb94f5374fce5edbc8e2a8697c15331677e6ebf0b"): Account(storage={100: 7637}),
    }
