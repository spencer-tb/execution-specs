...
callee_2 code:
    ...
    push1 0x40
    push1 0x00
    push20 0xa297e445dc76a67bf6fc17c444c1ec2c389ce53d
    push3 0x0493e0
    delegatecall
    push1 0x01
    sstore
...
def test_callcallcodecall_010(
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH1[0x2] + Op.PUSH20[0x7e63847aad8ca50fb7c04777dce6871a6bf8de0c]
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x1] + Op.PUSH20[0xfed08e44ae95ece264bc94a1fc45af8bc4ef4f1d]
    ...
    pre[callee_2] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0xa297e445dc76a67bf6fc17c444c1ec2c389ce53d] + Op.PUSH3[0x493e0]
    ...
    post = {
        ...
        Address("0x<contract:0x1000000000000000000000000000000000000001>"): Account(
            storage={1: 1, 2: 1, 5: 0x1000000000000000000000000000000000000000},
        ),
        ...
        Address("0x<contract:0x1000000000000000000000000000000000000003>"): Account(
            storage={3: 1, 4: 0x1000000000000000000000000000000000000001, 7: 2, 330: 0x1000000000000000000000000000000000000003, 332: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 336: 64, 338: 39, 340: 10},
        ),
    }
