...
def test_callcallcallcode_001(
    ...
    post = {
        ...
        Address("0x<contract:0x1000000000000000000000000000000000000002>"): Account(
            storage={2: 1, 3: 1, 4: 0x1000000000000000000000000000000000000001, 7: 2, 330: 0x1000000000000000000000000000000000000002, 332: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 336: 64, 338: 39, 340: 10},
        ),
