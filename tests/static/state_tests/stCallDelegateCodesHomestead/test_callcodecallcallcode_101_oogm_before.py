...
callee_1 code:
    ...
    push1 0x00
    push1 0x00
    push20 0x2640fcba4a90a13a6438eed47fafbd5d59ecbc47
    push3 0x0927c0
    call
    push1 0x01
    sstore
...
def test_callcodecallcallcode_101_oogm_before(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0x471072d55a5a95044c2326f0e94a6d8df5b8089e] + Op.PUSH3[0xc3500]
    ...
    pre[callee_1] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH20[0x2640fcba4a90a13a6438eed47fafbd5d59ecbc47]
