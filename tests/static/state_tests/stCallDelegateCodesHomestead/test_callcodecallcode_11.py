...
callee code:
    ...
    push1 0x40
    push1 0x00
    push20 0xcb4336321fac69281bd2902d427f4ef9e8584251
    push3 0x03d090
    delegatecall
    push1 0x01
    sstore
...
def test_callcodecallcode_11(
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH20[0xcb4336321fac69281bd2902d427f4ef9e8584251] + Op.PUSH3[0x3d090]
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x2b0691cd58a1cf4628d642e9aca9ab04946e3ec9] + Op.PUSH3[0x55730]
    ...
    post = {
        Address("0x1000000000000000000000000000000000000000"): Account(
            storage={0: 1, 1: 1, 2: 1, 4: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 230: 0x1000000000000000000000000000000000000000, 232: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 236: 64, 238: 34, 240: 10},
        ),
