...
contract code:
    ...
    push1 0x40
    push1 0x00
    push20 0xfd0cc1f9a105e057b84065348c4c878dd79fa4be
    push3 0x055730
    delegatecall
    push1 0x00
    sstore
...
def test_callcodecall_10(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0xfd0cc1f9a105e057b84065348c4c878dd79fa4be] + Op.PUSH3[0x55730]
    ...
    pre[callee_1] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x1] + Op.PUSH20[0xcb4336321fac69281bd2902d427f4ef9e8584251]
    ...
    post = {
        ...
        Address("0x<contract:0x1000000000000000000000000000000000000002>"): Account(
            storage={2: 1, 4: 0x1000000000000000000000000000000000000000, 7: 1, 230: 0x1000000000000000000000000000000000000002, 232: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 236: 64, 238: 34, 240: 10},
        ),
    }
