...
callee_1 code:
    ...
    push1 0x00
    push1 0x01
    push20 0x5f6eacde5a1e97f48c5db4ee84fdf614f9dd9756
    push3 0x0493e0
    call
    push1 0x01
    sstore
...
contract code:
    ...
    push1 0x40
    push1 0x00
    push20 0x3c83297c6dcbc0520cd68714f85dc444469fb287
    push3 0x055730
    delegatecall
    push1 0x00
    sstore
...
def test_callcodecallcall_100(
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH1[0x1] + Op.PUSH20[0x5f6eacde5a1e97f48c5db4ee84fdf614f9dd9756]
    ...
    pre[callee_2] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x2] + Op.PUSH20[0x181b4ed322e192361633cc3c0a418f259ab0cf4b]
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x3c83297c6dcbc0520cd68714f85dc444469fb287] + Op.PUSH3[0x55730]
    ...
    post = {
        ...
        Address("0x<contract:0x1000000000000000000000000000000000000002>"): Account(storage={2: 1}),
        Address("0x<contract:0x1000000000000000000000000000000000000003>"): Account(
            storage={3: 1, 4: 0x1000000000000000000000000000000000000002, 7: 2, 330: 0x1000000000000000000000000000000000000003, 332: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 336: 64, 338: 39, 340: 10},
        ),
    }
