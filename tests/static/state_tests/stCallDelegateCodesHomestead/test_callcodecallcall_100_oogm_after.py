...
callee_2 code:
    ...
    push1 0x00
    push1 0x00
    push20 0x8d7270785422b63a97d83bada6aac80bebc3a99d
    push3 0x0927c0
    call
    push1 0x01
    sstore
...
def test_callcodecallcall_100_oogm_after(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0xb5d1a486869d27225126c47727513f57d329a01a] + Op.PUSH3[0xc3500]
    ...
    pre[callee_2] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH20[0x8d7270785422b63a97d83bada6aac80bebc3a99d]
