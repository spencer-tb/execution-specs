...
contract code:
    ...
    push1 0x40
    push1 0x00
    push20 0x063f88dcf511e5686bc6b446d10538e665bf81a8
    push3 0x055730
    delegatecall
    push1 0x00
    sstore
...
def test_callcodecallcallcode_101(
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH3[0x493e0] + Op.CALL + Op.PUSH1[0x1] + Op.SSTORE + Op.CALLER
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x63f88dcf511e5686bc6b446d10538e665bf81a8] + Op.PUSH3[0x55730]
    ...
    post = {
        Address("0x1000000000000000000000000000000000000000"): Account(
            storage={0: 1, 1: 1, 5: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b},
        ),
        ...
        Address("0x<contract:0x1000000000000000000000000000000000000002>"): Account(
            storage={2: 1, 3: 1, 4: 0x1000000000000000000000000000000000000000, 6: 0x1000000000000000000000000000000000000000, 7: 1, 330: 0x1000000000000000000000000000000000000002, 332: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 336: 64, 338: 39, 340: 10},
        ),
