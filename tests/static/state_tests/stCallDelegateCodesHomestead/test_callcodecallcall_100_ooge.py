...
contract code:
    ...
    push1 0x40
    push1 0x00
    push20 0xbbdce54b3c571b853032cb3a637e8f5b81dbaf0d
    push3 0x0c3500
    delegatecall
    push1 0x00
    sstore
...
def test_callcodecallcall_100_ooge(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0xbbdce54b3c571b853032cb3a637e8f5b81dbaf0d] + Op.PUSH3[0xc3500]
    ...
    pre[callee_2] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH20[0xb11130cf7eef6d3f1552623d3506a5bbb07b12ce]
