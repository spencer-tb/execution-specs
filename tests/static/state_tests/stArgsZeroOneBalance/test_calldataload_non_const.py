...
@pytest.mark.parametrize(
    "tx_data_hex, tx_value, expected_storage",
    [
        ("", 0, {0: 0}),
        ("", 1, {0: 0}),
        ("11223344", 0, {0: 0x1122334400000000000000000000000000000000000000000000000000000000}),
        ("11223344", 1, {0: 0x2233440000000000000000000000000000000000000000000000000000000000}),
    ],
