...
contract code:
    push20 0xcb87599782f7101d77a9b56283a67cd13fa0d97e
    balance
    not
    push1 0x00
    sstore
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (1, {0: 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe}),
    ],
    ids=['case0', 'case1'],
)
...
def test_not_non_const(
    ...
    contract = Address("0xcb87599782f7101d77a9b56283a67cd13fa0d97e")
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH20[0xcb87599782f7101d77a9b56283a67cd13fa0d97e] + Op.BALANCE + Op.NOT
