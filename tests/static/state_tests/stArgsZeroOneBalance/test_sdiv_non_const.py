...
contract code:
    push20 0xa652fe2c234233d6eb3d62b283d56f67c76635bd
    balance
    push20 0xa652fe2c234233d6eb3d62b283d56f67c76635bd
    balance
    sdiv
...
def test_sdiv_non_const(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH20[0xa652fe2c234233d6eb3d62b283d56f67c76635bd] + Op.BALANCE
        + Op.PUSH20[0xa652fe2c234233d6eb3d62b283d56f67c76635bd] + Op.BALANCE + Op.SDIV
