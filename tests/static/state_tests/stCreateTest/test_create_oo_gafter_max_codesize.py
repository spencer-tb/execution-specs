...
@pytest.mark.parametrize(
    ...
    pytest.param(
        ...
        {Address("0x00000000000000000000000000000000000c0dea"): Account(storage={1: 1}, nonce=1), Address("0x00000000000000000000000000000000000c0deb"): Account(storage={}, nonce=1), Address("0x76e2310dc9277b22ffceb40d49229131674ebe02"): Account.NONEXISTENT, Address("0xb3210b741a5dfbddc1636521965b3558defa3e60"): Account.NONEXISTENT},
        id="case0",
    ),
    pytest.param(
