...
callee_21 code:
    ...
    dup3
    sstore
    push32 0x6001600055600060005560016000f30000000000000000000000000000000000
    dup2
    mstore
    dup2
    swap1
...
@pytest.mark.parametrize(
    ...
    pytest.param(
        ...
        {Address("0x4501f8fa1e67827ebfb1f6d5510c606871c5a599"): Account(storage={0: 1}, nonce=1, code=bytes.fromhex("00")), Address("0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b"): Account(nonce=2)},
        id="case0",
    ),
    pytest.param(
