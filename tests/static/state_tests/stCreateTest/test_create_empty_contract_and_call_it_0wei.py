"""
Ported from:
tests/static/state_tests/stCreateTest/CREATE_EmptyContractAndCallIt_0weiFiller.json
...
def test_create_empty_contract_and_call_it_0wei(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x1] + Op.SLOAD + Op.PUSH2[0xea60]
    ...
    post = {
        contract: Account(
            storage={0: 0x8d5b6, 1: 0xf1ecf98489fa9ed60a664fc4998db699cfa39d40, 2: 0x7abf8, 3: 1, 100: 0x6fe6b},
        ),
