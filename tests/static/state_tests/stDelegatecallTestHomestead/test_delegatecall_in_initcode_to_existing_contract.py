...
contract code:
    ...
    push1 0x00
    mstore
    push32 0xa0f4600055336001550000000000000000000000000000000000000000000000
    push1 0x20
    mstore
    push1 0x40
    push1 0x00
...
def test_delegatecall_in_initcode_to_existing_contract(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xa0f4600055336001550000000000000000000000000000000000000000000000]
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH5[0x6001600055] + Op.PUSH1[0x0] + Op.MSTORE + Op.PUSH1[0x5]
        + Op.PUSH1[0x1b] + Op.PUSH1[0x1] + Op.CREATE + Op.STOP
    ),
    )
    pre[callee_1] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH1[0x1] + Op.PUSH1[0x2] + Op.SSTORE + Op.CALLER + Op.PUSH1[0xb]
        + Op.SSTORE + Op.STOP
    ),
    )
