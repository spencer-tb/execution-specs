...
contract code:
    ...
    push1 0x00
    mstore
    push32 0xa0f4600055000000000000000000000000000000000000000000000000000000
    push1 0x20
    mstore
    push1 0x40
    push1 0x00
...
def test_delegatecall_in_initcode_to_empty_contract(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xa0f4600055000000000000000000000000000000000000000000000000000000]
    ...
    post = {
        Address("0x13136008b64ff592819b2fa6d43f2835c452020e"): Account(storage={0: 1}, balance=1),
    }
