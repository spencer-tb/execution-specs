"""
Ported from:
tests/static/state_tests/stDelegatecallTestHomestead/callWithHighValueAndGasOOGFiller.json
...
def test_call_with_high_value_and_gas_oog(
    ...
    contract = Address("0xa7465a0005567e06fbaa3ae783e57f22419c5a0a")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0x896f13e800125c0ccec44f3c434335f0a97bc1b]
        + Op.PUSH12[0xffffffffffffffffffffffff] + Op.DELEGATECALL + Op.PUSH1[0x0]
        + Op.SSTORE + Op.STOP
    ),
    )
