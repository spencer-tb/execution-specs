...
def test_callcall_00(
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH1[0x2] + Op.PUSH20[0x33f368f0b54063613cf5944941e8e0e4eeb64697]
    ...
    post = {
        Address("0x<contract:0x1000000000000000000000000000000000000002>"): Account(
            storage={2: 1, 4: 0x1000000000000000000000000000000000000001, 7: 2, 230: 0x1000000000000000000000000000000000000002, 232: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 236: 64, 238: 34, 240: 10},
        ),
    }
