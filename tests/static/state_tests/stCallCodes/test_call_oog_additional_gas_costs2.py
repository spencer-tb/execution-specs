...
def test_call_oog_additional_gas_costs2(
    ...
    post = {
        Address("0x1000000000000000000000000000000000000000"): Account(storage={0: 2}),
        Address("0x<contract:0x1000000000000000000000000000000000000001>"): Account(balance=0),
    }
