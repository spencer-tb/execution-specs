...
contract code:
    ...
    push1 0x00
    push1 0x00
    push20 0x9196f97bca1b117e521275693c79420479d9cc90
    push3 0x0249f0
    call
    push1 0x00
    sstore
...
def test_callcall_00_ooge(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0x9196f97bca1b117e521275693c79420479d9cc90]
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH2[0x4e34] + Op.CALL + Op.PUSH1[0x1] + Op.SSTORE + Op.PUSH1[0x1]
