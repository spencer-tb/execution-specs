...
contract code:
    ...
    push1 0x00
    push1 0x00
    push20 0xb5d1a486869d27225126c47727513f57d329a01a
    push3 0x0c3500
    callcode
    push1 0x00
    sstore
...
def test_callcodecallcallcode_101_oogm_after(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0xb5d1a486869d27225126c47727513f57d329a01a]
    ...
    pre[callee_2] = Account(
        ...
        + Op.PUSH3[0x927c0] + Op.CALL + Op.PUSH1[0x1] + Op.SSTORE + Op.PUSH3[0x2fffff]
