...
callee_2 code:
    ...
    push1 0x00
    push1 0x02
    push20 0x0ffffaeb931552e5f094ca96a70be612da56b887
    push3 0x0493e0
    callcode
    push1 0x01
    sstore
...
def test_callcallcodecallcode_011(
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH1[0x3] + Op.PUSH20[0x181b4ed322e192361633cc3c0a418f259ab0cf4b]
    ...
    pre[callee_2] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x2] + Op.PUSH20[0xffffaeb931552e5f094ca96a70be612da56b887]
    ...
    post = {
        Address("0x<contract:0x1000000000000000000000000000000000000001>"): Account(
            storage={1: 1, 2: 1, 3: 1, 4: 0x1000000000000000000000000000000000000001, 7: 3, 330: 0x1000000000000000000000000000000000000001, 332: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 336: 64, 338: 39, 340: 10},
        ),
    }
