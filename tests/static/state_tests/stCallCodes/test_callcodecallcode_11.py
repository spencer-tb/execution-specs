...
def test_callcodecallcode_11(
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x1] + Op.PUSH20[0x69142b38329c92930601fe8da12dc5866cde11c3]
    ...
    post = {
        Address("0x1000000000000000000000000000000000000000"): Account(
            storage={0: 1, 1: 1, 2: 1, 4: 0x1000000000000000000000000000000000000000, 7: 2, 230: 0x1000000000000000000000000000000000000000, 232: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 236: 64, 238: 34, 240: 10},
        ),
    }
