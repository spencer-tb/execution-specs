...
contract code:
    ...
    push1 0x00
    push1 0x00
    push20 0xa4173498c0da91570d8af9a128c337a67a6b4e69
    push3 0x0c3500
    callcode
    push1 0x00
    sstore
...
callee code:
    ...
    push1 0x00
    push1 0x00
    push20 0xdbb53599a5d13e0c465e1cc4ff24d7f00d780df4
    push3 0x0927c0
    callcode
    push1 0x01
    sstore
...
def test_callcodecallcodecallcode_111_oogm_before(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0xa4173498c0da91570d8af9a128c337a67a6b4e69]
    ...
    pre[callee] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH20[0xdbb53599a5d13e0c465e1cc4ff24d7f00d780df4]
    ...
    pre[callee_2] = Account(
        ...
        + Op.CALLCODE + Op.PUSH1[0x2] + Op.SSTORE + Op.STOP
    ),
    )
