...
contract code:
    ...
    push1 0x00
    push1 0x00
    push20 0xf741cfee7b7fb1025dccef3db5a3cbc8ffb776f8
    push3 0x0249f0
    call
    push1 0x00
    sstore
...
def test_callcall_00_suicide_end(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0xf741cfee7b7fb1025dccef3db5a3cbc8ffb776f8]
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH2[0xc350] + Op.CALL + Op.PUSH1[0x1] + Op.SSTORE
