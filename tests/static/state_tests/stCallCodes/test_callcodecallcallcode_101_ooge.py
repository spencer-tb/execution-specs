...
callee_2 code:
    ...
    push1 0x00
    push1 0x00
    push20 0x3568ec0dda63b253e338fbc4990869fd168ab515
    push3 0x0927c0
    call
    push1 0x01
    sstore
...
def test_callcodecallcallcode_101_ooge(
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH20[0xbbdce54b3c571b853032cb3a637e8f5b81dbaf0d]
    ...
    pre[callee_2] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH20[0x3568ec0dda63b253e338fbc4990869fd168ab515]
