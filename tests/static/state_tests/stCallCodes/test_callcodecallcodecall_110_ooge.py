...
callee_1 code:
    ...
    push1 0x00
    push1 0x00
    push20 0xdb067ddf10e702a0cdcaa489117330e5395155cb
    push3 0x0927c0
    callcode
    push1 0x01
    sstore
...
def test_callcodecallcodecall_110_ooge(
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0xdb067ddf10e702a0cdcaa489117330e5395155cb]
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH20[0x913cf7a18f61bab7bccf5607dfa9b730c5976000]
    ...
    pre[callee_2] = Account(
        ...
        + Op.PUSH3[0x61a80] + Op.CALL + Op.PUSH1[0x2] + Op.SSTORE + Op.PUSH1[0x1]
