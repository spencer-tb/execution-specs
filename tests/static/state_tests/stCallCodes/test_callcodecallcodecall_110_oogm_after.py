...
callee code:
    ...
    push1 0x00
    push1 0x00
    push20 0x83b7d129b58ab5315b795f9a8d34294ec60c9d63
    push3 0x0927c0
    callcode
    push1 0x01
    sstore
...
def test_callcodecallcodecall_110_oogm_after(
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0x83b7d129b58ab5315b795f9a8d34294ec60c9d63]
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH3[0x61a80] + Op.CALL + Op.PUSH1[0x2] + Op.SSTORE + Op.STOP
    ),
    )
