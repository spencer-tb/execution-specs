...
def test_refund50_1(
    ...
    post = {
        ...
        Address("0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b"): Account(nonce=1, balance=0x92f810),
    }
...
def test_refund50_2(
    ...
    coinbase = Address("0xeb201d2887816e041f6e807e804f64f3a7a226fe")
    sender = Address("0xabbef90b4b6d86caa8d6d6cd7f673a15a8de2d61")
    contract = Address("0xdd9bc2aec4f69625b8f1d9d0facb81c72e9a4d59")
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH1[0x1] + Op.PUSH1[0xa] + Op.SSTORE + Op.PUSH1[0x1] + Op.PUSH1[0xb]
        + Op.SSTORE + Op.PUSH1[0x0] + Op.PUSH1[0x1] + Op.SSTORE + Op.PUSH1[0x0]
        + Op.PUSH1[0x2] + Op.SSTORE + Op.PUSH1[0x0] + Op.PUSH1[0x3] + Op.SSTORE
        + Op.PUSH1[0x0] + Op.PUSH1[0x4] + Op.SSTORE + Op.PUSH1[0x0] + Op.PUSH1[0x5]
        + Op.SSTORE + Op.STOP
    ),
        storage={0x1: 0x1, 0x2: 0x1, 0x3: 0x1, 0x4: 0x1, 0x5: 0x1},
    )
