...
def test_refund_call_a_not_enough_gas_in_call(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH2[0x138d] + Op.CALL + Op.PUSH1[0x0] + Op.SSTORE + Op.STOP
    ),
        storage={0x1: 0x1},
    )
    ...
    post = {
        ...
        Address("0x<contract:0xaaae7baea6a6c7c4c2dfeb977efac326af552aaa>"): Account(storage={1: 1}),
        Address("0x<eoa:0x2adc25665018aa1fe0e6bc666dac8fc2697ff9ba>"): Account(balance=0),
        Address("0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b"): Account(nonce=1, balance=0xa8df4),
    }
