...
callee code:
    ...
    push1 0x00
    push1 0x00
    push20 0xf59fd1c021541704a4a52c067454304566717666
    gas
    call
    stop
...
contract code:
    ...
    push1 0x00
    push1 0x00
    push20 0x80d46fa47b41ab46a227915ae4f63559c0d4dfe2
    gas
    call
    stop
"""
...
def test_loop_calls_depth_then_revert(
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0xf59fd1c021541704a4a52c067454304566717666]
    ...
    pre[contract] = Account(
        ...
        Op.PUSH1[0x1] + Op.PUSH1[0x0] + Op.SLOAD + Op.ADD + Op.PUSH1[0x0]
        + Op.SSTORE + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH20[0x80d46fa47b41ab46a227915ae4f63559c0d4dfe2]
        + Op.GAS + Op.CALL + Op.STOP
    ),
    )
