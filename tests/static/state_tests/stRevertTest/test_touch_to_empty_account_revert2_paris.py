...
contract code:
    ...
    push1 0x00
    push1 0x00
    push20 0xfc4d79463bc948eb3fe54196270de2b78c201506
    push3 0x01fbd0
    call
    push1 0x01
    sstore
...
def test_touch_to_empty_account_revert2_paris(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0]
        + Op.PUSH20[0xfc4d79463bc948eb3fe54196270de2b78c201506] + Op.PUSH3[0x1fbd0]
    ...
    pre[callee_1] = Account(
        ...
        Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH20[0x76fae819612a29489a1a43208613d8f8557b8898]
        + Op.PUSH3[0x1fbd0] + Op.CALL + Op.PUSH1[0x2] + Op.SSTORE + Op.PUSH3[0x2fffff]
