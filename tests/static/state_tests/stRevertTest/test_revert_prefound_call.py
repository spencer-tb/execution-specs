...
contract code:
    ...
    push1 0x00
    push1 0x00
    push20 0x85fdde91fd0ce22a2968e1f1b2ebb9f9e5a180ba
    push2 0xc350
    call
    push1 0x00
    sstore
...
def test_revert_prefound_call(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0x85fdde91fd0ce22a2968e1f1b2ebb9f9e5a180ba]
    ...
    post = {
        Address("0x<eoa:0x7db299e0885c85039f56fa504a13dd8ce8a56aa7>"): Account(
            storage={},
            nonce=0,
            balance=1,
            code=b"",
