...
def test_loop_calls_depth_then_revert3(
    ...
    post = {
        Address("0x7db299e0885c85039f56fa504a13dd8ce8a56aa7"): Account(nonce=2, balance=1),
        Address("0xcd6807039caffddbd1c28a749ec91bef15f448e5"): Account(nonce=1, balance=2),
    }
