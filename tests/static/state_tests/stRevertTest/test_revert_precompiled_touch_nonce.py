...
def test_revert_precompiled_touch_nonce(
    ...
    post = {
        Address("0x<eoa:0x0000000000000000000000000000000000000001>"): Account(nonce=1, balance=0),
        Address("0x<eoa:0x0000000000000000000000000000000000000002>"): Account(nonce=1, balance=0),
        Address("0x<eoa:0x0000000000000000000000000000000000000003>"): Account(nonce=1, balance=0),
        Address("0x<eoa:0x0000000000000000000000000000000000000004>"): Account(nonce=1, balance=0),
        Address("0x<eoa:0x0000000000000000000000000000000000000005>"): Account(nonce=1, balance=0),
        Address("0x<eoa:0x0000000000000000000000000000000000000006>"): Account(nonce=1, balance=0),
        Address("0x<eoa:0x0000000000000000000000000000000000000007>"): Account(nonce=1, balance=0),
        Address("0x<eoa:0x0000000000000000000000000000000000000008>"): Account(nonce=1, balance=0),
    }
