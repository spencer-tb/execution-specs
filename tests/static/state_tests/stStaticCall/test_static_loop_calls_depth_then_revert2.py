"""
Ported from:
tests/static/state_tests/stStaticCall/static_LoopCallsDepthThenRevert2Filler.json
...
def test_static_loop_calls_depth_then_revert2(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH2[0x3ff] + Op.PUSH1[0x0] + Op.CALLDATALOAD + Op.EQ + Op.PUSH1[0x3d]
        ...
        + Op.GAS + Op.STATICCALL + Op.POP + Op.PUSH2[0x41a] + Op.PUSH1[0x0] + Op.MLOAD
        + Op.LT + Op.PUSH1[0x51] + Op.JUMPI + Op.JUMPDEST + Op.PUSH7[0x600060006002f0]
