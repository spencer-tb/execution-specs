"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcodecallcodecall_110_OOGE2Filler.json
...
contract code:
    ...
    push1 0x00
    callvalue
    push20 0x90390f435b22c948fbea0c86c37ecbfec700cf9d
    push3 0x0249f0
    callcode
    push1 0x00
    sstore
...
def test_static_callcodecallcodecall_110_ooge2(
    ...
    callee = Address("0x90390f435b22c948fbea0c86c37ecbfec700cf9d")
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.CALLVALUE + Op.PUSH20[0x90390f435b22c948fbea0c86c37ecbfec700cf9d]
