"""
Ported from:
tests/static/state_tests/stStaticCall/static_InternalCallHittingGasLimit2Filler.json
...
def test_static_internal_call_hitting_gas_limit2(
    ...
    contract = Address("0xf0801b78978104bae7d7d679f8e3990492825c3e")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0x285bb5c8a71646ab9a5796d4a718cc4826af8d06] + Op.PUSH2[0x61a8]
        + Op.STATICCALL + Op.PUSH1[0x1] + Op.SSTORE + Op.STOP
    ),
    )
    ...
    post = {
        Address("0xb94f5374fce5edbc8e2a8697c15331677e6ebf0b"): Account(storage={1: 0}),
    }
