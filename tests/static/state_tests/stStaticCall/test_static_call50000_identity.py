...
def test_static_call50000_identity(
    ...
    callee = Address("0x60ee5f7db2e72863689037b116bd02fd7c5edfe4")
    callee_1 = Address("0x8e9932c9d52eb968f6fa6bcaf50df4f2c7799852")
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH2[0xc350] + Op.PUSH1[0x0] + Op.PUSH1[0x4] + Op.PUSH2[0x61c]
