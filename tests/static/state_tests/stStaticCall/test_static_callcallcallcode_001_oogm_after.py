...
def test_static_callcallcallcode_001_oogm_after(
    ...
    post = {
        Address("0x1000000000000000000000000000000000000000"): Account(storage={0: 0, 1: 1, 2: 0}),
...
@pytest.mark.ported_from(
    ["tests/static/state_tests/stStaticCall/static_callcallcallcode_001_OOGMAfter_3Filler.json"],
)
@pytest.mark.valid_from("Cancun")
@pytest.mark.parametrize(
    "tx_data_hex",
...
def test_static_callcallcallcode_001_oogm_after_3(
    ...
    sender = Address("0xebaf50debf10e08302fe4280c32df010463ca297")
    contract = Address("0xf1f083974fd68b961e68130c27fc5ef37b49c1df")
    callee = Address("0x171a4477dfe54503dd5f21daf90429fd2f22d654")
    callee_1 = Address("0x335c5531b84765a7626e6e76688f18b81be5259c")
    callee_2 = Address("0x813986a928f9829ba2bd6633d33083759f1990a3")
    callee_3 = Address("0xc26255d9fcf9d7d38d2734cd4e980b8c00eceef6")
    ...
    pre[callee] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0xc26255d9fcf9d7d38d2734cd4e980b8c00eceef6] + Op.PUSH3[0x61ad0]
        + Op.STATICCALL + Op.POP + Op.PUSH1[0x1] + Op.PUSH1[0x3] + Op.SSTORE + Op.STOP
    ),
    )
    pre[callee_1] = Account(
