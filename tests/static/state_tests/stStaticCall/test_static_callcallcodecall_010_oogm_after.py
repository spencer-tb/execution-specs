"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcodecall_010_OOGMAfterFiller.json
...
callee_1 code:
    ...
    push1 0x40
    push1 0x00
    push20 0x5ad1f77e14fe15f07a2f5df1480dcaba5b4b6435
    push3 0x061ad0
    delegatecall
    pop
    jumpdest
...
def test_static_callcallcodecall_010_oogm_after(
    ...
    callee_1 = Address("0x3a2fb8850eea3cbd892bb77ff68da146ead9c49d")
    callee_2 = Address("0x5ad1f77e14fe15f07a2f5df1480dcaba5b4b6435")
    callee_3 = Address("0xc00fba9c86d497814a90912f8f6c63801ea59908")
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH20[0x5ad1f77e14fe15f07a2f5df1480dcaba5b4b6435] + Op.PUSH3[0x61ad0]
    ...
    pre[callee_2] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x335c5531b84765a7626e6e76688f18b81be5259c] + Op.PUSH3[0x1d4e8]
...
@pytest.mark.ported_from(
    ["tests/static/state_tests/stStaticCall/static_callcallcodecall_010_OOGMAfter_2Filler.json"],
)
@pytest.mark.valid_from("Cancun")
@pytest.mark.parametrize(
    "tx_data_hex",
