"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcodecall_010_OOGMAfter2Filler.json
...
def test_static_callcallcodecall_010_oogm_after2(
    ...
    callee_1 = Address("0x4c57f5c93feb3af1807980230371459b773a1f88")
    callee_2 = Address("0x6f67c62fa385edfe7bd280594eff367f33e51438")
    callee_3 = Address("0xce0959ec3ec0c6527232db11b856879585afb0bb")
    ...
    pre[callee_3] = Account(
        ...
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH20[0x6f67c62fa385edfe7bd280594eff367f33e51438]
        + Op.PUSH3[0x61ad0] + Op.CALLCODE + Op.POP + Op.PUSH1[0x1] + Op.PUSH1[0x1]
        + Op.SSTORE + Op.STOP
    ),
    )
