...
def test_static_call_ecrecover1(
    ...
    contract = Address("0x618120f7c175e20b183addd8859095183359b357")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.MSTORE + Op.PUSH1[0x1] + Op.PUSH1[0x20] + Op.MSTORE
        ...
        + Op.PUSH1[0x80] + Op.PUSH1[0x0] + Op.PUSH1[0x1] + Op.PUSH3[0x186a0]
