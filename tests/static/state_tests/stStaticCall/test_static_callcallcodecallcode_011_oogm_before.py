"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcodecallcode_011_OOGMBeforeFiller.json
...
contract code:
    ...
    push1 0x40
    push1 0x00
    push20 0xf752172f60d0024af14bee497ed232ab3a215362
    push3 0x0249f0
    staticcall
    push1 0x00
    sstore
...
def test_static_callcallcodecallcode_011_oogm_before(
    ...
    contract = Address("0xd28b8e27785ddee975645e09e8631d7bcb4133f3")
    callee = Address("0x25a467084f1402e7813d24d9904c6faefc4241c8")
    callee_1 = Address("0x335c5531b84765a7626e6e76688f18b81be5259c")
    callee_2 = Address("0x9d3e6c1d2bc6290f0e7161adbb3ad1ec4770d0d3")
    callee_3 = Address("0xf752172f60d0024af14bee497ed232ab3a215362")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0xf752172f60d0024af14bee497ed232ab3a215362] + Op.PUSH3[0x249f0]
    ...
    pre[callee_3] = Account(
        ...
        + Op.PUSH2[0x9c90] + Op.DELEGATECALL + Op.POP + Op.PUSH1[0x1] + Op.PUSH1[0x3]
        + Op.MSTORE + Op.STOP
    ),
    )
