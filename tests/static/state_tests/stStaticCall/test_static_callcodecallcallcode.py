"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcodecallcallcode_101Filler.json
...
contract code:
    ...
    push1 0x40
    push1 0x00
    push20 0xf553d6b8627c39028bd1e05a4f55e2a4b3042a1d
    push3 0x055730
    delegatecall
    push1 0x00
    sstore
...
callee_2 code:
    ...
    push1 0x40
    push1 0x00
    push20 0x999e3c988e5fdf24adf774e3502f0095e6530b72
    push3 0x0493e0
    staticcall
    pop
    push1 0x01
...
def test_static_callcodecallcallcode_101(
    ...
    callee_1 = Address("0x999e3c988e5fdf24adf774e3502f0095e6530b72")
    callee_2 = Address("0xf553d6b8627c39028bd1e05a4f55e2a4b3042a1d")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0xf553d6b8627c39028bd1e05a4f55e2a4b3042a1d] + Op.PUSH3[0x55730]
    ...
    pre[callee_1] = Account(
        ...
        + Op.DELEGATECALL + Op.POP + Op.PUSH1[0x1] + Op.PUSH1[0x1f] + Op.MSTORE
        + Op.STOP
    ),
    )
    ...
    pre[callee_2] = Account(
        ...
        Op.PUSH1[0x1] + Op.PUSH1[0x1] + Op.MSTORE + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x999e3c988e5fdf24adf774e3502f0095e6530b72] + Op.PUSH3[0x493e0]
