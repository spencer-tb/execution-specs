...
@pytest.mark.parametrize(
    ...
    [
        ("0000000000000000000000002455231c1be66d57981908f4ac3633dee2e242e0", {0: 1024, 1: 1, 2: 0, 3: 0}),
        ("000000000000000000000000daf588778cbccf0d5636643dbc67b42246b52f4a", {0: 0, 1: 0, 2: 0, 3: 0}),
    ],
    ids=['case0', 'case1'],
)
