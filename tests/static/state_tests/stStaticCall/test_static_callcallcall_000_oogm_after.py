"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcall_000_OOGMAfterFiller.json
...
contract code:
    ...
    push1 0x40
    push1 0x00
    push20 0x8ff16542095de9f85f7c395d6d543d19b30d97d7
    push3 0x092856
    staticcall
    push1 0x00
    sstore
...
callee_1 code:
    ...
    push1 0x40
    push1 0x00
    push20 0xc2234f6b4a777db8df1447c9c2d0c8cee376de76
    push3 0x061ad0
    staticcall
    pop
    push1 0x01
...
def test_static_callcallcall_000_oogm_after(
    ...
    contract = Address("0x03681c634a188409b5f9b8ca2382c1a1499d8a0d")
    callee = Address("0x335c5531b84765a7626e6e76688f18b81be5259c")
    callee_1 = Address("0x8ff16542095de9f85f7c395d6d543d19b30d97d7")
    callee_2 = Address("0xc2234f6b4a777db8df1447c9c2d0c8cee376de76")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0x8ff16542095de9f85f7c395d6d543d19b30d97d7] + Op.PUSH3[0x92856]
        + Op.STATICCALL + Op.PUSH1[0x0] + Op.SSTORE + Op.PUSH1[0x1] + Op.PUSH1[0x6f]
        + Op.SSTORE + Op.STOP
    ),
    )
    pre[callee] = Account(
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH20[0xc2234f6b4a777db8df1447c9c2d0c8cee376de76] + Op.PUSH3[0x61ad0]
