"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcodecall_010_SuicideEndFiller.json
...
def test_static_callcallcodecall_010_suicide_end(
    ...
    post = {
        Address("0x1000000000000000000000000000000000000000"): Account(storage={0: 1, 1: 1, 3: 0}),
