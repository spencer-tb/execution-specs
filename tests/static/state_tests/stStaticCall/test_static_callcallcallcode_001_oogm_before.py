"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcallcode_001_OOGMBeforeFiller.json
...
contract code:
    ...
    push1 0x20
    push1 0x00
    push20 0x10f374fca091cacd3e57e847ba123bc16695c44e
    push3 0x0927c0
    staticcall
    push1 0x00
    sstore
...
def test_static_callcallcallcode_001_oogm_before(
    ...
    contract = Address("0xc6df53af8aaf7c046b42cf493d4c6819ebec7994")
    callee = Address("0x10f374fca091cacd3e57e847ba123bc16695c44e")
    callee_1 = Address("0x335c5531b84765a7626e6e76688f18b81be5259c")
    callee_2 = Address("0x8214b87bb9fd41ed6c19255d74b7fcc66178c4d5")
    callee_3 = Address("0xeb89be27eb1850f5f46204e0609023f43c2edc35")
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH3[0x61ad0] + Op.STATICCALL + Op.POP + Op.PUSH1[0x1] + Op.PUSH1[0x20]
        + Op.MSTORE + Op.STOP
    ),
    )
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0x10f374fca091cacd3e57e847ba123bc16695c44e] + Op.PUSH3[0x927c0]
