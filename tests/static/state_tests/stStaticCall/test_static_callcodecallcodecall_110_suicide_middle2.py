"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcodecallcodecall_110_SuicideMiddle2Filler.json
...
def test_static_callcodecallcodecall_110_suicide_middle2(
    ...
    callee_1 = Address("0x408f1aceffec7bdaa35d77006cdcaead563bb694")
    callee_2 = Address("0x48e2d4c0b593bfebe5ddb4f13aa355b8bd83ddd3")
    ...
    pre[callee] = Account(
        ...
        + Op.CALLVALUE + Op.PUSH20[0x408f1aceffec7bdaa35d77006cdcaead563bb694]
    ...
    post = {
        Address("0x1000000000000000000000000000000000000000"): Account(balance=0xde0b6b3a7640000),
    }
