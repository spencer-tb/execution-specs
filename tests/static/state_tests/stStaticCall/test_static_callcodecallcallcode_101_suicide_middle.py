"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcodecallcallcode_101_SuicideMiddleFiller.json
...
def test_static_callcodecallcallcode_101_suicide_middle(
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH20[0x1000000000000000000000000000000000000002] + Op.PUSH3[0x186a0]
