"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcodecall_010_OOGMBefore2Filler.json
...
contract code:
    ...
    push1 0x40
    push1 0x00
    push20 0x21be848cb68a95437a4928ed657b6d5f17dd3b03
    push3 0x0c3500
    staticcall
    push1 0x00
    sstore
...
def test_static_callcallcodecall_010_oogm_before2(
    ...
    contract = Address("0x045bc6e334b0570cc84fbc4b86847063456e7c99")
    callee = Address("0x21be848cb68a95437a4928ed657b6d5f17dd3b03")
    callee_1 = Address("0x335c5531b84765a7626e6e76688f18b81be5259c")
    callee_2 = Address("0x698f17d55bfc6351c73d397d5df71d8a1a1d694d")
    callee_3 = Address("0xd0a1696cc7cfd386eb4f9236b61899a9ba48878c")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0x21be848cb68a95437a4928ed657b6d5f17dd3b03] + Op.PUSH3[0xc3500]
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.CALLDATALOAD + Op.PUSH3[0x61ad0]
        + Op.CALLCODE + Op.STOP
    ),
    )
