...
@pytest.mark.parametrize(
    ...
    [
        ("0000000000000000000000005eb006f1716196a0d072b390030a665386c48b9b", {0: 1, 1: 0, 2: 1001}),
        ("00000000000000000000000042223ec7d9570a769becbe4beed7d885e01e6e37", {0: 0, 1: 0, 2: 0}),
    ],
    ids=['case0', 'case1'],
)
