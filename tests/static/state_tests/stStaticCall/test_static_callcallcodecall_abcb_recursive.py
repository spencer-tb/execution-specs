"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcodecall_ABCB_RECURSIVEFiller.json
...
callee code:
    ...
    push1 0x40
    push1 0x00
    push20 0xe07076b3a07ff8e567e4f8451dac25bacefb88b2
    push3 0x0f4240
    delegatecall
    stop
...
def test_static_callcallcodecall_abcb_recursive(
    ...
    callee_1 = Address("0xe07076b3a07ff8e567e4f8451dac25bacefb88b2")
    ...
    pre[callee] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0xe07076b3a07ff8e567e4f8451dac25bacefb88b2] + Op.PUSH3[0xf4240]
