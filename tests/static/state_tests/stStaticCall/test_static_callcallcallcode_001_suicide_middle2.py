"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcallcode_001_SuicideMiddle2Filler.json
...
callee_2 code:
    ...
    push1 0x40
    push1 0x00
    push20 0x2dfe35a60d7de3d8eeb1d7a015541c76b0e00e9f
    push3 0x0186a0
    staticcall
    pop
    push1 0x01
...
def test_static_callcallcallcode_001_suicide_middle2(
    ...
    callee = Address("0x2dfe35a60d7de3d8eeb1d7a015541c76b0e00e9f")
    ...
    pre[callee_2] = Account(
        ...
        + Op.PUSH20[0x2dfe35a60d7de3d8eeb1d7a015541c76b0e00e9f] + Op.PUSH3[0x186a0]
