...
def test_static_callto_return2(
    ...
    contract = Address("0x547d0a349ccab317152d172e2f2ae7556c334cf3")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH2[0x1388] + Op.STATICCALL + Op.PUSH1[0x0] + Op.SSTORE + Op.PUSH1[0x0]
    ...
    post = {
        Address("0x095e7baea6a6c7c4c2dfeb977efac326af552d87"): Account(
            storage={0: 1, 1: 0x3700ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff},
            nonce=0,
        ),
    }
