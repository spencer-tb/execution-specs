"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcodecallcall_100_SuicideEndFiller.json
...
callee_1 code:
    ...
    push1 0x40
    push1 0x00
    push20 0x8c800abf2a49ca6ffac93555af4b5c7f9a3a8186
    push3 0x0186a0
    staticcall
    pop
    push1 0x01
...
def test_static_callcodecallcall_100_suicide_end(
    ...
    callee_2 = Address("0x8c800abf2a49ca6ffac93555af4b5c7f9a3a8186")
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH20[0x8c800abf2a49ca6ffac93555af4b5c7f9a3a8186] + Op.PUSH3[0x186a0]
