...
def test_static_post_to_return1(
    ...
    contract = Address("0x89478090b7c5e4389217f9728ef82cc3535cc1db")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x20] + Op.MSTORE + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x40]
        + Op.PUSH1[0x0] + Op.PUSH20[0xd5d9e9e0158920b17b6df82fac474b3e2691ee99]
        + Op.PUSH2[0x7530] + Op.STATICCALL + Op.PUSH1[0x1] + Op.SSTORE + Op.PUSH1[0x0]
    ...
    post = {
        Address("0x095e7baea6a6c7c4c2dfeb977efac326af552d87"): Account(
            storage={1: 1, 2: 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff},
        ),
    }
