"""
Ported from:
tests/static/state_tests/stStaticCall/static_CREATE_ContractSuicideDuringInitFiller.json
...
def test_static_create_contract_suicide_during_init(
    ...
    callee_3 = Address("0xe94f5374fce5edbc8e2a8697c15331677e6ebf0b")
