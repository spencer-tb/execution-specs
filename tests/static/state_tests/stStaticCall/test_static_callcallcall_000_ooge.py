...
@pytest.mark.parametrize(
    ...
    [
        ("000000000000000000000000071587c3e5f2ebf88b2a5b048733778605addb28", {0: 1, 1: 0, 2: 0, 3: 0}),
        ("0000000000000000000000009b0cb3cb3655d3173ff7c2cd51319aaf2cca3cad", {0: 1, 1: 1}),
    ],
    ids=['case0', 'case1'],
)
