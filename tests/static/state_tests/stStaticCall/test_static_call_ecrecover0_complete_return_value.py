"""
Ported from:
tests/static/state_tests/stStaticCall/static_CallEcrecover0_completeReturnValueFiller.json
...
def test_static_call_ecrecover0_complete_return_value(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x80] + Op.PUSH1[0x0] + Op.PUSH1[0x1] + Op.PUSH2[0x32c8]
    ...
    post = {
        contract: Account(storage={0: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 2: 1}),
    }
