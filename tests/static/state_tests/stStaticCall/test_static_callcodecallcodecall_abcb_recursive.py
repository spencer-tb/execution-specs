"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcodecallcodecall_ABCB_RECURSIVEFiller.json
...
def test_static_callcodecallcodecall_abcb_recursive(
    ...
    callee_1 = Address("0x2c81f66472668c71014ce3a9537b033db57af77b")
