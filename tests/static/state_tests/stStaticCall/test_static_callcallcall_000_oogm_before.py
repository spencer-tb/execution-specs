"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcall_000_OOGMBeforeFiller.json
...
contract code:
    ...
    push1 0x40
    push1 0x00
    push20 0x0edbfa645e2c5462398c0bd3a12e41ef8ec1f9f5
    push3 0x0927c0
    staticcall
    push1 0x00
    sstore
...
callee code:
    ...
    push1 0x40
    push1 0x00
    push20 0x97498b4ce896be02417bcfe036beac3332185563
    push3 0x061ad0
    staticcall
    stop
...
def test_static_callcallcall_000_oogm_before(
    ...
    contract = Address("0x081fa564a44bd568ecf6d6b044899f7ee4057f5f")
    callee = Address("0x0edbfa645e2c5462398c0bd3a12e41ef8ec1f9f5")
    callee_1 = Address("0x335c5531b84765a7626e6e76688f18b81be5259c")
    callee_2 = Address("0x97498b4ce896be02417bcfe036beac3332185563")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0xedbfa645e2c5462398c0bd3a12e41ef8ec1f9f5] + Op.PUSH3[0x927c0]
    ...
    pre[callee] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x97498b4ce896be02417bcfe036beac3332185563] + Op.PUSH3[0x61ad0]
