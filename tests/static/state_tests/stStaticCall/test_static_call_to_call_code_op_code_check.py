"""
Ported from:
tests/static/state_tests/stStaticCall/static_callToCallCodeOpCodeCheckFiller.json
...
callee code:
    ...
    push1 0x00
    push1 0x00
    push20 0xf0d7d1b32bbc0012f183fb3e3f4f9434abed93bd
    push3 0x0186a0
    callcode
    push1 0x00
    mstore
...
callee_1 code:
    ...
    jumpdest
    caller
    push20 0xea435169b5c0848d55c71080fb937e9b611a505d
    eq
    push1 0x4b
    jumpi
...
def test_static_call_to_call_code_op_code_check(
    ...
    callee = Address("0xea435169b5c0848d55c71080fb937e9b611a505d")
    callee_1 = Address("0xf0d7d1b32bbc0012f183fb3e3f4f9434abed93bd")
    ...
    pre[callee] = Account(
        ...
        code=(
        Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH20[0xf0d7d1b32bbc0012f183fb3e3f4f9434abed93bd]
        + Op.PUSH3[0x186a0] + Op.CALLCODE + Op.PUSH1[0x0] + Op.MSTORE + Op.PUSH1[0x0]
        + Op.MLOAD + Op.PUSH1[0x1] + Op.EQ + Op.PUSH1[0x38] + Op.JUMPI + Op.PUSH1[0x1]
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH20[0xea435169b5c0848d55c71080fb937e9b611a505d] + Op.EQ
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex("000000000000000000000000ea435169b5c0848d55c71080fb937e9b611a505d"),
        gas_limit=1000000,
        gas_price=10,
        nonce=0,
        value=100000,
