...
@pytest.mark.ported_from(
    ["tests/static/state_tests/stStaticCall/static_callcallcodecallcode_011_OOGMAfter_1Filler.json"],
)
@pytest.mark.valid_from("Cancun")
@pytest.mark.parametrize(
    "tx_data_hex",
...
def test_static_callcallcodecallcode_011_oogm_after_1(
    ...
    callee_1 = Address("0x037bf0d28af83352e42a45cd844899ee7c948a7c")
    callee_2 = Address("0x335c5531b84765a7626e6e76688f18b81be5259c")
    callee_3 = Address("0xea0c00bca818c88ecda8e81c47cc1eac92284a74")
