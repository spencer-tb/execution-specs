...
def test_static_callcodecallcall_100_2(
    ...
    coinbase = Address("0x2adc25665018aa1fe0e6bc666dac8fc2697ff9ba")
    sender = Address("0xebaf50debf10e08302fe4280c32df010463ca297")
    contract = Address("0x9f233647d252a405337c598a262f95052c23f7ee")
    callee = Address("0x2a142c79a9b097c111ce945214226126b75e332c")
    callee_1 = Address("0x47f2744d161ace12cc52a51922d3cee2e8ab3b89")
    callee_2 = Address("0xef859513ae36c397c43170a2980741575916167b")
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.CALLVALUE + Op.PUSH20[0x47f2744d161ace12cc52a51922d3cee2e8ab3b89]
