"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcodecallcode_011_SuicideEndFiller.json
...
def test_static_callcallcodecallcode_011_suicide_end(
    ...
    callee_2 = Address("0x92d7028788caa240253b7b2a92386464690cdc72")
