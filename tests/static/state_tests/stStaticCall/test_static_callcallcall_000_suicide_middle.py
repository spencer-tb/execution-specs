"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcall_000_SuicideMiddleFiller.json
...
callee_1 code:
    ...
    push1 0x40
    push1 0x00
    push20 0x72cc05b5a698aa0ae6848a4814180a756561f046
    push3 0x0186a0
    staticcall
    pop
    push1 0x01
...
callee_2 code:
    push20 0x8d1428c10723924a74ab6096c463edaab4cea5fb
    selfdestruct
    push1 0x40
    push1 0x00
    push1 0x40
...
def test_static_callcallcall_000_suicide_middle(
    ...
    contract = Address("0x8d1428c10723924a74ab6096c463edaab4cea5fb")
    callee = Address("0x48e2d4c0b593bfebe5ddb4f13aa355b8bd83ddd3")
    callee_1 = Address("0x620b381d01cbd812ffb798ab35a1a316bde90ce6")
    callee_2 = Address("0x72cc05b5a698aa0ae6848a4814180a756561f046")
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH20[0x72cc05b5a698aa0ae6848a4814180a756561f046] + Op.PUSH3[0x186a0]
    ...
    pre[callee_2] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH20[0x8d1428c10723924a74ab6096c463edaab4cea5fb] + Op.SELFDESTRUCT
