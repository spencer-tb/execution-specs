"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcodecall_010_SuicideMiddle2Filler.json
...
def test_static_callcallcodecall_010_suicide_middle2(
    ...
    callee_2 = Address("0x9712f0cc76e9a67107dfac82abab0f23783e97e0")
    ...
    pre[callee_2] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH20[0x408f1aceffec7bdaa35d77006cdcaead563bb694]
