"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcodecall_010_SuicideEnd2Filler.json
...
contract code:
    ...
    push1 0x40
    push1 0x00
    push20 0x9712f0cc76e9a67107dfac82abab0f23783e97e0
    push3 0x0249f0
    staticcall
    push1 0x00
    sstore
...
def test_static_callcallcodecall_010_suicide_end2(
    ...
    callee_1 = Address("0x9712f0cc76e9a67107dfac82abab0f23783e97e0")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0x9712f0cc76e9a67107dfac82abab0f23783e97e0] + Op.PUSH3[0x249f0]
    ...
    pre[callee_1] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH20[0xb7770360e0b87603e3d9c87c866451760c95abca]
    ...
    pre[callee_2] = Account(
        ...
        + Op.PUSH20[0x9712f0cc76e9a67107dfac82abab0f23783e97e0] + Op.SELFDESTRUCT
        + Op.STOP
    ),
    )
