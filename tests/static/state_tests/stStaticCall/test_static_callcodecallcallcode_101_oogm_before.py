"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcodecallcallcode_101_OOGMBeforeFiller.json
...
callee_2 code:
    ...
    push1 0x40
    push1 0x00
    push20 0x76c6dc23a4f29a65309c67ce40f50a05ed3409da
    push2 0x9c90
    staticcall
    pop
    push1 0x01
...
def test_static_callcodecallcallcode_101_oogm_before(
    ...
    callee_1 = Address("0x76c6dc23a4f29a65309c67ce40f50a05ed3409da")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0xee49ca410d3886cc84d3177a1e14451f0669852f] + Op.PUSH3[0x249f0]
    ...
    pre[callee_2] = Account(
        ...
        + Op.PUSH20[0x76c6dc23a4f29a65309c67ce40f50a05ed3409da] + Op.PUSH2[0x9c90]
