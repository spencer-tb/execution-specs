...
callee code:
    ...
    jumpdest
    caller
    push20 0x5e93bf4d3e4a5f90ae3a7a68dbd03e6c47f1245a
    eq
    push1 0x4b
    jumpi
...
def test_static_call_to_static_op_code_check(
    ...
    callee_1 = Address("0x5e93bf4d3e4a5f90ae3a7a68dbd03e6c47f1245a")
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH20[0x5e93bf4d3e4a5f90ae3a7a68dbd03e6c47f1245a] + Op.EQ
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH20[0xd366057a988cb6562f7fa2a601f06a503d30a90] + Op.PUSH3[0x186a0]
        + Op.STATICCALL + Op.PUSH1[0x0] + Op.MSTORE + Op.PUSH1[0x0] + Op.MLOAD
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex("0000000000000000000000005e93bf4d3e4a5f90ae3a7a68dbd03e6c47f1245a"),
        gas_limit=1000000,
        gas_price=10,
        nonce=0,
        value=100000,
