"""
Ported from:
tests/static/state_tests/stStaticCall/static_CallEcrecover0_overlappingInputOutputFiller.json
...
def test_static_call_ecrecover0_overlapping_input_output(
    ...
    post = {
        contract: Account(storage={0: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 1: 1, 2: 1}),
    }
