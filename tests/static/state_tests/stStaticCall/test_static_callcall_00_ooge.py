...
callee code:
    ...
    push1 0x40
    push1 0x00
    push20 0xce21f15217a7b94db9c505a66c9549e803bf141c
    push3 0x01d4d4
    staticcall
    pop
    push1 0x01
...
callee_1 code:
    ...
    push1 0x40
    push1 0x00
    push20 0x2814f1be80fce656766c827bc6e55bfb7a3bc4b9
    push3 0x055730
    staticcall
    push1 0x00
    sstore
...
callee_2 code:
    ...
    push1 0x40
    push1 0x00
    push20 0xa18394a87a4c414718bbbee0f695d74cd7a4f9de
    push3 0x0249f0
    staticcall
    push1 0x00
    sstore
...
@pytest.mark.parametrize(
    ...
    [
        ("0000000000000000000000002f9ec0afcb4edcd7d38c6a48f5e36038263ca3cd", {0: 1, 1: 0, 2: 0}),
        ("000000000000000000000000998a75f1a4457fb7b5872c51f34aa7256f732b1e", {0: 1, 1: 0, 2: 0}),
    ],
    ids=['case0', 'case1'],
)
...
def test_static_callcall_00_ooge(
    ...
    callee = Address("0x2814f1be80fce656766c827bc6e55bfb7a3bc4b9")
    callee_1 = Address("0x2f9ec0afcb4edcd7d38c6a48f5e36038263ca3cd")
    callee_2 = Address("0x998a75f1a4457fb7b5872c51f34aa7256f732b1e")
    callee_3 = Address("0xa18394a87a4c414718bbbee0f695d74cd7a4f9de")
    callee_4 = Address("0xce21f15217a7b94db9c505a66c9549e803bf141c")
    callee_5 = Address("0xe574f7ec5305be91332b5b8b12deb8966e05f42d")
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH20[0xce21f15217a7b94db9c505a66c9549e803bf141c] + Op.PUSH3[0x1d4d4]
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH20[0x2814f1be80fce656766c827bc6e55bfb7a3bc4b9] + Op.PUSH3[0x55730]
    ...
    pre[callee_2] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0xa18394a87a4c414718bbbee0f695d74cd7a4f9de] + Op.PUSH3[0x249f0]
        + Op.STATICCALL + Op.PUSH1[0x0] + Op.SSTORE + Op.STOP
    ),
    )
    pre[callee_3] = Account(
        ...
        Op.PUSH1[0x1] + Op.PUSH1[0x2] + Op.MSTORE + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0xe574f7ec5305be91332b5b8b12deb8966e05f42d] + Op.PUSH2[0x4e34]
        + Op.STATICCALL + Op.POP + Op.PUSH1[0x1] + Op.PUSH1[0x20] + Op.MSTORE
        + Op.STOP
    ),
    )
    ...
    pre[callee_4] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH1[0x1] + Op.PUSH1[0x2] + Op.SSTORE + Op.PUSH1[0x1] + Op.PUSH1[0x2]
        + Op.MSTORE + Op.STOP
    ),
    )
    ...
    post = {
        Address("0x<contract:0x2000000000000000000000000000000000000000>"): Account(storage=expected_storage),
    }
...
def test_static_callcall_00_ooge_2(
    ...
    sender = Address("0xebaf50debf10e08302fe4280c32df010463ca297")
    contract = Address("0xc0e4183389eb57f779a986d8c878f89b9401dc8e")
    callee = Address("0x2defc3fb57b42969b271935d982740948b92e86b")
    callee_1 = Address("0x609e4dfe6190235b9a0362084c741d9ec330fb1e")
    callee_2 = Address("0x998a75f1a4457fb7b5872c51f34aa7256f732b1e")
    callee_3 = Address("0xa2ca69f1cf9ffa7a761899e8dd2f941d40326fd6")
    callee_4 = Address("0xa65f4b36f21ef107a26ab282b736f93d47bf83de")
    callee_5 = Address("0xddc2b4bc1fb31ed3cd95025fb7c668ba01b2db6c")
    ...
    pre[callee_2] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0xddc2b4bc1fb31ed3cd95025fb7c668ba01b2db6c] + Op.PUSH3[0x249f0]
        + Op.STATICCALL + Op.PUSH1[0x0] + Op.SSTORE + Op.STOP
    ),
    )
    pre[callee_3] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x2defc3fb57b42969b271935d982740948b92e86b] + Op.PUSH3[0x249f0]
        + Op.STATICCALL + Op.PUSH1[0x0] + Op.SSTORE + Op.STOP
    ),
    )
    pre[callee_4] = Account(
