"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcallcode_001_SuicideEndFiller.json
...
callee_2 code:
    ...
    push1 0x40
    push1 0x00
    push20 0x4a31dd3a8c3c9a793ac0b3c234a4dbac2f201404
    push3 0x0186a0
    staticcall
    stop
"""
...
def test_static_callcallcallcode_001_suicide_end(
    ...
    callee_1 = Address("0x4a31dd3a8c3c9a793ac0b3c234a4dbac2f201404")
    ...
    pre[callee_2] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x4a31dd3a8c3c9a793ac0b3c234a4dbac2f201404] + Op.PUSH3[0x186a0]
