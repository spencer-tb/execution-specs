"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcodecallcode_011_OOGEFiller.json
...
callee code:
    ...
    push1 0x40
    push1 0x00
    push20 0x77612608c7a22f8929f6f1c9462a9954621aeefd
    push3 0x0186a0
    delegatecall
    stop
...
contract code:
    ...
    push1 0x40
    push1 0x00
    push20 0x630155b633b8b8f4bcb63e94e0baae0197c824eb
    push3 0x0249f0
    staticcall
    push1 0x00
    sstore
...
def test_static_callcallcodecallcode_011_ooge(
    ...
    callee = Address("0x630155b633b8b8f4bcb63e94e0baae0197c824eb")
    callee_1 = Address("0x77612608c7a22f8929f6f1c9462a9954621aeefd")
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH20[0x77612608c7a22f8929f6f1c9462a9954621aeefd] + Op.PUSH3[0x186a0]
    ...
    pre[contract] = Account(
        ...
        Op.PUSH1[0x0] + Op.CALLDATALOAD + Op.PUSH1[0x0] + Op.MSTORE + Op.PUSH1[0x40]
        + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x630155b633b8b8f4bcb63e94e0baae0197c824eb] + Op.PUSH3[0x249f0]
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH1[0x0] + Op.CALLDATALOAD + Op.PUSH2[0x4e34] + Op.DELEGATECALL
        + Op.STOP
    ),
    )
