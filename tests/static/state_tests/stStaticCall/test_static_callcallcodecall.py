...
contract code:
    ...
    push1 0x40
    push1 0x00
    push20 0x8bd89f495b3f37357d15a16d7b0f72470abe929f
    push3 0x055730
    staticcall
    push1 0x00
    sstore
...
callee_2 code:
    ...
    push1 0x40
    push1 0x00
    push20 0x5aaef6827794656b94367d6130f40d34b219f1fd
    push3 0x0493e0
    delegatecall
    pop
    push1 0x01
...
def test_static_callcallcodecall_010(
    ...
    contract = Address("0x46df4a924470cb27a2f8700239656c40dd4794c8")
    callee = Address("0x2a142c79a9b097c111ce945214226126b75e332c")
    callee_1 = Address("0x5aaef6827794656b94367d6130f40d34b219f1fd")
    callee_2 = Address("0x8bd89f495b3f37357d15a16d7b0f72470abe929f")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0x8bd89f495b3f37357d15a16d7b0f72470abe929f] + Op.PUSH3[0x55730]
    ...
    pre[callee_2] = Account(
        ...
        Op.PUSH1[0x1] + Op.PUSH1[0x3] + Op.MSTORE + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x5aaef6827794656b94367d6130f40d34b219f1fd] + Op.PUSH3[0x493e0]
...
def test_static_callcallcodecall_010_2(
    ...
    coinbase = Address("0x2adc25665018aa1fe0e6bc666dac8fc2697ff9ba")
    sender = Address("0xebaf50debf10e08302fe4280c32df010463ca297")
    contract = Address("0x04feba02513bfa1cf1456a0f32838b186775d8d4")
    callee = Address("0x335c5531b84765a7626e6e76688f18b81be5259c")
    callee_1 = Address("0x6b21d14ffae42852fc3a6f98da6275e551c07008")
    callee_2 = Address("0xd450d1d19aefb5a30dc4a483db88e86c215c67a0")
    callee_3 = Address("0xef859513ae36c397c43170a2980741575916167b")
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.CALLDATALOAD + Op.PUSH3[0x55730] + Op.STATICCALL
    ...
    pre[callee_1] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x2] + Op.PUSH20[0xef859513ae36c397c43170a2980741575916167b]
        + Op.PUSH3[0x493e0] + Op.CALLCODE + Op.STOP
    ),
    )
    pre[callee_2] = Account(
        balance=0xde0b6b3a7640000,
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH20[0xef859513ae36c397c43170a2980741575916167b]
        + Op.PUSH3[0x493e0] + Op.CALLCODE + Op.STOP
    ),
    )
    pre[sender] = Account(balance=0xde0b6b3a7640000, nonce=0)
