"""
Ported from:
tests/static/state_tests/stStaticCall/static_call_value_inherit_from_callFiller.json
...
contract code:
    ...
    push1 0x00
    push1 0x0a
    push20 0x453c54cfc5af8e6fd9110c386da8fbc47105d611
    push3 0x0186a0
    call
    stop
...
def test_static_call_value_inherit_from_call(
    ...
    contract = Address("0x0af4ae2156e6347e93d875a9d46085e31e57bbe9")
    callee = Address("0x453c54cfc5af8e6fd9110c386da8fbc47105d611")
    callee_1 = Address("0xcb9a81371bc2600a843f60738091e390318cda9c")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0xa] + Op.PUSH20[0x453c54cfc5af8e6fd9110c386da8fbc47105d611]
