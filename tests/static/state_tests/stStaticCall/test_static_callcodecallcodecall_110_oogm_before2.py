"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcodecallcodecall_110_OOGMBefore2Filler.json
...
contract code:
    ...
    push1 0x00
    callvalue
    push20 0x861e86c681836ff531a2f84c5cdde43e28e1d234
    push3 0x0249f0
    callcode
    push1 0x00
    sstore
...
def test_static_callcodecallcodecall_110_oogm_before2(
    ...
    contract = Address("0x45f35e7e68477a74b163dd6e4eb2833fb1979873")
    callee = Address("0x335c5531b84765a7626e6e76688f18b81be5259c")
    callee_1 = Address("0x861e86c681836ff531a2f84c5cdde43e28e1d234")
    ...
    pre[contract] = Account(
        ...
        + Op.CALLVALUE + Op.PUSH20[0x861e86c681836ff531a2f84c5cdde43e28e1d234]
