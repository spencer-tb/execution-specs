"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcodecallcodecallcode_111_SuicideEndFiller.json
...
contract code:
    ...
    push1 0x40
    push1 0x00
    push20 0x20052c9e11ec43b94405d98f61e2b5e8bb722ed1
    push3 0x0249f0
    delegatecall
    push1 0x00
    sstore
...
def test_static_callcodecallcodecallcode_111_suicide_end(
    ...
    callee = Address("0x20052c9e11ec43b94405d98f61e2b5e8bb722ed1")
    callee_1 = Address("0x48e2d4c0b593bfebe5ddb4f13aa355b8bd83ddd3")
    callee_2 = Address("0x90e9b92c59a0e93d8ab0b7afbc945d6999a50a9b")
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x20052c9e11ec43b94405d98f61e2b5e8bb722ed1] + Op.PUSH3[0x249f0]
    ...
    pre[callee_2] = Account(
        ...
        + Op.PUSH20[0x20052c9e11ec43b94405d98f61e2b5e8bb722ed1] + Op.SELFDESTRUCT
        + Op.STOP
    ),
    )
