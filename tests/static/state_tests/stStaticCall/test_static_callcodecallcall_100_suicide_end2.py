"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcodecallcall_100_SuicideEnd2Filler.json
...
def test_static_callcodecallcall_100_suicide_end2(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0x620b381d01cbd812ffb798ab35a1a316bde90ce6]
