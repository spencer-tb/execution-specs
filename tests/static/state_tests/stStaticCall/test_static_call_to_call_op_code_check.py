...
callee code:
    ...
    jumpdest
    caller
    push20 0x51a6b9d90fa023dbfe63296b65876f9caf3ff3fd
    eq
    push1 0x4b
    jumpi
...
callee_1 code:
    ...
    push1 0x00
    push1 0x00
    push20 0x0d366057a988cb6562f7fa2a601f06a503d30a90
    push3 0x0186a0
    call
    push1 0x00
    mstore
...
def test_static_call_to_call_op_code_check(
    ...
    callee = Address("0x0d366057a988cb6562f7fa2a601f06a503d30a90")
    callee_1 = Address("0x51a6b9d90fa023dbfe63296b65876f9caf3ff3fd")
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH20[0x51a6b9d90fa023dbfe63296b65876f9caf3ff3fd] + Op.EQ
        ...
        + Op.PUSH20[0xd366057a988cb6562f7fa2a601f06a503d30a90] + Op.EQ
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0xd366057a988cb6562f7fa2a601f06a503d30a90]
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex("00000000000000000000000051a6b9d90fa023dbfe63296b65876f9caf3ff3fd"),
        gas_limit=1000000,
        gas_price=10,
        nonce=0,
        value=100000,
