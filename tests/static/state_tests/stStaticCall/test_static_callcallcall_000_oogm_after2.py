"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcall_000_OOGMAfter2Filler.json
...
callee code:
    ...
    push1 0x40
    push1 0x00
    push20 0xa34eee061f267a63c872265bed51c483f777a7b0
    push3 0x06ddd0
    staticcall
    pop
    jumpdest
...
contract code:
    ...
    push1 0x40
    push1 0x00
    push20 0x10345562e309b2045c737ffdd46e941710495fc4
    push3 0x0aae60
    staticcall
    push1 0x00
    sstore
...
def test_static_callcallcall_000_oogm_after2(
    ...
    contract = Address("0x6de4e4fa82a7139e6804b5b47b42e366a9595946")
    callee = Address("0x10345562e309b2045c737ffdd46e941710495fc4")
    callee_1 = Address("0x335c5531b84765a7626e6e76688f18b81be5259c")
    callee_2 = Address("0xa34eee061f267a63c872265bed51c483f777a7b0")
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH20[0xa34eee061f267a63c872265bed51c483f777a7b0] + Op.PUSH3[0x6ddd0]
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0x10345562e309b2045c737ffdd46e941710495fc4] + Op.PUSH3[0xaae60]
