"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcodecallcallcode_101_OOGMAfter2Filler.json
...
def test_static_callcodecallcallcode_101_oogm_after2(
    ...
    pre[contract] = Account(
        ...
        + Op.CALLVALUE + Op.PUSH20[0x1000000000000000000000000000000000000001]
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH20[0x1000000000000000000000000000000000000002] + Op.PUSH2[0x9c90]
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH20[0x1000000000000000000000000000000000000003] + Op.PUSH2[0x4e34]
        + Op.CALLCODE + Op.STOP
    ),
    )
