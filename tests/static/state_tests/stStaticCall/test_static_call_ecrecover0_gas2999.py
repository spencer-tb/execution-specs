...
def test_static_call_ecrecover0_gas2999(
    ...
    contract = Address("0xa2c5b42ceef52ed9fad58b7c78f1a9fde7241247")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x80] + Op.PUSH1[0x0] + Op.PUSH1[0x1] + Op.PUSH2[0xbb7]
    ...
    post = {
        Address("0x095e7baea6a6c7c4c2dfeb977efac326af552d87"): Account(storage={2: 0}),
    }
