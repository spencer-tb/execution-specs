"""
Ported from:
tests/static/state_tests/stStaticCall/static_CallGoesOOGOnSecondLevel2Filler.json
...
contract code:
    ...
    push1 0x20
    push1 0x00
    push20 0x666ebb8afc7a9ba4bedb7d78f85184b65639531d
    push3 0x0927c0
    staticcall
    push1 0x00
    sstore
...
def test_static_call_goes_oog_on_second_level2(
    ...
    contract = Address("0xb9c1c6c39cb3e528b2ef06493c17d63b7827077b")
    callee = Address("0x45e70d14d712a8898dce133fe063f71179f04059")
    callee_1 = Address("0x666ebb8afc7a9ba4bedb7d78f85184b65639531d")
    callee_2 = Address("0xf2774cee95a518a51cd32426d3ce8db19f095b37")
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.CALLDATALOAD
        + Op.PUSH3[0x927c0] + Op.STATICCALL + Op.PUSH1[0x9] + Op.MSTORE + Op.STOP
    ),
    )
    pre[contract] = Account(
        ...
        + Op.PUSH20[0x666ebb8afc7a9ba4bedb7d78f85184b65639531d] + Op.PUSH3[0x927c0]
    ...
    post = {
        Address("0xb94f5374fce5edbc8e2a8697c15331677e6ebf0b"): Account(storage={0: 0, 1: 0}),
    }
