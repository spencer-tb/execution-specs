"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcodecallcall_100_SuicideMiddleFiller.json
...
contract code:
    ...
    push1 0x40
    push1 0x00
    push20 0xcbfd6696cbc67e0593fd4ae8a6646c6ac25ecfb8
    push3 0x0249f0
    delegatecall
    push1 0x00
    sstore
...
callee code:
    push20 0x31d06fad70e2a598413824a9bc68d80a5d2b194e
    selfdestruct
    push1 0x40
    push1 0x00
    push1 0x40
...
def test_static_callcodecallcall_100_suicide_middle(
    ...
    callee_2 = Address("0xcbfd6696cbc67e0593fd4ae8a6646c6ac25ecfb8")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0xcbfd6696cbc67e0593fd4ae8a6646c6ac25ecfb8] + Op.PUSH3[0x249f0]
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH20[0x31d06fad70e2a598413824a9bc68d80a5d2b194e] + Op.SELFDESTRUCT
        + Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
