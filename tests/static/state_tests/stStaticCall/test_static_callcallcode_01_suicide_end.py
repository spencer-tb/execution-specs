"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcode_01_SuicideEndFiller.json
...
contract code:
    ...
    push1 0x40
    push1 0x00
    push20 0x0f25670a9ca7bfa523e8b216478051e908ece142
    push3 0x0249f0
    staticcall
    push1 0x00
    sstore
...
def test_static_callcallcode_01_suicide_end(
    ...
    callee = Address("0x0f25670a9ca7bfa523e8b216478051e908ece142")
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0xf25670a9ca7bfa523e8b216478051e908ece142] + Op.PUSH3[0x249f0]
