"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcodecallcodecall_110_OOGMAfterFiller.json
...
callee_2 code:
    ...
    push1 0x40
    push1 0x00
    push20 0x1bdd0b2b81cb603f436225d2b20054c3d0593de3
    push2 0x9c90
    delegatecall
    pop
    jumpdest
...
contract code:
    ...
    push1 0x40
    push1 0x00
    push20 0x669f2ca35c01ee9379d6003704074ac1eeaa914d
    push2 0xeaf6
    delegatecall
    push1 0x00
    sstore
...
def test_static_callcodecallcodecall_110_oogm_after(
    ...
    callee = Address("0x1bdd0b2b81cb603f436225d2b20054c3d0593de3")
    callee_1 = Address("0x335c5531b84765a7626e6e76688f18b81be5259c")
    callee_2 = Address("0x669f2ca35c01ee9379d6003704074ac1eeaa914d")
    ...
    pre[callee_2] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x1bdd0b2b81cb603f436225d2b20054c3d0593de3] + Op.PUSH2[0x9c90]
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.PUSH20[0x669f2ca35c01ee9379d6003704074ac1eeaa914d] + Op.PUSH2[0xeaf6]
...
@pytest.mark.ported_from(
    ["tests/static/state_tests/stStaticCall/static_callcodecallcodecall_110_OOGMAfter_2Filler.json"],
)
@pytest.mark.valid_from("Cancun")
@pytest.mark.pre_alloc_mutable
...
@pytest.mark.ported_from(
    ["tests/static/state_tests/stStaticCall/static_callcodecallcodecall_110_OOGMAfter_3Filler.json"],
)
@pytest.mark.valid_from("Cancun")
@pytest.mark.pre_alloc_mutable
def test_static_callcodecallcodecall_110_oogm_after_3(
    ...
    coinbase = Address("0x2adc25665018aa1fe0e6bc666dac8fc2697ff9ba")
    sender = Address("0xebaf50debf10e08302fe4280c32df010463ca297")
    contract = Address("0x81450e6893351d2c0c43648338c0f2ae8d435bc1")
    callee = Address("0x335c5531b84765a7626e6e76688f18b81be5259c")
    callee_1 = Address("0xdf60cb36bcf8892d8a68903b2d2e455037149e48")
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH1[0x40] + Op.PUSH1[0x0] + Op.PUSH1[0x40] + Op.PUSH1[0x0]
        + Op.CALLVALUE + Op.PUSH20[0xdf60cb36bcf8892d8a68903b2d2e455037149e48]
