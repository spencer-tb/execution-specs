"""
Ported from:
tests/static/state_tests/stStaticCall/static_LoopCallsDepthThenRevert3Filler.json
...
def test_static_loop_calls_depth_then_revert3(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH2[0x3fe] + Op.PUSH1[0x0] + Op.CALLDATALOAD + Op.EQ + Op.PUSH1[0x3d]
        + Op.JUMPI + Op.PUSH1[0x1] + Op.PUSH1[0x0] + Op.CALLDATALOAD + Op.ADD
        ...
        + Op.GAS + Op.STATICCALL + Op.POP + Op.PUSH2[0x41a] + Op.PUSH1[0x0]
        + Op.CALLDATALOAD + Op.LT + Op.PUSH1[0x51] + Op.JUMPI + Op.JUMPDEST
        + Op.PUSH7[0x600060006002f0] + Op.PUSH1[0x0] + Op.MSTORE + Op.PUSH1[0x7]
        + Op.PUSH1[0x19] + Op.PUSH1[0x3] + Op.CREATE + Op.POP + Op.JUMPDEST
    ),
    )
