"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcallcode_001_SuicideMiddleFiller.json
...
callee_1 code:
    ...
    push1 0x40
    push1 0x00
    push20 0xb40862eb0c1f073048ac62d867277b80b57bf6e0
    push3 0x0186a0
    staticcall
    pop
    push1 0x01
...
def test_static_callcallcallcode_001_suicide_middle(
    ...
    callee_2 = Address("0xb40862eb0c1f073048ac62d867277b80b57bf6e0")
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH20[0xb40862eb0c1f073048ac62d867277b80b57bf6e0] + Op.PUSH3[0x186a0]
