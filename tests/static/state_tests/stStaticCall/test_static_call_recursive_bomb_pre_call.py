"""
Ported from:
tests/static/state_tests/stStaticCall/static_CallRecursiveBombPreCallFiller.json
...
contract code:
    ...
    push1 0x00
    push1 0x00
    push20 0x72e480206054168cfa7d5c6a1bd8c3ffe26a4d82
...
def test_static_call_recursive_bomb_pre_call(
    ...
    contract = Address("0x6a441a35b94353a66ffd7fd1e54550acecb81aaf")
    callee = Address("0x72e480206054168cfa7d5c6a1bd8c3ffe26a4d82")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0x72e480206054168cfa7d5c6a1bd8c3ffe26a4d82]
        + Op.PUSH8[0x7ffffffffffffff] + Op.DELEGATECALL + Op.PUSH1[0x0] + Op.SSTORE
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH20[0x72e480206054168cfa7d5c6a1bd8c3ffe26a4d82] + Op.PUSH3[0x36b00]
    ...
    post = {
        Address("0x095e7baea6a6c7c4c2dfeb977efac326af552d87"): Account(storage={0: 1, 1: 1}),
