"""
Ported from:
tests/static/state_tests/stStaticCall/static_callcallcallcode_001_OOGMAfter2Filler.json
...
callee code:
    ...
    push1 0x40
    push1 0x00
    push20 0xc26255d9fcf9d7d38d2734cd4e980b8c00eceef6
    push3 0x061ad0
    staticcall
    pop
    jumpdest
...
def test_static_callcallcallcode_001_oogm_after2(
    ...
    callee = Address("0x142cc6371ac4a38c018d3d1fda49a9327d8b0b45")
    callee_1 = Address("0x171a4477dfe54503dd5f21daf90429fd2f22d654")
