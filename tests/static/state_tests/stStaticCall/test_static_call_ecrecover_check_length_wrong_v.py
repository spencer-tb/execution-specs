"""
Ported from:
tests/static/state_tests/stStaticCall/static_CallEcrecoverCheckLengthWrongVFiller.json
...
def test_static_call_ecrecover_check_length_wrong_v(
    ...
    contract = Address("0x41f7ee7d96703a0f8bd1bf92288996596ca85bd6")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.MSTORE + Op.PUSH1[0x1d] + Op.PUSH1[0x20] + Op.MSTORE
        ...
        + Op.STATICCALL + Op.PUSH1[0x2] + Op.SSTORE + Op.PUSH1[0x80] + Op.MLOAD
        + Op.PUSH1[0x0] + Op.SSTORE + Op.MSIZE + Op.PUSH1[0x1] + Op.SSTORE + Op.STOP
    ),
    )
