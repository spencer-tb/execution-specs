...
def test_callcode_ecrecover2(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x61] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x1]
        + Op.PUSH3[0x186a0] + Op.CALLCODE + Op.PUSH1[0x2] + Op.SSTORE + Op.PUSH1[0xa0]
        + Op.PUSH1[0x2] + Op.EXP + Op.PUSH1[0x61] + Op.MLOAD + Op.MOD + Op.PUSH1[0x0]
