...
def test_call_sha256_0(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0xff] + Op.CALL + Op.PUSH1[0x0] + Op.MLOAD + Op.PUSH1[0x0]
        + Op.SSTORE
    ),
    )
...
def test_call_sha256_1(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH1[0x2] + Op.PUSH2[0x1f4] + Op.CALL + Op.PUSH1[0x2]
...
def test_call_sha256_2(
    ...
    coinbase = Address("0x2adc25665018aa1fe0e6bc666dac8fc2697ff9ba")
    sender = Address("0xebaf50debf10e08302fe4280c32df010463ca297")
    contract = Address("0x2558c91e1ca37007e96544e37e5348c5c209ae3d")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x2] + Op.PUSH2[0x1f4] + Op.CALL + Op.PUSH1[0x2] + Op.SSTORE
...
def test_call_sha256_3(
    ...
    coinbase = Address("0x2adc25665018aa1fe0e6bc666dac8fc2697ff9ba")
    sender = Address("0xebaf50debf10e08302fe4280c32df010463ca297")
    contract = Address("0x5ef7a23f9baea93bd729fd89fdce63578c13a01e")
...
def test_call_sha256_4(
    ...
    coinbase = Address("0x2adc25665018aa1fe0e6bc666dac8fc2697ff9ba")
    sender = Address("0xebaf50debf10e08302fe4280c32df010463ca297")
    contract = Address("0x6eaf78b8968e1ad784f281cc9ffc2ed8bdb61fbe")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x2] + Op.PUSH1[0x64] + Op.CALL
...
def test_call_sha256_5(
    ...
    coinbase = Address("0x2adc25665018aa1fe0e6bc666dac8fc2697ff9ba")
    sender = Address("0xebaf50debf10e08302fe4280c32df010463ca297")
    contract = Address("0x66088f99c73ae9e87363561b19c69011205344d0")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH2[0x258] + Op.CALL + Op.PUSH1[0x2] + Op.SSTORE + Op.PUSH1[0x0]
