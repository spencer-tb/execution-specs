"""
Ported from:
tests/static/state_tests/stPreCompiledContracts2/CALLCODEEcrecover0_Gas2999Filler.json
...
def test_callcode_ecrecover0_gas2999(
    ...
    contract = Address("0xe70dcf2a2964db146b6cb171326705f77b924943")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH2[0xbb7] + Op.CALLCODE + Op.PUSH1[0x2] + Op.SSTORE + Op.PUSH1[0xa0]
