"""
Ported from:
tests/static/state_tests/stPreCompiledContracts2/CallEcrecover0_Gas2999Filler.json
...
def test_call_ecrecover0_gas2999(
    ...
    contract = Address("0x34bc8d999c6ffd2df1999d36424d37aa91286fa3")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH2[0xbb7] + Op.CALL + Op.PUSH1[0x2] + Op.SSTORE + Op.PUSH1[0xa0]
