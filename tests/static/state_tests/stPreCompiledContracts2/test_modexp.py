"""
Puts the base 0, exponent 0 and modulus 0 into the MODEXP precompile, saves the hash of the result. Gives the execution 20500 gas

Ported from:
tests/static/state_tests/stPreCompiledContracts2/modexp_0_0_0_20500Filler.json
