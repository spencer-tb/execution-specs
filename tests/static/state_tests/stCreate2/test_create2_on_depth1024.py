...
def test_create2_on_depth1024(
    ...
    pre[contract] = Account(
        ...
        + Op.POP + Op.PUSH1[0x6d] + Op.JUMP + Op.JUMPDEST
        + Op.PUSH25[0x686000600060006000f56000526000600960176000f5600155]
        + Op.PUSH1[0x20] + Op.MSTORE + Op.PUSH1[0x0] + Op.PUSH1[0x19] + Op.PUSH1[0x27]
        + Op.PUSH1[0x0] + Op.CREATE2 + Op.PUSH1[0x1] + Op.SSTORE + Op.JUMPDEST
        + Op.STOP
    ),
    )
    pre[callee] = Account(
