...
def test_returndatacopy_0_0_following_successful_create(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH1[0x0] + Op.PUSH1[0x7] + Op.DUP1 + Op.PUSH1[0x1f] + Op.PUSH1[0x0]
        + Op.CODECOPY + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.CREATE2 + Op.POP
        + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.RETURNDATACOPY
        + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.SSTORE + Op.STOP + Op.STOP + Op.INVALID
        + Op.PUSH1[0x1] + Op.PUSH1[0x0] + Op.SSTORE + Op.STOP + Op.STOP
    ),
        storage={0x0: 0x1},
    )
