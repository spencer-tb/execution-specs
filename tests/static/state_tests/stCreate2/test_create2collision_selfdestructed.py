...
@pytest.mark.parametrize(
    ...
    pytest.param(
        ...
        {Address("0x0000000000000000000000000000000000000010"): Account(balance=1), Address("0x6295ee1b4f6dd65047762f924ecd367c17eabf8f"): Account(storage={0: 0}, nonce=2, balance=1), Address("0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b"): Account(nonce=1), Address("0xe2b35478fdd26477cc576dd906e6277761246a3c"): Account(nonce=0, balance=0)},
        id="case0",
    ),
    pytest.param(
        "6000600060006000600073af3ecba2fe09a4f6c19f16a9d119e44e08c2da0161c350f15064600160015560005260006005601b6000f500",
        {Address("0x0000000000000000000000000000000000000010"): Account(balance=1), Address("0x6295ee1b4f6dd65047762f924ecd367c17eabf8f"): Account(storage={0: 0}, nonce=2, balance=1), Address("0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b"): Account(nonce=1), Address("0xaf3ecba2fe09a4f6c19f16a9d119e44e08c2da01"): Account(nonce=0, balance=0)},
        id="case1",
    ),
    pytest.param(
        ...
        {Address("0x0000000000000000000000000000000000000010"): Account(balance=1), Address("0x6295ee1b4f6dd65047762f924ecd367c17eabf8f"): Account(storage={0: 0}, nonce=2, balance=1), Address("0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b"): Account(nonce=1), Address("0xec2c6832d00680ece8ff9254f81fdab0a5a2ac50"): Account(nonce=0, balance=0)},
        id="case2",
    ),
    ],
)
...
def test_create2collision_selfdestructed(
    ...
    pre[contract] = Account(balance=1, nonce=0, code=Op.PUSH1[0x10] + Op.SELFDESTRUCT + Op.STOP)
    pre[callee_1] = Account(balance=1, nonce=0, code=Op.PUSH1[0x10] + Op.SELFDESTRUCT + Op.STOP)
    pre[callee_2] = Account(balance=1, nonce=0, code=Op.PUSH1[0x10] + Op.SELFDESTRUCT + Op.STOP)
