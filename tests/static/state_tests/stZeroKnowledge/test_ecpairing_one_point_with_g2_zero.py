...
Ported from:
tests/static/state_tests/stZeroKnowledge/ecpairing_one_point_with_g2_zeroFiller.json
...
def test_ecpairing_one_point_with_g2_zero(
    ...
    pre[coinbase] = Account(balance=0xf260c, nonce=0)
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(""),
    ...
    post = {
        ...
        sender: Account(storage={}, nonce=7, code=b""),
