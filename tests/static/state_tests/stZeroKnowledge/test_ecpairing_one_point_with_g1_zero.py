...
Ported from:
tests/static/state_tests/stZeroKnowledge/ecpairing_one_point_with_g1_zeroFiller.json
...
def test_ecpairing_one_point_with_g1_zero(
    ...
    pre[coinbase] = Account(balance=0xbd43d, nonce=0)
    ...
    pre[sender] = Account(balance=0xde0b6b3a7582bc3, nonce=5)
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(""),
