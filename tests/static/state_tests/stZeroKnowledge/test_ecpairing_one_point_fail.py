...
Ported from:
tests/static/state_tests/stZeroKnowledge/ecpairing_one_point_failFiller.json
...
def test_ecpairing_one_point_fail(
    ...
    pre[coinbase] = Account(balance=0x881ee, nonce=0)
    ...
    pre[sender] = Account(balance=0xde0b6b3a75b7e12, nonce=4)
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(""),
