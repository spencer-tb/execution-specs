...
Ported from:
tests/static/state_tests/stZeroKnowledge/ecpairing_perturb_g2_by_field_modulusFiller.json
...
def test_ecpairing_perturb_g2_by_field_modulus(
    ...
    pre[coinbase] = Account(balance=0x6509f1, nonce=0)
    ...
    pre[sender] = Account(balance=0xde0b6b3a6fef60f, nonce=26)
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(""),
    ...
    post = {
        ...
        sender: Account(storage={}, nonce=27, code=b""),
