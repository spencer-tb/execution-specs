...
Ported from:
tests/static/state_tests/stZeroKnowledge/ecpairing_empty_dataFiller.json
...
def test_ecpairing_empty_data(
    ...
    pre[coinbase] = Account(balance=0x3dd71, nonce=0)
    ...
    pre[sender] = Account(balance=0xde0b6b3a760228f, nonce=2)
