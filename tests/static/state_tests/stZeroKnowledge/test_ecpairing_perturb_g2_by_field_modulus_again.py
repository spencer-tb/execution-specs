...
Ported from:
tests/static/state_tests/stZeroKnowledge/ecpairing_perturb_g2_by_field_modulus_againFiller.json
...
def test_ecpairing_perturb_g2_by_field_modulus_again(
    ...
    pre[coinbase] = Account(balance=0x68b559, nonce=0)
    ...
    pre[sender] = Account(balance=0xde0b6b3a6fb4aa7, nonce=27)
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(""),
    ...
    post = {
        ...
        sender: Account(storage={}, nonce=28, code=b""),
