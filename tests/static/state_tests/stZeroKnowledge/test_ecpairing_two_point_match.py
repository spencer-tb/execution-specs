...
Ported from:
tests/static/state_tests/stZeroKnowledge/ecpairing_two_point_match_1Filler.json
...
@pytest.mark.parametrize(
    ...
    pytest.param(
        331624,
        {Address("0x0000000000000000000000000000000000000001"): Account(storage={}, nonce=0, balance=1, code=b""), Address("0x0000000000000000000000000000000000000002"): Account(storage={}, nonce=0, balance=1, code=b""), Address("0x0000000000000000000000000000000000000003"): Account(storage={}, nonce=0, balance=1, code=b""), Address("0x0000000000000000000000000000000000000004"): Account(storage={}, nonce=0, balance=1, code=b""), Address("0x0000000000000000000000000000000000000005"): Account(storage={}, nonce=0, balance=1, code=b""), Address("0x0000000000000000000000000000000000000006"): Account(storage={}, nonce=0, balance=1, code=b""), Address("0x0000000000000000000000000000000000000007"): Account(storage={}, nonce=0, balance=1, code=b""), Address("0x0000000000000000000000000000000000000008"): Account(storage={}, nonce=0, balance=1, code=b""), Address("0x10a1c1cb95c92ec31d3f22c66eef1d9f3f258c6b"): Account(storage={}, nonce=0, balance=0xde0b6b3a7640000, code=b""), Address("0x13cbb8d99c6c4e0f2728c7d72606e78a29c4e224"): Account(storage={}, nonce=0, balance=0xde0b6b3a7640000, code=b""), Address("0x24143873e0e0815fdcbcffdbe09c979cbf9ad013"): Account(storage={}, nonce=0, balance=0xde0b6b3a7640000, code=b""), Address("0x3535353535353535353535353535353535353535"): Account(storage={}, nonce=0, code=b""), Address("0x598443f1880ef585b21f1d7585bd0577402861e5"): Account(storage={}, nonce=0, balance=0xde0b6b3a7640000, code=b""), Address("0x77db2bebba79db42a978f896968f4afce746ea1f"): Account(storage={}, nonce=0, balance=0xde0b6b3a7640000, code=b""), Address("0x7d577a597b2742b498cb5cf0c26cdcd726d39e6e"): Account(storage={}, nonce=0, balance=0xde0b6b3a7640000, code=b""), Address("0x82a978b3f5962a5b0957d9ee9eef472ee55b42f1"): Account(storage={}, nonce=12, code=b""), Address("0x90f0b1ebbba1c1936aff7aaf20a7878ff9e04b6c"): Account(storage={}, nonce=0, balance=0xde0b6b3a7640000, code=b""), Address("0xc305c901078781c232a2a521c2af7980f8385ee9"): Account(storage={0: 0xb10e2d527612073b26eecdfd717e6a320cf44b4afac2b0732d9fcbe2b7fa0cf6}, nonce=1, balance=0, code=Op.PUSH1[0x0] + Op.CALLDATALOAD + Op.PUSH1[0x1c] + Op.MSTORE + Op.PUSH21[0x10000000000000000000000000000000000000000] + Op.PUSH1[0x20] + Op.MSTORE + Op.PUSH16[0xffffffffffffffffffffffffffffffff] + Op.PUSH1[0x40] + Op.MSTORE + Op.PUSH32[0xffffffffffffffffffffffffffffffff00000000000000000000000000000001] + Op.PUSH1[0x60] + Op.MSTORE + Op.PUSH21[0x2540be3fffffffffffffffffffffffffdabf41c00] + Op.PUSH1[0x80] + Op.MSTORE + Op.PUSH32[0xfffffffffffffffffffffffdabf41c00000000000000000000000002540be400] + Op.PUSH1[0xa0] + Op.MSTORE + Op.PUSH4[0x30c8d1da] + Op.PUSH1[0x0] + Op.MLOAD + Op.EQ + Op.ISZERO + Op.PUSH2[0x12c] + Op.JUMPI + Op.PUSH2[0x780] + Op.PUSH1[0x4] + Op.CALLDATALOAD + Op.PUSH1[0x4] + Op.ADD + Op.CALLDATALOAD + Op.GT + Op.ISZERO + Op.ISZERO + Op.PC + Op.JUMPI + Op.PUSH1[0x4] + Op.CALLDATALOAD + Op.PUSH1[0x4] + Op.ADD + Op.CALLDATALOAD + Op.PUSH1[0x20] + Op.ADD + Op.PUSH1[0x4] + Op.CALLDATALOAD + Op.PUSH1[0x4] + Op.ADD + Op.PUSH2[0x140] + Op.CALLDATACOPY + Op.PUSH1[0x20] + Op.PUSH2[0x920] + Op.PUSH2[0x140] + Op.MLOAD + Op.PUSH2[0x160] + Op.PUSH1[0x0] + Op.PUSH1[0x8] + Op.PUSH4[0x5f5e0ff] + Op.CALL + Op.ISZERO + Op.PC + Op.JUMPI + Op.PUSH1[0x20] + Op.PUSH2[0x900] + Op.MSTORE + Op.PUSH2[0x900] + Op.PUSH1[0x40] + Op.DUP1 + Op.PUSH2[0x960] + Op.DUP3 + Op.DUP5 + Op.PUSH1[0x0] + Op.PUSH1[0x4] + Op.PUSH1[0x18] + Op.CALL + Op.POP + Op.POP + Op.POP + Op.PUSH2[0x960] + Op.DUP1 + Op.MLOAD + Op.PUSH1[0x20] + Op.DUP3 + Op.ADD + Op.SHA3 + Op.SWAP1 + Op.POP + Op.PUSH1[0x0] + Op.SSTORE + Op.PUSH2[0x960] + Op.PUSH1[0x20] + Op.PUSH1[0x20] + Op.DUP3 + Op.SUB + Op.MSTORE + Op.PUSH1[0x40] + Op.DUP2 + Op.MLOAD + Op.ADD + Op.PUSH1[0x20] + Op.PUSH1[0x1] + Op.DUP3 + Op.SUB + Op.MOD + Op.PUSH1[0x1f] + Op.DUP3 + Op.ADD + Op.SUB + Op.SWAP1 + Op.POP + Op.PUSH1[0x20] + Op.DUP3 + Op.SUB + Op.RETURN + Op.POP + Op.STOP + Op.JUMPDEST), Address("0xdceceaf3fc5c0a63d195d69b1a90011b7b19650d"): Account(storage={}, nonce=0, balance=0xde0b6b3a7640000, code=b""), Address("0xe0fc04fa2d34a66b779fd5cee748268032a146c0"): Account(storage={}, nonce=0, balance=0xde0b6b3a7640000, code=b"")},
        id="case0",
    ),
    pytest.param(
        90000,
...
def test_ecpairing_two_point_match_1(
    ...
    pre[coinbase] = Account(balance=0x22edad, nonce=0)
    ...
    pre[sender] = Account(balance=0xde0b6b3a7411253, nonce=11)
    ...
    pre[contract] = Account(
        ...
        storage={0x0: 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e563},
    )
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(""),
...
def test_ecpairing_two_point_match_2(
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(""),
        gas_limit=tx_gas_limit,
        gas_price=10,
        nonce=13,
        value=0,
...
def test_ecpairing_two_point_match_5(
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(""),
        gas_limit=tx_gas_limit,
        gas_price=10,
        nonce=17,
        value=0,
