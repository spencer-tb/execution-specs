...
@pytest.mark.parametrize(
    ...
    pytest.param(
        ...
        {Address("0x0000000000000000000000000000000000000512"): Account(storage={0: 4}, balance=0), Address("0xb94f5374fce5edbc8e2a8697c15331677e6ebf0b"): Account(storage={0: 1, 1: 1})},
        id="case0",
    ),
    pytest.param(
