...
@pytest.mark.parametrize(
    ...
    [
        (100000, {1: 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff}),
        (100000000000000000000, {0: 1, 1: 0x3700ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff}),
    ],
    ids=['case0', 'case1'],
)
