...
@pytest.mark.parametrize(
    ...
    pytest.param(
        96000,
        {Address("0x1000000000000000000000000000000000000001"): Account(storage={1: 1}), Address("0x6295ee1b4f6dd65047762f924ecd367c17eabf8f"): Account(balance=0)},
        id="case0",
    ),
    pytest.param(
        60000,
        {Address("0x1000000000000000000000000000000000000001"): Account(storage={1: 0}), Address("0x6295ee1b4f6dd65047762f924ecd367c17eabf8f"): Account(balance=0)},
        id="case1",
    ),
    ],
)
