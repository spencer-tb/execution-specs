...
def test_create_init_fail_oo_gduring_init2(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH1[0xd] + Op.DUP1 + Op.PUSH1[0xf] + Op.PUSH1[0x0] + Op.CODECOPY
        + Op.PUSH1[0x0] + Op.PUSH1[0x1] + Op.CREATE + Op.STOP + Op.INVALID
        + Op.PUSH1[0x1] + Op.PUSH1[0x1] + Op.SSTORE + Op.PUSH3[0x2fffff]
    ...
    post = {
        Address("0xd2571607e241ecf590ed94b12d87c94babe36db6"): Account.NONEXISTENT,
    }
