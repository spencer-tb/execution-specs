...
def test_create_js_example_contract(
    ...
    post = {
        Address("0x<contract:0x6295ee1b4f6dd65047762f924ecd367c17eabf8f>"): Account(
            storage={0: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 1: 66, 2: 35, 3: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 5: 0x54c98c81},
            code=Op.PUSH1[0x0] + Op.CALLDATALOAD + Op.PUSH1[0xe0] + Op.PUSH1[0x2] + Op.EXP + Op.SWAP1 + Op.DIV + Op.DUP1 + Op.PUSH4[0x43d726d6] + Op.EQ + Op.PUSH2[0x42] + Op.JUMPI + Op.DUP1 + Op.PUSH4[0x91b7f5ed] + Op.EQ + Op.PUSH2[0x50] + Op.JUMPI + Op.DUP1 + Op.PUSH4[0xd686f9ee] + Op.EQ + Op.PUSH2[0x61] + Op.JUMPI + Op.DUP1 + Op.PUSH4[0xf5bade66] + Op.EQ + Op.PUSH2[0x6f] + Op.JUMPI + Op.DUP1 + Op.PUSH4[0xfcfff16f] + Op.EQ + Op.PUSH2[0x80] + Op.JUMPI + Op.STOP + Op.JUMPDEST + Op.PUSH2[0x4a] + Op.PUSH2[0x1de] + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.RETURN + Op.JUMPDEST + Op.PUSH2[0x5b] + Op.PUSH1[0x4] + Op.CALLDATALOAD + Op.PUSH2[0xbf] + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.RETURN + Op.JUMPDEST + Op.PUSH2[0x69] + Op.PUSH2[0x304] + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.RETURN + Op.JUMPDEST + Op.PUSH2[0x7a] + Op.PUSH1[0x4] + Op.CALLDATALOAD + Op.PUSH2[0x8e] + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.RETURN + Op.JUMPDEST + Op.PUSH2[0x88] + Op.PUSH2[0xf0] + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.RETURN + Op.JUMPDEST + Op.PUSH1[0x0] + Op.SLOAD + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.CALLER + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.EQ + Op.ISZERO + Op.PUSH2[0xaf] + Op.JUMPI + Op.PUSH2[0xb4] + Op.JUMP + Op.JUMPDEST + Op.PUSH2[0xbc] + Op.JUMP + Op.JUMPDEST + Op.DUP1 + Op.PUSH1[0x1] + Op.DUP2 + Op.SWAP1 + Op.SSTORE + Op.POP + Op.JUMPDEST + Op.POP + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x0] + Op.SLOAD + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.CALLER + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.EQ + Op.ISZERO + Op.PUSH2[0xe0] + Op.JUMPI + Op.PUSH2[0xe5] + Op.JUMP + Op.JUMPDEST + Op.PUSH2[0xed] + Op.JUMP + Op.JUMPDEST + Op.DUP1 + Op.PUSH1[0x2] + Op.DUP2 + Op.SWAP1 + Op.SSTORE + Op.POP + Op.JUMPDEST + Op.POP + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x0] + Op.SLOAD + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.CALLER + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.EQ + Op.DUP1 + Op.PUSH2[0x125] + Op.JUMPI + Op.POP + Op.PUSH1[0x3] + Op.SLOAD + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.CALLER + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.EQ + Op.JUMPDEST + Op.PUSH2[0x12e] + Op.JUMPI + Op.PUSH2[0x161] + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x1] + Op.PUSH1[0x4] + Op.DUP2 + Op.SWAP1 + Op.SSTORE + Op.POP + Op.PUSH32[0x59ebeb90bc63057b6515673c3ecf9438e5058bca0f92585014eced636878c9a5] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.LOG1 + Op.PUSH2[0x1dc] + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x4] + Op.SLOAD + Op.PUSH1[0x1] + Op.EQ + Op.DUP1 + Op.PUSH2[0x173] + Op.JUMPI + Op.POP + Op.PUSH1[0x1] + Op.SLOAD + Op.CALLVALUE + Op.LT + Op.JUMPDEST + Op.PUSH2[0x1b8] + Op.JUMPI + Op.PUSH1[0x1] + Op.PUSH1[0x4] + Op.DUP2 + Op.SWAP1 + Op.SSTORE + Op.POP + Op.PUSH32[0x59ebeb90bc63057b6515673c3ecf9438e5058bca0f92585014eced636878c9a5] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.LOG1 + Op.TIMESTAMP + Op.PUSH1[0x5] + Op.DUP2 + Op.SWAP1 + Op.SSTORE + Op.POP + Op.CALLER + Op.PUSH1[0x3] + Op.DUP2 + Op.SWAP1 + Op.SSTORE + Op.POP + Op.PUSH2[0x1db] + Op.JUMP + Op.JUMPDEST + Op.CALLER + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.PUSH1[0x0] + Op.CALLVALUE + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.DUP5 + Op.DUP8 + Op.DUP8 + Op.CALL + Op.PUSH2[0x1d7] + Op.JUMPI + Op.STOP + Op.JUMPDEST + Op.POP + Op.POP + Op.POP + Op.JUMPDEST + Op.JUMPDEST + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x0] + Op.PUSH1[0x4] + Op.SLOAD + Op.PUSH1[0x0] + Op.EQ + Op.PUSH2[0x1ef] + Op.JUMPI + Op.PUSH2[0x1f4] + Op.JUMP + Op.JUMPDEST + Op.PUSH2[0x301] + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x0] + Op.SLOAD + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.CALLER + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.EQ + Op.DUP1 + Op.ISZERO + Op.PUSH2[0x22c] + Op.JUMPI + Op.POP + Op.PUSH1[0x0] + Op.SLOAD + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.PUSH1[0x3] + Op.SLOAD + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.EQ + Op.JUMPDEST + Op.PUSH2[0x235] + Op.JUMPI + Op.PUSH2[0x242] + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x0] + Op.PUSH1[0x4] + Op.DUP2 + Op.SWAP1 + Op.SSTORE + Op.POP + Op.PUSH2[0x301] + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x3] + Op.SLOAD + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.CALLER + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.EQ + Op.PUSH2[0x262] + Op.JUMPI + Op.PUSH2[0x300] + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x5] + Op.SLOAD + Op.TIMESTAMP + Op.SUB + Op.PUSH1[0x2] + Op.SLOAD + Op.MUL + Op.SWAP1 + Op.POP + Op.PUSH1[0x1] + Op.SLOAD + Op.DUP2 + Op.GT + Op.PUSH2[0x2c7] + Op.JUMPI + Op.PUSH1[0x3] + Op.SLOAD + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.PUSH1[0x0] + Op.DUP3 + Op.PUSH1[0x1] + Op.SLOAD + Op.SUB + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.DUP5 + Op.DUP8 + Op.DUP8 + Op.CALL + Op.PUSH2[0x29b] + Op.JUMPI + Op.STOP + Op.JUMPDEST + Op.POP + Op.POP + Op.POP + Op.PUSH1[0x0] + Op.SLOAD + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.PUSH1[0x0] + Op.DUP3 + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.DUP5 + Op.DUP8 + Op.DUP8 + Op.CALL + Op.PUSH2[0x2bf] + Op.JUMPI + Op.STOP + Op.JUMPDEST + Op.POP + Op.POP + Op.POP + Op.PUSH2[0x2ee] + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x0] + Op.SLOAD + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.PUSH1[0x0] + Op.PUSH1[0x1] + Op.SLOAD + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.DUP5 + Op.DUP8 + Op.DUP8 + Op.CALL + Op.PUSH2[0x2ea] + Op.JUMPI + Op.STOP + Op.JUMPDEST + Op.POP + Op.POP + Op.POP + Op.JUMPDEST + Op.PUSH1[0x0] + Op.PUSH1[0x4] + Op.DUP2 + Op.SWAP1 + Op.SSTORE + Op.POP + Op.PUSH1[0x0] + Op.SLOAD + Op.PUSH1[0x3] + Op.DUP2 + Op.SWAP1 + Op.SSTORE + Op.POP + Op.JUMPDEST + Op.JUMPDEST + Op.POP + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.SLOAD + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.CALLER + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.EQ + Op.ISZERO + Op.PUSH2[0x327] + Op.JUMPI + Op.PUSH2[0x32c] + Op.JUMP + Op.JUMPDEST + Op.PUSH2[0x37e] + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x5] + Op.SLOAD + Op.TIMESTAMP + Op.SUB + Op.PUSH1[0x2] + Op.SLOAD + Op.MUL + Op.SWAP1 + Op.POP + Op.PUSH1[0x1] + Op.SLOAD + Op.DUP2 + Op.GT + Op.PUSH2[0x345] + Op.JUMPI + Op.PUSH2[0x37d] + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x0] + Op.SLOAD + Op.PUSH1[0x1] + Op.PUSH1[0xa0] + Op.PUSH1[0x2] + Op.EXP + Op.SUB + Op.AND + Op.PUSH1[0x0] + Op.PUSH1[0x1] + Op.SLOAD + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.DUP5 + Op.DUP8 + Op.DUP8 + Op.CALL + Op.PUSH2[0x368] + Op.JUMPI + Op.STOP + Op.JUMPDEST + Op.POP + Op.POP + Op.POP + Op.PUSH1[0x0] + Op.PUSH1[0x4] + Op.DUP2 + Op.SWAP1 + Op.SSTORE + Op.POP + Op.PUSH1[0x0] + Op.SLOAD + Op.PUSH1[0x3] + Op.DUP2 + Op.SWAP1 + Op.SSTORE + Op.POP + Op.JUMPDEST + Op.JUMPDEST + Op.POP + Op.JUMP,
        ),
    }
