...
contract code:
    ...
    push1 0x00
    push1 0x00
    push20 0x180f2d7e0c9a56b7bb287e2f50101660110b641f
    push3 0x0186a0
    push1 0x00
    sload
    mul
...
def test_call_lose_gas_oog(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0x180f2d7e0c9a56b7bb287e2f50101660110b641f]
        + Op.PUSH3[0x186a0] + Op.PUSH1[0x0] + Op.SLOAD + Op.MUL + Op.PUSH1[0x1]
        + Op.ADD + Op.CALL + Op.PUSH1[0x1] + Op.SSTORE + Op.PUSH2[0x3e8]
