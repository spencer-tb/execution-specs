...
@pytest.mark.parametrize(
    ...
    pytest.param(
        23,
        {Address("0x0000000000000000000000000000000000000000"): Account(storage={}), Address("0xd2571607e241ecf590ed94b12d87c94babe36db6"): Account.NONEXISTENT},
        id="case0",
    ),
    pytest.param(
        24,
        {Address("0x0000000000000000000000000000000000000000"): Account.NONEXISTENT, Address("0xd2571607e241ecf590ed94b12d87c94babe36db6"): Account(storage={2: 1})},
        id="case1",
    ),
    ],
)
