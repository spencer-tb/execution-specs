...
contract code:
    ...
    push1 0x00
    push1 0x00
    push20 0x0878bc1c3d660907b056e31c854a309f7ef1b4c4
    push2 0x0401
    push1 0x00
    sload
    div
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (9320826, {0: 113, 1: 1, 2: 0x1b969}),
        (15720826, {0: 146, 1: 1, 2: 0x23a51}),
        (11220826, {0: 124, 1: 1, 2: 0x1e461}),
    ],
...
def test_call1024_oog(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0x878bc1c3d660907b056e31c854a309f7ef1b4c4]
        + Op.PUSH2[0x401] + Op.PUSH1[0x0] + Op.SLOAD + Op.DIV + Op.PUSH1[0x1] + Op.SUB
        + Op.PUSH2[0x2710] + Op.GAS + Op.SUB + Op.MUL + Op.CALL + Op.PUSH1[0x1]
