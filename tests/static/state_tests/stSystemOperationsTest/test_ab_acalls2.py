...
callee code:
    ...
    push1 0x00
    push1 0x00
    push20 0xc58b2120d2ad0cbfccd6ebaae6c11258aceac41b
    push3 0x0186a0
    gas
    sub
    call
...
def test_ab_acalls2(
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0xc58b2120d2ad0cbfccd6ebaae6c11258aceac41b]
    ...
    post = {
        Address("0x095e7baea6a6c7c4c2dfeb977efac326af552d87"): Account(storage={0: 201}),
