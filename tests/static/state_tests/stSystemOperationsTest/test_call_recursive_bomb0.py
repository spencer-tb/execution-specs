...
contract code:
    ...
    push1 0x00
    push1 0x17
    push20 0x783516813e6366b978f7101a6a12b4c8498b0283
    push4 0x05f5e100
    call
    stop
...
def test_call_recursive_bomb0(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x17] + Op.PUSH20[0x783516813e6366b978f7101a6a12b4c8498b0283]
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH1[0x0] + Op.ADDRESS + Op.PUSH2[0x2af8] + Op.GAS + Op.SUB + Op.CALL
