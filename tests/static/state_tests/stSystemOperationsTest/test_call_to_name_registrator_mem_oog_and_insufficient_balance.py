"""
Ported from:
tests/static/state_tests/stSystemOperationsTest/CallToNameRegistratorMemOOGAndInsufficientBalanceFiller.json
...
def test_call_to_name_registrator_mem_oog_and_insufficient_balance(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH6[0xffffffffffff] + Op.PUSH1[0x0] + Op.PUSH1[0x17]
        + Op.PUSH20[0x15eb18969e0925c8e4a76fd7cbce36a2b056b27e]
        + Op.PUSH5[0xffffffffff] + Op.CALL + Op.PUSH1[0x0] + Op.SSTORE + Op.STOP
    ),
    )
