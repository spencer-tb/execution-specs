...
contract code:
    ...
    push1 0x00
    push1 0x17
    push20 0x1ec76f80449bf4d3edf503813e06c0d4373fdf3d
    push2 0x7530
    call
    push1 0x01
    sstore
...
def test_post_to_return1(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0x1ec76f80449bf4d3edf503813e06c0d4373fdf3d] + Op.PUSH2[0x7530]
    ...
    post = {
        Address("0x095e7baea6a6c7c4c2dfeb977efac326af552d87"): Account(storage={1: 0, 2: 1}),
    }
