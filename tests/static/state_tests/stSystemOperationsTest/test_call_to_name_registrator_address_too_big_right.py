"""
Ported from:
tests/static/state_tests/stSystemOperationsTest/CallToNameRegistratorAddressTooBigRightFiller.json
...
contract code:
    ...
    push1 0x00
    push1 0x17
    push21 0x15eb18969e0925c8e4a76fd7cbce36a2b056b27eaa
    push2 0x03e8
    call
    push1 0x00
    sstore
...
def test_call_to_name_registrator_address_too_big_right(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH21[0x15eb18969e0925c8e4a76fd7cbce36a2b056b27eaa] + Op.PUSH2[0x3e8]
