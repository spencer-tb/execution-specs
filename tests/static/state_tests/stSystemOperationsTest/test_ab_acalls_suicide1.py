...
def test_ab_acalls_suicide1(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.PUSH1[0x18]
        + Op.PUSH20[0x945304eb96065b2a98b57a48a06ae28d285a71b5] + Op.PUSH1[0x0]
        + Op.CALLDATALOAD + Op.CALL + Op.PC + Op.SSTORE + Op.STOP
    ),
    )
    pre[callee] = Account(
        balance=23,
        ...
        code=(
        Op.PUSH1[0x0] + Op.CALLDATALOAD + Op.PUSH1[0x0] + Op.MSTORE + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.PUSH1[0x17]
        + Op.PUSH20[0x95e7baea6a6c7c4c2dfeb977efac326af552d87] + Op.PUSH2[0xc350]
        + Op.PUSH1[0x0] + Op.CALLDATALOAD + Op.SUB + Op.CALL + Op.PUSH1[0x1] + Op.ADD
        + Op.PC + Op.SSTORE + Op.PUSH20[0xf572e5295c57f15886f9b263e2f6d2d6c7b5ec6]
