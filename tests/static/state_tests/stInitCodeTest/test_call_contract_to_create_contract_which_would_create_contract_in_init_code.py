...
contract code:
    push12 0x600c600055602060406000f0
    push1 0x00
    mstore
    push1 0x0c
    push1 0x14
...
def test_call_contract_to_create_contract_which_would_create_contract_in_init_code(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH12[0x600c600055602060406000f0] + Op.PUSH1[0x0] + Op.MSTORE
        + Op.PUSH1[0xc] + Op.PUSH1[0x14] + Op.PUSH1[0x0] + Op.CREATE + Op.STOP
    ),
    )
    ...
    post = {
        ...
        Address("0xd2571607e241ecf590ed94b12d87c94babe36db6"): Account(storage={0: 12}, nonce=2),
    }
