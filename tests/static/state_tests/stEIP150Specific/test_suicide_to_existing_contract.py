...
callee code:
    push20 0xe110d543aadc3060d6b9e80d3e16be7a828128ec
    selfdestruct
    stop
...
def test_suicide_to_existing_contract(
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH20[0xe110d543aadc3060d6b9e80d3e16be7a828128ec] + Op.SELFDESTRUCT
        + Op.STOP
    ),
    )
    ...
    post = {
        ...
        Address("0xb94f5374fce5edbc8e2a8697c15331677e6ebf0b"): Account(storage={1: 7637}),
    }
