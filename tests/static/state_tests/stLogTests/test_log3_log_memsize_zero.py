...
contract code:
    ...
    push1 0x00
    push1 0x17
    push20 0x561ceb099a0d44d31649d7270095033c4003881f
    push2 0x03e8
    call
    push1 0x00
    sstore
...
def test_log3_log_memsize_zero(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x17] + Op.PUSH20[0x561ceb099a0d44d31649d7270095033c4003881f]
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH1[0x1] + Op.LOG3 + Op.STOP
    ),
    )
