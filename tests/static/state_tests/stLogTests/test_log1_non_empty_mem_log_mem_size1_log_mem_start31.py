...
contract code:
    ...
    push1 0x00
    push1 0x17
    push20 0xb0c981060788593ed6c8a538de7cbdc696d8d76c
    push2 0x03e8
    call
    push1 0x00
    sstore
...
def test_log1_non_empty_mem_log_mem_size1_log_mem_start31(
    ...
    callee = Address("0xb0c981060788593ed6c8a538de7cbdc696d8d76c")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x17] + Op.PUSH20[0xb0c981060788593ed6c8a538de7cbdc696d8d76c]
