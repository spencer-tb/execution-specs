...
contract code:
    ...
    push1 0x00
    push1 0x17
    push20 0x23886789bd30d62944a3475276b774a785cb3329
    push2 0x03e8
    call
    push1 0x00
    sstore
...
def test_log4_non_empty_mem_log_mem_size1_log_mem_start31(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x17] + Op.PUSH20[0x23886789bd30d62944a3475276b774a785cb3329]
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH1[0x1] + Op.PUSH1[0x1f] + Op.LOG4 + Op.STOP
    ),
    )
