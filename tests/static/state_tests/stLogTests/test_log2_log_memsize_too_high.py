...
contract code:
    ...
    push1 0x00
    push1 0x17
    push20 0x3bad71f49ad0cabda27d388877a6cf157e9a3471
    push2 0x03e8
    call
    push1 0x00
    sstore
...
def test_log2_log_memsize_too_high(
    ...
    callee = Address("0x3bad71f49ad0cabda27d388877a6cf157e9a3471")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x17] + Op.PUSH20[0x3bad71f49ad0cabda27d388877a6cf157e9a3471]
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH1[0x0] + Op.MSTORE + Op.PUSH1[0x0] + Op.PUSH1[0x0]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH1[0x1] + Op.LOG2 + Op.STOP
    ),
    )
