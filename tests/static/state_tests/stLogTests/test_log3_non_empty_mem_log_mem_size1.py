...
contract code:
    ...
    push1 0x00
    push1 0x17
    push20 0xe0885d29735cc94d2cf68da45b9ec5079c7102cc
    push2 0x03e8
    call
    push1 0x00
    sstore
...
def test_log3_non_empty_mem_log_mem_size1(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x17] + Op.PUSH20[0xe0885d29735cc94d2cf68da45b9ec5079c7102cc]
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH1[0x1] + Op.PUSH1[0x0] + Op.LOG3 + Op.STOP
    ),
    )
