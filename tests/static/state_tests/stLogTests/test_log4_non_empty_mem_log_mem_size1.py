...
contract code:
    ...
    push1 0x00
    push1 0x17
    push20 0xa1ba9edcb02902136b7a79a5c49409e244bc01c5
    push2 0x03e8
    call
    push1 0x00
    sstore
...
def test_log4_non_empty_mem_log_mem_size1(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x17] + Op.PUSH20[0xa1ba9edcb02902136b7a79a5c49409e244bc01c5]
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH1[0x1] + Op.PUSH1[0x0] + Op.LOG4 + Op.STOP
    ),
    )
