...
contract code:
    ...
    push1 0x00
    push1 0x17
    push20 0xb03fd6e714a14074a17e2ecfd412e35b1ddb21e5
    push2 0x03e8
    call
    push1 0x00
    sstore
...
def test_log4_log_memsize_zero(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x17] + Op.PUSH20[0xb03fd6e714a14074a17e2ecfd412e35b1ddb21e5]
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x1] + Op.LOG4 + Op.STOP
    ),
    )
