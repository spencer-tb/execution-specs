"""
Ported from:
tests/static/state_tests/stReturnDataTest/call_then_call_value_fail_then_returndatasizeFiller.json
...
def test_call_then_call_value_fail_then_returndatasize(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH6[0xffffffffffff]
        + Op.PUSH20[0x9898dd5e5c526b55ec49b1047e298705c13279f1]
        + Op.PUSH5[0x900000000] + Op.CALL + Op.POP + Op.RETURNDATASIZE + Op.PUSH1[0x0]
        + Op.SSTORE + Op.STOP
    ),
        storage={0x0: 0x1},
    )
    ...
    post = {
        Address("0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6"): Account(storage={0: 0}),
    }
