...
def test_create_callprecompile_returndatasize(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH1[0x23] + Op.DUP1 + Op.PUSH1[0x15] + Op.PUSH1[0x0] + Op.CODECOPY
        ...
        + Op.PUSH1[0x4] + Op.PUSH2[0x9000] + Op.CALL + Op.POP + Op.RETURNDATASIZE
        + Op.PUSH1[0x0] + Op.SSTORE + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.RETURN
        + Op.STOP + Op.STOP
    ),
        storage={0x0: 0x1},
    )
