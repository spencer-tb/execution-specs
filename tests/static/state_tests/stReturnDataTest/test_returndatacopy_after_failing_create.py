...
def test_returndatacopy_after_failing_create(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0xa] + Op.PUSH1[0x16] + Op.PUSH1[0x0] + Op.CREATE + Op.POP
        + Op.RETURNDATASIZE + Op.PUSH1[0x0] + Op.SSTORE + Op.PUSH1[0x20]
    ...
    post = {
        Address("0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6"): Account(storage={0: 32, 1: 2}),
    }
