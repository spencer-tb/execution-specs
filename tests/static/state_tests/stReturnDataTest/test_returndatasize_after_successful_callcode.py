...
def test_returndatasize_after_successful_callcode(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0xc6426ee9b84ce08176d8d295613a7d10c48576b]
        + Op.PUSH2[0xea60] + Op.CALLCODE + Op.POP + Op.RETURNDATASIZE + Op.PUSH1[0x0]
        + Op.SSTORE + Op.STOP
    ),
        storage={0x0: 0x0},
    )
    ...
    post = {
        Address("0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6"): Account(storage={0: 6}),
    }
