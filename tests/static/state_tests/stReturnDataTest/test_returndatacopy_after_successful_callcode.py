...
contract code:
    ...
    push1 0x00
    push1 0x00
    push20 0x53b272d553d8179d017aae6f3badf0570743593a
    push2 0xea60
    callcode
    pop
    push1 0x20
...
def test_returndatacopy_after_successful_callcode(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH20[0x53b272d553d8179d017aae6f3badf0570743593a]
        + Op.PUSH2[0xea60] + Op.CALLCODE + Op.POP + Op.PUSH1[0x20] + Op.PUSH1[0x0]
