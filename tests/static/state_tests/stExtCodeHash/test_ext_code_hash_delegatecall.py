"""
EXTCODEHASH of an account during a DELEGATECALL

Ported from:
tests/static/state_tests/stExtCodeHash/extCodeHashDELEGATECALLFiller.json
...
def test_ext_code_hash_delegatecall(
    ...
    contract = Address("0x87960b55cea4a399cdee9316eb9dc4b88aecd6d9")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0x307e5b123e61545f0ebb0f01dbcd8c6dff125788] + Op.PUSH3[0x249f0]
        ...
        + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0]
        + Op.PUSH20[0x6e37c7a39fd79ba4cd41ad3962df174a377773fa] + Op.PUSH3[0x249f0]
        + Op.DELEGATECALL + Op.POP + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.PUSH1[0x0]
        + Op.RETURNDATACOPY + Op.PUSH1[0x0] + Op.MLOAD + Op.PUSH1[0x1] + Op.SSTORE
        + Op.STOP
    ),
        storage={0x0: 0xdeadbeef},
    )
