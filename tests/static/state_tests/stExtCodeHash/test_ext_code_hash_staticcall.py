"""
EXTCODEHASH of an account during a STATICCALL

Ported from:
tests/static/state_tests/stExtCodeHash/extCodeHashSTATICCALLFiller.json
...
def test_ext_code_hash_staticcall(
    ...
    contract = Address("0x5bcc391839236c34b1de5d3075326ce4f6f9b45f")
