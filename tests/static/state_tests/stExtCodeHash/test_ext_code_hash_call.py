"""
EXTCODEHASH of an account during a CALL

Ported from:
tests/static/state_tests/stExtCodeHash/extCodeHashCALLFiller.json
...
def test_ext_code_hash_call(
    ...
    contract = Address("0xff04c454a051bfa63ad98dcbdd97e1b9027ccd1e")
