"""
EXTCODEHASH/EXTCODESIZE of an account created then deleted via CALL in same transaction

Ported from:
tests/static/state_tests/stExtCodeHash/extCodeHashCreatedAndDeletedAccountCallFiller.json
...
def test_ext_code_hash_created_and_deleted_account_call(
    ...
    post = {
        Address("0x7be7677a20a298ff0676ab31f91a0a923f8d9471"): Account.NONEXISTENT,
        contract: Account(
