...
def test_ext_code_hash_subcall_suicide_cancun(
    ...
    pre[callee] = Account(
        ...
        code=(
        Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH20[0x3e180b1862f9d158abb5e519a6d8605540c23682]
        + Op.PUSH3[0x55730] + Op.CALLCODE + Op.STOP
    ),
    )
    pre[sender] = Account(balance=0xde0b6b3a7640000, nonce=0)
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH1[0x49] + Op.DUP1 + Op.PUSH2[0x10c] + Op.PUSH1[0x0] + Op.CODECOPY
        ...
        + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0]
        + Op.PUSH20[0xa000000000000000000000000000000000000000] + Op.PUSH3[0x55730]
        + Op.CALL + Op.PUSH1[0x7] + Op.SSTORE + Op.STOP + Op.INVALID + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0]
        + Op.PUSH20[0xd000000000000000000000000000000000000000] + Op.PUSH3[0x186a0]
