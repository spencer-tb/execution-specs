...
def test_callcode_bounds(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH8[0x7ffffffffffffff] + Op.CALLCODE + Op.POP + Op.PUSH4[0xfffffff]
        + Op.PUSH1[0x0] + Op.PUSH4[0xfffffff] + Op.PUSH1[0x0] + Op.PUSH1[0x0]
        + Op.PUSH20[0x849f53126ade5f72469029537296f2b6644d4d41]
        + Op.PUSH8[0x7ffffffffffffff] + Op.CALLCODE + Op.POP + Op.PUSH4[0xffffffff]
        + Op.PUSH1[0x0] + Op.PUSH4[0xffffffff] + Op.PUSH1[0x0] + Op.PUSH1[0x0]
        + Op.PUSH20[0x849f53126ade5f72469029537296f2b6644d4d41]
        + Op.PUSH8[0x7ffffffffffffff] + Op.CALLCODE + Op.POP + Op.PUSH1[0x0]
