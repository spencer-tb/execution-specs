...
def test_create_bounds3(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x55] + Op.PUSH1[0x21] + Op.MSTORE8 + Op.PUSH8[0xffffffffffffffff]
        + Op.PUSH1[0x0] + Op.PUSH1[0x1] + Op.CREATE + Op.POP
        + Op.PUSH16[0xffffffffffffffffffffffffffffffff] + Op.PUSH1[0x0]
        + Op.PUSH1[0x1] + Op.CREATE + Op.POP
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH1[0x0] + Op.PUSH1[0x1] + Op.CREATE + Op.POP + Op.PUSH1[0x0]
        + Op.PUSH4[0xfffffff] + Op.PUSH1[0x1] + Op.CREATE + Op.POP + Op.PUSH1[0x0]
        + Op.PUSH4[0xffffffff] + Op.PUSH1[0x1] + Op.CREATE + Op.POP + Op.PUSH1[0x0]
        + Op.PUSH8[0xffffffffffffffff] + Op.PUSH1[0x1] + Op.CREATE + Op.POP
        + Op.PUSH1[0x0] + Op.PUSH16[0xffffffffffffffffffffffffffffffff]
        + Op.PUSH1[0x1] + Op.CREATE + Op.POP + Op.PUSH1[0x0]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH1[0x1] + Op.CREATE + Op.POP + Op.PUSH4[0xfffffff]
        + Op.PUSH4[0xfffffff] + Op.PUSH1[0x1] + Op.CREATE + Op.POP
        + Op.PUSH4[0xffffffff] + Op.PUSH4[0xffffffff] + Op.PUSH1[0x1] + Op.CREATE
        + Op.POP + Op.PUSH8[0xffffffffffffffff] + Op.PUSH8[0xffffffffffffffff]
        + Op.PUSH1[0x1] + Op.CREATE + Op.POP
        + Op.PUSH16[0xffffffffffffffffffffffffffffffff]
        + Op.PUSH16[0xffffffffffffffffffffffffffffffff] + Op.PUSH1[0x1] + Op.CREATE
        + Op.POP
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH1[0x1] + Op.CREATE + Op.STOP
    ),
    )
