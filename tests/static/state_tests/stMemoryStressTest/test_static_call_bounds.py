...
def test_static_call_bounds(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH8[0x7ffffffffffffff] + Op.STATICCALL + Op.POP + Op.PUSH4[0xfffffff]
        + Op.PUSH1[0x0] + Op.PUSH4[0xfffffff] + Op.PUSH1[0x0]
        + Op.PUSH20[0xcc704d60c46b9c08aab4d15281184441ac7ed35c]
        + Op.PUSH8[0x7ffffffffffffff] + Op.STATICCALL + Op.POP + Op.PUSH4[0xffffffff]
        + Op.PUSH1[0x0] + Op.PUSH4[0xffffffff] + Op.PUSH1[0x0]
        + Op.PUSH20[0xcc704d60c46b9c08aab4d15281184441ac7ed35c]
        + Op.PUSH8[0x7ffffffffffffff] + Op.STATICCALL + Op.POP + Op.PUSH1[0x0]
        + Op.PUSH4[0xfffffff] + Op.PUSH1[0x0] + Op.PUSH4[0xfffffff]
        + Op.PUSH20[0xcc704d60c46b9c08aab4d15281184441ac7ed35c]
        + Op.PUSH8[0x7ffffffffffffff] + Op.STATICCALL + Op.POP + Op.PUSH1[0x0]
        + Op.PUSH4[0xffffffff] + Op.PUSH1[0x0] + Op.PUSH4[0xffffffff]
        + Op.PUSH20[0xcc704d60c46b9c08aab4d15281184441ac7ed35c]
        + Op.PUSH8[0x7ffffffffffffff] + Op.STATICCALL + Op.POP + Op.PUSH1[0x0]
    ...
    post = {
        ...
        Address("0x<contract:0x1000000000000000000000000000000000000001>"): Account(storage={0: 0}),
    }
