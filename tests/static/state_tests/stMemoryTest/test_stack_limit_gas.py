...
def test_stack_limit_gas_1023(
    ...
    post = {
        Address("0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6"): Account(storage={}, nonce=0),
...
def test_stack_limit_gas_1024(
    ...
    coinbase = Address("0x2adc25665018aa1fe0e6bc666dac8fc2697ff9ba")
    sender = Address("0xc102734f6a1e4747310179c0a0fc16e674aa901d")
    contract = Address("0xb2b4442b80edd3930f9d8a8696794672fbeebfd0")
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH2[0x3fe] + Op.PUSH1[0x0] + Op.MSTORE + Op.JUMPDEST + Op.GAS
        + Op.PUSH1[0x1] + Op.PUSH1[0x0] + Op.MLOAD + Op.SUB + Op.PUSH1[0x0]
        + Op.MSTORE + Op.PUSH1[0x0] + Op.MLOAD + Op.PUSH1[0x6] + Op.JUMPI + Op.STOP
        + Op.STOP
    ),
...
def test_stack_limit_gas_1025(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH2[0x3ff] + Op.PUSH1[0x0] + Op.MSTORE + Op.JUMPDEST + Op.GAS
        + Op.PUSH1[0x1] + Op.PUSH1[0x0] + Op.MLOAD + Op.SUB + Op.PUSH1[0x0]
        + Op.MSTORE + Op.PUSH1[0x0] + Op.MLOAD + Op.PUSH1[0x6] + Op.JUMPI + Op.STOP
        + Op.STOP
    ),
