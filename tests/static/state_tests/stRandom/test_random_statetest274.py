...
def test_random_statetest274(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.DUP9 + Op.ADD
        + Op.GAS + Op.SWAP11 + Op.SDIV + Op.TIMESTAMP + Op.LOG1 + Op.GASPRICE
        + Op.SDIV + Op.EQ + Op.SWAP8 + Op.MLOAD + Op.TIMESTAMP + Op.ISZERO
    ),
    )
