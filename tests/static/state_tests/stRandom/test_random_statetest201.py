...
def test_random_statetest201(
    ...
    contract = Address("0x3d068bacd9155d630ad1636b586827a5bc9acc9d")
    ...
    pre[contract] = Account(
        ...
        "00000000ffffffffffffffffffffffffffffffffffffffff09ff7f000000000000000000"
        "00000000000000000000000000000000000000000000017f000000000000000000000000"
        "ffffffffffffffffffffffffffffffffffffffff8b8263974074da449e68610399600051"
        "55"
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000ffffffffffffffffffffffffffffffffffffffff09ff7f000000000000000000"
            "00000000000000000000000000000000000000000000017f000000000000000000000000"
            "ffffffffffffffffffffffffffffffffffffffff8b8263974074da449e68610399"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
