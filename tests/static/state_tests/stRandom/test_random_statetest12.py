...
contract code:
    ...
    push16 0x165490a41215369ef276037941163355
    push1 0x00
    mload
    sstore
"""
...
def test_random_statetest12(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.MUL
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH16[0x165490a41215369ef276037941163355] + Op.PUSH1[0x0] + Op.MLOAD
        + Op.SSTORE
    ),
    )
