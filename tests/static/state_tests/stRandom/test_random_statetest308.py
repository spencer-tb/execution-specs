...
def test_random_statetest308(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5] + Op.CALLDATALOAD
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.TIMESTAMP + Op.PUSH32[0xc350]
        + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.ADDMOD + Op.GAS
        + Op.ADD + Op.MULMOD + Op.PUSH7[0x30f38c9a600051] + Op.SSTORE
    ),
    )
    ...
    post = {
        contract: Account(storage={0x30f38c9a600051: 0x5cf25686ffffffffffffffff461b52f2}, nonce=0),
