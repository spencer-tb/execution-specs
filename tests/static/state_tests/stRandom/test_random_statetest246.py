...
def test_random_statetest246(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.NUMBER + Op.TIMESTAMP + Op.COINBASE + Op.BALANCE + Op.PREVRANDAO
        + Op.COINBASE + Op.NUMBER + Op.TIMESTAMP + Op.SWAP4 + Op.OR + Op.MULMOD
        + Op.SSTORE
    ),
    )
    ...
    post = {
        contract: Account(storage={57403: 1000, 0xd9250a4f8c: 0}, nonce=0),
