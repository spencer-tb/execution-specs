...
def test_random_statetest343(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH32[0x1] + Op.PUSH32[0xc350] + Op.PUSH32[0xc350] + Op.PUSH32[0x0]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.GT + Op.LT
        + Op.LT + Op.CALLDATACOPY + Op.COINBASE + Op.CALLDATALOAD + Op.SSTORE
