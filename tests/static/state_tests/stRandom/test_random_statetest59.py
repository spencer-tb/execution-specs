...
def test_random_statetest59(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.MUL + Op.ADDMOD
        + Op.PUSH8[0x3a06756406548b99] + Op.SSTORE
    ),
    )
    ...
    post = {
        Address("0x095e7baea6a6c7c4c2dfeb977efac326af552d87"): Account(
            storage={0x3a06756406548b99: 0xffffffffffffffffffffffff0000000000000000000000000000000000000002},
            nonce=0,
        ),
