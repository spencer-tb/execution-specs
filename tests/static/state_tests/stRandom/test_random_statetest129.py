...
contract code:
    ...
    push16 0x166e733343093a31a33b8e025a027055
    push1 0x00
    mload
    sstore
"""
...
def test_random_statetest129(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH16[0x166e733343093a31a33b8e025a027055] + Op.PUSH1[0x0] + Op.MLOAD
        + Op.SSTORE
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000000000000000c3507f0000000000000000000000004f3f"
