...
contract code:
    push5 0xd552603c57
    push31 0x9a3805d8c55157a82b7660ef2a049cfbf79c15fa8e3261f121d213590fa391
    push30 0x7d442a5e8734af2aaa4c859b452eed7860c2f7e051580427b6c3cc6d7fee
    push2 0x7a0d
    push5 0xef63e19225
    push14 0xe5d2ea2689decfd971c7478effb0
    push11 0xa9e792747ce0492abde8c2
    callcode
    push17 0xe93d5ed0b213fed7ae59294537d4864c0e
    push9 0xbbe30ec5d1e6b85402
    push25 0x62cfcbea15e8367dfaa080ee0da2b0d2ca892f5a7643543704
    push7 0xccddd03115ec8a
    push27 0xd2e6c62c29425a45ec842fb74c369fb15a42e4b4e48b3eb70be2a0
    dup5
    push21 0x69987980e6eaa539365a491d2366334f78f03acb17
    push25 0x09e7525add39a234d3d2ef1cf8544a52389411ef846d3cd7f3
    push14 0x0d1db7f414860020171f07598cfb
    push3 0x0e15a9
    push9 0x1c843d60aee9fb8a4e
    push31 0x37713afbf6ef9d1667513975c76f26ac35ce209b1e0a3bb7c1982136893153
...
def test_random_statetest347(
    ...
    sender = Address("0x2c0f18ba15fb0db9da3f68c4b0c52dd7a684d909")
    contract = Address("0x97bc67b6ee773e59e516d02edb13b971c3cbd856")
    callee = Address("0x79d9fbe6ac70917cb2e16ec4cd32968ce19c724d")
    ...
    pre[sender] = Account(balance=0x1024d289465fa51769, nonce=0)
    pre[callee] = Account(balance=0x4ea91708, nonce=89, code=Op.CALLDATASIZE)
    pre[contract] = Account(
        balance=0x33498455,
        nonce=233,
        code=(
        Op.PUSH5[0xd552603c57]
        + Op.PUSH31[0x9a3805d8c55157a82b7660ef2a049cfbf79c15fa8e3261f121d213590fa391]
        + Op.PUSH30[0x7d442a5e8734af2aaa4c859b452eed7860c2f7e051580427b6c3cc6d7fee]
        + Op.PUSH2[0x7a0d] + Op.PUSH5[0xef63e19225]
        + Op.PUSH14[0xe5d2ea2689decfd971c7478effb0]
        + Op.PUSH11[0xa9e792747ce0492abde8c2] + Op.CALLCODE
        ...
        + Op.PUSH7[0xb4692ca7e1e9c8] + Op.SWAP16 + Op.PUSH5[0xcdf879cb0c]
        + Op.PUSH3[0x551497]
        + Op.PUSH31[0xbca28f2ec8bb3a092bd0c30849558fe16a4b7070cb05aec329c0286c26fff5]
        + Op.PUSH24[0x95ce4ac7601160ea2d6656c8f2a554b43e263cc3a60e9fd0] + Op.LOG2
        ...
        + Op.PUSH13[0x6e9d05d54bbb4ad06cd62622e4] + Op.PUSH10[0xfbcd3e637a8f0d2ac914]
        + Op.SWAP12 + Op.PUSH17[0x76cce991cb5d4b4de1229e3decbcf46a3c]
        + Op.PUSH31[0x46aa1fdc218d936e56f55b5a38bbd798361040e1badb1ab06adc38a723badf]
        + Op.LOG0
        ...
        + Op.PUSH17[0x99eac9b0825d18018a5afcb6cecd9ab9a9] + Op.PUSH6[0x5ae262db08a2]
    ...
    tx = Transaction(
        secret_key=Hash(
            "0x1f2f6944f70460e655546d414267bd3491a2dd9dafb2280605404c858990d053"
        ),
        to=contract,
        data=bytes.fromhex(
            "73151af76abac2a99afe60eff5cfd8f68daf1b35e0608a690494ef4b1d043bf90e00916a"
            "cf5f0332c3ef3aa972eba960aa557dc165d1a3c726953fc637fe643a60543de4159f3bc0"
            "9673cd054235ddb44769fa2d6edb61b6e71feff2662043418ac9d2337bce1df4b842fbf8"
            "f07395b44bb506e8955d22a12176e2fb8e25bc546d77a6f5049a09f3126c915f14979d8c"
            "7c0cf88425567c6b8a6865b78e6d76208a641cb0d0651a758d9afdd5e36b2dcf740a8a1e"
            "2b19ebb0bc8ad6ac032577f3b5d483e40d0c9a40aaf32cebc478c0962e1ac5f6c648f476"
            "65f0850054ab4caab6eca1a24242087387c96452ad72e76a42a175db6c69a2d8cbcd7075"
            "9249b040a797894765385557e947875851cfe9734edc8b613cbb6bf40b41b762fa3bcbc6"
            "b59ecc66971fef9e8ed16d691702b224f0e2f8ad12577a943401f57334d3207b884a40ed"
    ...
    post = {
        Address("0x095e7baea6a6c7c4c2dfeb977efac326af552d87"): Account(storage={}, nonce=233),
