...
def test_random_statetest372(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5]
        + Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5] + Op.PUSH32[0x1]
        + Op.XOR + Op.ADDMOD + Op.PUSH1[0x0] + Op.MLOAD + Op.SSTORE
    ),
    )
    ...
    post = {
        contract: Account(storage={0: 0x945304eb96065b2a98b57a48a06ae28d285a71b4}, nonce=0),
