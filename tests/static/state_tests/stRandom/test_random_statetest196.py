...
def test_random_statetest196(
    ...
    pre[contract] = Account(
        ...
        + Op.CALLDATACOPY + Op.SUB + Op.PUSH6[0x9c5b3a6d7b9a] + Op.SWAP4 + Op.SLOAD
        + Op.CALLDATASIZE + Op.PUSH1[0x0] + Op.MLOAD + Op.SSTORE
    ),
    )
    ...
    post = {
        Address("0x095e7baea6a6c7c4c2dfeb977efac326af552d87"): Account(storage={0: 244}, nonce=0),
