...
contract code:
    ...
    sstore
    dup4
    push12 0x636c9c395a07320145334055
    push1 0x00
    mload
    sstore
"""
...
def test_random_statetest134(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.SSTORE + Op.DUP4
        + Op.PUSH12[0x636c9c395a07320145334055] + Op.PUSH1[0x0] + Op.MLOAD + Op.SSTORE
    ),
    )
