...
def test_random_statetest98(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0x0] + Op.SIGNEXTEND + Op.ADDMOD + Op.SSTORE + Op.PUSH1[0x0]
        + Op.MLOAD + Op.SSTORE
    ),
    )
    ...
    post = {
        Address("0x095e7baea6a6c7c4c2dfeb977efac326af552d87"): Account(
            storage={0: 0x945304eb96065b2a98b57a48a06ae28d285a71b5, 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe: 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff},
            nonce=0,
        ),
