...
def test_random_statetest260(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH32[0xc350] + Op.PUSH32[0x1] + Op.LOG0
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xc350]
        + Op.PUSH32[0xc350] + Op.PUSH32[0xc350] + Op.RETURN + Op.PUSH5[0x9156a6aa2]
        + Op.PUSH2[0x413b] + Op.JUMP + Op.CALLCODE + Op.ADDMOD + Op.SSTORE
    ),
    )
