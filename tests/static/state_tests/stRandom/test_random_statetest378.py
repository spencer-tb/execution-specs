...
contract code:
    ...
    gas
    push32 0x01
    push16 0x855b445834721a5706f2891711f00255
    push1 0x00
    mload
    sstore
"""
...
def test_random_statetest378(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.SLOAD
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x1]
        + Op.PUSH32[0xc350] + Op.PUSH32[0x0] + Op.GAS + Op.PUSH32[0x1]
        + Op.PUSH16[0x855b445834721a5706f2891711f00255] + Op.PUSH1[0x0] + Op.MLOAD
        + Op.SSTORE
    ),
    )
