...
def test_random_statetest100(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.COINBASE + Op.TIMESTAMP + Op.NUMBER + Op.PREVRANDAO + Op.NUMBER
        + Op.TIMESTAMP + Op.PREVRANDAO + Op.TIMESTAMP + Op.DUP4 + Op.CALLCODE
    ...
    post = {
        Address("0x095e7baea6a6c7c4c2dfeb977efac326af552d87"): Account(
            ...
            code=Op.COINBASE + Op.TIMESTAMP + Op.NUMBER + Op.PREVRANDAO + Op.NUMBER + Op.TIMESTAMP + Op.PREVRANDAO + Op.TIMESTAMP + Op.DUP4 + Op.CALLCODE + Op.PREVRANDAO + Op.SSTORE,
        ),
