...
def test_store_clears_and_internal_call_store_clears_oog(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH20[0xd61e0564fab2b0da5136f75db579b663bd9f2bd8] + Op.PUSH2[0x4e20]
        + Op.CALL + Op.STOP
    ),
    ...
    post = {
        ...
        Address("0xc94f5374fce5edbc8e2a8697c15331677e6ebf0b"): Account(storage={4: 12}, balance=20),
    }
