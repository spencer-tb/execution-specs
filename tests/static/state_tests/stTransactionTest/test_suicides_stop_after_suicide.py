...
def test_suicides_stop_after_suicide(
    ...
    pre[callee] = Account(balance=1110, nonce=0, code=Op.PUSH1[0x1] + Op.SELFDESTRUCT + Op.STOP)
    pre[sender] = Account(balance=0x7459280, nonce=0)
    pre[contract] = Account(
        balance=0x2710,
        nonce=0,
        code=(
        Op.PUSH1[0x0] + Op.SELFDESTRUCT + Op.PUSH1[0x0] + Op.PUSH1[0x0]
        + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0]
        + Op.PUSH2[0x7530] + Op.CALL + Op.STOP
    ),
    )
