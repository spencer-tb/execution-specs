...
class TestContractCreationGasUsage:
    ...
    def code_deposit_gas(self, fork: Fork, initcode: Initcode) -> int:
        ...
        Pre-Amsterdam: G_CODE_DEPOSIT_BYTE * code_size (= initcode.deployment_gas).
        Amsterdam+: cpsb * code_size + G_KECCAK_256_WORD * ceil(code_size / 32),
        where the per-byte cost becomes cost_per_state_byte and a code hash
        cost is added.
        """
