...
def test_delegatecall_oo_gin_call(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "60016000600060006000730896f13e800125c0ccec44f3c434335f0a97bc1b612710f401"  # noqa: E501
            "60005500"
        ),
    )
    ...
    post = {
        ...
        contract: Account(
            storage={0: 1},
            code=bytes.fromhex(
                "60016000600060006000730896f13e800125c0ccec44f3c434335f0a97bc1b612710f40160005500"  # noqa: E501
            ),
        ),
    }
