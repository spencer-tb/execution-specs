...
def test_delegatecall_basic(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "6002600060406000730896f13e800125c0ccec44f3c434335f0a97bc1b6207a120f46000"  # noqa: E501
            "5500"
        ),
    )
    ...
    post = {
        ...
        contract: Account(
            storage={0: 1, 1: 1},
            code=bytes.fromhex(
                "6002600060406000730896f13e800125c0ccec44f3c434335f0a97bc1b6207a120f460005500"  # noqa: E501
            ),
        ),
    }
