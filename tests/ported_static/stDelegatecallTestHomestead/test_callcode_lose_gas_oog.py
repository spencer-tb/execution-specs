...
def test_callcode_lose_gas_oog(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=0x1, value=Op.DELEGATECALL(gas=Op.ADD(0x1, Op.MUL(Op.SLOAD(key=0x0), 0x186a0)), address=0xbe855315b63d137b74d5eed6be5cd9dde6e2478d, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))
