...
def test_selfdestruct_eip2929(
    ...
    pre[contract] = Account(
        ...
        nonce=1,
        code=(
        Op.POP(Op.CALL(gas=0x0, address=0xcc, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))
    ...
    pre[callee_2] = Account(
        ...
        nonce=1,
        code=(
        Op.SELFDESTRUCT(address=Op.AND(0xffffffffffffffffffffffffffffffffffffffffff, Op.CALLDATALOAD(offset=0x0)))
    ),
    )
