...
def test_tx_e1c174e2(
    ...
    tx = Transaction(
        secret_key=Hash(
            "0x98d5e7375843784f7eb2606a693bab39ebac533561559e372dc3017f30519535"  # noqa: E501
        ),
        to=contract,
        data=bytes.fromhex(
    ...
    post = {
        contract: Account(
            ...
            code=(
                ...
                + Op.JUMPI(
                    pc=0x53F,
                    condition=Op.ISZERO(Op.EQ(Op.DUP2, 0x69E0998B)),
                )
                + Op.MSTORE(offset=0x80, value=Op.CALLDATALOAD(offset=0x4))
                + Op.MSTORE(offset=0xA0, value=Op.CALLDATALOAD(offset=0x24))
                + Op.MSTORE(offset=0x40, value=Op.CALLDATALOAD(offset=0x44))
                ...
                + Op.MSTORE(offset=Op.ADD(Op.DUP3, 0x20), value=0x1)
                + Op.MSTORE(
                    offset=Op.ADD(Op.DUP3, 0x40),
                    value=Op.MLOAD(offset=0x40),
                )
                + Op.MSTORE(
                    offset=Op.ADD(Op.DUP3, 0x60),
                    value=Op.MLOAD(offset=0x80),
                )
                + Op.MSTORE(
                    offset=Op.ADD(Op.DUP3, 0x80),
                    value=Op.MLOAD(offset=0xA0),
                )
                + Op.MSTORE(offset=Op.ADD(Op.DUP3, 0xA0), value=Op.CALLER)
                + Op.MSTORE(offset=Op.ADD(Op.DUP3, 0xC0), value=Op.NUMBER)
                ...
                + Op.JUMPI(
                    ...
                    condition=Op.ISZERO(
                        Op.ISZERO(
                            Op.SLOAD(
                                key=Op.ADD(
                                    0xE0000000000000000000000000000000000000000,  # noqa: E501
                                    Op.MUL(Op.MLOAD(offset=0x1C0), 0x8),
                                ),
                            ),
                        ),
                ...
                + Op.SSTORE(
                    ...
                    value=Op.ADD(
                        Op.SLOAD(
                            key=Op.ADD(
                                0xA, Op.MUL(Op.MLOAD(offset=0x40), 0xC)
                            ),
                        ),
                        0x1,
                    ),
                ...
                + Op.JUMPI(
                    pc=0xA0C,
                    condition=Op.ISZERO(Op.EQ(Op.DUP2, 0x909F073)),
                )
                + Op.MSTORE(offset=0x80, value=Op.CALLDATALOAD(offset=0x4))
                + Op.MSTORE(offset=0xA0, value=Op.CALLDATALOAD(offset=0x24))
                + Op.MSTORE(offset=0x40, value=Op.CALLDATALOAD(offset=0x44))
                ...
                + Op.JUMPI(
                    ...
                    condition=Op.ISZERO(
                        Op.ISZERO(
                            Op.SLT(
                                Op.MLOAD(offset=0x400), Op.MLOAD(offset=0x80)
                            ),
                        ),
                    ),
                )
                ...
                + Op.JUMPI(
                    pc=0x1733,
                    condition=Op.ISZERO(Op.EQ(Op.DUP2, 0x9998BD00)),
                )
                + Op.CALLDATASIZE
                + Op.MSIZE
                + Op.SWAP1
                ...
                + Op.JUMPI(
                    ...
                    condition=Op.ISZERO(
                        Op.SLT(
                            Op.MLOAD(offset=0x640),
                            Op.MLOAD(
                                offset=Op.SUB(Op.MLOAD(offset=0x600), 0x20)
                            ),
                        ),
                    ),
                )
                ...
                + Op.MLOAD(offset=0x5E0)
                + Op.JUMPI(
                    pc=0xBE0, condition=Op.ISZERO(Op.SLT(Op.DUP3, Op.DUP1))
                )
                + Op.DUP2
                + Op.JUMP(pc=0xBE2)
                + Op.JUMPDEST
                ...
                + Op.POP
                + Op.JUMPI(
                    pc=0xBF4, condition=Op.ISZERO(Op.SLT(Op.DUP3, Op.DUP1))
                )
                + Op.DUP2
                + Op.JUMP(pc=0xBF6)
                + Op.JUMPDEST
                ...
                + Op.MSTORE(
                    ...
                    value=Op.SDIV(
                        Op.MUL(
                            Op.MUL(
                                Op.MLOAD(offset=0x760), Op.MLOAD(offset=0xA0)
                            ),
                            0xDE0B6B3A7640000,
                        ),
                        Op.MUL(
                ...
                + Op.MSTORE(offset=0x860, value=Op.SLOAD(key=Op.SHA3))
                + Op.JUMPI(
                    pc=0xE3A, condition=Op.ISZERO(Op.MLOAD(offset=0x820))
                )
                + Op.MLOAD(offset=0x860)
                + Op.JUMP(pc=0xE3D)
                + Op.JUMPDEST
                ...
                + Op.JUMPDEST
                + Op.JUMPI(
                    pc=0xF05, condition=Op.ISZERO(Op.MLOAD(offset=0x820))
                )
                + Op.SSTORE(
                    key=Op.ADD(0xB, Op.MUL(Op.MLOAD(offset=0x40), 0xC)),
                    value=Op.MLOAD(offset=0x820),
                ...
                + Op.JUMPDEST
                + Op.JUMPI(
                    pc=0xF46, condition=Op.ISZERO(Op.MLOAD(offset=0x860))
                )
                + Op.PUSH1[0x0]
                + Op.PUSH1[0xA0]
                + Op.PUSH1[0xA0]
                ...
                + Op.JUMPDEST
                + Op.JUMPI(
                    pc=0xF86, condition=Op.ISZERO(Op.MLOAD(offset=0x820))
                )
                + Op.PUSH1[0x0]
                + Op.PUSH1[0xA0]
                + Op.PUSH1[0xA0]
                ...
                + Op.MSTORE(offset=0x860, value=Op.SLOAD(key=Op.SHA3))
                + Op.JUMPI(
                    pc=0x13AC, condition=Op.ISZERO(Op.MLOAD(offset=0x820))
                )
                + Op.MLOAD(offset=0x860)
                + Op.JUMP(pc=0x13AF)
                + Op.JUMPDEST
                ...
                + Op.JUMPDEST
                + Op.JUMPI(
                    pc=0x1477, condition=Op.ISZERO(Op.MLOAD(offset=0x820))
                )
                + Op.SSTORE(
                    key=Op.ADD(0xB, Op.MUL(Op.MLOAD(offset=0x40), 0xC)),
                    value=Op.MLOAD(offset=0x820),
                ...
                + Op.JUMPDEST
                + Op.JUMPI(
                    pc=0x14B8, condition=Op.ISZERO(Op.MLOAD(offset=0x860))
                )
                + Op.PUSH1[0x0]
                + Op.PUSH1[0xA0]
                + Op.PUSH1[0xA0]
                ...
                + Op.JUMPDEST
                + Op.JUMPI(
                    pc=0x14F8, condition=Op.ISZERO(Op.MLOAD(offset=0x820))
                )
                + Op.PUSH1[0x0]
                + Op.PUSH1[0xA0]
                + Op.PUSH1[0xA0]
                ...
                + Op.MSTORE(
                    offset=0x5E0,
                    value=Op.SUB(
                        Op.MLOAD(offset=0x5E0), Op.MLOAD(offset=0x760)
                    ),
                )
                + Op.MSTORE(
                    offset=0x620,
                    value=Op.SUB(
                        Op.MLOAD(offset=0x620), Op.MLOAD(offset=0x120)
                    ),
                )
                + Op.MSTORE(
                    offset=0x640,
                    value=Op.ADD(Op.MLOAD(offset=0x640), 0x1),
                )
                + Op.JUMP(pc=0xA46)
                + Op.JUMPDEST
                + Op.JUMPI(
                    pc=0x1726, condition=Op.ISZERO(Op.MLOAD(offset=0x620))
                )
                + Op.POP(
                    Op.CALL(
                        gas=0x1388,
                ...
                + Op.JUMPI(
                    pc=0x185B,
                    condition=Op.ISZERO(Op.EQ(Op.DUP2, 0x34A501C7)),
                )
                + Op.MSTORE(offset=0x80, value=Op.CALLDATALOAD(offset=0x4))
                + Op.MSTORE(offset=0x40, value=Op.CALLDATALOAD(offset=0x24))
                + Op.PUSH1[0x1C]
                ...
                + Op.POP(
                    Op.CALL(
                        ...
                        address=Op.SLOAD(
                            key=Op.ADD(
                                0x2, Op.MUL(Op.MLOAD(offset=0x40), 0xC)
                            ),
                        ),
                        value=0x0,
                        args_offset=Op.DUP4,
                ...
                + Op.JUMPI(
                    pc=0x1982,
                    condition=Op.ISZERO(Op.EQ(Op.DUP2, 0xE1ED3AD3)),
                )
                + Op.MSTORE(offset=0x80, value=Op.CALLDATALOAD(offset=0x4))
                + Op.MSTORE(offset=0x40, value=Op.CALLDATALOAD(offset=0x24))
                + Op.PUSH1[0x80]
                ...
                + Op.JUMPI(
                    pc=0x1F08,
                    condition=Op.ISZERO(Op.EQ(Op.DUP2, 0x327A22F1)),
                )
                + Op.MSTORE(offset=0x1C0, value=Op.CALLDATALOAD(offset=0x4))
                + Op.MSTORE(
                    offset=0x700,
                ...
                + Op.JUMPI(
                    pc=0x1EFB,
                    condition=Op.ISZERO(
                        Op.EQ(Op.CALLER, Op.MLOAD(offset=0x720))
                    ),
                )
                + Op.SSTORE(
                    key=Op.ADD(
                ...
                + Op.MSTORE(offset=0x860, value=Op.SLOAD(key=Op.SHA3))
                + Op.JUMPI(
                    pc=0x1C00, condition=Op.ISZERO(Op.MLOAD(offset=0x820))
                )
                + Op.MLOAD(offset=0x860)
                + Op.JUMP(pc=0x1C03)
                + Op.JUMPDEST
                ...
                + Op.JUMPDEST
                + Op.JUMPI(
                    pc=0x1CCB, condition=Op.ISZERO(Op.MLOAD(offset=0x820))
                )
                + Op.SSTORE(
                    key=Op.ADD(0xB, Op.MUL(Op.MLOAD(offset=0x40), 0xC)),
                    value=Op.MLOAD(offset=0x820),
                ...
                + Op.JUMPDEST
                + Op.JUMPI(
                    pc=0x1D0C, condition=Op.ISZERO(Op.MLOAD(offset=0x860))
                )
                + Op.PUSH1[0x0]
                + Op.PUSH1[0xA0]
                + Op.PUSH1[0xA0]
                ...
                + Op.JUMPDEST
                + Op.JUMPI(
                    pc=0x1D4C, condition=Op.ISZERO(Op.MLOAD(offset=0x820))
                )
                + Op.PUSH1[0x0]
                + Op.PUSH1[0xA0]
                + Op.PUSH1[0xA0]
                ...
                + Op.JUMPI(
                    pc=0x22F0,
                    condition=Op.ISZERO(Op.EQ(Op.DUP2, 0xD91E22F4)),
                )
                + Op.MSTORE(offset=0xF80, value=Op.CALLDATALOAD(offset=0x4))
                + Op.MSTORE(offset=0x680, value=Op.CALLDATALOAD(offset=0x24))
                + Op.MSTORE(offset=0x6A0, value=Op.CALLDATALOAD(offset=0x44))
                ...
                + Op.JUMPI(
                    pc=0x232A,
                    condition=Op.ISZERO(Op.EQ(Op.DUP2, 0x41569661)),
                )
                + Op.MSTORE(offset=0x1220, value=Op.CALLDATALOAD(offset=0x4))
                + Op.MSTORE(
                    offset=0x1240,
                ...
                + Op.JUMPI(
                    pc=0x2364,
                    condition=Op.ISZERO(Op.EQ(Op.DUP2, 0xFCDE9F78)),
                )
                + Op.MSTORE(offset=0xF80, value=Op.CALLDATALOAD(offset=0x4))
                + Op.MSTORE(
                    offset=0x1260,
                ...
                + Op.JUMPI(
                    pc=0x2392,
                    condition=Op.ISZERO(Op.EQ(Op.DUP2, 0x6E5B4343)),
                )
                + Op.MSTORE(
                    offset=0x1280,
                    value=Op.SLOAD(
                ...
                + Op.JUMPI(
                    pc=0x24E6,
                    condition=Op.ISZERO(Op.EQ(Op.DUP2, 0xFAFA69C2)),
                )
                + Op.MSTORE(offset=0xFC0, value=Op.CALLDATALOAD(offset=0x4))
                + Op.PUSH2[0x180]
                + Op.MSIZE
                ...
                + Op.JUMPI(
                    pc=0x24B2, condition=Op.ISZERO(Op.MLOAD(offset=0x12A0))
                )
                + Op.MLOAD(offset=0x12A0)
                + Op.MSTORE(offset=Op.SUB(Op.DUP3, 0x40), value=0x20)
                + Op.RETURN(
                ...
                + Op.JUMPI(
                    pc=0x262E,
                    condition=Op.ISZERO(Op.EQ(Op.DUP2, 0x9CFC1535)),
                )
                + Op.MSTORE(offset=0x40, value=Op.CALLDATALOAD(offset=0x4))
                + Op.MSTORE(
                    offset=0x1340,
                ...
                + Op.JUMPI(
                    ...
                    condition=Op.ISZERO(
                        Op.SLT(
                            Op.MLOAD(offset=0x13A0), Op.MLOAD(offset=0x1340)
                        ),
                    ),
                )
                + Op.PUSH1[0xA0]
                ...
                + Op.MSTORE(
                    offset=0x13A0,
                    value=Op.ADD(Op.MLOAD(offset=0x13A0), 0x1),
                )
                + Op.JUMP(pc=0x253D)
                + Op.JUMPDEST
                + Op.JUMPI(
                    pc=0x25FA, condition=Op.ISZERO(Op.MLOAD(offset=0x600))
                )
                + Op.MLOAD(offset=0x600)
                + Op.MSTORE(offset=Op.SUB(Op.DUP3, 0x40), value=0x20)
                + Op.RETURN(
                ...
                + Op.JUMPI(
                    pc=0x27E9,
                    condition=Op.ISZERO(Op.EQ(Op.DUP2, 0xF718190)),
                )
                + Op.MSTORE(offset=0xFC0, value=Op.CALLDATALOAD(offset=0x4))
                + Op.PUSH2[0x120]
                + Op.MSIZE
                ...
                + Op.JUMPI(
                    pc=0x27B5, condition=Op.ISZERO(Op.MLOAD(offset=0x180))
                )
                + Op.MLOAD(offset=0x180)
                + Op.MSTORE(offset=Op.SUB(Op.DUP3, 0x40), value=0x20)
                + Op.RETURN(
                ...
                + Op.JUMPI(
                    pc=0x2893,
                    condition=Op.ISZERO(Op.EQ(Op.DUP2, 0x1C9AA4B6)),
                )
                + Op.MSTORE(offset=0x1220, value=Op.CALLDATALOAD(offset=0x4))
                + Op.MSTORE(offset=0x40, value=Op.CALLDATALOAD(offset=0x24))
                + Op.PUSH1[0x60]
