...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallDelegateCodesHomestead/callcodecallcodecall_110_SuicideMiddleFiller.json",  # noqa: E501
    ],
)
...
def test_callcodecallcodecall_110_suicide_middle(
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "604060006040600073ac90bb4611b91d4c6292bd64e8656110822e01ed620186a0f46001"  # noqa: E501
            "5500"
        ),
    )
    ...
    post = {
        ...
        callee: Account(
            code=bytes.fromhex(
                "604060006040600073ac90bb4611b91d4c6292bd64e8656110822e01ed620186a0f460015500"  # noqa: E501
            ),
        ),
