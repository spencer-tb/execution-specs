...
def test_callcallcode_01(
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x1, value=Op.DELEGATECALL(gas=0x3d090, address=0xb096eca04cd5c92c88ba466f92627d4f04d53c95, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.STOP
    ),
    )
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x0, value=Op.CALL(gas=0x55730, address=0x2b0691cd58a1cf4628d642e9aca9ab04946e3ec9, value=0x1, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.STOP
    ),
    )
    ...
    post = {
        callee: Account(
            storage={1: 1, 2: 1, 4: 0xeb09ff15547417853f6f4b240b8804769c37b0f1, 7: 1, 230: 0x2b0691cd58a1cf4628d642e9aca9ab04946e3ec9, 232: 0xebaf50debf10e08302fe4280c32df010463ca297, 236: 64, 238: 34, 240: 10},
            code=Op.SSTORE(key=0x1, value=Op.DELEGATECALL(gas=0x3d090, address=0xb096eca04cd5c92c88ba466f92627d4f04d53c95, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)) + Op.STOP,
        ),
        callee_1: Account(
        ...
        contract: Account(
            storage={0: 1},
            code=Op.SSTORE(key=0x0, value=Op.CALL(gas=0x55730, address=0x2b0691cd58a1cf4628d642e9aca9ab04946e3ec9, value=0x1, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)) + Op.STOP,
        ),
    }
