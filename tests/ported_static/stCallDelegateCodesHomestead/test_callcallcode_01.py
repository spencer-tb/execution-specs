...
def test_callcallcode_01(
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "604060006040600073b096eca04cd5c92c88ba466f92627d4f04d53c956203d090f46001"  # noqa: E501
            "5500"
        ),
    )
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "60406000604060006001732b0691cd58a1cf4628d642e9aca9ab04946e3ec962055730f1"  # noqa: E501
            "60005500"
        ),
    )
    ...
    post = {
        callee: Account(
            ...
            code=bytes.fromhex(
                "604060006040600073b096eca04cd5c92c88ba466f92627d4f04d53c956203d090f460015500"  # noqa: E501
            ),
        ),
        callee_1: Account(
            code=bytes.fromhex(
        ...
        contract: Account(
            storage={0: 1},
            code=bytes.fromhex(
                "60406000604060006001732b0691cd58a1cf4628d642e9aca9ab04946e3ec962055730f160005500"  # noqa: E501
            ),
        ),
    }
