...
Ported from:
tests/static/state_tests/stCallDelegateCodesHomestead/callcodecallcodecall_110_OOGMBeforeFiller.json
"""
...
def test_callcodecallcodecall_110_oogm_before(
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x1, value=Op.DELEGATECALL(gas=0x927c0, address=0x51a61d678ec27711369c527e5d42a9de66a5727f, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
    ...
    post = {
        ...
        callee: Account(
            code=Op.SSTORE(key=0x1, value=Op.DELEGATECALL(gas=0x927c0, address=0x51a61d678ec27711369c527e5d42a9de66a5727f, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)) + Op.SSTORE(key=0xb, value=0x1) + Op.STOP,
        ),
        callee_1: Account(
