"""
Ported from:
tests/static/state_tests/stCallDelegateCodesHomestead/callcallcallcode_001_SuicideMiddleFiller.json
"""
...
def test_callcallcallcode_001_suicide_middle(
    ...
    pre[callee_2] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x1, value=Op.CALL(gas=0x186a0, address=0x124b38fa011c9d36b7fe193dc636813a2f8bdaa7, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.STOP
    ),
    )
    ...
    post = {
        ...
        callee_2: Account(
            storage={1: 1},
            code=Op.SSTORE(key=0x1, value=Op.CALL(gas=0x186a0, address=0x124b38fa011c9d36b7fe193dc636813a2f8bdaa7, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)) + Op.STOP,
        ),
    }
