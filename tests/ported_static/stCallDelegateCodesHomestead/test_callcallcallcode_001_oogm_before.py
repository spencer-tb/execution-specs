...
def test_callcallcallcode_001_oogm_before(
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x1, value=Op.CALL(gas=0x927c0, address=0xefe4727369c5f495aebf4ea778cc48d1155bf978, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
    ...
    post = {
        ...
        callee: Account(
            storage={11: 1},
            code=Op.SSTORE(key=0x1, value=Op.CALL(gas=0x927c0, address=0xefe4727369c5f495aebf4ea778cc48d1155bf978, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)) + Op.SSTORE(key=0xb, value=0x1) + Op.STOP,
        ),
