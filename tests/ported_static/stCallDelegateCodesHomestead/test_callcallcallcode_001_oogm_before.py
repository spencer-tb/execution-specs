...
def test_callcallcallcode_001_oogm_before(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "6040600060406000600073471072d55a5a95044c2326f0e94a6d8df5b8089e620c3500f1"  # noqa: E501
            "60005500"
        ),
    )
    pre[callee] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "6040600060406000600073efe4727369c5f495aebf4ea778cc48d1155bf978620927c0f1"  # noqa: E501
            "6001556001600b5500"
        ),
    )
    ...
    post = {
        contract: Account(
            storage={0: 1},
            code=bytes.fromhex(
                "6040600060406000600073471072d55a5a95044c2326f0e94a6d8df5b8089e620c3500f160005500"  # noqa: E501
            ),
        ),
        callee: Account(
            storage={11: 1},
            code=bytes.fromhex(
                "6040600060406000600073efe4727369c5f495aebf4ea778cc48d1155bf978620927c0f16001556001600b5500"  # noqa: E501
            ),
        ),
