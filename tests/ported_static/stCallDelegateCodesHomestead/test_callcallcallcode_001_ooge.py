...
def test_callcallcallcode_001_ooge(
    ...
    pre[callee_2] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "60406000604060006000733e423a7b1fba04d0c3f9423a3ae2a180d2878d5b620927c0f1"  # noqa: E501
            "60015500"
        ),
    )
    ...
    post = {
        ...
        callee_2: Account(
            storage={1: 1},
            code=bytes.fromhex(
                "60406000604060006000733e423a7b1fba04d0c3f9423a3ae2a180d2878d5b620927c0f160015500"  # noqa: E501
            ),
        ),
    }
