...
Ported from:
tests/static/state_tests/stCallDelegateCodesHomestead/callcallcodecall_010_OOGMBeforeFiller.json
"""
...
def test_callcallcodecall_010_oogm_before(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x0, value=Op.CALL(gas=0xc3500, address=0x97367129e262c26ff9d41b4424eb9e460270f83f, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.STOP
    ),
    )
    pre[callee] = Account(
    ...
    post = {
        contract: Account(
            storage={0: 1},
            code=Op.SSTORE(key=0x0, value=Op.CALL(gas=0xc3500, address=0x97367129e262c26ff9d41b4424eb9e460270f83f, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)) + Op.STOP,
        ),
        callee: Account(
