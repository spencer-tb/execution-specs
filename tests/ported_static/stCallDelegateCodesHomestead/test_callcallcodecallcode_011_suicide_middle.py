...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallDelegateCodesHomestead/callcallcodecallcode_011_SuicideMiddleFiller.json",  # noqa: E501
    ],
)
...
def test_callcallcodecallcode_011_suicide_middle(
        ...
        code=(
            Op.SSTORE(
                ...
                value=Op.DELEGATECALL(
                    gas=0x186A0,
                    address=0x6A45EC7F08C71B222CFC454A9608BC278E87F0AB,
                    args_offset=0x0,
                    args_size=0x40,
                    ret_offset=0x0,
                    ret_size=0x40,
    ...
    pre.deploy_contract(
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address("0x6a45ec7f08c71b222cfc454a9608bc278e87f0ab"),  # noqa: E501
    )
    pre.deploy_contract(
