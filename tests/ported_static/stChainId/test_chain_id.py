...
def test_chain_id(
    ...
    pre[contract] = Account(balance=0, nonce=0, code=Op.SSTORE(key=0x1, value=Op.CHAINID) + Op.STOP)
    ...
    post = {
        contract: Account(storage={1: 1}, code=Op.SSTORE(key=0x1, value=Op.CHAINID) + Op.STOP),
    }
