    ...
    post = {
        contract: Account(
            ...
            code=(
                ...
                + Op.JUMPI(
                    pc=Op.PUSH2[0x65], condition=Op.EQ(Op.DUP2, 0x173825D9)
                )
                + Op.JUMPI(
                    pc=Op.PUSH2[0xB7], condition=Op.EQ(0x2F54BF6E, Op.DUP1)
                )
                + Op.JUMPI(
                    pc=Op.PUSH2[0xE8], condition=Op.EQ(0x7065CB48, Op.DUP1)
                )
                + Op.JUMPI(pc=0x105, condition=Op.EQ(0xB75C7DC6, Op.DUP1))
                + Op.JUMPI(pc=0x142, condition=Op.EQ(0xBA51A6DF, Op.DUP1))
                + Op.JUMPI(pc=0x15F, condition=Op.EQ(0xF00D4B5D, Op.DUP1))
                ...
                + Op.DUP1
                + Op.JUMPI(
                    pc=0x58F, condition=Op.ISZERO(Op.EQ(Op.DUP2, Op.DUP4))
                )
                + Op.JUMP(pc=0x586)
                + Op.JUMPDEST
                + Op.PUSH2[0x187]
                ...
                + Op.DUP1
                + Op.JUMPI(
                    pc=0x191, condition=Op.ISZERO(Op.EQ(Op.DUP2, Op.DUP4))
                )
                + Op.JUMP(pc=0x213)
                + Op.JUMPDEST
                + Op.PUSH2[0x181]
                ...
                + Op.JUMPDEST
                + Op.JUMPI(
                    pc=0x80C, condition=Op.ISZERO(Op.LT(Op.DUP2, Op.DUP2))
                )
                + Op.PUSH2[0x104]
                + Op.SLOAD(key=Op.DUP1)
                + Op.DUP3
                ...
                + Op.JUMPDEST
                + Op.JUMPI(
                    pc=0x6A4, condition=Op.ISZERO(Op.GT(Op.DUP3, Op.DUP1))
                )
                + Op.SSTORE(key=Op.DUP2, value=0x0)
                + Op.PUSH1[0x1]
                + Op.ADD
                ...
                + Op.JUMPDEST
                + Op.JUMPI(
                    pc=0x27F, condition=Op.ISZERO(Op.GT(Op.DUP3, Op.DUP1))
                )
                + Op.SSTORE(key=Op.DUP2, value=0x0)
                + Op.PUSH1[0x1]
                + Op.ADD
