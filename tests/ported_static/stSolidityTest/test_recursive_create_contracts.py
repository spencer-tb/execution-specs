    ...
    post = {
        contract: Account(
            ...
            code=(
                ...
                + Op.DIV
                + Op.JUMPI(
                    pc=Op.PUSH2[0x21], condition=Op.EQ(0x820B13F6, Op.DUP1)
                )
                + Op.JUMPI(
                    pc=Op.PUSH2[0x32], condition=Op.EQ(0xA444F5E9, Op.DUP1)
                )
                + Op.STOP
                + Op.JUMPDEST
                + Op.PUSH2[0x2C]
                ...
                + Op.PUSH1[0x0]
                + Op.CODECOPY(
                    dest_offset=0x0, offset=Op.PUSH2[0xE5], size=0xC8
                )
                + Op.PUSH1[0xC8]
                + Op.MSTORE(
                    offset=Op.DUP2,
                ...
                + Op.PUSH1[0x0]
                + Op.MSTORE(
                    offset=0x0, value=Op.MUL(Op.EXP(0x2, 0xE0), Op.DUP3)
                )
                + Op.PUSH1[0x4]
                + Op.MSTORE(offset=Op.DUP2, value=Op.DUP6)
                + Op.PUSH1[0x20]
