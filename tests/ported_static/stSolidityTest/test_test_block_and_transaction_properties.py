...
def test_test_block_and_transaction_properties(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.MSTORE(offset=0x40, value=0x60) + Op.CALLDATALOAD(offset=0x0)
        ...
        + Op.JUMP(pc=Op.PUSH2[0x8e]) + Op.JUMPDEST + Op.MLOAD(offset=0x40) + Op.DUP1
        + Op.MSTORE(offset=Op.DUP2, value=Op.ISZERO(Op.ISZERO(Op.DUP3)))
        + Op.PUSH1[0x20] + Op.ADD + Op.SWAP2 + Op.POP + Op.POP + Op.MLOAD(offset=0x40)
        + Op.DUP1 + Op.SWAP2 + Op.SUB + Op.SWAP1 + Op.RETURN + Op.JUMPDEST
        + Op.PUSH2[0x76] + Op.PUSH1[0x4] + Op.POP(Op.DUP1) + Op.POP
        + Op.JUMP(pc=Op.PUSH2[0xc9]) + Op.JUMPDEST + Op.MLOAD(offset=0x40) + Op.DUP1
        + Op.MSTORE(offset=Op.DUP2, value=Op.ISZERO(Op.ISZERO(Op.DUP3)))
        + Op.PUSH1[0x20] + Op.ADD + Op.SWAP2 + Op.POP + Op.POP + Op.MLOAD(offset=0x40)
        + Op.DUP1 + Op.SWAP2 + Op.SUB + Op.SWAP1 + Op.RETURN + Op.JUMPDEST
        + Op.PUSH1[0x0] + Op.PUSH2[0x98] + Op.JUMP(pc=Op.PUSH2[0xc9]) + Op.JUMPDEST
        ...
        + Op.JUMP(pc=Op.PUSH2[0xc6]) + Op.JUMPDEST + Op.SWAP1 + Op.JUMP + Op.JUMPDEST
