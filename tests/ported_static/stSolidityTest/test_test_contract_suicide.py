    ...
    post = {
        contract: Account(
            ...
            code=(
                ...
                + Op.JUMPI(
                    pc=Op.PUSH2[0x39], condition=Op.EQ(Op.DUP2, 0xA60EEDDA)
                )
                + Op.JUMPI(
                    pc=Op.PUSH2[0x4B], condition=Op.EQ(0xC0406226, Op.DUP1)
                )
                + Op.STOP
                + Op.JUMPDEST
                + Op.PUSH2[0x41]
                ...
                + Op.POP
                + Op.JUMPI(
                    pc=0x148, condition=Op.EQ(0xE1, Op.MLOAD(offset=0x0))
                )
                + Op.JUMP(pc=0x151)
                + Op.JUMPDEST
                + Op.PUSH1[0x1]
