...
def test_random_statetest542(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.CODECOPY(dest_offset=Op.PUSH32[0x0], offset=Op.PUSH32[0x10000000000000000000000000000000000000000], size=Op.TIMESTAMP)
    ...
    post = {
        contract: Account(
            storage={0: 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, 0xffffffffffffffffffffffffffffffffffffffff: 0x10000000000000000000000000000000000000000},
            code=Op.CODECOPY(dest_offset=Op.PUSH32[0x0], offset=Op.PUSH32[0x10000000000000000000000000000000000000000], size=Op.TIMESTAMP) + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.SWAP3 + Op.SSTORE + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
        coinbase: Account(
