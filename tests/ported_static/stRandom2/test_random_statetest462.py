...
def test_random_statetest462(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH16[0x8e0186019d029d1354681482826f3755] + Op.PUSH1[0x0] + Op.MLOAD
        + Op.SSTORE
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0010000000000000000000000000000000000010007f0000000000000000000000001000"
            "0000000000000000000000000000000010007f0000000000000000000000001000000000"
            "0000000000000000000000000010007f0000000000000000000000010000000000000000"
