...
def test_random_statetest541(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.LT(Op.SIGNEXTEND(Op.CALLDATALOAD(offset=0x6e089257368d07897d57), Op.CALLDATALOAD(offset=Op.NUMBER)), Op.PUSH32[0x10000000000000000000000000000000000000000]), value=Op.PUSH32[0x0])
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000100000000000000000000000000000000000000004335696e089257368d07897d5735"
            "0b10"
        ),
        gas_limit=100000,
        gas_price=10,
