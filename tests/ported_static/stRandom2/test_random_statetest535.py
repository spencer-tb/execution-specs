...
def test_random_statetest535(
    ...
    contract = Address("0xfb33a18f5315642fac0f83122a6c44c9fb6f4f4d")
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.PUSH32[0x0], value=Op.PUSH32[0x10000000000000000000000000000000000000000])
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0000000000000000000000000000000000000000017f0000000000000000000000004f3f"
            "701464972e74606d6ea82d4d3080599a0e797f0000000000000000000000010000000000"
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x1] + Op.PUSH32[0x1] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.SSTORE(key=Op.PUSH32[0x0], value=Op.PUSH32[0x10000000000000000000000000000000000000000]),
        ),
    }
