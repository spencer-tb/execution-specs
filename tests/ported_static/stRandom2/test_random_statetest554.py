...
def test_random_statetest554(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.LOG0(offset=0xdc, size=0x14) + Op.PUSH1[0x29]
        ...
        + Op.CALL(gas=0x176fe819, address=0xd4932c914a13bd1791675290fdd56965c3fcbd03, value=0x7efe33a, args_offset=0x8, args_size=0x3, ret_offset=0x1b, ret_size=0x13)
