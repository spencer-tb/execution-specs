...
def test_random_statetest564(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.JUMPDEST + Op.PUSH32[0x10000000000000000000000000000000000000000]
        ...
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.POP(Op.GASLIMIT) + Op.SSTORE(key=Op.AND, value=Op.ADDMOD)
    ),
    )
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(
            "5b7f00000000000000000000000100000000000000000000000000000000000000007f00"
            ...
            "0000000000945304eb96065b2a98b57a48a06ae28d285a71b57fffffffffffffffffffff"
    ...
    post = {
        contract: Account(
            ...
            code=Op.JUMPDEST + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.POP(Op.GASLIMIT) + Op.SSTORE(key=Op.AND, value=Op.ADDMOD),
        ),
        coinbase: Account(
