...
def test_random_statetest389(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xc350]
        + Op.CALLDATACOPY(dest_offset=Op.SLT(Op.PC, Op.SLOAD(key=Op.CODESIZE)), offset=Op.DUP7, size=Op.GASPRICE)
    ...
    post = {
        ...
        contract: Account(
            storage={0: 50000},
            code=Op.GASLIMIT + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x0] + Op.TIMESTAMP + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xc350] + Op.CALLDATACOPY(dest_offset=Op.SLT(Op.PC, Op.SLOAD(key=Op.CODESIZE)), offset=Op.DUP7, size=Op.GASPRICE) + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
    }
