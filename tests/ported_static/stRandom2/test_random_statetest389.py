...
def test_random_statetest389(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "000000000000000000000000000000000000c3503a86385458123760005155"
        ),
    )
    ...
    post = {
        ...
        contract: Account(
            storage={0: 50000},
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
    }
