...
def test_random_statetest472(
    ...
    contract = Address("0x5b9efb31b8be05e6e52f6921f9ee79769a6792d0")
    ...
    pre[contract] = Account(
        ...
        + Op.COINBASE + Op.NUMBER
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.EXP(Op.MULMOD(Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]), 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe))
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000004f3f701464972e74606d6ea82d4d3080599a0e7941437fffffff"
    ...
    post = {
        ...
        contract: Account(
            code=Op.PUSH32[0x0] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.COINBASE + Op.NUMBER + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.EXP(Op.MULMOD(Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]), 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe)),
        ),
    }
