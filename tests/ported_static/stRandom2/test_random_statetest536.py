...
def test_random_statetest536(
    ...
    contract = Address("0x85e66f40eb86a2d63df2dc248b3d6f4fc138b003")
    ...
    pre[contract] = Account(
        ...
        "00000000000000000000000000000000000000000000000000c350537f00000000000000"
    ...
    post = {
        ...
        contract: Account(
            code=bytes.fromhex(""),
        ),
    }
