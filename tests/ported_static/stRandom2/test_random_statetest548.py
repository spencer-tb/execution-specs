...
def test_random_statetest548(
    ...
    pre[contract] = Account(
        ...
        + Op.NOT(Op.PUSH32[0x10000000000000000000000000000000000000000]) + Op.COINBASE
        + Op.PUSH32[0x1]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x777a349a646633977da01a315a3c0355)
    ),
    )
