...
def test_random_statetest629(
    ...
    contract = Address("0xd4302fbf760860b03f9b86b05d19f7f41567dc69")
    ...
    pre[contract] = Account(
        ...
        + Op.GT(Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79], Op.CALLVALUE)
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x427277147c617f4354a35a1a47977a55)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "004f3f701464972e74606d6ea82d4d3080599a0e79347f0000000000000000000000004f"
            "3f701464972e74606d6ea82d4d3080599a0e79116f427277147c617f4354a35a1a47977a"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x0] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.GT(Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79], Op.CALLVALUE) + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x427277147c617f4354a35a1a47977a55),
        ),
    }
