...
def test_random_statetest499(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xc350]
        + Op.CODECOPY(dest_offset=Op.PUSH32[0x0], offset=Op.PUSH32[0x10000000000000000000000000000000000000000], size=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff)
        + Op.SWAP16 + Op.DUP7 + Op.SWAP11 + Op.SELFDESTRUCT + Op.EXTCODESIZE + Op.MOD
        + Op.CALLER + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.CODESIZE)
    ),
    )
