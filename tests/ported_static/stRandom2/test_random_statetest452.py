...
def test_random_statetest452(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH16[0xa3289746806163630047dff98310555] + Op.PUSH1[0x0] + Op.MLOAD
        + Op.SSTORE
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffff7f0000000000000000000000001000000000000000"
            "0000000000000000000010006f0a3289746806163630047dff983105"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
