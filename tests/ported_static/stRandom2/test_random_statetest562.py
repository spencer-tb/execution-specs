...
def test_random_statetest562(
    ...
    contract = Address("0x86e63b3928d89817589609c1e2180e22939d6a62")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x1] + Op.SWAP4
        + Op.LOG0(offset=Op.PUSH32[0xc350], size=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff)
        + Op.SWAP5 + Op.PREVRANDAO + Op.DUP8 + Op.PREVRANDAO
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000000000000000000000000000000001937fffffffffffffffffffff"
