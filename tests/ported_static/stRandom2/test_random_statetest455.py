...
def test_random_statetest455(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH16[0x858b1411f218693ca2245b918274f355] + Op.PUSH1[0x0] + Op.MLOAD
        + Op.SSTORE
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0000000000000000000000000000017f0000000000000000000000001000000000000000"
            "0000000000000000000010006f858b1411f218693ca2245b918274f3"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
