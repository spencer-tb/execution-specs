...
def test_random_statetest559(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x0]
        + Op.SELFDESTRUCT(address=Op.MULMOD(Op.DUP6, Op.PUSH32[0x10000000000000000000000000000000000000000], Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]))
        + Op.ISZERO + Op.SSTORE
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0000000000000000000000000000000000007f000000000000000000000000ffffffffff"
            "ffffffffffffffffffffffffffffff7f0000000000000000000000010000000000000000"
    ...
    post = {
        contract: Account(
            code=Op.PUSH32[0xc350] + Op.PUSH32[0xc350] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xc350] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x0] + Op.SELFDESTRUCT(address=Op.MULMOD(Op.DUP6, Op.PUSH32[0x10000000000000000000000000000000000000000], Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])) + Op.ISZERO + Op.SSTORE,
        ),
        coinbase: Account(
