...
def test_random_statetest559(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "0000000000000000000000008509ff1555"
        ),
    )
    ...
    post = {
        contract: Account(
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
        coinbase: Account(
            code=bytes.fromhex("6000355415600957005b60203560003555"),
