...
def test_random_statetest482(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x27c9d313d9b09376505927c8e715655)
    ),
    )
