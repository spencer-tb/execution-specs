...
def test_random_statetest533(
    ...
    pre[contract] = Account(
        ...
        + Op.DUP5
        + Op.SMOD(Op.GASPRICE, Op.PUSH32[0x10000000000000000000000000000000000000000])
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000000000000000000001847f00000000000000000000000100000000"
    ...
    post = {
        ...
        contract: Account(
            storage={0: 21077},
            code=Op.PUSH32[0x1] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x1] + Op.DUP5 + Op.SMOD(Op.GASPRICE, Op.PUSH32[0x10000000000000000000000000000000000000000]) + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x5255),
        ),
    }
