...
def test_random_statetest600(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xc350] + Op.PUSH32[0xc350] + Op.NUMBER + Op.GASLIMIT
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0xb6f37208e76a402927039198c969907)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000000000000000000000c35043457fffffffffffffffffff"
            "fffffffffffffffffffffffffffffffffffffffffffffe6f0b6f37208e76a40292703919"
            "8c969907"
        ),
        gas_limit=100000,
        gas_price=10,
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xc350] + Op.PUSH32[0xc350] + Op.NUMBER + Op.GASLIMIT + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0xb6f37208e76a402927039198c969907),
        ),
    }
