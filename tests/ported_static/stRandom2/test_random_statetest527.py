...
def test_random_statetest527(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.CALLVALUE + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
        ...
        + Op.LOG1(offset=Op.DUP1, size=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], topic_1=Op.PUSH32[0xc350])
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(
            "347f000000000000000000000000ffffffffffffffffffffffffffffffffffffffff447f"
