...
def test_random_statetest501(
    ...
    contract = Address("0x8dcbdf86469ad8b7711977ce5c41cfac654ea87a")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.SSTORE(key=Op.MULMOD(Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff), value=Op.PUSH32[0xc350])
    ...
    post = {
        ...
        contract: Account(
            storage={0: 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, 0xffffffffffffffffffffffff0000000000000000000000000000000000000000: 50000},
            code=Op.PUSH32[0x0] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.SSTORE(key=Op.MULMOD(Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff), value=Op.PUSH32[0xc350]) + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
    }
