"""
Ported from:
tests/static/state_tests/stRandom2/randomStatetest558Filler.json
"""
...
def test_random_statetest558(
    ...
    contract = Address("0xfea0fd6f8e6416af47ab5057d310ed005855772a")
    ...
    pre[contract] = Account(balance=0xde0b6b3a7640000, nonce=0, code=bytes.fromhex("43767855"))
    ...
    post = {
        ...
        contract: Account(code=bytes.fromhex("43767855")),
    }
