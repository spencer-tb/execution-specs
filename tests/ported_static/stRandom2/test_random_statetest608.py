...
def test_random_statetest608(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000000000000000000000000000c350537fffffffffffffff"
