...
def test_random_statetest545(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "00000000000000000000c350637c9c8213300560005155"
        ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
        coinbase: Account(
            code=bytes.fromhex("6000355415600957005b60203560003555"),
