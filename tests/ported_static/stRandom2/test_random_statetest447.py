...
def test_random_statetest447(
    ...
    contract = Address("0xe1655b4f3e5f4fd17126a28f5cc273efeb1c89b3")
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.ADDMOD(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], Op.NUMBER), value=0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe)
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.SSTORE(key=Op.ADDMOD(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], Op.NUMBER), value=0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe) + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
    }
