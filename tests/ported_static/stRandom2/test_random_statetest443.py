...
def test_random_statetest443(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.GT(Op.PUSH32[0x0], 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff), value=Op.PUSH32[0x1])
        + Op.SWAP4 + Op.CALLDATACOPY + Op.DIV
    ),
    )
