...
def test_random_statetest406(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.SSTORE(key=0xb58b8e99f33c647165337e389f7b9c909cba, value=0x7f000000000000000000000000945304eb96065b2a98b57a48a06ae28d285a)
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000945304eb96065b2a98b57a48a06ae28d285a71b57fffffffffff"
            "fffffffffffffffffffffffffffffffffffffffffffffffffffffe7f0000000000000000"
            "00000000945304eb96065b2a98b57a48a06ae28d285a71b57fffffffffffffffffffffff"
            "fffffffffffffffffffffffffffffffffffffffffe7e7f00000000000000000000000094"
            "5304eb96065b2a98b57a48a06ae28d285a71b58b8e99f33c647165337e389f7b9c909cba"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
    ...
    post = {
        contract: Account(
            ...
            code=Op.PUSH32[0x0] + Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.SSTORE(key=0xb58b8e99f33c647165337e389f7b9c909cba, value=0x7f000000000000000000000000945304eb96065b2a98b57a48a06ae28d285a) + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
        coinbase: Account(
