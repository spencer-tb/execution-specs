...
def test_random_statetest466(
    ...
    contract = Address("0x01b1e973a4d051cfbb5acde495eccdf5ad34a422")
    ...
    pre[contract] = Account(
        ...
        + Op.PREVRANDAO + Op.SWAP1 + Op.DIV(Op.PREVRANDAO, Op.TIMESTAMP) + Op.SSTORE
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000ffffffffffffffffffffffffffffffffffffffff424490424404"
        ),
        gas_limit=14265563,
        gas_price=10,
        nonce=0,
    ...
    post = {
        contract: Account(
            storage={0: 0x20000, 131: 1000},
            code=Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.TIMESTAMP + Op.PREVRANDAO + Op.SWAP1 + Op.DIV(Op.PREVRANDAO, Op.TIMESTAMP) + Op.SSTORE + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
        coinbase: Account(
