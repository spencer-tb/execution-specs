...
def test_random_statetest605(
    ...
    pre[contract] = Account(
        ...
        + Op.SWAP1 + Op.ADDMOD(Op.DUP6, Op.SUB, Op.PC) + Op.SSTORE
    ),
    )
    ...
    post = {
        contract: Account(
            storage={0xffffffffffffffffffffffff00000000000000000000000000000000000000e9: 0x10000000000000000000000000000000000000000},
            code=Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xc350] + Op.NUMBER + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.SWAP1 + Op.ADDMOD(Op.DUP6, Op.SUB, Op.PC) + Op.SSTORE,
        ),
        coinbase: Account(
