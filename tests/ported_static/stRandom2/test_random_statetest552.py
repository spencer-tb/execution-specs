...
def test_random_statetest552(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xc350]
        + Op.EQ(Op.TIMESTAMP, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])
        + Op.SLOAD(key=0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe)
        + Op.PUSH32[0x0]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x6a72a37b5219f089416d4336a08e8255)
    ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xc350] + Op.EQ(Op.TIMESTAMP, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]) + Op.SLOAD(key=0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe) + Op.PUSH32[0x0] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x6a72a37b5219f089416d4336a08e8255),
        ),
        coinbase: Account(
