...
def test_random_statetest416(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.NUMBER, value=Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79])
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00ffffffffffffffffffffffffffffffffffffffff427f0000000000000000000000004f"
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0x0] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x0] + Op.PUSH32[0x1] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.TIMESTAMP + Op.SSTORE(key=Op.NUMBER, value=Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]),
        ),
    }
