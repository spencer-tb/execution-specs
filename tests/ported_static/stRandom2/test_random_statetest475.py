...
def test_random_statetest475(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MULMOD(Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe), value=Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79])
    ),
    )
    ...
    post = {
        contract: Account(
            storage={0xfffffffffffffffffffffffe000000000000000000000001ffffffffffffffff: 0x4f3f701464972e74606d6ea82d4d3080599a0e79},
