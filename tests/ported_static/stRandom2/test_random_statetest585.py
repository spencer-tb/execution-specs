...
def test_random_statetest585(
    ...
    contract = Address("0xac0f5185babc3f1b583c2b31429e4f4b5f843ac3")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x10000000000000000000000000000000000000000]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.SSTORE(key=0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, value=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff)
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            storage={0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe: 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff},
            code=Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xc350] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.SSTORE(key=0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, value=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff),
        ),
    }
