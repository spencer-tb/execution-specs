...
def test_random_statetest537(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "96065b2a98b57a48a06ae28d285a71b5688068515a6a996a540a03686d6d60005155"  # noqa: E501
        ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
        coinbase: Account(
            code=bytes.fromhex("6000355415600957005b60203560003555"),
