...
def test_random_statetest437(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "000000000000000000000000000000013a1339085560005155"
        ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
        coinbase: Account(
            code=bytes.fromhex("6000355415600957005b60203560003555"),
