...
def test_random_statetest437(
    ...
    pre[contract] = Account(
        ...
        + Op.NUMBER + Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5]
        + Op.PUSH32[0x0] + Op.PUSH32[0x10000000000000000000000000000000000000000]
        + Op.CODECOPY(dest_offset=Op.SGT(Op.GASPRICE, Op.PUSH32[0x1]), offset=Op.PUSH32[0x10000000000000000000000000000000000000000], size=Op.PUSH32[0x1])
        + Op.ADDMOD + Op.SSTORE + Op.MLOAD(offset=0x0) + Op.SSTORE
    ),
    )
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(
            "7ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe437f00"
            "0000000000000000000000945304eb96065b2a98b57a48a06ae28d285a71b57f00000000"
    ...
    post = {
        contract: Account(
            storage={0: 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, 0x6bacfb1469f9a4d5674a85b75f951d72d7a58e4b: 1},
            code=Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.NUMBER + Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5] + Op.PUSH32[0x0] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.CODECOPY(dest_offset=Op.SGT(Op.GASPRICE, Op.PUSH32[0x1]), offset=Op.PUSH32[0x10000000000000000000000000000000000000000], size=Op.PUSH32[0x1]) + Op.ADDMOD + Op.SSTORE + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
        coinbase: Account(
