...
def test_random_statetest526(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5] + Op.COINBASE
        + Op.SSTORE(key=0xb5419e01950777810975058c746f55600051, value=0x7f000000000000000000000000945304eb96065b2a98b57a48a06ae28d285a)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000945304eb96065b2a98b57a48a06ae28d285a71b5417e7f000000000000000000"
            "000000945304eb96065b2a98b57a48a06ae28d285a71b5419e01950777810975058c746f"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
    ...
    post = {
        contract: Account(
            storage={0xb5419e01950777810975058c746f55600051: 0x7f000000000000000000000000945304eb96065b2a98b57a48a06ae28d285a},
            code=Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x0] + Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5] + Op.COINBASE + Op.SSTORE(key=0xb5419e01950777810975058c746f55600051, value=0x7f000000000000000000000000945304eb96065b2a98b57a48a06ae28d285a),
        ),
        coinbase: Account(
