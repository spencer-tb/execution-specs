...
def test_random_statetest506(
    ...
    pre[contract] = Account(
        ...
        + Op.CALLDATACOPY(dest_offset=Op.TIMESTAMP, offset=Op.PUSH32[0x0], size=Op.PUSH32[0xc350])
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0x10000000000000000000000000000000000000000]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0xa218f370862059149e3cff20)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000000000000000000000000042377f000000000000000000"
            "000000ffffffffffffffffffffffffffffffffffffffff7f000000000000000000000001"
            "00000000000000000000000000000000000000006ba218f370862059149e3cff20"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
