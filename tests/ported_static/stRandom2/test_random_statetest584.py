...
def test_random_statetest584(
    ...
    pre[contract] = Account(
        ...
        + Op.SWAP7 + Op.SWAP3 + Op.NOT + Op.SSTORE(key=Op.CALLER, value=Op.MULMOD)
    ...
    post = {
        ...
        contract: Account(
            storage={0: 0xffffffffffffffffffffffffffffffffffffffff, 0x2e3d0156d2b99a6eacba540c55f423c8f5a33143: 0xffffffffffffffffffffffff0000000000000000000000000000000000000000},
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xc350] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0x1] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.SWAP7 + Op.SWAP3 + Op.NOT + Op.SSTORE(key=Op.CALLER, value=Op.MULMOD) + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
    }
