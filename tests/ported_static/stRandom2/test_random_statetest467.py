...
def test_random_statetest467(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.SLOAD(key=0xab6605e03171122aeebd20b63699a72d4) + Op.PUSH3[0x863934]
        ...
        + Op.SWAP12 + Op.CALLDATASIZE
        + Op.LOG3(offset=0xef2f, size=0xc0, topic_1=0x66225cb464667bd081c949847a95e2821f589dad, topic_2=0x68b512, topic_3=0xc956e6c5567da1d8a656406871eb0dd4)
        + Op.SMOD(0x34ca1a8a0c86c26d, 0x9e17c2b3a94181a8f8a89b48)
        + Op.CALL(gas=0x6158e2e1, address=0x79940e2f1225eba4fab3405b111535075c733270, value=0x5e0d7386, args_offset=0x12, args_size=0x6, ret_offset=0x11, ret_size=0x4)
