...
def test_random_statetest612(
    ...
    pre[contract] = Account(
        ...
        + Op.NUMBER + Op.PUSH32[0x1] + Op.PUSH32[0xc350]
        + Op.SSTORE(key=Op.MULMOD(Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe), value=Op.PUSH32[0x10000000000000000000000000000000000000000])
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(
            "7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff437f00"
    ...
    post = {
        ...
        contract: Account(
            storage={0: 50000, 0xffffffffffffffffffffffffffffffffffffffff: 0x10000000000000000000000000000000000000000},
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.NUMBER + Op.PUSH32[0x1] + Op.PUSH32[0xc350] + Op.SSTORE(key=Op.MULMOD(Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe), value=Op.PUSH32[0x10000000000000000000000000000000000000000]) + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
    }
