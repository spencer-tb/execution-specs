...
def test_random_statetest539(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.COINBASE, value=0x94200bf18b0b316e) + Op.MLOAD(offset=0x0)
        + Op.SSTORE
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000ffffffffffffffffffffffffffffffffffffffff457f00000000"
    ...
    post = {
        ...
        contract: Account(
            storage={0x4f3f701464972e74606d6ea82d4d3080599a0e79: 0x94200bf18b0b316e},
