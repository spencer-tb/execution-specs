...
def test_random_statetest386(
    ...
    contract = Address("0xc36f24a2628ca6bf3d13fb8e6090844962dfbb86")
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.GT(Op.DUP2, Op.SIGNEXTEND(Op.ADD(Op.COINBASE, Op.CALLDATASIZE), Op.SGT(Op.SDIV(Op.PUSH32[0x1], Op.DIV(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff)), Op.PUSH32[0x0]))))
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffff047f00000000000000000000000000000000"
