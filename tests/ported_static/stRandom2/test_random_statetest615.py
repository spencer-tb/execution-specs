...
def test_random_statetest615(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x0]
        + Op.SSTORE(key=Op.MULMOD(Op.PUSH32[0x10000000000000000000000000000000000000000], Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], Op.DUP4), value=0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe)
        + Op.PUSH13[0x6f390a3054d7368a9a55600051] + Op.SSTORE
    ),
    )
    ...
    post = {
        contract: Account(
            storage={0xffffffffffffffffffffffff000000000000000000000000ffffffffffffffff: 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe},
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x0] + Op.SSTORE(key=Op.MULMOD(Op.PUSH32[0x10000000000000000000000000000000000000000], Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], Op.DUP4), value=0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe) + Op.PUSH13[0x6f390a3054d7368a9a55600051] + Op.SSTORE,
        ),
        coinbase: Account(
