...
def test_random_statetest398(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x3781413b695a69079d7f510582920755)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "701464972e74606d6ea82d4d3080599a0e796f3781413b695a69079d7f5105829207"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
    ...
    post = {
        contract: Account(
            ...
            code=Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xc350] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x3781413b695a69079d7f510582920755),
        ),
        coinbase: Account(
