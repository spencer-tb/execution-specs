"""
Ported from:
tests/static/state_tests/stRandom2/randomStatetest531Filler.json
"""
...
def test_random_statetest531(
    ...
    contract = Address("0x83c3fd438bec2a4bb605ae688641469341532d9f")
    ...
    post = {
        ...
        contract: Account(code=bytes.fromhex("41414143434344456a12c140f3933655")),
    }
