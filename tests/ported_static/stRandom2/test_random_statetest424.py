...
def test_random_statetest424(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x18116552626186825096665471140a55)
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.NUMBER + Op.PUSH32[0x0] + Op.PUSH32[0xc350] + Op.PUSH32[0x0] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x0] + Op.NUMBER + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x18116552626186825096665471140a55),
        ),
    }
