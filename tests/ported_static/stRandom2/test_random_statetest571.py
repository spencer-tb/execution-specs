...
def test_random_statetest571(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x1] + Op.PUSH32[0x1000000000000000000000000000000000001000]
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000000000000000000000017f00000000000000000000000010000000"
            "000000000000000000000000000010003c6508766c8b6b403a"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
