...
def test_random_statetest571(
    ...
    pre[contract] = Account(
        ...
        + Op.EXTCODECOPY + Op.PUSH6[0x8766c8b6b40]
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0000000000000000000000000000000000000000000000015b7f00000000000000000000"
            "000100000000000000000000000000000000000000007f00000000000000000000000000"
            "000000000000000000000000000000000000017f0000000000000000000000004f3f7014"
    ...
    post = {
        ...
        contract: Account(
            storage={0: 10},
            code=Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x1] + Op.JUMPDEST + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x1] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.EXTCODECOPY + Op.PUSH6[0x8766c8b6b40] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.GASPRICE),
        ),
    }
