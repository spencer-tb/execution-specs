...
def test_random_statetest401(
    ...
    contract = Address("0x88643bc22681e376675775eaaa381d0ba45054de")
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000000000000000c35044427f000000000000000000000000"
    ...
    post = {
        ...
        contract: Account(
            code=Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xc350] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xc350] + Op.PREVRANDAO + Op.TIMESTAMP + Op.SELFDESTRUCT(address=Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]) + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
    }
