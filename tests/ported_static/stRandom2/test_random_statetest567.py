...
def test_random_statetest567(
    ...
    contract = pre.deploy_contract(
        code=bytes.fromhex(
            ...
            "0000000000000000000000000000000000000000017e7f00000000000000000000000000"  # noqa: E501
        ...
        nonce=0,
        address=Address("0x4860849f881f7ecbb6a4c146eef8f95f52f462bb"),  # noqa: E501
    )
    # Source: raw bytecode
    pre.deploy_contract(
        code=(
