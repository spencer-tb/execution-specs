...
def test_random_statetest421(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x38454051968ff184a47d500912319717)
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.NUMBER + Op.PUSH32[0x0] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x38454051968ff184a47d500912319717),
        ),
    }
