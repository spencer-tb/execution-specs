...
def test_random_statetest425(
    ...
    contract = Address("0xeb68f6349f807bcac96d6c9571c26d8a47eef786")
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x885707818b889a89975552f012844255)
    ),
    )
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(
            "7f0000000000000000000000010000000000000000000000000000000000000000417f00"
            ...
            "0000000000ffffffffffffffffffffffffffffffffffffffff6f885707818b889a899755"
            "52f0128442"
        ),
        gas_limit=100000,
        gas_price=10,
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.COINBASE + Op.PUSH32[0x1] + Op.PUSH32[0xc350] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x885707818b889a89975552f012844255),
        ),
    }
