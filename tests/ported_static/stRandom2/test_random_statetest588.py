...
def test_random_statetest588(
    ...
    pre[contract] = Account(
        ...
        + Op.COINBASE + Op.NUMBER + Op.PUSH32[0x1]
        + Op.CALLDATACOPY(dest_offset=Op.MOD(Op.NUMBER, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff), offset=Op.PUSH32[0x1], size=Op.PUSH32[0xc350])
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(
            "7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff41437f"
    ...
    post = {
        contract: Account(
            storage={0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff: 1},
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.COINBASE + Op.NUMBER + Op.PUSH32[0x1] + Op.CALLDATACOPY(dest_offset=Op.MOD(Op.NUMBER, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff), offset=Op.PUSH32[0x1], size=Op.PUSH32[0xc350]) + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
        coinbase: Account(
