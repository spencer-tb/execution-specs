...
def test_random_statetest493(
    ...
    contract = Address("0xb48bf563d8d32f5c2632d374277b74f85810617d")
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MULMOD(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe), value=Op.PUSH32[0x1])
    ...
    post = {
        ...
        contract: Account(
            storage={0: 0xffffffffffffffffffffffffffffffffffffffff, 0xffffffffffffffffffffffffffffffffffffffff: 1},
            code=Op.PUSH32[0x1] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.NUMBER + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.SSTORE(key=Op.MULMOD(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe), value=Op.PUSH32[0x1]) + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
    }
