...
def test_random_statetest413(
    ...
    pre[contract] = Account(
        ...
        + Op.SUB(0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, Op.DUP2)
        + Op.PUSH32[0x1]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x86e2055149345ad1a018b0637081455)
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xc350] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.SUB(0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, Op.DUP2) + Op.PUSH32[0x1] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x86e2055149345ad1a018b0637081455),
        ),
    }
