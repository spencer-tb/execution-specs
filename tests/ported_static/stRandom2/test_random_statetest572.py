...
def test_random_statetest572(
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.GASLIMIT
        + Op.LOG1(offset=Op.SIGNEXTEND(Op.PREVRANDAO, Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]), size=Op.MULMOD(0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe), topic_1=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])
        + Op.EXTCODESIZE + Op.CODESIZE
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            code=Op.GASLIMIT + Op.LOG1(offset=Op.SIGNEXTEND(Op.PREVRANDAO, Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]), size=Op.MULMOD(0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe), topic_1=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]) + Op.EXTCODESIZE + Op.CODESIZE,
        ),
    }
