...
def test_random_statetest518(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x3c589f416d947a5134f268515b6c9255)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0100000000000000000000000000000000000000007f0000000000000000000000000000"
            "00000000000000000000000000000000c3507f0000000000000000000000004f3f701464"
            "972e74606d6ea82d4d3080599a0e797f000000000000000000000000ffffffffffffffff"
    ...
    post = {
        contract: Account(
            ...
            code=Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x0] + Op.PUSH32[0xc350] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xc350] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x3c589f416d947a5134f268515b6c9255),
        ),
        coinbase: Account(
