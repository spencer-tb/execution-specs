...
def test_random_statetest489(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x0] + Op.GASLIMIT
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x2b8e846b91987417705a126e77076455)
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0x0] + Op.PUSH32[0x0] + Op.GASLIMIT + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x2b8e846b91987417705a126e77076455),
        ),
    }
