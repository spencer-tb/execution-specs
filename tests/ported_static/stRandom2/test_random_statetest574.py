...
def test_random_statetest574(
    ...
    contract = Address("0x9d24ee5545abdccf759a8a1be28db858416fa3e7")
    ...
    pre[contract] = Account(
        ...
        + Op.DIV(Op.PUSH32[0x1], Op.PUSH32[0xc350]) + Op.PUSH32[0x1]
        + Op.SSTORE(key=0x369354827d7433a335af55600051, value=Op.DIV(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, Op.PUSH32[0xc350]))
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000000000000000000000000000000001047f00000000000000000000"
    ...
    post = {
        ...
        contract: Account(
            storage={0x369354827d7433a335af55600051: 0x14f8b588e368f08461f9f01b866e43aa79bbadc0980b242070b8cfbfc6540},
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.DIV(Op.PUSH32[0x1], Op.PUSH32[0xc350]) + Op.PUSH32[0x1] + Op.SSTORE(key=0x369354827d7433a335af55600051, value=Op.DIV(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, Op.PUSH32[0xc350])),
        ),
    }
