...
def test_random_statetest430(
    ...
    contract = Address("0x477526f193cfa214f3d2bcbb76ac3612b1dad747")
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(
            "7ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe427f00"
            ...
            "000000000000000000000000000000000000017f00000000000000000000000000000000"
    ...
    post = {
        contract: Account(
            ...
            code=Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.TIMESTAMP + Op.PUSH32[0xc350] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xc350] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0x1] + Op.PUSH32[0x0] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x7d41a29934035b748e96a3135b696455),
        ),
        coinbase: Account(
