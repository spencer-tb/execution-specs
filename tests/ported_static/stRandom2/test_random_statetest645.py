...
@pytest.mark.parametrize(
    ...
    [
        (4074160023, {Address("0x322c72dedad1a81092ab9ba908fbec8779ce1c32"): Account(code=Op.PC + Op.PUSH8[0x9b8e24022d8c28f3] + Op.SGT(0x84bc2f83, 0xb55a0) + Op.EQ(0xea3e9d28799d45aa77bf1fc1a84edf0193dea2d610209eaaf9c8, 0x15b61916f0f5)), Address("0xaa0103980a7c3113d3a8f81478b0281492eb3d38"): Account(code=Op.MSTORE(offset=0x1d72de, value=0xcbb01282) + Op.LOG1(offset=0xc396eb18074f148d96fd766dda35b6cc250661b5f83f0ed625ba68a5ff49a, size=0x1ef17f23ed237d9f3262c4eb1b95112820595b127c516074df06223db, topic_1=0x22948f746c938a0cb))}),
        (0, {Address("0x322c72dedad1a81092ab9ba908fbec8779ce1c32"): Account(code=Op.PC + Op.PUSH8[0x9b8e24022d8c28f3] + Op.SGT(0x84bc2f83, 0xb55a0) + Op.EQ(0xea3e9d28799d45aa77bf1fc1a84edf0193dea2d610209eaaf9c8, 0x15b61916f0f5)), Address("0xaa0103980a7c3113d3a8f81478b0281492eb3d38"): Account(code=Op.MSTORE(offset=0x1d72de, value=0xcbb01282) + Op.LOG1(offset=0xc396eb18074f148d96fd766dda35b6cc250661b5f83f0ed625ba68a5ff49a, size=0x1ef17f23ed237d9f3262c4eb1b95112820595b127c516074df06223db, topic_1=0x22948f746c938a0cb))}),
    ],
    ids=['case0', 'case1'],
)
...
def test_random_statetest645(
    ...
    pre[callee] = Account(
        ...
        nonce=29,
        code=(
        Op.PC + Op.PUSH8[0x9b8e24022d8c28f3] + Op.SGT(0x84bc2f83, 0xb55a0)
