...
def test_random_statetest473(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "96065b2a98b57a48a06ae28d285a71b59102095560005155"
        ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
        coinbase: Account(
            code=bytes.fromhex("6000355415600957005b60203560003555"),
