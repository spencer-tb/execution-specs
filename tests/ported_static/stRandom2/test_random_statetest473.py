...
def test_random_statetest473(
    ...
    pre[contract] = Account(
        ...
        + Op.BALANCE(address=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])
        + Op.PUSH32[0xc350]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0x1]
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5] + Op.SWAP2
        + Op.SSTORE(key=Op.MULMOD, value=Op.MUL) + Op.MLOAD(offset=0x0) + Op.SSTORE
    ),
    )
