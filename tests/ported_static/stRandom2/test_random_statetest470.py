...
def test_random_statetest470(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.SIGNEXTEND(Op.PUSH32[0x0], Op.CALLDATALOAD(offset=Op.PUSH32[0x1])))
    ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=Op.GASLIMIT + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xc350] + Op.PUSH32[0xc350] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.SIGNEXTEND(Op.PUSH32[0x0], Op.CALLDATALOAD(offset=Op.PUSH32[0x1]))),
        ),
        coinbase: Account(
