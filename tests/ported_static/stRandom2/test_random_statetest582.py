...
def test_random_statetest582(
    ...
    contract = Address("0x99e6f87cba9c1737f49965828c1badec51a91dfd")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.PUSH32[0xc350] + Op.ADDMOD(Op.GASLIMIT, Op.PUSH32[0x0], Op.PUSH32[0x0])
        + Op.RETURN(offset=Op.DUP1, size=0x17718) + Op.SSTORE + Op.MLOAD(offset=0x0)
        + Op.SSTORE
    ),
    )
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(
            "7f0000000000000000000000004f3f701464972e74606d6ea82d4d3080599a0e79417f00"
    ...
    post = {
        ...
        contract: Account(
            code=Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.COINBASE + Op.PUSH32[0x0] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xc350] + Op.ADDMOD(Op.GASLIMIT, Op.PUSH32[0x0], Op.PUSH32[0x0]) + Op.RETURN(offset=Op.DUP1, size=0x17718) + Op.SSTORE + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
    }
