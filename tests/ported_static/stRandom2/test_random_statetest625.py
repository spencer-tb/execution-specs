...
def test_random_statetest625(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000010000000000000000000000000000000000000000887f00000000"
            ...
            "0000000000000000000000000000000000000000c350457fffffffffffffffffffffffff"
    ...
    post = {
        contract: Account(
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.DUP9 + Op.LOG3(offset=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, size=Op.GASLIMIT, topic_1=Op.PUSH32[0xc350], topic_2=Op.PUSH32[0x0], topic_3=Op.PUSH32[0x0]) + Op.ADD + Op.SSTORE + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
        coinbase: Account(
