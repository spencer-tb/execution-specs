...
def test_random_statetest497(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.DIV(Op.MULMOD(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe), Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]), value=Op.PUSH32[0xc350])
    ),
    )
