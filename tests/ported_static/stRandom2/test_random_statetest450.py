...
def test_random_statetest450(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x1000000000000000000000000000000000001000] + Op.CALLDATALOAD
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0xc350] + Op.PUSH32[0x10000000000000000000000000000000000000000]
        + Op.SUB + Op.GASPRICE + Op.DUP1 + Op.PUSH1[0x0] + Op.MLOAD + Op.SSTORE
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000001000000000000000000000000000000000001000357fffffffffffffffffffff"
