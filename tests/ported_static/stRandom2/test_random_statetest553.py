...
def test_random_statetest553(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "0000000000000000000000000000016f94819c780585376da073368c45828ca060005155"  # noqa: E501
        ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
        coinbase: Account(
            code=bytes.fromhex("6000355415600957005b60203560003555"),
