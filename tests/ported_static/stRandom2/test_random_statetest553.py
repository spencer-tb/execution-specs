...
def test_random_statetest553(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x94819c780585376da073368c45828ca0)
    ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=Op.PUSH32[0x1] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x1] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x94819c780585376da073368c45828ca0),
        ),
        coinbase: Account(
