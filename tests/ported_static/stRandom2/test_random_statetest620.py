...
def test_random_statetest620(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x6c54a420327d73727d9d1a667bf38955)
    ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.TIMESTAMP + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.GASLIMIT + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xc350] + Op.PUSH32[0x0] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x6c54a420327d73727d9d1a667bf38955),
        ),
        coinbase: Account(
