...
def test_random_statetest580(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x0] + Op.GASLIMIT + Op.PUSH32[0x0] + Op.PUSH32[0xc350]
        + Op.PUSH32[0x0]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x4640879d18777b953a209836379a3055)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000000000000000000000000000000000457f00000000000000000000"
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0x0] + Op.PUSH32[0x1] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x0] + Op.GASLIMIT + Op.PUSH32[0x0] + Op.PUSH32[0xc350] + Op.PUSH32[0x0] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x4640879d18777b953a209836379a3055),
        ),
    }
