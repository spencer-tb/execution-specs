...
def test_random_statetest517(
    ...
    contract = Address("0x0fe6decc565c9f9247255d874ddb1b4d613d2b47")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.GASPRICE
        + Op.PUSH16[0x450831a46a867f32569596f0099f7b8c] + Op.SWAP2 + Op.SSTORE
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00ffffffffffffffffffffffffffffffffffffffff3a6f450831a46a867f32569596f009"
            "9f7b8c91"
        ),
        gas_limit=100000,
        gas_price=10,
    ...
    post = {
        contract: Account(
            storage={0: 0x450831a46a867f32569596f0099f7b8c, 0xffffffffffffffffffffffffffffffffffffffff: 10},
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x1] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.GASPRICE + Op.PUSH16[0x450831a46a867f32569596f0099f7b8c] + Op.SWAP2 + Op.SSTORE + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
        coinbase: Account(
