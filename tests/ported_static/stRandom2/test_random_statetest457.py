...
def test_random_statetest457(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x949fa28af308a37a136c626218927d55)
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PREVRANDAO + Op.COINBASE + Op.PUSH32[0x1] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x0] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x949fa28af308a37a136c626218927d55),
        ),
    }
