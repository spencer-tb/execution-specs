...
def test_random_statetest446(
    ...
    contract = Address("0x96afbef3471549b91fd7d4b57acc0c10f822914c")
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MULMOD(Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe), value=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            storage={0xfffffffffffffffffffffffe000000000000000000000001ffffffffffffffff: 0xffffffffffffffffffffffffffffffffffffffff},
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x0] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.SSTORE(key=Op.MULMOD(Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe), value=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]),
        ),
    }
