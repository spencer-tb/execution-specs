...
def test_random_statetest478(
    ...
    contract = Address("0xcfbded6c35b6aeffc2afe1c21fc42d489ad4e002")
    ...
    pre[contract] = Account(
        ...
        "000000000000000000000000000000000000000000000000000001447f00000000000000"
    ...
    post = {
        ...
        contract: Account(
            code=bytes.fromhex(""),
        ),
    }
