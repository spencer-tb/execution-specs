...
def test_random_statetest524(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "00000000000000000000000000000000000000000000000034208a340a9e5560005155"  # noqa: E501
        ),
    )
    ...
    post = {
        ...
        contract: Account(
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
    }
