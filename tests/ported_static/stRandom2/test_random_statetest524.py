...
def test_random_statetest524(
    ...
    pre[contract] = Account(
        ...
        + Op.TIMESTAMP
        + Op.CALLDATALOAD(offset=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x0]
        + Op.SHA3(offset=Op.CALLVALUE, size=Op.PUSH32[0x0])
        + Op.EXP(Op.CALLVALUE, Op.DUP11) + Op.SWAP15 + Op.SSTORE
    ...
    post = {
        ...
        contract: Account(
            code=Op.GASLIMIT + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.TIMESTAMP + Op.CALLDATALOAD(offset=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]) + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x0] + Op.SHA3(offset=Op.CALLVALUE, size=Op.PUSH32[0x0]) + Op.EXP(Op.CALLVALUE, Op.DUP11) + Op.SWAP15 + Op.SSTORE + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
    }
