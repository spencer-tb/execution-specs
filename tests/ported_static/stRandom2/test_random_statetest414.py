...
def test_random_statetest414(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.EQ(Op.CALL, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]))
    ),
    )
    ...
    post = {
        contract: Account(
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH3[0x51437f] + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.ADD + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.NUMBER + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.EQ(Op.CALL, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])),
        ),
        coinbase: Account(
