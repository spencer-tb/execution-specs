"""
Ported from:
tests/static/state_tests/stRandom2/randomStatetest543Filler.json
"""
...
def test_random_statetest543(
    ...
    contract = Address("0xb04d75cc292c99077da7bc4149ceafb239447f01")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x0] + Op.GASLIMIT + Op.DUP7
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0000000000000000000000000000004586"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
    ...
    post = {
        ...
        contract: Account(
            code=Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x0] + Op.PUSH32[0x0] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x1] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x0] + Op.GASLIMIT + Op.DUP7,
        ),
    }
