...
def test_random_statetest505(
    ...
    pre[contract] = Account(
        ...
        + Op.TIMESTAMP + Op.PUSH32[0x1] + Op.PUSH32[0x0]
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.GASLIMIT + Op.PUSH32[0x0]
        + Op.PUSH32[0x10000000000000000000000000000000000000000]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x44a06f550371317376738c5399843755)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffffffffffffffffffffe457f000000000000000000"
            "00000000000000000000000000000000000000000000007f000000000000000000000001"
            "00000000000000000000000000000000000000006f44a06f550371317376738c53998437"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
