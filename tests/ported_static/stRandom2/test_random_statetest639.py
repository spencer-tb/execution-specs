...
def test_random_statetest639(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.SGT(0xab95e6f8772a548229700e2dcc612ac9ceeb898af8436680a2e1074df8ced0, 0x993d78e80807a0d34bdbfa4e0afa9d)
        + Op.LOG1(offset=0xb1f5, size=0xc1, topic_1=0x64d71c8fe8a10fb58f8706ea3ee1b54a0848e742ca357e3d0234)
        + Op.ISZERO(0x48da2ae1e6987c52223414746fab0e39130693d15a48d39b5130096a7c)
        ...
        + Op.ORIGIN
        + Op.CALL(gas=0x56837182, address=0x9fecb32d9ae49c08da1e2551ba9257be9a181e76, value=0x29ec801e, args_offset=0x18, args_size=0x9, ret_offset=0x9, ret_size=0x15)
