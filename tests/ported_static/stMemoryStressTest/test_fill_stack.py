...
@pytest.mark.parametrize(
    ...
    [
        (3141592, {Address("0x4f3f701464972e74606d6ea82d4d3080599a0e79"): Account(code=Op.JUMPI(pc=0x9, condition=Op.ISZERO(Op.SLOAD(key=Op.CALLDATALOAD(offset=0x0)))) + Op.STOP + Op.JUMPDEST + Op.SSTORE(key=Op.CALLDATALOAD(offset=0x0), value=Op.CALLDATALOAD(offset=0x20))), Address("0x709ee68118ab00ce0bab659c9aa89744b35703fa"): Account(code=Op.JUMPDEST + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.GASLIMIT + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x1] + Op.JUMPI(pc=Op.NUMBER, condition=Op.PUSH32[0xc350]) + Op.ISZERO + Op.MSTORE8 + Op.SHA3 + Op.DUP1 + Op.GASPRICE + Op.SWAP8 + Op.SSTORE + Op.MLOAD(offset=0x0) + Op.SSTORE)}),
        (16777216, {Address("0x4f3f701464972e74606d6ea82d4d3080599a0e79"): Account(code=Op.JUMPI(pc=0x9, condition=Op.ISZERO(Op.SLOAD(key=Op.CALLDATALOAD(offset=0x0)))) + Op.STOP + Op.JUMPDEST + Op.SSTORE(key=Op.CALLDATALOAD(offset=0x0), value=Op.CALLDATALOAD(offset=0x20))), Address("0x709ee68118ab00ce0bab659c9aa89744b35703fa"): Account(code=Op.JUMPDEST + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.GASLIMIT + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x1] + Op.JUMPI(pc=Op.NUMBER, condition=Op.PUSH32[0xc350]) + Op.ISZERO + Op.MSTORE8 + Op.SHA3 + Op.DUP1 + Op.GASPRICE + Op.SWAP8 + Op.SSTORE + Op.MLOAD(offset=0x0) + Op.SSTORE)}),
    ],
    ids=['case0', 'case1'],
)
...
def test_fill_stack(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x1] + Op.JUMPI(pc=Op.NUMBER, condition=Op.PUSH32[0xc350])
        + Op.ISZERO + Op.MSTORE8 + Op.SHA3 + Op.DUP1 + Op.GASPRICE + Op.SWAP8
