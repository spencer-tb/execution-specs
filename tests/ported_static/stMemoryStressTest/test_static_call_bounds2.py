...
@pytest.mark.parametrize(
    ...
    [
        (150000, {Address("0x849f53126ade5f72469029537296f2b6644d4d41"): Account(code=Op.SSTORE(key=0x0, value=Op.ADD(0x1, Op.SLOAD(key=0x0))) + Op.STOP), Address("0x897c36dffce5cc08eb13170a6c308ab09fa72e65"): Account(code=Op.STATICCALL(gas=0x7ffffffffffffff, address=0x849f53126ade5f72469029537296f2b6644d4d41, args_offset=0xfffffff, args_size=0xfffffff, ret_offset=0xfffffff, ret_size=0xfffffff) + Op.STOP)}),
...
def test_static_call_bounds2(
    ...
    contract = Address("0x897c36dffce5cc08eb13170a6c308ab09fa72e65")
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.STATICCALL(gas=0x7ffffffffffffff, address=0x849f53126ade5f72469029537296f2b6644d4d41, args_offset=0xfffffff, args_size=0xfffffff, ret_offset=0xfffffff, ret_size=0xfffffff)
        + Op.STOP
    ),
    )
