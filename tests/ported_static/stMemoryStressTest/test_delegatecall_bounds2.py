...
@pytest.mark.parametrize(
    ...
    [
        (150000, {Address("0x7b7e1fed40d6cb2420c7f2718725badb76616d4d"): Account(code=Op.DELEGATECALL(gas=0x7ffffffffffffff, address=0x849f53126ade5f72469029537296f2b6644d4d41, args_offset=0xffffffff, args_size=0xffffffff, ret_offset=0xffffffff, ret_size=0xffffffff) + Op.STOP), Address("0x849f53126ade5f72469029537296f2b6644d4d41"): Account(code=Op.SSTORE(key=0x0, value=Op.ADD(0x1, Op.SLOAD(key=0x0))) + Op.STOP)}),
        (16777216, {Address("0x7b7e1fed40d6cb2420c7f2718725badb76616d4d"): Account(code=Op.DELEGATECALL(gas=0x7ffffffffffffff, address=0x849f53126ade5f72469029537296f2b6644d4d41, args_offset=0xffffffff, args_size=0xffffffff, ret_offset=0xffffffff, ret_size=0xffffffff) + Op.STOP), Address("0x849f53126ade5f72469029537296f2b6644d4d41"): Account(code=Op.SSTORE(key=0x0, value=Op.ADD(0x1, Op.SLOAD(key=0x0))) + Op.STOP)}),
    ],
    ids=['case0', 'case1'],
)
...
def test_delegatecall_bounds2(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.DELEGATECALL(gas=0x7ffffffffffffff, address=0x849f53126ade5f72469029537296f2b6644d4d41, args_offset=0xffffffff, args_size=0xffffffff, ret_offset=0xffffffff, ret_size=0xffffffff)
        + Op.STOP
    ),
    )
    pre[callee] = Account(
