...
@pytest.mark.parametrize(
    ...
    [
        (150000, {Address("0x83143406093d1f3560dd269416596d3406f1c991"): Account(code=Op.POP(Op.STATICCALL(gas=0x7ffffffffffffff, address=0xcc704d60c46b9c08aab4d15281184441ac7ed35c, args_offset=0x0, args_size=0xffffffffffffffff, ret_offset=0x0, ret_size=0xffffffffffffffff)) + Op.POP(Op.STATICCALL(gas=0x7ffffffffffffff, address=0xcc704d60c46b9c08aab4d15281184441ac7ed35c, args_offset=0x0, args_size=0xffffffffffffffffffffffffffffffff, ret_offset=0x0, ret_size=0xffffffffffffffffffffffffffffffff)) + Op.POP(Op.STATICCALL(gas=0x7ffffffffffffff, address=0xcc704d60c46b9c08aab4d15281184441ac7ed35c, args_offset=0x0, args_size=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, ret_offset=0x0, ret_size=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff)) + Op.POP(Op.STATICCALL(gas=0x7ffffffffffffff, address=0xcc704d60c46b9c08aab4d15281184441ac7ed35c, args_offset=0xffffffff, args_size=0xffffffff, ret_offset=0xffffffff, ret_size=0xffffffff)) + Op.POP(Op.STATICCALL(gas=0x7ffffffffffffff, address=0xcc704d60c46b9c08aab4d15281184441ac7ed35c, args_offset=0xffffffffffffffff, args_size=0xffffffffffffffff, ret_offset=0xffffffffffffffff, ret_size=0xffffffffffffffff)) + Op.POP(Op.STATICCALL(gas=0x7ffffffffffffff, address=0xcc704d60c46b9c08aab4d15281184441ac7ed35c, args_offset=0xffffffffffffffffffffffffffffffff, args_size=0xffffffffffffffffffffffffffffffff, ret_offset=0xffffffffffffffffffffffffffffffff, ret_size=0xffffffffffffffffffffffffffffffff)) + Op.STATICCALL(gas=0x7ffffffffffffff, address=0xcc704d60c46b9c08aab4d15281184441ac7ed35c, args_offset=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, args_size=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, ret_offset=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, ret_size=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff) + Op.STOP), Address("0xcc704d60c46b9c08aab4d15281184441ac7ed35c"): Account(code=Op.MSTORE(offset=0x0, value=Op.ADD(0x1, Op.SLOAD(key=0x0))) + Op.STOP)}),
        (16777216, {Address("0x83143406093d1f3560dd269416596d3406f1c991"): Account(code=Op.POP(Op.STATICCALL(gas=0x7ffffffffffffff, address=0xcc704d60c46b9c08aab4d15281184441ac7ed35c, args_offset=0x0, args_size=0xffffffffffffffff, ret_offset=0x0, ret_size=0xffffffffffffffff)) + Op.POP(Op.STATICCALL(gas=0x7ffffffffffffff, address=0xcc704d60c46b9c08aab4d15281184441ac7ed35c, args_offset=0x0, args_size=0xffffffffffffffffffffffffffffffff, ret_offset=0x0, ret_size=0xffffffffffffffffffffffffffffffff)) + Op.POP(Op.STATICCALL(gas=0x7ffffffffffffff, address=0xcc704d60c46b9c08aab4d15281184441ac7ed35c, args_offset=0x0, args_size=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, ret_offset=0x0, ret_size=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff)) + Op.POP(Op.STATICCALL(gas=0x7ffffffffffffff, address=0xcc704d60c46b9c08aab4d15281184441ac7ed35c, args_offset=0xffffffff, args_size=0xffffffff, ret_offset=0xffffffff, ret_size=0xffffffff)) + Op.POP(Op.STATICCALL(gas=0x7ffffffffffffff, address=0xcc704d60c46b9c08aab4d15281184441ac7ed35c, args_offset=0xffffffffffffffff, args_size=0xffffffffffffffff, ret_offset=0xffffffffffffffff, ret_size=0xffffffffffffffff)) + Op.POP(Op.STATICCALL(gas=0x7ffffffffffffff, address=0xcc704d60c46b9c08aab4d15281184441ac7ed35c, args_offset=0xffffffffffffffffffffffffffffffff, args_size=0xffffffffffffffffffffffffffffffff, ret_offset=0xffffffffffffffffffffffffffffffff, ret_size=0xffffffffffffffffffffffffffffffff)) + Op.STATICCALL(gas=0x7ffffffffffffff, address=0xcc704d60c46b9c08aab4d15281184441ac7ed35c, args_offset=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, args_size=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, ret_offset=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, ret_size=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff) + Op.STOP), Address("0xcc704d60c46b9c08aab4d15281184441ac7ed35c"): Account(code=Op.MSTORE(offset=0x0, value=Op.ADD(0x1, Op.SLOAD(key=0x0))) + Op.STOP)}),
    ],
    ids=['case0', 'case1'],
)
...
def test_static_call_bounds3(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.POP(Op.STATICCALL(gas=0x7ffffffffffffff, address=0xcc704d60c46b9c08aab4d15281184441ac7ed35c, args_offset=0x0, args_size=0xffffffffffffffff, ret_offset=0x0, ret_size=0xffffffffffffffff))
    ...
    pre[callee] = Account(
        balance=0,
        nonce=0,
        code=Op.MSTORE(offset=0x0, value=Op.ADD(0x1, Op.SLOAD(key=0x0))) + Op.STOP,
    )
