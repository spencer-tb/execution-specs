...
def test_static_ab_acalls3(
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH20[0x1000000000000000000000000000000000001200] + Op.PUSH3[0x186a0]
    ...
    pre[callee_1] = Account(
        ...
        Op.PUSH1[0x1] + Op.PUSH1[0x0] + Op.SLOAD + Op.ADD + Op.PUSH1[0x0]
        + Op.SSTORE + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.PUSH1[0x0]
        + Op.PUSH20[0x1000000000000000000000000000000000001100] + Op.PUSH3[0x186a0]
        + Op.GAS + Op.SUB + Op.STATICCALL + Op.STOP
    ),
    )
    pre[callee_2] = Account(
        ...
        + Op.PUSH20[0x1000000000000000000000000000000000001400] + Op.PUSH3[0x186a0]
        + Op.GAS + Op.SUB + Op.STATICCALL + Op.STOP
    ),
    )
