...
def test_static_return_bounds_oog(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.CALLDATALOAD + Op.EQ + Op.PUSH2[0x2af]
        + Op.JUMPI + Op.GAS + Op.PUSH2[0x2b7] + Op.JUMP + Op.JUMPDEST
