...
def test_non_zero_value_call_to_one_storage_key_paris(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "5a60005260006000600060006001734757608f18b70777ae788dd4056eeed52f7aa68f61"  # noqa: E501
    ...
    post = {
        ...
        contract: Account(
            ...
            code=bytes.fromhex(
                "5a60005260006000600060006001734757608f18b70777ae788dd4056eeed52f7aa68f61ea60f16001555a6000510360645500"  # noqa: E501
            ),
        ),
    }
