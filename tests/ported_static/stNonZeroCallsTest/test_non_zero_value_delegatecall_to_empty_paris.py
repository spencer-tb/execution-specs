...
def test_non_zero_value_delegatecall_to_empty_paris(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "5a60005260006000600060007376fae819612a29489a1a43208613d8f8557b889861ea60"  # noqa: E501
    ...
    post = {
        contract: Account(
            ...
            code=bytes.fromhex(
                "5a60005260006000600060007376fae819612a29489a1a43208613d8f8557b889861ea60f46001555a6000510360645500"  # noqa: E501
            ),
        ),
    }
