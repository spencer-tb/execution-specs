...
Ported from:
tests/static/state_tests/stCallDelegateCodesCallCodeHomestead/callcallcodecallcode_011_OOGEFiller.json
"""
...
def test_callcallcodecallcode_011_ooge(
    ...
    pre[callee_2] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x1, value=Op.DELEGATECALL(gas=0x927c0, address=0x3e423a7b1fba04d0c3f9423a3ae2a180d2878d5b, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.STOP
    ),
    )
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x0, value=Op.CALLCODE(gas=0xc3500, address=0x69a0017a51ad556682f48b32235d0b61abdf4da4, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.STOP
    ),
    )
    ...
    post = {
        ...
        callee_2: Account(
            code=Op.SSTORE(key=0x1, value=Op.DELEGATECALL(gas=0x927c0, address=0x3e423a7b1fba04d0c3f9423a3ae2a180d2878d5b, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)) + Op.STOP,
        ),
        contract: Account(
            storage={0: 1, 1: 1, 11: 1},
            code=Op.SSTORE(key=0x0, value=Op.CALLCODE(gas=0xc3500, address=0x69a0017a51ad556682f48b32235d0b61abdf4da4, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)) + Op.STOP,
        ),
    }
