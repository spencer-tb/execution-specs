...
def test_callcallcodecall_abcb_recursive(
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "6040600060406000600073e0b280638526cecd3ec29969b517aeb3fcbb31fa6207a120f2"  # noqa: E501
            "60025500"
        ),
    )
    pre[callee_1] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "604060006040600073a71333d8c0291cfd6da54bec5a3957563ab16c1c620f4240f46001"  # noqa: E501
            "5500"
        ),
    )
    ...
    post = {
        contract: Account(
            storage={0: 1, 1: 1},
            code=bytes.fromhex(
                "6040600060406000600073e0b280638526cecd3ec29969b517aeb3fcbb31fa63017d7840f260005500"  # noqa: E501
            ),
        ),
        callee: Account(
            code=bytes.fromhex(
