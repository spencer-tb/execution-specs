...
def test_callcallcallcode_001_ooge(
    ...
    pre[callee_2] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x1, value=Op.CALLCODE(gas=0x927c0, address=0x3e423a7b1fba04d0c3f9423a3ae2a180d2878d5b, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.STOP
    ),
    )
    ...
    post = {
        ...
        callee_2: Account(
            code=Op.SSTORE(key=0x1, value=Op.CALLCODE(gas=0x927c0, address=0x3e423a7b1fba04d0c3f9423a3ae2a180d2878d5b, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)) + Op.STOP,
        ),
        contract: Account(
