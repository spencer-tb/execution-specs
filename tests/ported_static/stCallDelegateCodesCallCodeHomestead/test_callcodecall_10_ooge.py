...
def test_callcodecall_10_ooge(
    ...
    pre[callee_1] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "6040600060406000600073766b2cf0691f51029181fc511395b7ab71353a88620927c0f2"  # noqa: E501
            "6001556001600b5500"
        ),
    )
    ...
    post = {
        ...
        callee_1: Account(
            code=bytes.fromhex(
                "6040600060406000600073766b2cf0691f51029181fc511395b7ab71353a88620927c0f26001556001600b5500"  # noqa: E501
            ),
        ),
    }
