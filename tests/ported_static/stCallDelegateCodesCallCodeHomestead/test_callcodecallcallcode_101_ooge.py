...
def test_callcodecallcallcode_101_ooge(
    ...
    pre[callee_1] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "6040600060406000600073fcf790146e167fb47d128896c5ba30b0265b1780620927c0f2"  # noqa: E501
            "60015500"
        ),
    )
    ...
    post = {
        ...
        callee_1: Account(
            code=bytes.fromhex(
                "6040600060406000600073fcf790146e167fb47d128896c5ba30b0265b1780620927c0f260015500"  # noqa: E501
            ),
        ),
        callee_2: Account(
            code=bytes.fromhex(
