...
def test_callcodecall_10(
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x1, value=Op.CALLCODE(gas=0x3d090, address=0xd42cd48f1d9a88f4b75bfb5e46e754c1128bd7fb, value=0x2, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.STOP
    ),
    )
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x0, value=Op.DELEGATECALL(gas=0x55730, address=0x69142b38329c92930601fe8da12dc5866cde11c3, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.STOP
    ),
    )
    ...
    post = {
        callee: Account(
            code=Op.SSTORE(key=0x1, value=Op.CALLCODE(gas=0x3d090, address=0xd42cd48f1d9a88f4b75bfb5e46e754c1128bd7fb, value=0x2, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)) + Op.STOP,
        ),
        contract: Account(
            storage={0: 1, 1: 1, 2: 1, 4: 0xd26e26d5a4796d450bfa296d70c05f02dbc1a4b9, 5: 2, 230: 0xd26e26d5a4796d450bfa296d70c05f02dbc1a4b9, 232: 0xebaf50debf10e08302fe4280c32df010463ca297, 236: 64, 238: 34, 240: 10},
            code=Op.SSTORE(key=0x0, value=Op.DELEGATECALL(gas=0x55730, address=0x69142b38329c92930601fe8da12dc5866cde11c3, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)) + Op.STOP,
        ),
        callee_1: Account(
