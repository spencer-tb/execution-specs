...
def test_callcallcodecall_010_oogm_before(
    ...
    pre[callee_1] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "6040600060406000730d33ab78ac3965e7d6f9548dff5839138a9f69c5620927c0f46001"  # noqa: E501
            "556001600b5500"
        ),
    )
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "604060006040600060007329f893b720e998ccd5971409fa9a8802822fdcbc620c3500f2"  # noqa: E501
            "60005500"
        ),
    )
    ...
    post = {
        ...
        callee_1: Account(
            code=bytes.fromhex(
                "6040600060406000730d33ab78ac3965e7d6f9548dff5839138a9f69c5620927c0f46001556001600b5500"  # noqa: E501
            ),
        ),
        contract: Account(
            storage={0: 1, 11: 1},
            code=bytes.fromhex(
                "604060006040600060007329f893b720e998ccd5971409fa9a8802822fdcbc620c3500f260005500"  # noqa: E501
            ),
        ),
