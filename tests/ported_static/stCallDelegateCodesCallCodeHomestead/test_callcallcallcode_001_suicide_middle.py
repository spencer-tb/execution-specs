...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallDelegateCodesCallCodeHomestead/callcallcallcode_001_SuicideMiddleFiller.json",  # noqa: E501
    ],
)
...
def test_callcallcallcode_001_suicide_middle(
    ...
    pre[callee_2] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "6040600060406000600073124b38fa011c9d36b7fe193dc636813a2f8bdaa7620186a0f2"  # noqa: E501
            "60015500"
        ),
    )
    ...
    post = {
        ...
        callee_2: Account(
            code=bytes.fromhex(
                "6040600060406000600073124b38fa011c9d36b7fe193dc636813a2f8bdaa7620186a0f260015500"  # noqa: E501
            ),
        ),
    }
