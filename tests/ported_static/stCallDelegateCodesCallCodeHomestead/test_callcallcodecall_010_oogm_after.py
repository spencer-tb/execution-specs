...
Ported from:
tests/static/state_tests/stCallDelegateCodesCallCodeHomestead/callcallcodecall_010_OOGMAfterFiller.json
"""
...
def test_callcallcodecall_010_oogm_after(
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x1, value=Op.DELEGATECALL(gas=0x927c0, address=0x926dfbcc20b2ab686fc85331883541d174ccc738, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
    ...
    post = {
        callee: Account(
            code=Op.SSTORE(key=0x1, value=Op.DELEGATECALL(gas=0x927c0, address=0x926dfbcc20b2ab686fc85331883541d174ccc738, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)) + Op.SHA3(offset=0x0, size=0x2fffff) + Op.STOP,
        ),
        contract: Account(
            storage={11: 1},
