...
def test_callcallcodecall_010_oogm_after(
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "604060006040600073926dfbcc20b2ab686fc85331883541d174ccc738620927c0f46001"  # noqa: E501
            "55622fffff60002000"
        ),
    )
    ...
    post = {
        callee: Account(
            code=bytes.fromhex(
                "604060006040600073926dfbcc20b2ab686fc85331883541d174ccc738620927c0f4600155622fffff60002000"  # noqa: E501
            ),
        ),
        contract: Account(
            storage={11: 1},
