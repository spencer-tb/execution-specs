...
Ported from:
tests/static/state_tests/stCallDelegateCodesCallCodeHomestead/callcallcodecall_010_OOGEFiller.json
"""
...
def test_callcallcodecall_010_ooge(
    ...
    pre[callee_2] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x1, value=Op.DELEGATECALL(gas=0x927c0, address=0x6322dc554acdcada01cbf7ac6a163d207c34ded2, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.STOP
    ),
    )
    ...
    post = {
        ...
        callee_2: Account(
            code=Op.SSTORE(key=0x1, value=Op.DELEGATECALL(gas=0x927c0, address=0x6322dc554acdcada01cbf7ac6a163d207c34ded2, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)) + Op.STOP,
        ),
        contract: Account(
