...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallDelegateCodesCallCodeHomestead/callcallcodecallcode_011_SuicideEndFiller.json",  # noqa: E501
    ],
)
...
def test_callcallcodecallcode_011_suicide_end(
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "604060006040600073ac521409e2fa9526bfe6b827805783d2e307c4ce620186a0f46001"  # noqa: E501
            "5500"
        ),
    )
    ...
    pre[callee_2] = Account(
        ...
        code=bytes.fromhex(
            ...
            "732cac1d43f00e8b40b63426ab460c7e8717ee6455ff00"
        ),
    )
    ...
    post = {
        callee: Account(
            code=bytes.fromhex(
                "604060006040600073ac521409e2fa9526bfe6b827805783d2e307c4ce620186a0f460015500"  # noqa: E501
            ),
        ),
        ...
        callee_2: Account(
            code=bytes.fromhex(
                "60406000604060007373b954ebc05bb0ff4a0f6a13a054d50ad158409961c350f4600255732cac1d43f00e8b40b63426ab460c7e8717ee6455ff00"  # noqa: E501
            ),
        ),
    }
