...
Ported from:
tests/static/state_tests/stEIP1559/gasPriceDiffPlacesOsakaFiller.yml
"""
...
@pytest.mark.parametrize(
    ...
    ids=['case0', 'case1', 'case2', 'case3', 'case4', 'case5', 'case6', 'case7', 'case8', 'case9', 'case10', 'case11', 'case12', 'case13', 'case14', 'case15', 'case16', 'case17', 'case18', 'case19', 'case20', 'case21', 'case22', 'case23', 'case24', 'case25', 'case26', 'case27', 'case28', 'case29', 'case30', 'case31', 'case32', 'case33'],
)
def test_gas_price_diff_places_osaka(
    ...
    pre[callee] = Account(
        ...
        nonce=1,
        code=(
        Op.GASPRICE + Op.PUSH1[0x0] + Op.MSTORE + Op.PUSH1[0x0] + Op.MLOAD
    ...
    pre[callee_1] = Account(
        ...
        nonce=1,
        code=(
        Op.GASPRICE + Op.PUSH1[0x0] + Op.MSTORE + Op.PUSH1[0x20] + Op.PUSH1[0x0]
        + Op.RETURN
    ),
    )
    pre[callee_2] = Account(
        ...
        nonce=1,
        code=(
        Op.GASPRICE + Op.PUSH1[0x0] + Op.DUP2 + Op.DUP2 + Op.MSTORE + Op.SSTORE
        + Op.INVALID
    ),
        storage={0x0: 0x60a7},
    )
    ...
    pre[callee_11] = Account(
        ...
        + Op.JUMPI + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.RETURN + Op.JUMPDEST
        + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.REVERT + Op.JUMPDEST + Op.GASPRICE
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH2[0x581] + Op.JUMPI + Op.DUP4 + Op.PUSH1[0xf1] + Op.EQ
        + Op.PUSH2[0x56b] + Op.JUMPI + Op.DUP4 + Op.PUSH1[0xf2] + Op.EQ
        + Op.PUSH2[0x555] + Op.JUMPI + Op.DUP4 + Op.PUSH1[0xf4] + Op.EQ
        + Op.PUSH2[0x540] + Op.JUMPI + Op.DUP4 + Op.PUSH1[0xfa] + Op.EQ
        + Op.PUSH2[0x52b] + Op.JUMPI + Op.DUP4 + Op.PUSH2[0xf1f1] + Op.EQ
        + Op.PUSH2[0x513] + Op.JUMPI + Op.DUP4 + Op.PUSH2[0xf2f1] + Op.EQ
        + Op.PUSH2[0x4fb] + Op.JUMPI + Op.DUP4 + Op.PUSH2[0xf4f1] + Op.EQ
        + Op.PUSH2[0x4e4] + Op.JUMPI + Op.DUP4 + Op.PUSH2[0xfaf1] + Op.EQ
        + Op.PUSH2[0x4cd] + Op.JUMPI + Op.DUP4 + Op.PUSH2[0xf1f2] + Op.EQ
        + Op.PUSH2[0x4b5] + Op.JUMPI + Op.DUP4 + Op.PUSH2[0xf2f2] + Op.EQ
        + Op.PUSH2[0x49d] + Op.JUMPI + Op.DUP4 + Op.PUSH2[0xf4f2] + Op.EQ
        + Op.PUSH2[0x486] + Op.JUMPI + Op.DUP4 + Op.PUSH2[0xfaf2] + Op.EQ
        + Op.PUSH2[0x46f] + Op.JUMPI + Op.DUP4 + Op.PUSH2[0xf1f4] + Op.EQ
        + Op.PUSH2[0x457] + Op.JUMPI + Op.DUP4 + Op.PUSH2[0xf2f4] + Op.EQ
        + Op.PUSH2[0x43f] + Op.JUMPI + Op.DUP4 + Op.PUSH2[0xf4f4] + Op.EQ
        + Op.PUSH2[0x428] + Op.JUMPI + Op.DUP4 + Op.PUSH2[0xfaf4] + Op.EQ
        + Op.PUSH2[0x411] + Op.JUMPI + Op.DUP4 + Op.PUSH2[0xf1fa] + Op.EQ
        + Op.PUSH2[0x3f9] + Op.JUMPI + Op.DUP4 + Op.PUSH2[0xf2fa] + Op.EQ
        + Op.PUSH2[0x3e1] + Op.JUMPI + Op.DUP4 + Op.PUSH2[0xf4fa] + Op.EQ
        + Op.PUSH2[0x3ca] + Op.JUMPI + Op.DUP4 + Op.PUSH2[0xfafa] + Op.EQ
        + Op.PUSH2[0x3b3] + Op.JUMPI + Op.DUP4 + Op.PUSH1[0xfd] + Op.EQ
        + Op.PUSH2[0x37e] + Op.JUMPI + Op.DUP4 + Op.PUSH1[0xfe] + Op.EQ
        + Op.PUSH2[0x347] + Op.JUMPI + Op.DUP4 + Op.PUSH1[0xff] + Op.EQ
        ...
        + Op.POP + Op.POP + Op.GASPRICE + Op.PUSH1[0x0] + Op.MSTORE + Op.PUSH1[0x0]
        + Op.MLOAD + Op.PUSH1[0x0] + Op.SSTORE + Op.PUSH1[0x0] + Op.DUP1 + Op.DUP1
        + Op.DUP1 + Op.DUP1 + Op.PUSH4[0xdeaddead] + Op.GAS + Op.CALL + Op.POP
        + Op.GASPRICE + Op.PUSH1[0x0] + Op.DUP2 + Op.DUP2 + Op.MSTORE + Op.SLOAD
        + Op.EQ + Op.PUSH2[0x156] + Op.JUMPI + Op.PUSH5[0xbadbadbad] + Op.PUSH1[0x0]
        + Op.MSTORE + Op.PUSH2[0x156] + Op.JUMP + Op.JUMPDEST + Op.POP + Op.POP
        + Op.POP + Op.POP + Op.GASPRICE + Op.PUSH1[0x0] + Op.MSTORE + Op.PUSH1[0x0]
        + Op.MLOAD + Op.PUSH1[0x0] + Op.SSTORE + Op.PUSH1[0x0] + Op.DUP1 + Op.DUP1
        + Op.DUP1 + Op.DUP1 + Op.PUSH3[0x60006] + Op.PUSH2[0x61a8] + Op.CALL + Op.POP
        + Op.GASPRICE + Op.PUSH1[0x0] + Op.DUP2 + Op.DUP2 + Op.MSTORE + Op.SLOAD
        + Op.EQ + Op.PUSH2[0x156] + Op.JUMPI + Op.PUSH5[0xbadbadbad] + Op.PUSH1[0x0]
        + Op.MSTORE + Op.PUSH2[0x156] + Op.JUMP + Op.JUMPDEST + Op.POP + Op.POP
        + Op.POP + Op.POP + Op.GASPRICE + Op.PUSH1[0x0] + Op.MSTORE + Op.PUSH1[0x0]
        + Op.MLOAD + Op.PUSH1[0x0] + Op.SSTORE + Op.PUSH1[0x0] + Op.DUP1 + Op.DUP1
        + Op.DUP1 + Op.DUP1 + Op.PUSH3[0x60bacc] + Op.GAS + Op.CALL + Op.POP
        + Op.GASPRICE + Op.PUSH1[0x0] + Op.DUP2 + Op.DUP2 + Op.MSTORE + Op.SLOAD
        + Op.EQ + Op.PUSH2[0x156] + Op.JUMPI + Op.PUSH5[0xbadbadbad] + Op.PUSH1[0x0]
        + Op.MSTORE + Op.PUSH2[0x156] + Op.JUMP + Op.JUMPDEST + Op.POP + Op.POP
        + Op.POP + Op.POP + Op.POP + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.DUP1
        + Op.DUP1 + Op.PUSH4[0xca1100fa] + Op.GAS + Op.STATICCALL + Op.PUSH2[0x156]
        + Op.JUMP + Op.JUMPDEST + Op.POP + Op.POP + Op.POP + Op.POP + Op.POP
        + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.DUP1 + Op.DUP1 + Op.PUSH4[0xca1100fa]
        + Op.GAS + Op.DELEGATECALL + Op.PUSH2[0x156] + Op.JUMP + Op.JUMPDEST + Op.POP
        + Op.POP + Op.POP + Op.POP + Op.POP + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.DUP1
        + Op.DUP1 + Op.DUP1 + Op.PUSH4[0xca1100fa] + Op.GAS + Op.CALLCODE
        + Op.PUSH2[0x156] + Op.JUMP + Op.JUMPDEST + Op.POP + Op.POP + Op.POP + Op.POP
        + Op.POP + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.DUP1 + Op.DUP1 + Op.DUP1
        + Op.PUSH4[0xca1100fa] + Op.GAS + Op.CALL + Op.PUSH2[0x156] + Op.JUMP
        ...
        + Op.POP + Op.POP + Op.POP + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.DUP1
        + Op.DUP1 + Op.PUSH4[0xca1100f4] + Op.GAS + Op.DELEGATECALL + Op.PUSH2[0x156]
        + Op.JUMP + Op.JUMPDEST + Op.POP + Op.POP + Op.POP + Op.POP + Op.POP
        + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.DUP1 + Op.DUP1 + Op.DUP1
        + Op.PUSH4[0xca1100f4] + Op.GAS + Op.CALLCODE + Op.PUSH2[0x156] + Op.JUMP
        + Op.JUMPDEST + Op.POP + Op.POP + Op.POP + Op.POP + Op.POP + Op.PUSH1[0x20]
        + Op.PUSH1[0x0] + Op.DUP1 + Op.DUP1 + Op.DUP1 + Op.PUSH4[0xca1100f4] + Op.GAS
        + Op.CALL + Op.PUSH2[0x156] + Op.JUMP + Op.JUMPDEST + Op.POP + Op.POP + Op.POP
        + Op.POP + Op.POP + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.DUP1 + Op.DUP1
        + Op.PUSH4[0xca1100f2] + Op.GAS + Op.STATICCALL + Op.PUSH2[0x156] + Op.JUMP
        + Op.JUMPDEST + Op.POP + Op.POP + Op.POP + Op.POP + Op.POP + Op.PUSH1[0x20]
        + Op.PUSH1[0x0] + Op.DUP1 + Op.DUP1 + Op.PUSH4[0xca1100f2] + Op.GAS
        + Op.DELEGATECALL + Op.PUSH2[0x156] + Op.JUMP + Op.JUMPDEST + Op.POP + Op.POP
        + Op.POP + Op.POP + Op.POP + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.DUP1
        + Op.DUP1 + Op.DUP1 + Op.PUSH4[0xca1100f2] + Op.GAS + Op.CALLCODE
        + Op.PUSH2[0x156] + Op.JUMP + Op.JUMPDEST + Op.POP + Op.POP + Op.POP + Op.POP
        + Op.POP + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.DUP1 + Op.DUP1 + Op.DUP1
        + Op.PUSH4[0xca1100f2] + Op.GAS + Op.CALL + Op.PUSH2[0x156] + Op.JUMP
        + Op.JUMPDEST + Op.POP + Op.POP + Op.POP + Op.POP + Op.POP + Op.PUSH1[0x20]
        + Op.PUSH1[0x0] + Op.DUP1 + Op.DUP1 + Op.PUSH4[0xca1100f1] + Op.GAS
        + Op.STATICCALL + Op.PUSH2[0x156] + Op.JUMP + Op.JUMPDEST + Op.POP + Op.POP
        + Op.POP + Op.POP + Op.POP + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.DUP1
        + Op.DUP1 + Op.PUSH4[0xca1100f1] + Op.GAS + Op.DELEGATECALL + Op.PUSH2[0x156]
        + Op.JUMP + Op.JUMPDEST + Op.POP + Op.POP + Op.POP + Op.POP + Op.POP
        + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.DUP1 + Op.DUP1 + Op.DUP1
        + Op.PUSH4[0xca1100f1] + Op.GAS + Op.CALLCODE + Op.PUSH2[0x156] + Op.JUMP
        + Op.JUMPDEST + Op.POP + Op.POP + Op.POP + Op.POP + Op.POP + Op.PUSH1[0x20]
        + Op.PUSH1[0x0] + Op.DUP1 + Op.DUP1 + Op.DUP1 + Op.PUSH4[0xca1100f1] + Op.GAS
        + Op.CALL + Op.PUSH2[0x156] + Op.JUMP + Op.JUMPDEST + Op.POP + Op.POP + Op.POP
        + Op.POP + Op.POP + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.DUP1 + Op.DUP1
        + Op.PUSH2[0xca11] + Op.GAS + Op.STATICCALL + Op.PUSH2[0x156] + Op.JUMP
        + Op.JUMPDEST + Op.POP + Op.POP + Op.POP + Op.POP + Op.POP + Op.PUSH1[0x20]
        + Op.PUSH1[0x0] + Op.DUP1 + Op.DUP1 + Op.PUSH2[0xca11] + Op.GAS
        + Op.DELEGATECALL + Op.PUSH2[0x156] + Op.JUMP + Op.JUMPDEST + Op.POP + Op.POP
        + Op.POP + Op.POP + Op.POP + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.DUP1
        + Op.DUP1 + Op.DUP1 + Op.PUSH2[0xca11] + Op.GAS + Op.CALLCODE
        + Op.PUSH2[0x156] + Op.JUMP + Op.JUMPDEST + Op.POP + Op.POP + Op.POP + Op.POP
        + Op.POP + Op.PUSH1[0x20] + Op.PUSH1[0x0] + Op.DUP1 + Op.DUP1 + Op.DUP1
        + Op.PUSH2[0xca11] + Op.GAS + Op.CALL + Op.PUSH2[0x156] + Op.JUMP
        + Op.JUMPDEST + Op.POP + Op.POP + Op.POP + Op.POP + Op.GASPRICE
        + Op.PUSH1[0x0] + Op.MSTORE + Op.PUSH2[0x156] + Op.JUMP
    ),
        storage={0x0: 0x60a7},
    )
