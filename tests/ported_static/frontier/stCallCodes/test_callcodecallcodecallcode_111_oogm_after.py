...
Ported from:
state_tests/stCallCodes/callcodecallcodecallcode_111_OOGMAfterFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stCallCodes/callcodecallcodecallcode_111_OOGMAfterFiller.json"  # noqa: E501
    ],
)
