...
Ported from:
state_tests/stCallCodes/callcodecallcall_100Filler.json
...
def test_callcodecallcall_100(
    ...
    # Source: lll
    # {  [[ 2 ]] (CALL 250000 <contract:0x1000000000000000000000000000000000000003> 3 0 64 0 64 ) }  # noqa: E501
    ...
    # Source: lll
    # {  [[ 1 ]] (CALL 300000 <contract:0x1000000000000000000000000000000000000002> 2 0 64 0 64 ) }  # noqa: E501
