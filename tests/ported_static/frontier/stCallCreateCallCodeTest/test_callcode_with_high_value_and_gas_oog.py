...
Ported from:
state_tests/stCallCreateCallCodeTest/callcodeWithHighValueAndGasOOGFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stCallCreateCallCodeTest/callcodeWithHighValueAndGasOOGFiller.json"  # noqa: E501
    ],
)
