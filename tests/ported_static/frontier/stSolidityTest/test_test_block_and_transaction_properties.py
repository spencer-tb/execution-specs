...
def test_test_block_and_transaction_properties(
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.JUMPI(
            pc=0x123,
            condition=Op.ISZERO(Op.ISZERO(Op.EQ(Op.PREVRANDAO, 0x2B8FEB0))),
        )
        + Op.PUSH1[0x0]
        + Op.SWAP1
        + Op.POP
        ...
        + Op.JUMPDEST
        + Op.JUMPI(
            pc=0x150, condition=Op.ISZERO(Op.ISZERO(Op.EQ(Op.NUMBER, 0x78)))
        )
        + Op.PUSH1[0x0]
        + Op.SWAP1
        + Op.POP
        ...
        + Op.JUMPDEST
        + Op.JUMPI(
            pc=0x1A7, condition=Op.ISZERO(Op.ISZERO(Op.EQ(Op.CALLVALUE, 0x64)))
        )
        + Op.PUSH1[0x0]
        + Op.SWAP1
        + Op.POP
        ...
        + Op.JUMPDEST
        + Op.JUMPI(
            pc=0x1BA, condition=Op.ISZERO(Op.ISZERO(Op.EQ(Op.GASPRICE, 0x1)))
        )
        + Op.PUSH1[0x0]
        + Op.SWAP1
        + Op.POP
