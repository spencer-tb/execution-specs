"""
Test_log3_log_memsize_zero.

Ported from:
state_tests/stLogTests/log3_logMemsizeZeroFiller.json
"""
...
def test_log3_log_memsize_zero(
    ...
    # Source: lll
    # { (MSTORE 0 0xaabbffffffffffffffffffffffffffffffffffffffffffffffffffffffffccdd) (LOG3 1 0 0 0 0) }  # noqa: E501
