"""
Test_log3_non_empty_mem_log_mem_size1_log_mem_start31.

Ported from:
state_tests/stLogTests/log3_nonEmptyMem_logMemSize1_logMemStart31Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stLogTests/log3_nonEmptyMem_logMemSize1_logMemStart31Filler.json"  # noqa: E501
    ],
)
...
def test_log3_non_empty_mem_log_mem_size1_log_mem_start31(
    ...
    # Source: lll
    # { (MSTORE 0 0xaabbffffffffffffffffffffffffffffffffffffffffffffffffffffffffccdd) (LOG3 31 1 0 0 0) }  # noqa: E501
