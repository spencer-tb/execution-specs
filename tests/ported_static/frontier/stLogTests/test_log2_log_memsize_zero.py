"""
Test_log2_log_memsize_zero.

Ported from:
state_tests/stLogTests/log2_logMemsizeZeroFiller.json
"""
...
def test_log2_log_memsize_zero(
    ...
    # Source: lll
    # { (MSTORE 0 0xaabbffffffffffffffffffffffffffffffffffffffffffffffffffffffffccdd) (LOG2 1 0 0 0) }  # noqa: E501
