"""
Test_log3_log_mem_start_too_high.

Ported from:
state_tests/stLogTests/log3_logMemStartTooHighFiller.json
"""
...
def test_log3_log_mem_start_too_high(
    ...
    # Source: lll
    # { (MSTORE 0 0xaabbffffffffffffffffffffffffffffffffffffffffffffffffffffffffccdd) (LOG3 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff 1 0 0 0) }  # noqa: E501
