"""
Test_log2_non_empty_mem_log_mem_size1.

Ported from:
state_tests/stLogTests/log2_nonEmptyMem_logMemSize1Filler.json
"""
...
def test_log2_non_empty_mem_log_mem_size1(
    ...
    # Source: lll
    # { (MSTORE 0 0xaabbffffffffffffffffffffffffffffffffffffffffffffffffffffffffccdd) (LOG2 0 1 0 0) }  # noqa: E501
