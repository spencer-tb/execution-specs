"""
Test_create_name_registrator_out_of_memory_bonds1.

Ported from:
state_tests/stSystemOperationsTest/createNameRegistratorOutOfMemoryBonds1Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stSystemOperationsTest/createNameRegistratorOutOfMemoryBonds1Filler.json"  # noqa: E501
    ],
)
