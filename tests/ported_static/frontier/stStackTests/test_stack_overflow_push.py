...
def test_stack_overflow_push(
    ...
    """
    Test pushing to the stack with all PUSH* opcodes until a stack overflow
    occurs.
    """
    max_stack_height = fork.max_stack_height()
    initcode = opcode[0x0] * (max_stack_height + 1)
