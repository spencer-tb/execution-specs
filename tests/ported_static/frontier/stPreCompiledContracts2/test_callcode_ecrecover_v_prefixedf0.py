"""
Test_callcode_ecrecover_v_prefixedf0.
...
@pytest.mark.ported_from(
    [
        "state_tests/stPreCompiledContracts2/CALLCODEEcrecoverV_prefixedf0Filler.json"  # noqa: E501
    ],
)
...
def test_callcode_ecrecover_v_prefixedf0(
    ...
    tx_data = [
        Hash(0xF01C),
        Hash(0xF000000000000000000000000000001C),
    ]
    tx_gas = [3652240]
    tx_value = [100000]
