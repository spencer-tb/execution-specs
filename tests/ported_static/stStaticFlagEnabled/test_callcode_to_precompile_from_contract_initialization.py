...
Ported from:
tests/static/state_tests/stStaticFlagEnabled/CallcodeToPrecompileFromContractInitializationFiller.yml
"""
...
."""
    ...
    pre[callee] = Account(
        ...
        + Op.MSTORE(offset=0x2000, value=0x0) + Op.MSTORE(offset=0x2020, value=0x0)
        ...
        + Op.MSTORE(offset=0x0, value=0x0) + Op.MSTORE(offset=0x20, value=0x0)
        + Op.MSTORE(offset=0x40, value=0x0) + Op.MSTORE(offset=0x60, value=0x0)
        + Op.MSTORE(offset=0x3000, value=0x0) + Op.MSTORE(offset=0x3020, value=0x0)
        + Op.MSTORE(offset=0x0, value=0xf25929bcb43d5a57391564615c9e70a992b10eafa4db109709649cf48c50dd2)
        + Op.MSTORE(offset=0x20, value=0x16da2f5cb6be7a0aa72c440c53c9bbdfec6c36c7d515536431b3a865468acbba)
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x0, value=0xfeedfeedfeedfeedfeedfeedfeedfeedfeedfeedfeedfeedfeedfeedfeedfeed)
        + Op.CALLDATACOPY(dest_offset=0x0, offset=0x0, size=Op.CALLDATASIZE)
        + Op.SSTORE(key=0x1, value=Op.CREATE2(value=0x0, offset=0x0, size=Op.CALLDATASIZE, salt=0x5a175a17))
        + Op.SSTORE(key=0x2, value=0xfeedfeedfeedfeedfeedfeedfeedfeedfeedfeedfeedfeedfeedfeedfeedfeed)
        + Op.STOP
    ),
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "620a000051610a0055620b000051610b0055620a010051610a0155620b010051610b0155"
            "620a020051610a0255620b020051610b0255620a030051610a0355620b030051610b0355"
            "620a040051610a0455620b040051610b0455620a050051610a0555620b050051610b0555"
            "620a060051610a0655620b060051610b0655620a070051610a0755620b070051610b0755"
            "620a080051610a0855620b080051610b0855620a090051610a0955620b090051610b0955"
            "620a100051610a1055620b100051610b1055620a110051610a1155620b110051610b1155"
            "620a120051610a1255620b120051610b1255620a130051610a1355620b130051610b1355"
            "620a140051610a1455620b140051610b1455620a150051610a1555620b150051610b1555"
            "620a160051610a1655620b160051610b1655620a170051610a1755620b170051610b1755"
            "620a180051610a1855620b180051610b1855620a190051610a1955620b190051610b1955"
