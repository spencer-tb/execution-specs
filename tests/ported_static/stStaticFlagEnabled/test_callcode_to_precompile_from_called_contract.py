...
Ported from:
tests/static/state_tests/stStaticFlagEnabled/CallcodeToPrecompileFromCalledContractFiller.yml
"""
...
."""
    ...
    pre[callee_1] = Account(
        ...
        + Op.SSTORE(key=0x1, value=0xfeedfeedfeedfeedfeedfeedfeedfeedfeedfeedfeedfeedfeedfeedfeedfeed)
