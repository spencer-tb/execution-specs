...
Ported from:
tests/static/state_tests/stZeroKnowledge/ecpairing_one_point_with_g2_zero_and_g1_invalidFiller.json
"""
...
def test_ecpairing_one_point_with_g2_zero_and_g1_invalid(
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(""),
