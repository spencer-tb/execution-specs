"""
Various inputs to the bn254_pairing precompile.

Ported from:
tests/static/state_tests/stZeroKnowledge/ecpairing_inputsFiller.yml
"""
...
@pytest.mark.parametrize(
    ...
    [
        (
            "",  # noqa: E501
            {
                Address("0x000000000000000000000000000000000000c0de"): Account(
                    ...
                    + Op.CALLDATASIZE
                    + Op.CALLDATACOPY(
                        dest_offset=Op.DUP1, offset=Op.DUP3, size=Op.DUP1
                    )
                    + Op.DUP2
                    + Op.PUSH1[0x8]
                    + Op.PUSH4[0xFFFFFFFF]
        ...
        (
            "",  # noqa: E501
            {
                Address("0x000000000000000000000000000000000000c0de"): Account(
                    code=Op.PUSH1[0x20]
                    + Op.PUSH0
        ...
        (
            "",  # noqa: E501
            {
                Address("0x000000000000000000000000000000000000c0de"): Account(
                    storage={1: 1},
                    code=Op.PUSH1[0x20]
...
def test_ecpairing_inputs(
    ...
    """Various inputs to the bn254_pairing precompile."""
    coinbase = Address("0x00000000000000000000000000000000c014bace")
    sender = EOA(
