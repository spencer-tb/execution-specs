...
def test_create2_on_depth1023(
    ...
    pre[contract] = Account(
        ...
        + Op.JUMP(pc=0x60) + Op.JUMPDEST
        + Op.MSTORE(offset=0x20, value=0x6000600060006000f5600155)
        + Op.SSTORE(key=0x1, value=Op.CREATE2(value=0x0, offset=0x34, size=0xc, salt=0x0))
        + Op.JUMPDEST + Op.STOP
    ),
    )
    pre[callee] = Account(
