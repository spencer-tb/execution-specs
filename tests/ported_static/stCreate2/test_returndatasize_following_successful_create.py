...
def test_returndatasize_following_successful_create(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH1[0x0] + Op.PUSH1[0xd]
        + Op.CODECOPY(dest_offset=0x0, offset=0x17, size=Op.DUP1) + Op.PUSH1[0x0]
    ...
    post = {
        contract: Account(
            code=Op.PUSH1[0x0] + Op.PUSH1[0xd] + Op.CODECOPY(dest_offset=0x0, offset=0x17, size=Op.DUP1) + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.POP(Op.CREATE2) + Op.SSTORE(key=0x0, value=Op.RETURNDATASIZE) + Op.STOP + Op.STOP + Op.INVALID + Op.MSTORE(offset=0x0, value=0x112233) + Op.RETURN(offset=0x0, size=0x20) + Op.STOP,
        ),
