...
Ported from:
tests/static/state_tests/stCallCreateCallCodeTest/createInitFailStackUnderflowFiller.json
"""
...
def test_create_init_fail_stack_underflow(
    ...
    post = {
        contract: Account(
            code=Op.MSTORE8(offset=0x0, value=0x1) + Op.SELFDESTRUCT(address=Op.CREATE(value=0x1, offset=0x0, size=0x1)) + Op.STOP,
        ),
    }
