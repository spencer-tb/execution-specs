...
def test_callcode_output3(
    ...
    pre[contract] = Account(
        ...
        + Op.POP(Op.CALLCODE(gas=0x249f0, address=0xbcc1197ccd23a97607f2f96d031f3432e0d16a02, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x20))
