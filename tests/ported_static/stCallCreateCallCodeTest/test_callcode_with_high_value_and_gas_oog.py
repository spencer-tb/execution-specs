...
Ported from:
tests/static/state_tests/stCallCreateCallCodeTest/callcodeWithHighValueAndGasOOGFiller.json
"""
...
def test_callcode_with_high_value_and_gas_oog(
    ...
    contract = Address("0x0b4e1c683c41f86dc747fbf0dd02cd4398b41373")
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=0x0, value=Op.CALLCODE(gas=0xffffffffffffffffffffffff, address=0x896f13e800125c0ccec44f3c434335f0a97bc1b, value=0x56bc75e2d63100000, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x2))
        + Op.STOP
    ),
    )
