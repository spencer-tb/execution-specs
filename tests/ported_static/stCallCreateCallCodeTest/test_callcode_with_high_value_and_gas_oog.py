...
def test_callcode_with_high_value_and_gas_oog(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "97bc1b6bfffffffffffffffffffffffff260005500"
        ),
    )
    ...
    post = {
        ...
        contract: Account(
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
    }
