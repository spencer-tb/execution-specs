...
def test_callcode_with_high_value(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x0, value=Op.CALLCODE(gas=0xc350, address=0x896f13e800125c0ccec44f3c434335f0a97bc1b, value=0xde0b6b3a7640001, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x2))
        + Op.STOP
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            code=Op.SSTORE(key=0x0, value=Op.CALLCODE(gas=0xc350, address=0x896f13e800125c0ccec44f3c434335f0a97bc1b, value=0xde0b6b3a7640001, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x2)) + Op.STOP,
        ),
    }
