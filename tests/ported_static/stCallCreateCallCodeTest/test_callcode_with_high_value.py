...
def test_callcode_with_high_value(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "6002600060406000670de0b6b3a7640001730896f13e800125c0ccec44f3c434335f0a97"  # noqa: E501
            "bc1b61c350f260005500"
        ),
    )
    ...
    post = {
        ...
        contract: Account(
            code=bytes.fromhex(
                "6002600060406000670de0b6b3a7640001730896f13e800125c0ccec44f3c434335f0a97bc1b61c350f260005500"  # noqa: E501
            ),
        ),
    }
