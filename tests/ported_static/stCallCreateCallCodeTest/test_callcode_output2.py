...
def test_callcode_output2(
    ...
    pre[contract] = Account(
        ...
        + Op.POP(Op.CALLCODE(gas=0xc350, address=0xbcc1197ccd23a97607f2f96d031f3432e0d16a02, value=0x0, args_offset=0x0, args_size=0x20, ret_offset=0x0, ret_size=0x0))
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.MSTORE(offset=0x0, value=0x5e20a0453cecd065ea59c37ac63e079ee08998b6045136a8ce6635c7912ec0b6) + Op.POP(Op.CALLCODE(gas=0xc350, address=0xbcc1197ccd23a97607f2f96d031f3432e0d16a02, value=0x0, args_offset=0x0, args_size=0x20, ret_offset=0x0, ret_size=0x0)) + Op.SSTORE(key=0x0, value=Op.MLOAD(offset=0x0)) + Op.STOP,
        ),
    }
