...
def test_call_with_high_value_oo_gin_call(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH1[0x0] + Op.PUSH8[0xde0b6b3a7640000]
        + Op.PUSH20[0x1000000000000000000000000000000000001000] + Op.PUSH2[0x2710]
        + Op.CALL + Op.ADD + Op.PUSH1[0x0] + Op.SSTORE + Op.STOP
    ),
    )
