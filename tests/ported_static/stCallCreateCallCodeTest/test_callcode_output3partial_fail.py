...
Ported from:
tests/static/state_tests/stCallCreateCallCodeTest/callcodeOutput3partialFailFiller.json
"""
...
def test_callcode_output3partial_fail(
    ...
    contract = Address("0xee172f045cfa9101ee8c62faf6975d8f4c1e2099")
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.MSTORE(offset=0x0, value=0x5e20a0453cecd065ea59c37ac63e079ee08998b6045136a8ce6635c7912ec0b6) + Op.POP(Op.CALLCODE(gas=0xc350, address=0x834abc2c68c5f44ea9ae82b67aaf92044901cdc6, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0xa)) + Op.SSTORE(key=0x0, value=Op.MLOAD(offset=0x0)) + Op.STOP,
        ),
    }
