...
def test_callcode_output3partial(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "600a600060006000600073bcc1197ccd23a97607f2f96d031f3432e0d16a02620249f0f2"  # noqa: E501
            "5060005160005500"
        ),
    )
    pre[callee] = Account(
    ...
    post = {
        contract: Account(
            ...
            code=bytes.fromhex(
                "7f5e20a0453cecd065ea59c37ac63e079ee08998b6045136a8ce6635c7912ec0b6600052600a600060006000600073bcc1197ccd23a97607f2f96d031f3432e0d16a02620249f0f25060005160005500"  # noqa: E501
            ),
        ),
