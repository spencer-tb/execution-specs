...
def test_create_init_fail_stack_size_larger_than1024(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.MSTORE(offset=0x0, value=0x6103ff6000525b7f0102030405060708090a0102030405060708090a01020304)
    ...
    post = {
        contract: Account(
            code=Op.MSTORE(offset=0x0, value=0x6103ff6000525b7f0102030405060708090a0102030405060708090a01020304) + Op.MSTORE(offset=0x20, value=0x5060708090a0102600160005103600052600051600657000000000000000000) + Op.SELFDESTRUCT(address=Op.CREATE(value=0x1, offset=0x0, size=0x40)) + Op.STOP,
        ),
    }
