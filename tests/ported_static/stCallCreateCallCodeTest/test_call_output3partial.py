...
def test_call_output3partial(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "600a600060006000600073bcc1197ccd23a97607f2f96d031f3432e0d16a02620249f0f1"  # noqa: E501
            "5060005160005500"
        ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=bytes.fromhex(
                "7f5e20a0453cecd065ea59c37ac63e079ee08998b6045136a8ce6635c7912ec0b6600052600a600060006000600073bcc1197ccd23a97607f2f96d031f3432e0d16a02620249f0f15060005160005500"  # noqa: E501
            ),
        ),
        callee: Account(
            storage={0: 2},
