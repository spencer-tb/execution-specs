...
def test_call_to_empty_then_call_error_paris(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "600060006000600060007376fae819612a29489a1a43208613d8f8557b88986000f15060"  # noqa: E501
            "00600060006000600073ab4cdae660b629c6f7be5a12139558e6296ad0b56000f100"  # noqa: E501
        ),
    )
    pre[callee] = Account(balance=10, nonce=0)
    pre[callee_1] = Account(balance=0, nonce=0, code=bytes.fromhex("5a00"))
    ...
    post = {
        contract: Account(
            code=bytes.fromhex(
                "600060006000600060007376fae819612a29489a1a43208613d8f8557b88986000f1506000600060006000600073ab4cdae660b629c6f7be5a12139558e6296ad0b56000f100"  # noqa: E501
            ),
        ),
        callee_1: Account(code=bytes.fromhex("5a00")),
    }
