...
def test_refund_call_a_not_enough_gas_in_call(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "6000600060006000600073f4c9fc42faeda49049e3b8e2b97a17cc2fe9571861138df160"  # noqa: E501
            "005500"
        ),
        storage={0x1: 0x1},
    )
    ...
    post = {
        contract: Account(
            storage={1: 1},
            code=bytes.fromhex(
                "6000600060006000600073f4c9fc42faeda49049e3b8e2b97a17cc2fe9571861138df160005500"  # noqa: E501
            ),
        ),
