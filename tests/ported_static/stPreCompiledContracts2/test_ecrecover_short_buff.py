...
def test_ecrecover_short_buff(
    ...
    pre[contract] = Account(
        ...
        nonce=1,
        code=(
        Op.PUSH1[0xa0] + Op.PUSH1[0x0] + Op.JUMPDEST
        + Op.JUMPI(pc=0x8a, condition=Op.LT(Op.DUP2, Op.DUP2)) + Op.POP
        + Op.MSTORE(offset=Op.DUP1, value=0x0) + Op.MSTORE(offset=0x20, value=0x1b)
        ...
        + Op.JUMPI(pc=0x67, condition=Op.LT(Op.DUP2, Op.DUP2)) + Op.STOP + Op.JUMPDEST
        + Op.DUP1 + Op.PUSH1[0x20] + Op.PUSH2[0x100] + Op.PUSH1[0x1] + Op.SWAP4
        + Op.PUSH1[0x0] + Op.DUP1 + Op.DUP7 + Op.GAS + Op.CALL + Op.DUP3 + Op.SWAP1
        ...
        + Op.SSTORE(key=Op.DUP3, value=Op.DUP1) + Op.ADD(Op.DUP3, 0x1000) + Op.SSTORE
        + Op.PUSH1[0x1] + Op.ADD + Op.JUMP(pc=0x4)
    ),
