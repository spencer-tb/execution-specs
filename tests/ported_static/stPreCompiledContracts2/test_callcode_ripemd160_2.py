...
def test_callcode_ripemd160_2(
    ...
    post = {
        contract: Account(
            ...
            code=Op.MSTORE(offset=0x5, value=0xf34578907f) + Op.SSTORE(key=0x2, value=Op.CALLCODE(gas=0x1770, address=0x3, value=0x0, args_offset=0x0, args_size=0x25, ret_offset=0x0, ret_size=0x20)) + Op.SSTORE(key=0x0, value=Op.MLOAD(offset=0x0)) + Op.STOP,
        ),
    }
