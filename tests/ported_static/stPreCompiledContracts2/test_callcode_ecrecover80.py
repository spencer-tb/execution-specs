...
def test_callcode_ecrecover80(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=0x2, value=Op.CALLCODE(gas=0x493e0, address=0x1, value=0x0, args_offset=0x0, args_size=0x80, ret_offset=0x80, ret_size=0x20))
    ...
    post = {
        contract: Account(
            storage={2: 1},
            code=Op.MSTORE(offset=0x0, value=0xc547e4f7b0f325ad1e56f57e26c745b09a3e503d86e00e5255ff7f715d3d1c) + Op.MSTORE(offset=0x20, value=0x1c) + Op.MSTORE(offset=0x40, value=0xb1693892219d736caba55bdb67216e485557ea6b6af75f37096c9aa6a5a75f) + Op.MSTORE(offset=0x60, value=0xb940b1d03b21e36b0e47e79769f095fe2ab855bd91e3a38756b7d75a9c4549) + Op.SSTORE(key=0x2, value=Op.CALLCODE(gas=0x493e0, address=0x1, value=0x0, args_offset=0x0, args_size=0x80, ret_offset=0x80, ret_size=0x20)) + Op.SSTORE(key=0x0, value=Op.MOD(Op.MLOAD(offset=0x80), Op.EXP(0x2, 0xa0))) + Op.SSTORE(key=0x1, value=Op.EQ(Op.ORIGIN, Op.SLOAD(key=0x0))) + Op.STOP,
        ),
    }
