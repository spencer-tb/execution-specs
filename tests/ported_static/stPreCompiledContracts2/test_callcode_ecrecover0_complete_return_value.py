"""
Ported from:
tests/static/state_tests/stPreCompiledContracts2/CALLCODEEcrecover0_completeReturnValueFiller.json
"""
...
def test_callcode_ecrecover0_complete_return_value(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=0x2, value=Op.CALLCODE(gas=0xbb8, address=0x1, value=0x0, args_offset=0x0, args_size=0x80, ret_offset=0x80, ret_size=0x20))
    ...
    post = {
        contract: Account(
            storage={0: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 2: 1},
