"""
Ported from:
tests/static/state_tests/stPreCompiledContracts2/CallEcrecover0_overlappingInputOutputFiller.json
"""
...
def test_call_ecrecover0_overlapping_input_output(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=0x2, value=Op.CALL(gas=0x493e0, address=0x1, value=0x0, args_offset=0x0, args_size=0x80, ret_offset=0x40, ret_size=0x20))
