...
def test_callcode_sha256_0(
    ...
    post = {
        contract: Account(
            ...
            code=Op.MSTORE(offset=0x0, value=0x1) + Op.CALLCODE(gas=0xff, address=0x2, value=0x0, args_offset=0x0, args_size=0x20, ret_offset=0x0, ret_size=0x20) + Op.SSTORE(key=0x0, value=Op.MLOAD(offset=0x0)),
        ),
    }
