...
def test_callcode_sha256_5(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "60206000620f4240600060006002610258f260025560005160005500"
        ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=bytes.fromhex(
                "7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff60005260206000620f4240600060006002610258f260025560005160005500"  # noqa: E501
            ),
        ),
    }
