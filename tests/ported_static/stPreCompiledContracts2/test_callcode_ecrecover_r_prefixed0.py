"""
Ported from:
tests/static/state_tests/stPreCompiledContracts2/CALLCODEEcrecoverR_prefixed0Filler.json
"""
...
def test_callcode_ecrecover_r_prefixed0(
    ...
    contract = Address("0xb5ef5e7a96b20d5519b730bca2e026bd49a95f3e")
