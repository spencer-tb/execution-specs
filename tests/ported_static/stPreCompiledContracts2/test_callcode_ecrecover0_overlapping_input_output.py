"""
Ported from:
tests/static/state_tests/stPreCompiledContracts2/CALLCODEEcrecover0_overlappingInputOutputFiller.json
"""
...
def test_callcode_ecrecover0_overlapping_input_output(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=0x2, value=Op.CALLCODE(gas=0x493e0, address=0x1, value=0x0, args_offset=0x0, args_size=0x80, ret_offset=0x40, ret_size=0x20))
        + Op.SSTORE(key=0x0, value=Op.MOD(Op.MLOAD(offset=0x40), Op.EXP(0x2, 0xa0)))
    ...
    post = {
        contract: Account(
            storage={0: 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b, 1: 1, 2: 1},
