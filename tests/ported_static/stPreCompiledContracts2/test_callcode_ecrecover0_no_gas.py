"""
Ported from:
tests/static/state_tests/stPreCompiledContracts2/CALLCODEEcrecover0_NoGasFiller.json
"""
...
def test_callcode_ecrecover0_no_gas(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=0x2, value=Op.CALLCODE(gas=0x0, address=0x1, value=0x1, args_offset=0x0, args_size=0x80, ret_offset=0x80, ret_size=0x20))
