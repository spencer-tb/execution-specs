...
def test_call_sha256_1_nonzero_value(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x2, value=Op.CALL(gas=0x30d40, address=0x2, value=0x13, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x20))
    ...
    post = {
        contract: Account(
            ...
            code=Op.SSTORE(key=0x2, value=Op.CALL(gas=0x30d40, address=0x2, value=0x13, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x20)) + Op.SSTORE(key=0x0, value=Op.MLOAD(offset=0x0)) + Op.STOP,
        ),
    }
