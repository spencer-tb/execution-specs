...
def test_stack_limit_gas_1025(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.MSTORE(offset=0x0, value=0x3ff) + Op.JUMPDEST + Op.GAS
    ...
    post = {
        contract: Account(
            code=Op.MSTORE(offset=0x0, value=0x3ff) + Op.JUMPDEST + Op.GAS + Op.MSTORE(offset=0x0, value=Op.SUB(Op.MLOAD(offset=0x0), 0x1)) + Op.JUMPI(pc=0x6, condition=Op.MLOAD(offset=0x0)) + Op.STOP + Op.STOP,
        ),
    }
