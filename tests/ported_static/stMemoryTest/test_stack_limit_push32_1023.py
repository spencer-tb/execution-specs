...
def test_stack_limit_push32_1023(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.MSTORE(offset=0x0, value=0x3fd) + Op.JUMPDEST
    ...
    post = {
        contract: Account(
            code=Op.MSTORE(offset=0x0, value=0x3fd) + Op.JUMPDEST + Op.PUSH32[0x102030405060708090a0102030405060708090a0102030405060708090a0102] + Op.MSTORE(offset=0x0, value=Op.SUB(Op.MLOAD(offset=0x0), 0x1)) + Op.JUMPI(pc=0x6, condition=Op.MLOAD(offset=0x0)) + Op.STOP + Op.STOP,
        ),
    }
