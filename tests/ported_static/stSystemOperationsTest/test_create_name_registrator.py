"""
Ported from:
tests/static/state_tests/stSystemOperationsTest/createNameRegistratorFiller.json
"""
...
def test_create_name_registrator(
    ...
    post = {
        ...
        Address("0xd2571607e241ecf590ed94b12d87c94babe36db6"): Account(
            code=Op.JUMPI(pc=0x9, condition=Op.ISZERO(Op.SLOAD(key=Op.CALLDATALOAD(offset=0x0)))) + Op.STOP + Op.JUMPDEST + Op.CALLDATALOAD(offset=0x20) + Op.CALLDATALOAD(offset=0x0),
        ),
    }
