...
def test_call_to_name_registrator_not_much_memory0(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "6000620f12066040600060177315eb18969e0925c8e4a76fd7cbce36a2b056b27e6101f4"  # noqa: E501
            "f160005500"
        ),
    )
    ...
    post = {
        ...
        contract: Account(
            code=bytes.fromhex(
                "7feeffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff006000527faaffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffaa6020526000620f12066040600060177315eb18969e0925c8e4a76fd7cbce36a2b056b27e6101f4f160005500"  # noqa: E501
            ),
        ),
    }
