...
def test_post_to_return1(
    ...
    pre[callee] = Account(
        balance=23,
        nonce=0,
        code=Op.MSTORE8(offset=0x0, value=0x37) + Op.PUSH1[0x2] + Op.PUSH1[0x0] + Op.CALLCODE,
    )
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=0x1, value=Op.CALL(gas=0x7530, address=0x1ec76f80449bf4d3edf503813e06c0d4373fdf3d, value=0x17, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x0))
