"""
Ported from:
tests/static/state_tests/stSystemOperationsTest/callcodeToNameRegistrator0Filler.json
"""
...
def test_callcode_to_name_registrator0(
    ...
    contract = Address("0xc390a3ed1719280f32a2a74cbb1f8a3e7b1f002e")
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=0x0, value=Op.CALLCODE(gas=0x3e8, address=0x15eb18969e0925c8e4a76fd7cbce36a2b056b27e, value=0x17, args_offset=0x0, args_size=0x40, ret_offset=0x40, ret_size=0x0))
        + Op.STOP
    ),
    )
