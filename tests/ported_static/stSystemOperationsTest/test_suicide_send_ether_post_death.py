...
def test_suicide_send_ether_post_death(
    ...
    pre[contract] = Account(
        ...
        + Op.JUMP(pc=Op.PUSH2[0x8d]) + Op.JUMPDEST + Op.MLOAD(offset=0x40) + Op.DUP1
        + Op.MSTORE(offset=Op.DUP2, value=Op.DUP3) + Op.PUSH1[0x20] + Op.ADD
        + Op.SWAP2 + Op.POP + Op.POP + Op.MLOAD(offset=0x40) + Op.DUP1 + Op.SWAP2
        + Op.SUB + Op.SWAP1 + Op.RETURN + Op.JUMPDEST
        + Op.SELFDESTRUCT(address=Op.AND(0xffffffffffffffffffffffffffffffffffffffff, Op.ADDRESS))
        + Op.JUMPDEST + Op.JUMP + Op.JUMPDEST + Op.PUSH1[0x0] + Op.PUSH1[0x0]
        ...
        + Op.SWAP4 + Op.POP + Op.POP + Op.POP + Op.POP + Op.POP + Op.DUP1 + Op.SWAP2
        + Op.POP + Op.JUMP(pc=0x147) + Op.JUMPDEST + Op.POP + Op.SWAP1 + Op.JUMP
    ),
    )
