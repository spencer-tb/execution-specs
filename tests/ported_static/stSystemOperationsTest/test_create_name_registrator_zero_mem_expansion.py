...
def test_create_name_registrator_zero_mem_expansion(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "7c601080600c6000396000f3006000355415600957005b60203560003555600052600060"  # noqa: E501
            "006017f060005500"
        ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=bytes.fromhex(
                "7c601080600c6000396000f3006000355415600957005b60203560003555600052600060006017f060005500"  # noqa: E501
            ),
        ),
    }
