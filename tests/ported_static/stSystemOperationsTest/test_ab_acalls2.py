...
def test_ab_acalls2(
    ...
    post = {
        callee: Account(
            storage={0: 201},
            code=Op.SSTORE(key=0x0, value=Op.ADD(Op.SLOAD(key=0x0), 0x1)) + Op.CALL(gas=Op.SUB(Op.GAS, 0x186a0), address=0xc58b2120d2ad0cbfccd6ebaae6c11258aceac41b, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0) + Op.STOP,
        ),
        contract: Account(
            storage={0: 201},
