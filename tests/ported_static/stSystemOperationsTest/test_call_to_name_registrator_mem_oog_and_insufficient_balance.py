...
def test_call_to_name_registrator_mem_oog_and_insufficient_balance(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=0x0, value=Op.CALL(gas=0xffffffffff, address=0x15eb18969e0925c8e4a76fd7cbce36a2b056b27e, value=0x17, args_offset=0x0, args_size=0xffffffffffff, ret_offset=0x40, ret_size=0x0))
        + Op.STOP
    ),
    )
