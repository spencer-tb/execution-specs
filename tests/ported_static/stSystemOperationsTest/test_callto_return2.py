...
def test_callto_return2(
    ...
    pre[callee] = Account(
        ...
        + Op.PUSH1[0x2] + Op.PUSH1[0x0] + Op.CALLCODE
    ),
    )
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=0x0, value=Op.CALL(gas=0x1388, address=0x2b45331c406df38b99656c3ed3a97ef219979232, value=0x17, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x2))
        + Op.STOP
    ),
    )
