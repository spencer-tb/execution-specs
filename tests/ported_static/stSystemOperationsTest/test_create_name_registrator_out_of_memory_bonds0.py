...
def test_create_name_registrator_out_of_memory_bonds0(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=0x0, value=Op.CREATE(value=0x17, offset=0xfffffffffff, size=0x1d))
        + Op.STOP
    ),
    )
    ...
    post = {
        contract: Account(
            code=Op.MSTORE(offset=0x0, value=0x601080600c6000396000f3006000355415600957005b60203560003555) + Op.SSTORE(key=0x0, value=Op.CREATE(value=0x17, offset=0xfffffffffff, size=0x1d)) + Op.STOP,
        ),
    }
