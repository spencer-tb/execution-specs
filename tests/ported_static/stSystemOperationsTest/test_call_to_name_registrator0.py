"""
Ported from:
tests/static/state_tests/stSystemOperationsTest/CallToNameRegistrator0Filler.json
"""
...
def test_call_to_name_registrator0(
    ...
    contract = Address("0xf32cbf847e357d4ac1a41d8202aa2ee516dc32d1")
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=0x0, value=Op.CALL(gas=0x186a0, address=0x15eb18969e0925c8e4a76fd7cbce36a2b056b27e, value=0x17, args_offset=0x0, args_size=0x40, ret_offset=0x40, ret_size=0x0))
        + Op.STOP
    ),
    )
    ...
    post = {
        callee: Account(
            storage={0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff: 0xaaffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffaa},
