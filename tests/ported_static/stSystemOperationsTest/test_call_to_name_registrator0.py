...
def test_call_to_name_registrator0(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "600060406040600060177315eb18969e0925c8e4a76fd7cbce36a2b056b27e620186a0f1"  # noqa: E501
            "60005500"
        ),
    )
    ...
    post = {
        ...
        contract: Account(
            storage={0: 1},
            code=bytes.fromhex(
                "7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff6000527faaffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffaa602052600060406040600060177315eb18969e0925c8e4a76fd7cbce36a2b056b27e620186a0f160005500"  # noqa: E501
            ),
        ),
    }
