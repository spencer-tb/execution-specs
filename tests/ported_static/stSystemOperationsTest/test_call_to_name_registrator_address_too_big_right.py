...
def test_call_to_name_registrator_address_too_big_right(
    ...
    contract = Address("0x2308da9c42e252155baed45bca437ef6cf3fb0b2")
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "600060406040600060177415eb18969e0925c8e4a76fd7cbce36a2b056b27eaa6103e8f1"  # noqa: E501
            "60005500"
        ),
    )
    ...
    post = {
        ...
        contract: Account(
            storage={0: 1},
            code=bytes.fromhex(
                "7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff6000527faaffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffaa602052600060406040600060177415eb18969e0925c8e4a76fd7cbce36a2b056b27eaa6103e8f160005500"  # noqa: E501
            ),
        ),
    }
