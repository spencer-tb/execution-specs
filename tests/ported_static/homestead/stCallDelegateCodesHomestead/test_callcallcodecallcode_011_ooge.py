...
Ported from:
state_tests/stCallDelegateCodesHomestead/callcallcodecallcode_011_OOGEFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stCallDelegateCodesHomestead/callcallcodecallcode_011_OOGEFiller.json"  # noqa: E501
    ],
)
