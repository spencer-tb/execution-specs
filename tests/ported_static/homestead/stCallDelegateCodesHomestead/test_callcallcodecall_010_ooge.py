...
Ported from:
state_tests/stCallDelegateCodesHomestead/callcallcodecall_010_OOGEFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stCallDelegateCodesHomestead/callcallcodecall_010_OOGEFiller.json"  # noqa: E501
    ],
)
