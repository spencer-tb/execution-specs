...
Ported from:
state_tests/stCallDelegateCodesHomestead/callcodecallcall_100Filler.json
...
@pytest.mark.ported_from(
    [
        "state_tests/stCallDelegateCodesHomestead/callcodecallcall_100Filler.json"  # noqa: E501
    ],
)
...
def test_callcodecallcall_100(
    ...
    # Source: lll
    # {  [[ 2 ]] (CALL 250000 <contract:0x1000000000000000000000000000000000000003> 2 0 64 0 64 ) }  # noqa: E501
    ...
    post = {
        target: Account(storage={0: 1, 1: 1, 5: sender}),
        addr_2: Account(storage={2: 1}),
        addr_3: Account(
            storage={
                3: 1,
                4: addr_2,
