...
@pytest.mark.ported_from(
    [
        "state_tests/stCallDelegateCodesHomestead/callcallcodecall_010Filler.json"  # noqa: E501
    ],
)
...
def test_callcallcodecall_010(
    ...
    # Source: lll
    # {  [[ 2 ]] (CALL 250000 <contract:0x1000000000000000000000000000000000000003> 2 0 64 0 64 ) (SSTORE 5 (CALLER))}  # noqa: E501
    ...
    post = {
        ...
        addr: Account(storage={1: 1, 2: 1, 5: target}),
