...
Ported from:
state_tests/stCallDelegateCodesHomestead/callcodecallcall_100_OOGMAfterFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stCallDelegateCodesHomestead/callcodecallcall_100_OOGMAfterFiller.json"  # noqa: E501
    ],
)
