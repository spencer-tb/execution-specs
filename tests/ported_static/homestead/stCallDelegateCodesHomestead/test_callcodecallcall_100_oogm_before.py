...
Ported from:
state_tests/stCallDelegateCodesHomestead/callcodecallcall_100_OOGMBeforeFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stCallDelegateCodesHomestead/callcodecallcall_100_OOGMBeforeFiller.json"  # noqa: E501
    ],
)
