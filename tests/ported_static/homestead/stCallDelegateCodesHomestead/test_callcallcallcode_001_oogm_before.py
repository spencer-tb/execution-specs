...
Ported from:
state_tests/stCallDelegateCodesHomestead/callcallcallcode_001_OOGMBeforeFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stCallDelegateCodesHomestead/callcallcallcode_001_OOGMBeforeFiller.json"  # noqa: E501
    ],
)
