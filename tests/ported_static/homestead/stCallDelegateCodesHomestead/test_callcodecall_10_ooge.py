...
Ported from:
state_tests/stCallDelegateCodesHomestead/callcodecall_10_OOGEFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stCallDelegateCodesHomestead/callcodecall_10_OOGEFiller.json"  # noqa: E501
    ],
)
