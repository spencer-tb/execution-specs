...
Ported from:
state_tests/stCallDelegateCodesHomestead/callcallcode_01_OOGEFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stCallDelegateCodesHomestead/callcallcode_01_OOGEFiller.json"  # noqa: E501
    ],
)
