...
Ported from:
state_tests/stCallDelegateCodesHomestead/callcallcallcode_001_OOGEFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stCallDelegateCodesHomestead/callcallcallcode_001_OOGEFiller.json"  # noqa: E501
    ],
)
