...
Ported from:
state_tests/stCallDelegateCodesHomestead/callcodecallcallcode_101_OOGEFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stCallDelegateCodesHomestead/callcodecallcallcode_101_OOGEFiller.json"  # noqa: E501
    ],
)
