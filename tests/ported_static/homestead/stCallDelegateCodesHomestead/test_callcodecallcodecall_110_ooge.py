...
Ported from:
state_tests/stCallDelegateCodesHomestead/callcodecallcodecall_110_OOGEFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stCallDelegateCodesHomestead/callcodecallcodecall_110_OOGEFiller.json"  # noqa: E501
    ],
)
