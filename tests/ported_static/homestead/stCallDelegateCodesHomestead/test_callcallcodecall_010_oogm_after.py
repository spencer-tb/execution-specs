...
Ported from:
state_tests/stCallDelegateCodesHomestead/callcallcodecall_010_OOGMAfterFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stCallDelegateCodesHomestead/callcallcodecall_010_OOGMAfterFiller.json"  # noqa: E501
    ],
)
