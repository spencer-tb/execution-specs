...
Ported from:
state_tests/stCallDelegateCodesCallCodeHomestead/callcallcallcode_001Filler.json
...
@pytest.mark.ported_from(
    [
        "state_tests/stCallDelegateCodesCallCodeHomestead/callcallcallcode_001Filler.json"  # noqa: E501
    ],
)
