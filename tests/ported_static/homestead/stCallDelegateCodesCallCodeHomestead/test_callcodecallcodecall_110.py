...
@pytest.mark.ported_from(
    [
        "state_tests/stCallDelegateCodesCallCodeHomestead/callcodecallcodecall_110Filler.json"  # noqa: E501
    ],
)
...
def test_callcodecallcodecall_110(
    ...
    # Source: lll
    # {  [[ 2 ]] (CALLCODE 250000 <contract:0x1000000000000000000000000000000000000003> 1 0 64 0 64 ) (SSTORE 6 (CALLER))}  # noqa: E501
