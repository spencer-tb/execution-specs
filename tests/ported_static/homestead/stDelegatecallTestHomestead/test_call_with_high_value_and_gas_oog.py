...
Ported from:
state_tests/stDelegatecallTestHomestead/callWithHighValueAndGasOOGFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stDelegatecallTestHomestead/callWithHighValueAndGasOOGFiller.json"  # noqa: E501
    ],
)
