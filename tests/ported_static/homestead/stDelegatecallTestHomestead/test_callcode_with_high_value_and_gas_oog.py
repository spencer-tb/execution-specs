...
Ported from:
state_tests/stDelegatecallTestHomestead/callcodeWithHighValueAndGasOOGFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stDelegatecallTestHomestead/callcodeWithHighValueAndGasOOGFiller.json"  # noqa: E501
    ],
)
