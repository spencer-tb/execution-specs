...
Ported from:
state_tests/stStaticCall/static_callcodecallcodecall_110_OOGMAfterFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stStaticCall/static_callcodecallcodecall_110_OOGMAfterFiller.json"  # noqa: E501
    ],
)
