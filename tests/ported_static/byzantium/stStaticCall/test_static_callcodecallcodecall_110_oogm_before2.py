"""
Test_static_callcodecallcodecall_110_oogm_before2.

Ported from:
state_tests/stStaticCall/static_callcodecallcodecall_110_OOGMBefore2Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stStaticCall/static_callcodecallcodecall_110_OOGMBefore2Filler.json"  # noqa: E501
    ],
)
...
def test_static_callcodecallcodecall_110_oogm_before2(
    ...
    # Source: lll
    # {  (CALLCODE 40080 <contract:0x1000000000000000000000000000000000000002> (- (CALLVALUE) 1) 0 64 0 64 ) }  # noqa: E501
