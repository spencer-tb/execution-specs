"""
Test_static_log0_log_memsize_zero.

Ported from:
state_tests/stStaticCall/static_log0_logMemsizeZeroFiller.json
"""
...
def test_static_log0_log_memsize_zero(
    ...
    # Source: lll
    # { (MSTORE 0 0xaabbffffffffffffffffffffffffffffffffffffffffffffffffffffffffccdd) (LOG0 1 0) }  # noqa: E501
