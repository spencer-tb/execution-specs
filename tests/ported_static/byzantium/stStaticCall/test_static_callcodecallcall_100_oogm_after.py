"""
Test_static_callcodecallcall_100_oogm_after.

Ported from:
state_tests/stStaticCall/static_callcodecallcall_100_OOGMAfterFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stStaticCall/static_callcodecallcall_100_OOGMAfterFiller.json"  # noqa: E501
    ],
)
...
def test_static_callcodecallcall_100_oogm_after(
    ...
    # Source: lll
    # {  (MSTORE 3 1) (STATICCALL 20020 <contract:0x1000000000000000000000000000000000000003> 0 64 0 64 ) (MSTORE 32 1) }  # noqa: E501
