...
Ported from:
state_tests/stStaticCall/static_callcodecallcallcode_101_OOGE_2Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stStaticCall/static_callcodecallcallcode_101_OOGE_2Filler.json"  # noqa: E501
    ],
)
