"""
Test_returndatacopy_following_create.

Ported from:
state_tests/stReturnDataTest/returndatacopy_following_createFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stReturnDataTest/returndatacopy_following_createFiller.json"  # noqa: E501
    ],
)
