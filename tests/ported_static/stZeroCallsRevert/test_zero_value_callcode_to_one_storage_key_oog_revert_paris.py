...
def test_zero_value_callcode_to_one_storage_key_oog_revert_paris(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "5a60005560006000600060006000734757608f18b70777ae788dd4056eeed52f7aa68f61"  # noqa: E501
    ...
    post = {
        contract: Account(
            code=bytes.fromhex(
                "5a60005560006000600060006000734757608f18b70777ae788dd4056eeed52f7aa68f61ea60f2600155600c600255600c600355600c6004555a60645500"  # noqa: E501
            ),
        ),
