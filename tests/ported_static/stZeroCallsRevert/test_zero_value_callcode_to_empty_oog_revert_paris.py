...
def test_zero_value_callcode_to_empty_oog_revert_paris(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "5a600055600060006000600060007376fae819612a29489a1a43208613d8f8557b889861"  # noqa: E501
    ...
    post = {
        contract: Account(
            code=bytes.fromhex(
                "5a600055600060006000600060007376fae819612a29489a1a43208613d8f8557b889861ea60f2600155600c600255600c600355600c6004555a60645500"  # noqa: E501
            ),
        ),
    }
