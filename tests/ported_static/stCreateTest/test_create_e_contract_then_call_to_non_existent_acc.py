"""
Ported from:
tests/static/state_tests/stCreateTest/CREATE_EContract_ThenCALLToNonExistentAccFiller.json
"""
...
def test_create_e_contract_then_call_to_non_existent_acc(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=0x3, value=Op.CALL(gas=0xea60, address=0xe1ecf98489fa9ed60a664fc4998db699cfa39d40, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))
    ...
    post = {
        contract: Account(
            storage={0: 0x8d5b6, 1: 0xf1ecf98489fa9ed60a664fc4998db699cfa39d40, 2: 0x7abf8, 3: 1, 100: 0x6f50b},
