            ...
            "01",
            {
                ...
                Address("0xcccccccccccccccccccccccccccccccccccccccc"): Account(
                    ...
                    code=Op.MSTORE(
                        offset=0x100,
                        value=Op.DIV(
                            Op.CALLDATALOAD(offset=0x0), Op.EXP(0x2, 0xF8)
                        ),
                    )
                    + Op.PUSH1[0x15]
                    + Op.CODECOPY(
                        dest_offset=0x300, offset=0x158, size=Op.DUP1
                    )
                    + Op.PUSH2[0x540]
                    + Op.MSTORE
                    + Op.PUSH1[0x6]
                    + Op.CODECOPY(
                        dest_offset=0x200, offset=0x16D, size=Op.DUP1
                    )
                    + Op.PUSH2[0x520]
                    + Op.MSTORE
                    + Op.JUMPI(
                    ...
                    + Op.SSTORE(
                        key=0x12, value=Op.SUB(Op.MLOAD(offset=0x640), 0x1)
                    )
