...
def test_call_contract_to_create_contract_which_would_create_contract_if_called(  # noqa: E501
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "00600060006000600160005461c350f100"
        ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=bytes.fromhex(
                "74600c60005566602060406000f060205260076039f36000526015600b6001f06000556000600060006000600160005461c350f100"  # noqa: E501
            ),
        ),
