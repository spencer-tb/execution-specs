...
def test_raw_call_gas_value_transfer_memory_ask(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "5a600052611f406000611f406000600a73e497cd0909c3691e0b6d2a42e26f36696fc27b"  # noqa: E501
            "a5622dc6c0f1505a6000510360015500"
        ),
    )
    ...
    post = {
        contract: Account(
            storage={1: 32308},
            code=bytes.fromhex(
                "5a600052611f406000611f406000600a73e497cd0909c3691e0b6d2a42e26f36696fc27ba5622dc6c0f1505a6000510360015500"  # noqa: E501
            ),
        ),
        callee: Account(
            storage={2: 0x70AC4},
            code=bytes.fromhex("5a60025500"),
        ),
    }
