...
def test_gas_cost_exp(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=0x0, value=Op.SUB(Op.SUB(Op.MLOAD(offset=0x40), Op.MLOAD(offset=0x60)), Op.MLOAD(offset=0x20)))
        + Op.STOP
    ),
        storage={0x0: 0x60a7},
    )
