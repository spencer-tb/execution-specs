...
def test_raw_ext_code_copy_gas(
    ...
    post = {
        contract: Account(
            storage={1: 2629},
            code=Op.MSTORE(offset=0x0, value=Op.GAS) + Op.EXTCODECOPY(address=0x4a84c43fba78ae75cbc15c5b63caa15da55f4464, dest_offset=0x20, offset=0x0, size=0x14) + Op.SSTORE(key=0x1, value=Op.SUB(Op.MLOAD(offset=0x0), Op.GAS)) + Op.STOP,
        ),
