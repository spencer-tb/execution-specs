...
def test_raw_delegate_call_gas(
    ...
    post = {
        contract: Account(
            storage={1: 24736, 2: 29998},
            code=Op.MSTORE(offset=0x0, value=Op.GAS) + Op.POP(Op.DELEGATECALL(gas=0x7530, address=0xe497cd0909c3691e0b6d2a42e26f36696fc27ba5, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)) + Op.SSTORE(key=0x1, value=Op.SUB(Op.MLOAD(offset=0x0), Op.GAS)) + Op.STOP,
        ),
