...
def test_random_statetest267(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=0xb5a132776d398e3b7c14686a07346f600051, value=0x7f000000000000000000000000945304eb96065b2a98b57a48a06ae28d285a)
    ),
    )
    ...
    post = {
        contract: Account(
            storage={0xb5a132776d398e3b7c14686a07346f600051: 0x7f000000000000000000000000945304eb96065b2a98b57a48a06ae28d285a},
            code=Op.PREVRANDAO + Op.PUSH32[0xc350] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5] + Op.PUSH32[0x0] + Op.SSTORE(key=0xb5a132776d398e3b7c14686a07346f600051, value=0x7f000000000000000000000000945304eb96065b2a98b57a48a06ae28d285a),
        ),
        coinbase: Account(
