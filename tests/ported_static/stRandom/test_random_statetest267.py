...
def test_random_statetest267(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "945304eb96065b2a98b57a48a06ae28d285a71b5a132776d398e3b7c14686a07346f6000"  # noqa: E501
            "5155"
        ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
        coinbase: Account(
            code=bytes.fromhex("6000355415600957005b60203560003555"),
