...
def test_random_statetest245(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffe0469877c39141650434587895560005155"  # noqa: E501
        ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
        coinbase: Account(
            code=bytes.fromhex("6000355415600957005b60203560003555"),
