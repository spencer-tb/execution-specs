...
def test_random_statetest301(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xc350]
        + Op.CALLDATACOPY(dest_offset=Op.PUSH32[0x0], offset=Op.PUSH32[0x0], size=Op.PUSH32[0xc350])
        + Op.DUP5 + Op.SWAP5
    ...
    post = {
        contract: Account(
            storage={0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff: 0x737aa092f1975664518a55},
            code=Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xc350] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xc350] + Op.CALLDATACOPY(dest_offset=Op.PUSH32[0x0], offset=Op.PUSH32[0x0], size=Op.PUSH32[0xc350]) + Op.DUP5 + Op.SWAP5 + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x737aa092f1975664518a55),
        ),
        coinbase: Account(
