...
def test_random_statetest222(
    ...
    pre[contract] = Account(
        ...
        + Op.CODECOPY(dest_offset=Op.NUMBER, offset=Op.PUSH32[0x10000000000000000000000000000000000000000], size=Op.PUSH32[0xc350])
        + Op.PUSH32[0x1] + Op.PUSH32[0x10000000000000000000000000000000000000000]
        + Op.PUSH32[0xc350] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.DUP2)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000001000000000000000000000000000000000000000043397f000000000000"
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.CODECOPY(dest_offset=Op.NUMBER, offset=Op.PUSH32[0x10000000000000000000000000000000000000000], size=Op.PUSH32[0xc350]) + Op.PUSH32[0x1] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xc350] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.DUP2),
        ),
    }
