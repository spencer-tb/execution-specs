...
def test_random_statetest26(
    ...
    contract = Address("0x40c94440235e91bd2d3e4555b8663698dc80d6ca")
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.NUMBER + Op.TIMESTAMP + Op.TIMESTAMP + Op.PREVRANDAO + Op.JUMPDEST
    ...
    post = {
        contract: Account(
            storage={46: 1000},
            code=Op.NUMBER + Op.TIMESTAMP + Op.TIMESTAMP + Op.PREVRANDAO + Op.JUMPDEST + Op.SSTORE(key=Op.SMOD, value=Op.BALANCE(address=Op.COINBASE)),
        ),
        coinbase: Account(
