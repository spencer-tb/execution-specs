...
def test_random_statetest108(
    ...
    contract = Address("0xf3c8d5ea3ce820d6b26253d4d1d9106008c757db")
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.COINBASE + Op.PREVRANDAO
        + Op.RETURN(offset=Op.TIMESTAMP, size=Op.CALLVALUE) + Op.TIMESTAMP
        + Op.COINBASE
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            code=Op.COINBASE + Op.PREVRANDAO + Op.RETURN(offset=Op.TIMESTAMP, size=Op.CALLVALUE) + Op.TIMESTAMP + Op.COINBASE,
        ),
    }
