...
def test_random_statetest356(
    ...
    contract = Address("0x744cd72ca97273b1a4c6495db482d22141b79c36")
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000004f3f701464972e74606d6ea82d4d3080599a0e79827f00000000000000000000"
