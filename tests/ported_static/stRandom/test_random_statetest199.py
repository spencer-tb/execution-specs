...
def test_random_statetest199(
    ...
    contract = Address("0x961ce95e83ad7816d5fec439ea9847ca3a5543c5")
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.ADDRESS + Op.TIMESTAMP + Op.SMOD(Op.NUMBER, Op.GASLIMIT) + Op.TIMESTAMP
    ...
    post = {
        ...
        contract: Account(
            storage={46: 1000},
            code=Op.ADDRESS + Op.TIMESTAMP + Op.SMOD(Op.NUMBER, Op.GASLIMIT) + Op.TIMESTAMP + Op.SSTORE(key=Op.BALANCE(address=Op.COINBASE), value=Op.TIMESTAMP),
        ),
    }
