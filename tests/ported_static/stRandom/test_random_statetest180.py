...
def test_random_statetest180(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x11576b693c128a9e0820609c050a219d)
    ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x1] + Op.PREVRANDAO + Op.PUSH32[0xc350] + Op.PUSH32[0x0] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x11576b693c128a9e0820609c050a219d),
        ),
        coinbase: Account(
