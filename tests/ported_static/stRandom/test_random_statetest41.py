...
def test_random_statetest41(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "945304eb96065b2a98b57a48a06ae28d285a71b56a84a10719a1786a6510349b028255"  # noqa: E501
        ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
        coinbase: Account(
            code=bytes.fromhex("6000355415600957005b60203560003555"),
