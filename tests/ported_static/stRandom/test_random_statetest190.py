...
def test_random_statetest190(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "ffffffffffffffffffffffff0960005155"
        ),
    )
    ...
    post = {
        contract: Account(
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
        coinbase: Account(
            code=bytes.fromhex("6000355415600957005b60203560003555"),
