...
def test_random_statetest190(
    ...
    contract = Address("0x2bf1e46c1ec71ac6066d16a4400ce88ae6ade599")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.MULMOD(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]))
    ),
    )
    ...
    post = {
        contract: Account(
            code=Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x0] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.MULMOD(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])),
        ),
        coinbase: Account(
