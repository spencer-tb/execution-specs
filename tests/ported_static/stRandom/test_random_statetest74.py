...
def test_random_statetest74(
    ...
    pre[contract] = Account(
        ...
        + Op.GASPRICE + Op.PUSH32[0x1000000000000000000000000000000000001000]
        + Op.PUSH32[0x0] + Op.PUSH16[0x141097788a7b5a72139c07076f184255]
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000010000000000000000000000000000000000010007f000000000000000000"
