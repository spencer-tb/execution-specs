...
def test_random_statetest167(
    ...
    contract = Address("0x7deb9d5a0ab7cc3cc567ca833c7da186f1519963")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH32[0x1] + Op.MUL(Op.PUSH32[0x1], Op.NUMBER)
        + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0xa00b875630178a439384941395369e55)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000000000000000000000000000000000000001437f00000000000000"
            "00000000000000000000000000000000000000000000000001027f000000000000000000"
            "0000004f3f701464972e74606d6ea82d4d3080599a0e797fffffffffffffffffffffffff"
            "ffffffffffffffffffffffffffffffffffffffff6fa00b875630178a439384941395369e"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
