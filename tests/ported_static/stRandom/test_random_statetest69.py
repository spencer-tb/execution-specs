...
def test_random_statetest69(
    ...
    pre[contract] = Account(
        ...
        + Op.NUMBER + Op.MSIZE
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x15a0770a7676611a6595057b768b6455)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffffffe43596f15a0770a7676611a6595057b768b64"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0xc350] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x1] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.NUMBER + Op.MSIZE + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x15a0770a7676611a6595057b768b6455),
        ),
    }
