"""
Ported from:
tests/static/state_tests/stRandom/randomStatetest126Filler.json
"""
...
def test_random_statetest126(
    ...
    contract = Address("0x14d62b5f3407c5252cf14978b30aa72f1d70c9b7")
    ...
    pre[contract] = Account(balance=0xde0b6b3a7640000, nonce=0, code=Op.COINBASE + Op.TIMESTAMP)
    ...
    post = {
        contract: Account(code=Op.COINBASE + Op.TIMESTAMP),
        coinbase: Account(
