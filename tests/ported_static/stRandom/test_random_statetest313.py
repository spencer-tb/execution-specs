...
def test_random_statetest313(
    ...
    pre[contract] = Account(
        ...
        + Op.LOG3
        + Op.LOG3(offset=Op.DUP8, size=Op.DUP3, topic_1=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, topic_2=Op.GASLIMIT, topic_3=Op.GASLIMIT)
        + Op.SHA3 + Op.DUP13 + Op.DUP13
    ...
    post = {
        ...
        contract: Account(
            code=Op.SIGNEXTEND + Op.PUSH32[0x1] + Op.EXTCODECOPY + Op.PUSH32[0xc350] + Op.LOG3 + Op.LOG3(offset=Op.DUP8, size=Op.DUP3, topic_1=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, topic_2=Op.GASLIMIT, topic_3=Op.GASLIMIT) + Op.SHA3 + Op.DUP13 + Op.DUP13 + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.GAS),
        ),
    }
