...
def test_random_statetest207(
    ...
    contract = Address("0x91d304e462c8cd746ca0a735a4e921b10cc49fe1")
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.NUMBER + Op.BALANCE(address=Op.COINBASE) + Op.PUSH1[0x43] + Op.SWAP2
        + Op.SSTORE
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            storage={1: 46},
            code=Op.NUMBER + Op.BALANCE(address=Op.COINBASE) + Op.PUSH1[0x43] + Op.SWAP2 + Op.SSTORE,
        ),
    }
