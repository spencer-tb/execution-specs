...
def test_random_statetest154(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.LOG2(offset=0x1ba1, size=0x9d, topic_1=0xb7d0e2328333e94698e0d570db9b316cba0adbae, topic_2=0xb1267c8bba268d1408f7b3e269afee3fea86c5bc8aec8108fd6aaa954f51)
        + Op.ORIGIN
        + Op.CALL(gas=0x5c2491ee, address=0xf8e70c18db2bf1444417c2820af74d3ab1d6a06f, value=0x2de40a27, args_offset=0xf, args_size=0x5, ret_offset=0xd, ret_size=0x4)
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            code=Op.LOG2(offset=0x1ba1, size=0x9d, topic_1=0xb7d0e2328333e94698e0d570db9b316cba0adbae, topic_2=0xb1267c8bba268d1408f7b3e269afee3fea86c5bc8aec8108fd6aaa954f51) + Op.ORIGIN + Op.CALL(gas=0x5c2491ee, address=0xf8e70c18db2bf1444417c2820af74d3ab1d6a06f, value=0x2de40a27, args_offset=0xf, args_size=0x5, ret_offset=0xd, ret_size=0x4),
        ),
    }
