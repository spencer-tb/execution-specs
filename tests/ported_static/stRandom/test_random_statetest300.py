...
def test_random_statetest300(
    ...
    post = {
        ...
        contract: Account(
            code=Op.PUSH32[0x0] + Op.PREVRANDAO + Op.PUSH32[0xc350] + Op.PUSH22[0x7f000000000000000000000000000000000000000000] + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.STOP + Op.ADD + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.PUSH32[0xc350]),
        ),
    }
