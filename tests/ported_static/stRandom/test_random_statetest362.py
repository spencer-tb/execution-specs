...
def test_random_statetest362(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.SSTORE(key=Op.MULMOD(Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5], 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff), value=0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffe7f000000000000000000000000945304eb96065b2a"
    ...
    post = {
        contract: Account(
            storage={0xffffffffffffffffffffffff6bacfb1469f9a4d5674a85b75f951d72d7a58e4a: 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe},
            code=Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.SSTORE(key=Op.MULMOD(Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5], 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff), value=0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe),
        ),
        coinbase: Account(
