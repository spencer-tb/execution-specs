...
def test_random_statetest73(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x0] + Op.PUSH32[0xc350] + Op.PUSH32[0x1]
        + Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5]
        + Op.SSTORE(key=0xb5b573198d729b711671056e0a0555346138, value=0x7f000000000000000000000000945304eb96065b2a98b57a48a06ae28d285a)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00945304eb96065b2a98b57a48a06ae28d285a71b57e7f00000000000000000000000094"
            "5304eb96065b2a98b57a48a06ae28d285a71b5b573198d729b711671056e0a0555346138"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
    ...
    post = {
        contract: Account(
            storage={0xb5b573198d729b711671056e0a0555346138: 0x7f000000000000000000000000945304eb96065b2a98b57a48a06ae28d285a},
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x0] + Op.PUSH32[0xc350] + Op.PUSH32[0x1] + Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5] + Op.SSTORE(key=0xb5b573198d729b711671056e0a0555346138, value=0x7f000000000000000000000000945304eb96065b2a98b57a48a06ae28d285a),
        ),
        coinbase: Account(
