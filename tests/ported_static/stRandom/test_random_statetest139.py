...
def test_random_statetest139(
    ...
    pre[contract] = Account(
        ...
        + Op.PREVRANDAO + Op.SSTORE(key=Op.GASLIMIT, value=Op.ISZERO(0x3345))
    ...
    post = {
        ...
        contract: Account(
            storage={0: 0x20000},
            code=Op.CALLER + Op.PREVRANDAO + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xc350] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.NUMBER + Op.PREVRANDAO + Op.SSTORE(key=Op.GASLIMIT, value=Op.ISZERO(0x3345)) + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
    }
