...
def test_random_statetest117(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x8aa4a4980274f18c6158368d41571455)
    ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=Op.PREVRANDAO + Op.PUSH32[0x1] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.TIMESTAMP + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x8aa4a4980274f18c6158368d41571455),
        ),
        coinbase: Account(
