...
def test_random_statetest156(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x813982583141966b389c159aa48b3a88)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000000000c3506f813982583141966b389c159aa48b3a88"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
    ...
    post = {
        contract: Account(
            ...
            code=Op.PUSH32[0x0] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xc350] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xc350] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x813982583141966b389c159aa48b3a88),
        ),
        coinbase: Account(
