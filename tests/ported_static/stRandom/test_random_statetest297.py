...
def test_random_statetest297(
    ...
    contract = Address("0x63b282b5df9618a0f5c8b782f7286eb615a43b27")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.TIMESTAMP
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x91085661509214157d9c8a7775851855)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffffffffe426f91085661509214157d9c8a77758518"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.NUMBER + Op.PUSH32[0x0] + Op.PUSH32[0x0] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.TIMESTAMP + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x91085661509214157d9c8a7775851855),
        ),
    }
