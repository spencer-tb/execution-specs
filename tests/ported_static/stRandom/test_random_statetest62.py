...
def test_random_statetest62(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x1]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x7268713013964a96ac57580433250155)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffffffffff437f000000000000000000000000ff"
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0x0] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.NUMBER + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x1] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x7268713013964a96ac57580433250155),
        ),
    }
