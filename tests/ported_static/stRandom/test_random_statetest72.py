...
def test_random_statetest72(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
        + Op.DIV(Op.SGT(Op.MULMOD(0x688dff579830, 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]), Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]), Op.COINBASE)
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.DIV(Op.SGT(Op.MULMOD(0x688dff579830, 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]), Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]), Op.COINBASE),
        ),
    }
