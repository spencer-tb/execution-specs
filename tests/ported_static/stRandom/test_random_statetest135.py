...
def test_random_statetest135(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffff0075a0b64319218663016870455"
        ),
    )
    ...
    post = {
        ...
        contract: Account(
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
    }
