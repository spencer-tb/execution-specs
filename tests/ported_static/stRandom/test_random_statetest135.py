...
def test_random_statetest135(
    ...
    pre[contract] = Account(
        ...
        + Op.COINBASE
        + Op.SSTORE(key=Op.DIV(Op.DUP8, Op.AND(0x3192186630, Op.SIGNEXTEND(Op.GAS, Op.SMOD(Op.CREATE(value=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, offset=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], size=Op.PUSH32[0x0]), Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79])))), value=Op.PUSH32[0x0])
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            code=Op.PUSH32[0xc350] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.COINBASE + Op.SSTORE(key=Op.DIV(Op.DUP8, Op.AND(0x3192186630, Op.SIGNEXTEND(Op.GAS, Op.SMOD(Op.CREATE(value=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, offset=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], size=Op.PUSH32[0x0]), Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79])))), value=Op.PUSH32[0x0]),
        ),
    }
