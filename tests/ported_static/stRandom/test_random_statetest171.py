...
def test_random_statetest171(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffffffffffe095560005155"
        ),
    )
    ...
    post = {
        ...
        contract: Account(
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
    }
