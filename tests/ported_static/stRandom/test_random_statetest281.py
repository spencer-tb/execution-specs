...
def test_random_statetest281(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x649a7a3457645670a27fa170639718a2)
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.GASLIMIT + Op.PUSH32[0xc350] + Op.COINBASE + Op.PUSH32[0x1] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x649a7a3457645670a27fa170639718a2),
        ),
    }
