...
def test_random_statetest39(
    ...
    contract = Address("0x1321a8bef07739a53dc17cdbe4e7da245ab5e3cb")
    ...
    pre[contract] = Account(
        ...
        + Op.SWAP7 + Op.SSTORE(key=Op.SUB(Op.PC, 0x8ea2179a), value=Op.DIV)
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffffffffffffffffffffff427f00000000000000"
    ...
    post = {
        contract: Account(
            storage={0: 0x10000000000000000000000000000000000000000, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff715de955: 0x14f8b588e368f08461f9f01b866e43aa79bbadc0980b242070b8cfbfc6540},
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.TIMESTAMP + Op.PUSH32[0x1] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xc350] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.SWAP7 + Op.SSTORE(key=Op.SUB(Op.PC, 0x8ea2179a), value=Op.DIV) + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
        coinbase: Account(
