"""
Ported from:
tests/static/state_tests/stRandom/randomStatetest252Filler.json
"""
...
def test_random_statetest252(
    ...
    contract = Address("0xcb10591583644b914d53d1d9538866320d00bad3")
    ...
    post = {
        ...
        contract: Account(code=bytes.fromhex("387b414543444043899e863a628b55")),
    }
