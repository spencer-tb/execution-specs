...
def test_random_statetest216(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xc350]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x766d67fe07853208991306449455)
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0x0] + Op.PUSH32[0xc350] + Op.PUSH32[0xc350] + Op.PREVRANDAO + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xc350] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xc350] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x766d67fe07853208991306449455),
        ),
    }
