...
def test_random_statetest83(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0xa1109af20740728e72150a7a9c095955)
    ),
    )
