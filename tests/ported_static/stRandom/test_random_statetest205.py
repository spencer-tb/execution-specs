...
def test_random_statetest205(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.CALLER + Op.LOG0(offset=0xedef, size=0xb2) + Op.ORIGIN
