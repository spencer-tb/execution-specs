...
def test_random_statetest42(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.BYTE(0x36f0f11901, Op.CALLDATALOAD(offset=Op.PUSH32[0xc350])), value=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])
    ...
    post = {
        contract: Account(
            ...
            code=Op.PUSH32[0xc350] + Op.PUSH32[0xc350] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xc350] + Op.GAS + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.SSTORE(key=Op.BYTE(0x36f0f11901, Op.CALLDATALOAD(offset=Op.PUSH32[0xc350])), value=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]) + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
        coinbase: Account(
