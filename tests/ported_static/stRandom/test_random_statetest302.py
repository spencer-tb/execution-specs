...
def test_random_statetest302(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.SWAP8 + Op.BYTE
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PREVRANDAO
        + Op.PUSH32[0x0] + Op.PUSH10[0x89206c0b8a01867bf155]
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000010000000000000000000000000000000000000000971a7f000000000000"
            "000000000000ffffffffffffffffffffffffffffffffffffffff447f0000000000000000"
            "0000000000000000000000000000000000000000000000006989206c0b8a01867bf1"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
    ...
    post = {
        ...
        contract: Account(
            code=Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.SWAP8 + Op.BYTE + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PREVRANDAO + Op.PUSH32[0x0] + Op.PUSH10[0x89206c0b8a01867bf155],
        ),
    }
