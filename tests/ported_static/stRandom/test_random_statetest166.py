...
def test_random_statetest166(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x1] + Op.PUSH32[0xc350] + Op.GASLIMIT
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x8eb7099d9f160532785143c5937e1855)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000ffffffffffffffffffffffffffffffffffffffff817f00000000"
            "00000000000000010000000000000000000000000000000000000000417f000000000000"
            "00000000000000000000000000000000000000000000000000017f000000000000000000"
            "000000000000000000000000000000000000000000c350456f8eb7099d9f160532785143"
            "c5937e18"
        ),
        gas_limit=100000,
        gas_price=10,
    ...
    post = {
        contract: Account(
            ...
            code=Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.DUP2 + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.COINBASE + Op.PUSH32[0x1] + Op.PUSH32[0xc350] + Op.GASLIMIT + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x8eb7099d9f160532785143c5937e1855),
        ),
        coinbase: Account(
