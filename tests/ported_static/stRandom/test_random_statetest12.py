...
def test_random_statetest12(
    ...
    pre[contract] = Account(
        ...
        + Op.GASLIMIT
        + Op.MUL(Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79], 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe)
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x165490a41215369ef276037941163355)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffffffffffffffffffffff457fffffffffffffff"
            "fffffffffffffffffffffffffffffffffffffffffffffffffe7f00000000000000000000"
            "00004f3f701464972e74606d6ea82d4d3080599a0e79027f000000000000000000000000"
            "ffffffffffffffffffffffffffffffffffffffff6f165490a41215369ef2760379411633"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.GASLIMIT + Op.MUL(Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79], 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe) + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x165490a41215369ef276037941163355),
        ),
    }
