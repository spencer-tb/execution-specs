...
def test_random_statetest29(
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH32[0x0]
        + Op.SSTORE(key=Op.MULMOD(Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, Op.ADDMOD(Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], Op.PUSH32[0x0], Op.PUSH32[0x10000000000000000000000000000000000000000])), value=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00ffffffffffffffffffffffffffffffffffffffff087fffffffffffffffffffffffffff"
