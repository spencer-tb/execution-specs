...
def test_random_statetest63(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "0000000000000000000000006f977f157e088003767a86928e8252965560005155"  # noqa: E501
        ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
        coinbase: Account(
            code=bytes.fromhex("6000355415600957005b60203560003555"),
