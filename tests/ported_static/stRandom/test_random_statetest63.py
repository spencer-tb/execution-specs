...
def test_random_statetest63(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x977f157e088003767a86928e82529655)
    ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=Op.PUSH32[0x0] + Op.PUSH32[0xc350] + Op.PUSH32[0x0] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xc350] + Op.PUSH32[0x0] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x977f157e088003767a86928e82529655),
        ),
        coinbase: Account(
