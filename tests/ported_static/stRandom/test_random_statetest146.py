...
def test_random_statetest146(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.NUMBER + Op.TIMESTAMP + Op.NUMBER + Op.NUMBER + Op.PREVRANDAO
        + Op.PREVRANDAO + Op.TIMESTAMP + Op.POP(Op.NUMBER)
    ...
    post = {
        ...
        contract: Account(
            code=Op.NUMBER + Op.TIMESTAMP + Op.NUMBER + Op.NUMBER + Op.PREVRANDAO + Op.PREVRANDAO + Op.TIMESTAMP + Op.POP(Op.NUMBER) + Op.EXP(Op.CALLCODE, Op.EQ(Op.CALLDATASIZE, Op.ADDRESS)),
        ),
    }
