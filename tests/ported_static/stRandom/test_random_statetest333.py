...
def test_random_statetest333(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x410263f305963310856c15ff5037a055)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000004f3f701464972e74606d6ea82d4d3080599a0e79457fffffffffffffffffffff"
            "ffffffffffffffffffffffffffffffffffffffffffff6f410263f305963310856c15ff50"
            "37a0"
        ),
        gas_limit=100000,
        gas_price=10,
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0xc350] + Op.PUSH32[0xc350] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.GASLIMIT + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x410263f305963310856c15ff5037a055),
        ),
    }
