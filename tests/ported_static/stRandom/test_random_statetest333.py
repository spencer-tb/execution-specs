...
def test_random_statetest333(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x1000000000000000000000000000000000001000] + Op.GASLIMIT
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.PUSH16[0x410263f305963310856c15ff5037a055] + Op.PUSH1[0x0] + Op.MLOAD
        + Op.SSTORE
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000001000000000000000000000000000000000001000457fffffffffffffffffffff"
