...
def test_random_statetest169(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x1]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe)
    ),
    )
