...
def test_random_statetest231(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH16[0x7b98a491727a089df3365353329e8055] + Op.PUSH1[0x0] + Op.MLOAD
        + Op.SSTORE
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000c3507f0000000000000000000000001000000000000000"
            "0000000000000000000010006f7b98a491727a089df3365353329e80"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
