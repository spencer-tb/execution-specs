...
def test_random_statetest287(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.SMOD + Op.MSIZE
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "701464972e74606d6ea82d4d3080599a0e79ff7f00000000000000000000000100000000"
    ...
    post = {
        contract: Account(
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x1] + Op.PUSH32[0x0] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.SELFDESTRUCT(address=Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]) + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.SMOD + Op.MSIZE,
        ),
        coinbase: Account(
