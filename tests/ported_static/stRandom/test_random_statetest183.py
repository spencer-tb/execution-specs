...
def test_random_statetest183(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH32[0xc350] + Op.PUSH32[0xc350] + Op.PUSH32[0xc350]
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.NUMBER
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x4134547075687854849d7b6465863055)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "004f3f701464972e74606d6ea82d4d3080599a0e79436f4134547075687854849d7b6465"
            "8630"
        ),
        gas_limit=100000,
        gas_price=10,
    ...
    post = {
        contract: Account(
            ...
            code=Op.PUSH32[0xc350] + Op.PUSH32[0xc350] + Op.PUSH32[0xc350] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.NUMBER + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x4134547075687854849d7b6465863055),
        ),
        coinbase: Account(
