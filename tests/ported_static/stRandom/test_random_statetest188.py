...
def test_random_statetest188(
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xc350] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.DUP2 + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.TIMESTAMP + Op.DUP7 + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x7859f3837971879455),
        ),
    }
