...
def test_random_statetest188(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffffff4286687859f383797187945560005155"  # noqa: E501
        ),
    )
    ...
    post = {
        ...
        contract: Account(
            storage={0: 0x7859F3837971879455},
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
    }
