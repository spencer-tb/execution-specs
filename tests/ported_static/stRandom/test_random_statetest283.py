...
def test_random_statetest283(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000ffffffffffffffffffffffffffffffffffffffff457fffffffff"
    ...
    post = {
        ...
        contract: Account(
            storage={0: 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe},
            code=Op.PUSH32[0x0] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.GASLIMIT + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.CODECOPY(dest_offset=Op.PUSH32[0x1], offset=Op.PUSH32[0x10000000000000000000000000000000000000000], size=Op.PUSH32[0xc350]) + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
    }
