...
def test_random_statetest212(
    ...
    contract = Address("0x4fcdeb59ea62ab23fbabb8475cc6b4d9a7b4ef10")
    ...
    pre[contract] = Account(
        ...
        + Op.SELFDESTRUCT(address=Op.ADDMOD(Op.MULMOD(Op.XOR(Op.MOD(0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]), Op.PUSH32[0x1]), 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe), Op.PUSH32[0x1], Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]))
        + Op.SSTORE(key=Op.MLOAD(offset=0xf28e61990a52556000), value=Op.GASPRICE)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0000000000000000000000000000000000017f000000000000000000000000ffffffffff"
    ...
    post = {
        ...
        contract: Account(
            code=Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.SELFDESTRUCT(address=Op.ADDMOD(Op.MULMOD(Op.XOR(Op.MOD(0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]), Op.PUSH32[0x1]), 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe), Op.PUSH32[0x1], Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79])) + Op.SSTORE(key=Op.MLOAD(offset=0xf28e61990a52556000), value=Op.GASPRICE),
        ),
    }
