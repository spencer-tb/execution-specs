...
def test_random_statetest380(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x1]
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x967737653485593c63408b3994397555)
    ),
    )
