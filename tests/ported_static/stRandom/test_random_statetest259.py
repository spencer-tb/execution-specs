...
def test_random_statetest259(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xc350]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x4831adc0812f0954492740790070955)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000000000000000000000000000000001587fffffffffffffffffffff"
            "ffffffffffffffffffffffffffffffffffffffffffff7f00000000000000000000000000"
            "0000000000000000000000000000000000c3506f04831adc0812f09544927407900709"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
