...
def test_random_statetest6(
    ...
    pre[contract] = Account(
        ...
        + Op.NUMBER + Op.COINBASE
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x1732797105f237768fe506871ac85355)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "004f3f701464972e74606d6ea82d4d3080599a0e794143416f1732797105f237768fe506"
            "871ac853"
        ),
        gas_limit=100000,
        gas_price=10,
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0x1] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.COINBASE + Op.NUMBER + Op.COINBASE + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x1732797105f237768fe506871ac85355),
        ),
    }
