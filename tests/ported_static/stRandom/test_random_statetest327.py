...
def test_random_statetest327(
    ...
    contract = Address("0x85f19e026a6f76db9583e20941653f5e029c9671")
    ...
    post = {
        ...
        contract: Account(
            code=bytes.fromhex(""),
        ),
    }
