...
def test_random_statetest347(
    ...
    tx = Transaction(
        secret_key=Hash(
            "0x1f2f6944f70460e655546d414267bd3491a2dd9dafb2280605404c858990d053"  # noqa: E501
        ),
        to=contract,
        data=bytes.fromhex(
    ...
    post = {
        ...
        contract: Account(
            code=(
                ...
                + Op.PUSH9[0xBBE30EC5D1E6B85402]
                + Op.PUSH25[
                    0x62CFCBEA15E8367DFAA080EE0DA2B0D2CA892F5A7643543704
                ]
                + Op.PUSH7[0xCCDDD03115EC8A]
                + Op.PUSH27[
                    0xD2E6C62C29425A45EC842FB74C369FB15A42E4B4E48B3EB70BE2A0
                ...
                + Op.PUSH21[0x69987980E6EAA539365A491D2366334F78F03ACB17]
                + Op.PUSH25[
                    0x9E7525ADD39A234D3D2EF1CF8544A52389411EF846D3CD7F3
                ]
                + Op.PUSH14[0xD1DB7F414860020171F07598CFB]
                + Op.PUSH3[0xE15A9]
                + Op.PUSH9[0x1C843D60AEE9FB8A4E]
                ...
                + Op.PUSH15[0xE0601677961DA7EBAD5F583F6EB6DA]
                + Op.PUSH29[
                    0x8348425FE784F532F288963CCDBF9DE3AC3EBC38B75A806B40E51B895C  # noqa: E501
                ]
                + Op.PUSH7[0x2D0BCAB255A04B]
                + Op.PUSH19[0x3F1E500517D17EB720E02F445CB046BD0FE7D2]
                + Op.PUSH22[0x9438C79AA2DFCAEF1CF57E4EB9C832F7EF449A9C32F6]
                ...
                + Op.PUSH26[
                    0x478808A236DEEFD761DF6BC151FDED80BBE4BA725E7DB7B9FC50
                ]
                + Op.PUSH32[
                    0xB8121A009384C7BC4443747BD1AC9DC7682B32BEC0937C7FB27BA3926ACD0D6  # noqa: E501
                ]
                ...
                + Op.PUSH11[0x56DAA511E7E693AAB3D434]
                + Op.PUSH29[
                    0xEBDD5B63238ACDEEDC3D8EB8F69EA18CB429EE8F09C26845507BA28EBA  # noqa: E501
                ]
                + Op.SWAP2
                + Op.PUSH13[0x74FD62CD9E587A8F013122D935]
                + Op.PUSH26[
                    0xB6B7DA091527251A4B70051BE4F0F96F61E5DC4AB713C473174C
                ]
                + Op.PUSH31[
                    0x2EBB463615B03C4787B74E8C204975399439FA553838F186AE028A47F3CCD4  # noqa: E501
                ]
                ...
                + Op.PUSH30[
                    0x761836EF5761178BD07FDE9A0DED16E1659A6C80281C259CE42E3FDBE236  # noqa: E501
                ]
                + Op.PUSH5[0xCE783B58D5]
                + Op.SWAP6
            ),
