...
def test_random_statetest100(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.COINBASE + Op.TIMESTAMP
        + Op.SSTORE(key=Op.PREVRANDAO, value=Op.CALLCODE(gas=Op.DUP4, address=Op.TIMESTAMP, value=Op.PREVRANDAO, args_offset=Op.TIMESTAMP, args_size=Op.NUMBER, ret_offset=Op.PREVRANDAO, ret_size=Op.NUMBER))
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            storage={0x20000: 1},
            code=Op.COINBASE + Op.TIMESTAMP + Op.SSTORE(key=Op.PREVRANDAO, value=Op.CALLCODE(gas=Op.DUP4, address=Op.TIMESTAMP, value=Op.PREVRANDAO, args_offset=Op.TIMESTAMP, args_size=Op.NUMBER, ret_offset=Op.PREVRANDAO, ret_size=Op.NUMBER)),
        ),
    }
