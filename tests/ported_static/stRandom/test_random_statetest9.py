...
def test_random_statetest9(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x757fb845405bf1ff959ba03a9c336b55)
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0xc350] + Op.PUSH32[0x1] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x1] + Op.PUSH32[0x1] + Op.PUSH32[0x1] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x757fb845405bf1ff959ba03a9c336b55),
        ),
    }
