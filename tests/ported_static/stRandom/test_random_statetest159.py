...
def test_random_statetest159(
    ...
    pre[contract] = Account(
        ...
        + Op.CALL(gas=0x39570738, address=0xbadab8ec78e07cdbb4b25f913769fea51e5a9c2a, value=0x4b1e2f2, args_offset=0x13, args_size=0x7, ret_offset=0xb, ret_size=0x1e)
        + Op.SSTORE(key=0xcbd00120239df2d03db2fdd9c233df848ead9d3c84d4, value=0xf327f570c11aa84a7a5480b98c51)
