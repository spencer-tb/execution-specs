...
def test_random_statetest384(
    ...
    post = {
        contract: Account(
            ...
            code=(
                Op.EXTCODESIZE(
                    address=0x6675A4758D443DBFF535F034A4EDA729A6FFC1E59F674E0C55,  # noqa: E501
                )
                + Op.PUSH6[0x5D7974272AC7]
                + Op.AND(0xFFFF, 0x18CE2014249172572ED5EAC0B9D2E4)
                + Op.SWAP1
                ...
                + Op.PUSH25[
                    0x89CC6512F8D604E5D0656C17F2D45B916DF6816A1999719F2B
                ]
                + Op.JUMPI(
                    pc=Op.ADD(0x8, Op.PC),
                    condition=Op.AND(
                        0x1, 0xD521394F07100138B341F1DEBC06C3FB3CBC
                    ),
                )
                + Op.POP(0xCB)
                + Op.JUMPDEST
                ...
                + Op.SWAP7
                + Op.PUSH25[
                    0x996410D0BF28E5E3E1B35B37FFCE70E346E013D5345494D476
                ]
                + Op.SWAP1
                + Op.CALLER
                + Op.TIMESTAMP
