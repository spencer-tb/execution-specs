...
def test_random_statetest339(
    ...
    contract = Address("0x978dd1566835c8ad84120731b668015399eabe79")
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH32[0x1] + Op.PUSH32[0x0] + Op.PUSH32[0x1] + Op.PUSH32[0x0]
        + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79]
        + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x0]
        + Op.PUSH32[0xc350]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x89029e850708a293905668f1a367a255)
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "004f3f701464972e74606d6ea82d4d3080599a0e797f0000000000000000000000010000"
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0x1] + Op.PUSH32[0x0] + Op.PUSH32[0x1] + Op.PUSH32[0x0] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x0] + Op.PUSH32[0xc350] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x89029e850708a293905668f1a367a255),
        ),
    }
