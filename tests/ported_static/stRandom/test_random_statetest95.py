...
def test_random_statetest95(
    ...
    pre[contract] = Account(
        ...
        code=(
        Op.PUSH32[0x0]
        + Op.EQ(Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])
        + Op.PREVRANDAO
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.JUMPDEST + Op.MLOAD(offset=0x0) + Op.SSTORE
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000ffffffffffffffffffffffffffffffffffffffff14447fffffffffffff"
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0x0] + Op.EQ(Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]) + Op.PREVRANDAO + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.JUMPDEST + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
    }
