...
def test_random_statetest95(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffffffffffffff5b60005155"
        ),
    )
    ...
    post = {
        ...
        contract: Account(
            ...
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
    }
