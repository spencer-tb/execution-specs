...
def test_random_statetest372(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "000000000000000000000001180860005155"
        ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
        coinbase: Account(
            code=bytes.fromhex("6000355415600957005b60203560003555"),
