...
def test_random_statetest16(
    ...
    pre[contract] = Account(
        ...
        "000000000000000000000000000000000000000000000000557f00000000000000000000"
    ...
    post = {
        ...
        contract: Account(
            code=bytes.fromhex(""),
        ),
    }
