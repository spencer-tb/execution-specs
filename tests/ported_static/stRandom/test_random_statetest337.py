...
def test_random_statetest337(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH32[0x1] + Op.PUSH32[0xc350] + Op.PUSH32[0x1] + Op.PUSH32[0x1]
        + Op.PUSH32[0x1]
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0x1] + Op.PUSH32[0xc350] + Op.PUSH32[0x1] + Op.PUSH32[0x1] + Op.PUSH32[0x1] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xc350] + Op.SSTORE(key=0xb9af27e9a6468a1, value=Op.PUSH32[0xc350]) + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
    }
