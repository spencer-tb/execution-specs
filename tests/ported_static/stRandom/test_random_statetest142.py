...
def test_random_statetest142(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.SWAP6 + Op.SWAP2 + Op.CALLDATACOPY + Op.PUSH4[0x364087e]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.ADD(0x431107c88, Op.BYTE))
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            storage={0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff: 0x431107c88},
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xc350] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0x1] + Op.PUSH32[0x1] + Op.PUSH32[0x0] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.SWAP6 + Op.SWAP2 + Op.CALLDATACOPY + Op.PUSH4[0x364087e] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.ADD(0x431107c88, Op.BYTE)),
        ),
    }
