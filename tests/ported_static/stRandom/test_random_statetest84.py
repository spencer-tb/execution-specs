...
def test_random_statetest84(
    ...
    post = {
        contract: Account(
            code=Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PREVRANDAO + Op.XOR(Op.PUSH32[0x1], Op.GASLIMIT) + Op.MSTORE(offset=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, value=Op.PUSH32[0x1]) + Op.SSTORE(key=Op.MSIZE, value=Op.ISZERO),
        ),
        coinbase: Account(
