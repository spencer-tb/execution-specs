...
def test_random_statetest338(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MOD(Op.NOT(Op.ADD(0x7a9df32e6851606c, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])), Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]), value=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffffffffffffe7f000000000000000000000000ffff"
    ...
    post = {
        contract: Account(
            storage={0: 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, 0xffffffff85620cd197ae9f93: 0xffffffffffffffffffffffffffffffffffffffff},
            code=Op.PUSH32[0x1] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.SSTORE(key=Op.MOD(Op.NOT(Op.ADD(0x7a9df32e6851606c, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])), Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]), value=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]) + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
        coinbase: Account(
