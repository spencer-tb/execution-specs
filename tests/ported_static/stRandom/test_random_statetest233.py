...
def test_random_statetest233(
    ...
    pre[contract] = Account(
        ...
        + Op.DUP2
        + Op.SDIV(Op.TIMESTAMP, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff)
        + Op.MLOAD(offset=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])
    ...
    post = {
        contract: Account(
            code=Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.DUP2 + Op.SDIV(Op.TIMESTAMP, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff) + Op.MLOAD(offset=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]) + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH6[0x715460005155],
        ),
        coinbase: Account(
