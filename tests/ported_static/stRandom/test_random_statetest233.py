...
def test_random_statetest233(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "0000000000000001000000000000000000000000000000000000000065715460005155"  # noqa: E501
        ),
    )
    ...
    post = {
        contract: Account(
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
        coinbase: Account(
            code=bytes.fromhex("6000355415600957005b60203560003555"),
