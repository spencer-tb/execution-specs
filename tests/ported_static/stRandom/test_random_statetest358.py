...
def test_random_statetest358(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x679b82a092078f136b5541888c057a55)
    ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.COINBASE + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.NUMBER + Op.PUSH32[0xc350] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x679b82a092078f136b5541888c057a55),
        ),
        coinbase: Account(
