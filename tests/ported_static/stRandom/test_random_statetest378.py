...
def test_random_statetest378(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xc350] + Op.PUSH32[0x0] + Op.GAS + Op.PUSH32[0x1]
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x855b445834721a5706f2891711f00255)
    ),
    )
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(
            "7f000000000000000000000000ffffffffffffffffffffffffffffffffffffffff547f00"
            ...
            "000000000000000000000000000000000000000000005a7f000000000000000000000000"
            "00000000000000000000000000000000000000016f855b445834721a5706f2891711f002"
        ),
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.SLOAD(key=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]) + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x1] + Op.PUSH32[0xc350] + Op.PUSH32[0x0] + Op.GAS + Op.PUSH32[0x1] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x855b445834721a5706f2891711f00255),
        ),
    }
