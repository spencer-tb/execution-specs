...
def test_random_statetest31(
    ...
    contract = Address("0xf96aa31000bb2a6b92f34b6a9f626a5da00bf714")
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.CODESIZE + Op.PUSH32[0x10000000000000000000000000000000000000000]
        + Op.PUSH32[0xc350] + Op.PUSH32[0xc350]
        + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xc350]
        + Op.PUSH32[0x0] + Op.PUSH32[0x0] + Op.SWAP1 + Op.CALLDATACOPY + Op.SSTORE
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(
            "387f00000000000000000000000100000000000000000000000000000000000000007f00"
    ...
    post = {
        ...
        contract: Account(
            storage={0x10000000000000000000000000000000000000000: 50000, 0x387f000000000000000000000001000000000000000000000000000000000000: 50000},
            code=Op.CODESIZE + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xc350] + Op.PUSH32[0xc350] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xc350] + Op.PUSH32[0x0] + Op.PUSH32[0x0] + Op.SWAP1 + Op.CALLDATACOPY + Op.SSTORE + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
    }
