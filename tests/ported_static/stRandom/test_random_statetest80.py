...
def test_random_statetest80(
    ...
    pre[contract] = Account(
        ...
        + Op.GT(Op.PUSH32[0x10000000000000000000000000000000000000000], Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5])
        + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff]
        + Op.SSTORE(key=0xb5681069127b3b9c877d6f6169ff36600051, value=0x7f000000000000000000000000945304eb96065b2a98b57a48a06ae28d285a)
    ),
    )
    ...
    post = {
        contract: Account(
            storage={0xb5681069127b3b9c877d6f6169ff36600051: 0x7f000000000000000000000000945304eb96065b2a98b57a48a06ae28d285a},
            code=Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5] + Op.PUSH32[0xc350] + Op.GT(Op.PUSH32[0x10000000000000000000000000000000000000000], Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5]) + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.SSTORE(key=0xb5681069127b3b9c877d6f6169ff36600051, value=0x7f000000000000000000000000945304eb96065b2a98b57a48a06ae28d285a),
        ),
        coinbase: Account(
