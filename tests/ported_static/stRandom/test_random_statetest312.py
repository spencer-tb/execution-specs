...
def test_random_statetest312(
    ...
    contract = pre.deploy_contract(
        code=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffffffffffffffff427f00000000000000000000"  # noqa: E501
        ...
        nonce=0,
        address=Address("0xa7a903566abeab1b0a9eb4f54909e6b00848a2a6"),  # noqa: E501
    )
