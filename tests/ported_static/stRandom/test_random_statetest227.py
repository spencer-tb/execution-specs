...
def test_random_statetest227(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "701464972e74606d6ea82d4d3080599a0e796f108fa27475689e44993a528752a1523359"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
    ...
    post = {
        contract: Account(
            ...
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x0] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x1] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.SSTORE(key=Op.MSIZE, value=0x108fa27475689e44993a528752a15233),
        ),
        coinbase: Account(
