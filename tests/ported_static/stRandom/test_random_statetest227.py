...
def test_random_statetest227(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH16[0x108fa27475689e44993a528752a15233] + Op.MSIZE + Op.SSTORE
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0000000000000000000000000000000000000000017f0000000000000000000000001000"
            "0000000000000000000000000000000010006f108fa27475689e44993a528752a1523359"
        ),
        gas_limit=100000,
        gas_price=10,
        nonce=0,
