...
def test_random_statetest1(
    ...
    post = {
        contract: Account(
            code=Op.GASLIMIT + Op.GASLIMIT + Op.CALLCODE(gas=Op.MSIZE, address=Op.TIMESTAMP, value=Op.PREVRANDAO, args_offset=Op.COINBASE, args_size=Op.NUMBER, ret_offset=Op.COINBASE, ret_size=Op.NUMBER),
        ),
        coinbase: Account(
