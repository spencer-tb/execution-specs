...
def test_random_statetest137(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "945304eb96065b2a98b57a48a06ae28d285a71b5a130e86ca17390989355f092a2556000"  # noqa: E501
            "5155"
        ),
    )
    ...
    post = {
        contract: Account(
            ...
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
        coinbase: Account(
            code=bytes.fromhex("6000355415600957005b60203560003555"),
