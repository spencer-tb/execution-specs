...
def test_random_statetest137(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.ADDMOD(Op.PUSH32[0x0], Op.PUSH32[0x0], Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])
        + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x1]
        + Op.SSTORE(key=0xb5a130e86ca17390989355f092a255600051, value=0x7f000000000000000000000000945304eb96065b2a98b57a48a06ae28d285a)
    ),
    )
    ...
    post = {
        contract: Account(
            storage={0xb5a130e86ca17390989355f092a255600051: 0x7f000000000000000000000000945304eb96065b2a98b57a48a06ae28d285a},
            code=Op.ADDMOD(Op.PUSH32[0x0], Op.PUSH32[0x0], Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]) + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x1] + Op.SSTORE(key=0xb5a130e86ca17390989355f092a255600051, value=0x7f000000000000000000000000945304eb96065b2a98b57a48a06ae28d285a),
        ),
        coinbase: Account(
