...
def test_random_statetest158(
    ...
    contract = Address("0xfa9512ffc9c4019c1680c63c1285d623d6579c46")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.POP(Op.NUMBER) + Op.MLOAD(offset=0x0) + Op.SSTORE
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0000000000000000000000000000000000017f0000000000000000000000010000000000"
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x1] + Op.PUSH32[0x1] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.POP(Op.NUMBER) + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
    }
