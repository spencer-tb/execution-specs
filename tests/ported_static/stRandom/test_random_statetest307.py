...
def test_random_statetest307(
    ...
    post = {
        contract: Account(
            code=Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5] + Op.PUSH32[0xc350] + Op.SLOAD(key=Op.PUSH32[0x945304eb96065b2a98b57a48a06ae28d285a71b5]) + Op.PUSH32[0xc350] + Op.CALLDATACOPY(dest_offset=Op.PUSH32[0x0], offset=Op.PUSH32[0x0], size=Op.PUSH32[0xc350]) + Op.CREATE + Op.SSTORE,
        ),
        coinbase: Account(
