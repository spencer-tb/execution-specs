...
def test_random_statetest292(
    ...
    contract = Address("0x6f333ed29ba1f098ba2b1f681f8e6131c7f3d2c2")
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0xc350]
        + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe]
        + Op.PUSH32[0x1] + Op.ADDRESS + Op.PUSH4[0xa09c825a] + Op.CALLER + Op.DUP15
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000004f3f701464972e74606d6ea82d4d3080599a0e79417f00000000000000000000"
    ...
    post = {
        ...
        contract: Account(
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.COINBASE + Op.PUSH32[0xc350] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x1] + Op.ADDRESS + Op.PUSH4[0xa09c825a] + Op.CALLER + Op.DUP15,
        ),
    }
