...
def test_random_statetest279(
    ...
    pre[contract] = Account(
        ...
        + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.SWAP5
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79])
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000000000000000000000947f0000000000000000000000004f3f7014"
