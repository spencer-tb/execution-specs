...
def test_random_statetest195(
    ...
    contract = Address("0xdcc17f922f302df332310eb0931f83d016dc3f1b")
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH32[0xc350] + Op.PUSH32[0xc350] + Op.COINBASE
        + Op.SSTORE(key=Op.PUSH32[0x10000000000000000000000000000000000000000], value=Op.MULMOD(Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff))
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000000000000000000000000000000000c350417fffffffff"
            ...
            "0000ffffffffffffffffffffffffffffffffffffffff097f000000000000000000000001"
