...
def test_random_statetest291(
    ...
    contract = Address("0xa8cbfeaf9a78d390bada18771f29715b4b54c94e")
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.PUSH32[0x1], value=Op.PUSH32[0x1]) + Op.MLOAD(offset=0x0)
        + Op.SSTORE
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000000000000000c3507f000000000000000000000000ffff"
    ...
    post = {
        ...
        contract: Account(
            storage={0: 0xffffffffffffffffffffffffffffffffffffffff, 1: 1},
            code=Op.PUSH32[0x0] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x0] + Op.PUSH32[0xc350] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.SSTORE(key=Op.PUSH32[0x1], value=Op.PUSH32[0x1]) + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
    }
