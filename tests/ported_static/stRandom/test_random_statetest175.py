...
def test_random_statetest175(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x6985f2837e09689844171a0235833c55)
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xc350] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xc350] + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x6985f2837e09689844171a0235833c55),
        ),
    }
