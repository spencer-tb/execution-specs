...
def test_random_statetest244(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.SMOD(Op.TIMESTAMP, Op.GASLIMIT) + Op.NUMBER + Op.NUMBER + Op.TIMESTAMP
        + Op.SSTORE(key=Op.MLOAD(offset=Op.BALANCE(address=Op.COINBASE)), value=Op.COINBASE)
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.SMOD(Op.TIMESTAMP, Op.GASLIMIT) + Op.NUMBER + Op.NUMBER + Op.TIMESTAMP + Op.SSTORE(key=Op.MLOAD(offset=Op.BALANCE(address=Op.COINBASE)), value=Op.COINBASE),
        ),
    }
