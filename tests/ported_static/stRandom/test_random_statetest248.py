...
def test_random_statetest248(
    ...
    contract = Address("0x6131276e33583c2356c9ac9b9eb5eec9999ef591")
    ...
    pre[contract] = Account(
        ...
        + Op.CALLCODE(gas=Op.CALLDATASIZE, address=Op.DUP7, value=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, args_offset=Op.PUSH32[0x0], args_size=Op.PUSH32[0xc350], ret_offset=Op.TIMESTAMP, ret_size=Op.PUSH32[0x1])
        + Op.MSIZE + Op.SWAP1 + Op.SSTORE
    ),
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000000000000000000000000000000001427f00000000000000000000"
    ...
    post = {
        ...
        contract: Account(
            storage={0: 50016},
            code=Op.PUSH32[0x1] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.CALLCODE(gas=Op.CALLDATASIZE, address=Op.DUP7, value=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, args_offset=Op.PUSH32[0x0], args_size=Op.PUSH32[0xc350], ret_offset=Op.TIMESTAMP, ret_size=Op.PUSH32[0x1]) + Op.MSIZE + Op.SWAP1 + Op.SSTORE,
        ),
    }
