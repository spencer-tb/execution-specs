...
def test_random_statetest200(
    ...
    post = {
        contract: Account(
            storage={0x42051af2a24050039e9d3a678b028a0a: 0x42051af2a24050039e9d3a678b028a0a},
            code=Op.NUMBER + Op.PUSH32[0xc350] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.CALLVALUE + Op.SSTORE(key=Op.DUP1, value=0x42051af2a24050039e9d3a678b028a0a),
        ),
        coinbase: Account(
