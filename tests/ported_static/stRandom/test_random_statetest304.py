...
def test_random_statetest304(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.CALL, value=Op.SIGNEXTEND(Op.SMOD(Op.ADDRESS, Op.SLOAD(key=Op.DUP13)), Op.SIGNEXTEND(Op.SMOD(Op.TIMESTAMP, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]), Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])))
    ...
    post = {
        ...
        contract: Account(
            code=Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.LOG2 + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.AND + Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.SSTORE(key=Op.CALL, value=Op.SIGNEXTEND(Op.SMOD(Op.ADDRESS, Op.SLOAD(key=Op.DUP13)), Op.SIGNEXTEND(Op.SMOD(Op.TIMESTAMP, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]), Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]))) + Op.MLOAD(offset=0x0) + Op.SSTORE,
        ),
    }
