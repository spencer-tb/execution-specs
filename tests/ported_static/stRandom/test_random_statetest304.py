...
def test_random_statetest304(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffffffff42070b8c5430070bf15560005155"  # noqa: E501
        ),
    )
    ...
    post = {
        ...
        contract: Account(
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
    }
