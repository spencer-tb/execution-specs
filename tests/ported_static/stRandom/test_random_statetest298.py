...
def test_random_statetest298(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x7c542006528b69ff3a7a3a0401613c55)
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            ...
            code=Op.PUSH32[0xc350] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0x0] + Op.EXP(Op.PUSH32[0xc350], Op.PUSH32[0x0]) + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0x7c542006528b69ff3a7a3a0401613c55),
        ),
    }
