...
def test_random_statetest226(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffe5a605560005155"
        ),
    )
    ...
    post = {
        ...
        contract: Account(
            storage={0: 85},
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
    }
