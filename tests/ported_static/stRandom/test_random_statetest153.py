...
def test_random_statetest153(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.SHA3(offset=Op.NUMBER, size=Op.TIMESTAMP), value=Op.PREVRANDAO)
    ),
    )
    ...
    post = {
        ...
        contract: Account(
            storage={0xae72e2bf2302ebcd309e003e5be58830f96deddaf87bb89eeea159388bfe3ec1: 0x20000},
            code=Op.SIGNEXTEND(Op.TIMESTAMP, Op.PREVRANDAO) + Op.SSTORE(key=Op.SHA3(offset=Op.NUMBER, size=Op.TIMESTAMP), value=Op.PREVRANDAO),
        ),
    }
