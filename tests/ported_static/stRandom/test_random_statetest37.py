...
def test_random_statetest37(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=0xa49835863514f0f29b930b97f1169355)
    ),
    )
