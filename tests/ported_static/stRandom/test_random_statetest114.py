...
def test_random_statetest114(
    ...
    pre[contract] = Account(
        ...
        code=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffff6f3584357ea388725483637d4471727f55600051"  # noqa: E501
            "55"
        ),
    )
    ...
    post = {
        ...
        contract: Account(
            ...
            code=bytes.fromhex(
                ""  # noqa: E501
            ),
        ),
    }
