...
def test_random_statetest149(
    ...
    pre[contract] = Account(
        ...
        + Op.MULMOD(Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff])
        + Op.SWAP1 + Op.SSTORE + Op.MLOAD
    ...
    post = {
        ...
        contract: Account(
            code=Op.PUSH32[0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe] + Op.PUSH32[0x4f3f701464972e74606d6ea82d4d3080599a0e79] + Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff] + Op.PUSH32[0xc350] + Op.PUSH32[0x10000000000000000000000000000000000000000] + Op.MULMOD(Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff], 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe, Op.PUSH32[0xffffffffffffffffffffffffffffffffffffffff]) + Op.SWAP1 + Op.SSTORE + Op.MLOAD + Op.SSTORE(key=Op.MLOAD(offset=0x0), value=Op.SMOD),
        ),
    }
