...
def test_callcallcode_01(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x0, value=Op.CALL(gas=0x55730, address=0x69142b38329c92930601fe8da12dc5866cde11c3, value=0x1, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.STOP
    ),
    )
    ...
    post = {
        callee: Account(
            storage={1: 1, 2: 1, 4: 0x69142b38329c92930601fe8da12dc5866cde11c3, 7: 2, 230: 0x69142b38329c92930601fe8da12dc5866cde11c3, 232: 0xebaf50debf10e08302fe4280c32df010463ca297, 236: 64, 238: 34, 240: 10},
        ...
        contract: Account(
            storage={0: 1},
            code=Op.SSTORE(key=0x0, value=Op.CALL(gas=0x55730, address=0x69142b38329c92930601fe8da12dc5866cde11c3, value=0x1, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)) + Op.STOP,
        ),
    }
