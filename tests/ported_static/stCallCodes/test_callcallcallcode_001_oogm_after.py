...
def test_callcallcallcode_001_oogm_after(
    ...
    pre[callee_2] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "60406000604060006000730be2d28f50cb59ffbd66d2eb6a3e8d34f3561d8b620927c0f1"  # noqa: E501
    ...
    post = {
        ...
        callee_2: Account(
            code=bytes.fromhex(
                "60406000604060006000730be2d28f50cb59ffbd66d2eb6a3e8d34f3561d8b620927c0f1600155622fffff60002000"  # noqa: E501
            ),
        ),
        contract: Account(
            storage={11: 1},
