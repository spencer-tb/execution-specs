...
def test_callcallcodecall_abcb_recursive(
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "6040600060406000600073e2ab9779f4fb1d9d39211cc2082083add172e69c6207a120f1"  # noqa: E501
            "60025500"
        ),
    )
    pre[callee_1] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "604060006040600060007391a8703c1bef34c1e76e152c1f7fb8c336c3be24620f4240f2"  # noqa: E501
            "60015500"
        ),
    )
