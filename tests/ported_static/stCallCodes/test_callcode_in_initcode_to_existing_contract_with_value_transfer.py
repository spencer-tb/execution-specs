...
def test_callcode_in_initcode_to_existing_contract_with_value_transfer(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.MSTORE(offset=0x0, value=0x6040600060406000600573945304eb96065b2a98b57a48a06ae28d285a71b562)
    ...
    post = {
        contract: Account(
            code=Op.MSTORE(offset=0x0, value=0x6040600060406000600573945304eb96065b2a98b57a48a06ae28d285a71b562) + Op.MSTORE(offset=0x20, value=0x186a0f260005500000000000000000000000000000000000000000000000000) + Op.CREATE(value=0x5, offset=0x0, size=0x40) + Op.STOP,
        ),
        Address("0x13136008b64ff592819b2fa6d43f2835c452020e"): Account(storage={0: 1, 2: 1}),
