...
def test_callcallcodecallcode_011_ooge(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "6040600060406000600073913cf7a18f61bab7bccf5607dfa9b730c5976000620c3500f1"  # noqa: E501
            "60005500"
        ),
    )
    ...
    post = {
        ...
        contract: Account(
            storage={0: 1},
            code=bytes.fromhex(
                "6040600060406000600073913cf7a18f61bab7bccf5607dfa9b730c5976000620c3500f160005500"  # noqa: E501
            ),
        ),
        callee_1: Account(
            code=bytes.fromhex(
