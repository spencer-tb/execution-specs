...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallCodes/callcodecallcodecallcode_111_SuicideMiddleFiller.json",  # noqa: E501
    ],
)
...
def test_callcodecallcodecallcode_111_suicide_middle(
    ...
    pre[callee_2] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "604060006040600060007323a077e1e6b0740d6bfbc41de582f2930abd1762620186a0f2"  # noqa: E501
            "60015500"
        ),
    )
    ...
    post = {
        callee: Account(
            code=bytes.fromhex(
                "73a74ca10b765dcda3b60687f73f2881e2a56eda64ff604060006040600060007373b954ebc05bb0ff4a0f6a13a054d50ad158409961c350f260025500"  # noqa: E501
            ),
        ),
        ...
        callee_2: Account(
            code=bytes.fromhex(
                "604060006040600060007323a077e1e6b0740d6bfbc41de582f2930abd1762620186a0f260015500"  # noqa: E501
            ),
        ),
    }
