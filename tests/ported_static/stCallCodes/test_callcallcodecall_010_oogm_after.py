...
def test_callcallcodecall_010_oogm_after(
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "60406000604060006000738d7270785422b63a97d83bada6aac80bebc3a99d620927c0f2"  # noqa: E501
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "604060006040600060007337e72dd6ff3c2ac8c1ddab092a26164a2ad5988c620c3500f1"  # noqa: E501
            "6000556001600b5500"
        ),
    )
    ...
    post = {
        callee: Account(
            code=bytes.fromhex(
                "60406000604060006000738d7270785422b63a97d83bada6aac80bebc3a99d620927c0f2600155622fffff60002000"  # noqa: E501
            ),
        ),
        callee_1: Account(
            code=bytes.fromhex(
        ...
        contract: Account(
            storage={11: 1},
            code=bytes.fromhex(
                "604060006040600060007337e72dd6ff3c2ac8c1ddab092a26164a2ad5988c620c3500f16000556001600b5500"  # noqa: E501
            ),
        ),
    }
