...
def test_callcodecallcodecall_110_ooge(
    ...
    pre[callee_1] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "6040600060406000600073db067ddf10e702a0cdcaa489117330e5395155cb620927c0f2"  # noqa: E501
            "60015500"
        ),
    )
    ...
    post = {
        ...
        callee_1: Account(
            code=bytes.fromhex(
                "6040600060406000600073db067ddf10e702a0cdcaa489117330e5395155cb620927c0f260015500"  # noqa: E501
            ),
        ),
        contract: Account(
