...
def test_callcallcodecall_010_oogm_before(
    ...
    pre[callee_1] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "604060006040600060007351a61d678ec27711369c527e5d42a9de66a5727f620927c0f2"  # noqa: E501
            "6001556001600b5500"
        ),
    )
    ...
    post = {
        ...
        callee_1: Account(
            storage={11: 1},
            code=bytes.fromhex(
                "604060006040600060007351a61d678ec27711369c527e5d42a9de66a5727f620927c0f26001556001600b5500"  # noqa: E501
            ),
        ),
