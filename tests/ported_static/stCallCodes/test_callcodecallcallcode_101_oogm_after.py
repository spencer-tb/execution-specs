...
def test_callcodecallcallcode_101_oogm_after(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "6040600060406000600073b5d1a486869d27225126c47727513f57d329a01a620c3500f2"  # noqa: E501
            "6000556001600b5500"
        ),
    )
    pre[callee] = Account(
    ...
    pre[callee_2] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "6040600060406000600073926dfbcc20b2ab686fc85331883541d174ccc738620927c0f1"  # noqa: E501
    ...
    post = {
        contract: Account(
            storage={11: 1},
            code=bytes.fromhex(
                "6040600060406000600073b5d1a486869d27225126c47727513f57d329a01a620c3500f26000556001600b5500"  # noqa: E501
            ),
        ),
        callee: Account(
            code=bytes.fromhex(
        ...
        callee_2: Account(
            code=bytes.fromhex(
                "6040600060406000600073926dfbcc20b2ab686fc85331883541d174ccc738620927c0f1600155622fffff60002000"  # noqa: E501
            ),
        ),
    }
