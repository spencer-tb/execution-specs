...
def test_callcallcall_000_oogm_before(
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x1, value=Op.CALL(gas=0x927c0, address=0x51a61d678ec27711369c527e5d42a9de66a5727f, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
    ...
    post = {
        ...
        callee: Account(
            storage={11: 1},
            code=Op.SSTORE(key=0x1, value=Op.CALL(gas=0x927c0, address=0x51a61d678ec27711369c527e5d42a9de66a5727f, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)) + Op.SSTORE(key=0xb, value=0x1) + Op.STOP,
        ),
        callee_1: Account(
