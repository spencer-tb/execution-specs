...
def test_callcallcall_000_oogm_before(
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "604060006040600060007351a61d678ec27711369c527e5d42a9de66a5727f620927c0f1"  # noqa: E501
            "6001556001600b5500"
        ),
    )
    ...
    post = {
        ...
        callee: Account(
            storage={11: 1},
            code=bytes.fromhex(
                "604060006040600060007351a61d678ec27711369c527e5d42a9de66a5727f620927c0f16001556001600b5500"  # noqa: E501
            ),
        ),
        callee_1: Account(
            code=bytes.fromhex(
