...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallCodes/callcallcodecallcode_011_SuicideMiddleFiller.json",  # noqa: E501
    ],
)
...
def test_callcallcodecallcode_011_suicide_middle(
    ...
    pre[callee_2] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "604060006040600060007358ded445d89963dfb8668b9a16b24afa6f9b83a8620186a0f2"  # noqa: E501
            "60015500"
        ),
    )
    ...
    post = {
        ...
        callee_2: Account(
            storage={1: 1},
            code=bytes.fromhex(
                "604060006040600060007358ded445d89963dfb8668b9a16b24afa6f9b83a8620186a0f260015500"  # noqa: E501
            ),
        ),
    }
