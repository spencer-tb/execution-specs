...
def test_callcallcodecall_010_ooge(
    ...
    pre[callee_2] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "60406000604060006000738232556dc6a7eed9ebe5b86c640a52aadf2c29af620927c0f2"  # noqa: E501
            "60015500"
        ),
    )
    ...
    post = {
        ...
        callee_2: Account(
            storage={1: 1, 11: 1},
            code=bytes.fromhex(
                "60406000604060006000738232556dc6a7eed9ebe5b86c640a52aadf2c29af620927c0f260015500"  # noqa: E501
            ),
        ),
    }
