...
def test_callcodecallcodecallcode_111_oogm_before(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "6040600060406000600073a4173498c0da91570d8af9a128c337a67a6b4e69620c3500f2"  # noqa: E501
            "60005500"
        ),
    )
    pre[callee] = Account(
    ...
    post = {
        contract: Account(
            storage={0: 1, 11: 1},
            code=bytes.fromhex(
                "6040600060406000600073a4173498c0da91570d8af9a128c337a67a6b4e69620c3500f260005500"  # noqa: E501
            ),
        ),
        callee: Account(
            code=bytes.fromhex(
