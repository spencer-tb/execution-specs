...
def test_callcallcallcode_001_ooge(
    ...
    pre[callee_2] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x1, value=Op.CALL(gas=0x927c0, address=0x6322dc554acdcada01cbf7ac6a163d207c34ded2, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40))
        + Op.STOP
    ),
    )
    ...
    post = {
        ...
        callee_2: Account(
            storage={1: 1},
            code=Op.SSTORE(key=0x1, value=Op.CALL(gas=0x927c0, address=0x6322dc554acdcada01cbf7ac6a163d207c34ded2, value=0x0, args_offset=0x0, args_size=0x40, ret_offset=0x0, ret_size=0x40)) + Op.STOP,
        ),
    }
