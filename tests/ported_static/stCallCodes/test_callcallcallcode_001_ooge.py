...
def test_callcallcallcode_001_ooge(
    ...
    pre[callee_2] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "60406000604060006000736322dc554acdcada01cbf7ac6a163d207c34ded2620927c0f1"  # noqa: E501
            "60015500"
        ),
    )
    ...
    post = {
        ...
        callee_2: Account(
            storage={1: 1},
            code=bytes.fromhex(
                "60406000604060006000736322dc554acdcada01cbf7ac6a163d207c34ded2620927c0f160015500"  # noqa: E501
            ),
        ),
    }
