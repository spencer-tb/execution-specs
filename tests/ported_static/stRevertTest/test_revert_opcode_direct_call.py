...
@pytest.mark.parametrize(
    ...
    [
        (460000, {Address("0x93a599bde9a3b6390afdb06952aa5ec0b8c44f3b"): Account(code=Op.SSTORE(key=0x1, value=0xc) + Op.REVERT(offset=0x0, size=0x1) + Op.SSTORE(key=0x3, value=0xd) + Op.STOP), Address("0xceb48d108c874b5b014acdd1a2466d65a3d01de6"): Account(storage={2: 14}, code=Op.SSTORE(key=0x0, value=Op.CALL(gas=0xc350, address=0x93a599bde9a3b6390afdb06952aa5ec0b8c44f3b, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)) + Op.SSTORE(key=0x2, value=0xe) + Op.STOP), Address("0xf94d87faf19d8c731e70e1b0a25f9668718f6e17"): Account(code=Op.SSTORE(key=0xa, value=Op.CALL(gas=0xea60, address=Op.CALLDATALOAD(offset=0x0), value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)) + Op.STOP)}),
        (62912, {Address("0x93a599bde9a3b6390afdb06952aa5ec0b8c44f3b"): Account(code=Op.SSTORE(key=0x1, value=0xc) + Op.REVERT(offset=0x0, size=0x1) + Op.SSTORE(key=0x3, value=0xd) + Op.STOP), Address("0xceb48d108c874b5b014acdd1a2466d65a3d01de6"): Account(code=Op.SSTORE(key=0x0, value=Op.CALL(gas=0xc350, address=0x93a599bde9a3b6390afdb06952aa5ec0b8c44f3b, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)) + Op.SSTORE(key=0x2, value=0xe) + Op.STOP), Address("0xf94d87faf19d8c731e70e1b0a25f9668718f6e17"): Account(code=Op.SSTORE(key=0xa, value=Op.CALL(gas=0xea60, address=Op.CALLDATALOAD(offset=0x0), value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)) + Op.STOP)}),
    ],
    ids=['case0', 'case1'],
)
...
def test_revert_opcode_direct_call(
    ...
    pre[callee_1] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0xa, value=Op.CALL(gas=0xea60, address=Op.CALLDATALOAD(offset=0x0), value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))
        + Op.STOP
    ),
    )
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex("000000000000000000000000ceb48d108c874b5b014acdd1a2466d65a3d01de6"),
