...
def test_exp_power256(
    ...
    pre[contract] = Account(
        ...
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x0), 0x1), value=Op.EXP(0xff, 0x0))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x0), 0x2), value=Op.EXP(0x101, 0x0))
        + Op.SSTORE(key=Op.MUL(0x10, 0x1), value=Op.EXP(0x100, 0x1))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x1), 0x1), value=Op.EXP(0xff, 0x1))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x1), 0x2), value=Op.EXP(0x101, 0x1))
        + Op.SSTORE(key=Op.MUL(0x10, 0x2), value=Op.EXP(0x100, 0x2))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x2), 0x1), value=Op.EXP(0xff, 0x2))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x2), 0x2), value=Op.EXP(0x101, 0x2))
        + Op.SSTORE(key=Op.MUL(0x10, 0x3), value=Op.EXP(0x100, 0x3))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x3), 0x1), value=Op.EXP(0xff, 0x3))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x3), 0x2), value=Op.EXP(0x101, 0x3))
        + Op.SSTORE(key=Op.MUL(0x10, 0x4), value=Op.EXP(0x100, 0x4))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x4), 0x1), value=Op.EXP(0xff, 0x4))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x4), 0x2), value=Op.EXP(0x101, 0x4))
        + Op.SSTORE(key=Op.MUL(0x10, 0x5), value=Op.EXP(0x100, 0x5))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x5), 0x1), value=Op.EXP(0xff, 0x5))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x5), 0x2), value=Op.EXP(0x101, 0x5))
        + Op.SSTORE(key=Op.MUL(0x10, 0x6), value=Op.EXP(0x100, 0x6))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x6), 0x1), value=Op.EXP(0xff, 0x6))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x6), 0x2), value=Op.EXP(0x101, 0x6))
        + Op.SSTORE(key=Op.MUL(0x10, 0x7), value=Op.EXP(0x100, 0x7))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x7), 0x1), value=Op.EXP(0xff, 0x7))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x7), 0x2), value=Op.EXP(0x101, 0x7))
        + Op.SSTORE(key=Op.MUL(0x10, 0x8), value=Op.EXP(0x100, 0x8))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x8), 0x1), value=Op.EXP(0xff, 0x8))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x8), 0x2), value=Op.EXP(0x101, 0x8))
        + Op.SSTORE(key=Op.MUL(0x10, 0x9), value=Op.EXP(0x100, 0x9))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x9), 0x1), value=Op.EXP(0xff, 0x9))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x9), 0x2), value=Op.EXP(0x101, 0x9))
        + Op.SSTORE(key=Op.MUL(0x10, 0xa), value=Op.EXP(0x100, 0xa))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0xa), 0x1), value=Op.EXP(0xff, 0xa))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0xa), 0x2), value=Op.EXP(0x101, 0xa))
        + Op.SSTORE(key=Op.MUL(0x10, 0xb), value=Op.EXP(0x100, 0xb))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0xb), 0x1), value=Op.EXP(0xff, 0xb))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0xb), 0x2), value=Op.EXP(0x101, 0xb))
        + Op.SSTORE(key=Op.MUL(0x10, 0xc), value=Op.EXP(0x100, 0xc))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0xc), 0x1), value=Op.EXP(0xff, 0xc))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0xc), 0x2), value=Op.EXP(0x101, 0xc))
        + Op.SSTORE(key=Op.MUL(0x10, 0xd), value=Op.EXP(0x100, 0xd))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0xd), 0x1), value=Op.EXP(0xff, 0xd))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0xd), 0x2), value=Op.EXP(0x101, 0xd))
        + Op.SSTORE(key=Op.MUL(0x10, 0xe), value=Op.EXP(0x100, 0xe))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0xe), 0x1), value=Op.EXP(0xff, 0xe))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0xe), 0x2), value=Op.EXP(0x101, 0xe))
        + Op.SSTORE(key=Op.MUL(0x10, 0xf), value=Op.EXP(0x100, 0xf))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0xf), 0x1), value=Op.EXP(0xff, 0xf))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0xf), 0x2), value=Op.EXP(0x101, 0xf))
        + Op.SSTORE(key=Op.MUL(0x10, 0x10), value=Op.EXP(0x100, 0x10))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x10), 0x1), value=Op.EXP(0xff, 0x10))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x10), 0x2), value=Op.EXP(0x101, 0x10))
        + Op.SSTORE(key=Op.MUL(0x10, 0x11), value=Op.EXP(0x100, 0x11))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x11), 0x1), value=Op.EXP(0xff, 0x11))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x11), 0x2), value=Op.EXP(0x101, 0x11))
        + Op.SSTORE(key=Op.MUL(0x10, 0x12), value=Op.EXP(0x100, 0x12))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x12), 0x1), value=Op.EXP(0xff, 0x12))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x12), 0x2), value=Op.EXP(0x101, 0x12))
        + Op.SSTORE(key=Op.MUL(0x10, 0x13), value=Op.EXP(0x100, 0x13))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x13), 0x1), value=Op.EXP(0xff, 0x13))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x13), 0x2), value=Op.EXP(0x101, 0x13))
        + Op.SSTORE(key=Op.MUL(0x10, 0x14), value=Op.EXP(0x100, 0x14))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x14), 0x1), value=Op.EXP(0xff, 0x14))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x14), 0x2), value=Op.EXP(0x101, 0x14))
        + Op.SSTORE(key=Op.MUL(0x10, 0x15), value=Op.EXP(0x100, 0x15))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x15), 0x1), value=Op.EXP(0xff, 0x15))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x15), 0x2), value=Op.EXP(0x101, 0x15))
        + Op.SSTORE(key=Op.MUL(0x10, 0x16), value=Op.EXP(0x100, 0x16))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x16), 0x1), value=Op.EXP(0xff, 0x16))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x16), 0x2), value=Op.EXP(0x101, 0x16))
        + Op.SSTORE(key=Op.MUL(0x10, 0x17), value=Op.EXP(0x100, 0x17))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x17), 0x1), value=Op.EXP(0xff, 0x17))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x17), 0x2), value=Op.EXP(0x101, 0x17))
        + Op.SSTORE(key=Op.MUL(0x10, 0x18), value=Op.EXP(0x100, 0x18))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x18), 0x1), value=Op.EXP(0xff, 0x18))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x18), 0x2), value=Op.EXP(0x101, 0x18))
        + Op.SSTORE(key=Op.MUL(0x10, 0x19), value=Op.EXP(0x100, 0x19))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x19), 0x1), value=Op.EXP(0xff, 0x19))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x19), 0x2), value=Op.EXP(0x101, 0x19))
        + Op.SSTORE(key=Op.MUL(0x10, 0x1a), value=Op.EXP(0x100, 0x1a))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x1a), 0x1), value=Op.EXP(0xff, 0x1a))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x1a), 0x2), value=Op.EXP(0x101, 0x1a))
        + Op.SSTORE(key=Op.MUL(0x10, 0x1b), value=Op.EXP(0x100, 0x1b))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x1b), 0x1), value=Op.EXP(0xff, 0x1b))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x1b), 0x2), value=Op.EXP(0x101, 0x1b))
        + Op.SSTORE(key=Op.MUL(0x10, 0x1c), value=Op.EXP(0x100, 0x1c))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x1c), 0x1), value=Op.EXP(0xff, 0x1c))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x1c), 0x2), value=Op.EXP(0x101, 0x1c))
        + Op.SSTORE(key=Op.MUL(0x10, 0x1d), value=Op.EXP(0x100, 0x1d))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x1d), 0x1), value=Op.EXP(0xff, 0x1d))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x1d), 0x2), value=Op.EXP(0x101, 0x1d))
        + Op.SSTORE(key=Op.MUL(0x10, 0x1e), value=Op.EXP(0x100, 0x1e))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x1e), 0x1), value=Op.EXP(0xff, 0x1e))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x1e), 0x2), value=Op.EXP(0x101, 0x1e))
        + Op.SSTORE(key=Op.MUL(0x10, 0x1f), value=Op.EXP(0x100, 0x1f))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x1f), 0x1), value=Op.EXP(0xff, 0x1f))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x1f), 0x2), value=Op.EXP(0x101, 0x1f))
        + Op.SSTORE(key=Op.MUL(0x10, 0x20), value=Op.EXP(0x100, 0x20))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x20), 0x1), value=Op.EXP(0xff, 0x20))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x20), 0x2), value=Op.EXP(0x101, 0x20))
        + Op.SSTORE(key=Op.MUL(0x10, 0x21), value=Op.EXP(0x100, 0x21))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x21), 0x1), value=Op.EXP(0xff, 0x21))
        + Op.SSTORE(key=Op.ADD(Op.MUL(0x10, 0x21), 0x2), value=Op.EXP(0x101, 0x21))
        + Op.STOP
    ),
    )
