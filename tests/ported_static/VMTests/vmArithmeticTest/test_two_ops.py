...
def test_two_ops(
    ...
    pre[contract] = Account(
        ...
        nonce=1,
        code=(
        Op.SSTORE(key=0x11000100010000, value=Op.ADD(Op.ADD(0x2, 0x1), 0x3))
        ...
        + Op.SSTORE(key=0x11000100080000, value=Op.ADD(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11000100080001, value=Op.ADD(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11000100090000, value=Op.ADD(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11000100090001, value=Op.ADD(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
        ...
        + Op.SSTORE(key=0x11000200080000, value=Op.MUL(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11000200080001, value=Op.MUL(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11000200090000, value=Op.MUL(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11000200090001, value=Op.MUL(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
        ...
        + Op.SSTORE(key=0x11000300080000, value=Op.SUB(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11000300080001, value=Op.SUB(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11000300090000, value=Op.SUB(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11000300090001, value=Op.SUB(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
        ...
        + Op.SSTORE(key=0x11000400080000, value=Op.DIV(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11000400080001, value=Op.DIV(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11000400090000, value=Op.DIV(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11000400090001, value=Op.DIV(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
        ...
        + Op.SSTORE(key=0x11000500050000, value=Op.SDIV(Op.SDIV(0x2, 0x1), 0x3))
        + Op.SSTORE(key=0x11000500050001, value=Op.SDIV(Op.SDIV(0x2, 0x1), 0x1))
        ...
        + Op.SSTORE(key=0x11000500070000, value=Op.SDIV(Op.SMOD(0x2, 0x1), 0x3))
        + Op.SSTORE(key=0x11000500070001, value=Op.SDIV(Op.SMOD(0x2, 0x1), 0x1))
        + Op.SSTORE(key=0x11000500080000, value=Op.SDIV(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11000500080001, value=Op.SDIV(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11000500090000, value=Op.SDIV(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11000500090001, value=Op.SDIV(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
        ...
        + Op.SSTORE(key=0x110005001a0000, value=Op.SDIV(Op.BYTE(0x2, 0x1), 0x3))
        + Op.SSTORE(key=0x110005001a0001, value=Op.SDIV(Op.BYTE(0x2, 0x1), 0x1))
        ...
        + Op.SSTORE(key=0x11000600080000, value=Op.MOD(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11000600080001, value=Op.MOD(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11000600090000, value=Op.MOD(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11000600090001, value=Op.MOD(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
        ...
        + Op.SSTORE(key=0x11000700050000, value=Op.SMOD(Op.SDIV(0x2, 0x1), 0x3))
        + Op.SSTORE(key=0x11000700050001, value=Op.SMOD(Op.SDIV(0x2, 0x1), 0x1))
        ...
        + Op.SSTORE(key=0x11000700070000, value=Op.SMOD(Op.SMOD(0x2, 0x1), 0x3))
        + Op.SSTORE(key=0x11000700070001, value=Op.SMOD(Op.SMOD(0x2, 0x1), 0x1))
        + Op.SSTORE(key=0x11000700080000, value=Op.SMOD(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11000700080001, value=Op.SMOD(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11000700090000, value=Op.SMOD(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11000700090001, value=Op.SMOD(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
        ...
        + Op.SSTORE(key=0x110007001a0000, value=Op.SMOD(Op.BYTE(0x2, 0x1), 0x3))
        + Op.SSTORE(key=0x110007001a0001, value=Op.SMOD(Op.BYTE(0x2, 0x1), 0x1))
        ...
        + Op.SSTORE(key=0x11000800010000, value=Op.ADDMOD(Op.ADD(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000800010001, value=Op.ADDMOD(Op.ADD(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000800020000, value=Op.ADDMOD(Op.MUL(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000800020001, value=Op.ADDMOD(Op.MUL(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000800030000, value=Op.ADDMOD(Op.SUB(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000800030001, value=Op.ADDMOD(Op.SUB(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000800040000, value=Op.ADDMOD(Op.DIV(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000800040001, value=Op.ADDMOD(Op.DIV(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000800050000, value=Op.ADDMOD(Op.SDIV(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000800050001, value=Op.ADDMOD(Op.SDIV(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000800060000, value=Op.ADDMOD(Op.MOD(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000800060001, value=Op.ADDMOD(Op.MOD(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000800070000, value=Op.ADDMOD(Op.SMOD(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000800070001, value=Op.ADDMOD(Op.SMOD(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000800080000, value=Op.ADDMOD(Op.ADDMOD(0x2, 0x1, 0x3), 0x3, 0x2))
        + Op.SSTORE(key=0x11000800080001, value=Op.ADDMOD(Op.ADDMOD(0x2, 0x1, 0x3), 0x1, 0x2))
        + Op.SSTORE(key=0x11000800090000, value=Op.ADDMOD(Op.MULMOD(0x2, 0x1, 0x3), 0x3, 0x2))
        + Op.SSTORE(key=0x11000800090001, value=Op.ADDMOD(Op.MULMOD(0x2, 0x1, 0x3), 0x1, 0x2))
        + Op.SSTORE(key=0x110008000a0000, value=Op.ADDMOD(Op.EXP(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x110008000a0001, value=Op.ADDMOD(Op.EXP(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000800100000, value=Op.ADDMOD(Op.LT(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000800100001, value=Op.ADDMOD(Op.LT(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000800110000, value=Op.ADDMOD(Op.GT(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000800110001, value=Op.ADDMOD(Op.GT(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000800120000, value=Op.ADDMOD(Op.SLT(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000800120001, value=Op.ADDMOD(Op.SLT(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000800130000, value=Op.ADDMOD(Op.SGT(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000800130001, value=Op.ADDMOD(Op.SGT(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000800140000, value=Op.ADDMOD(Op.EQ(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000800140001, value=Op.ADDMOD(Op.EQ(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000800150000, value=Op.ADDMOD(Op.ISZERO(0x2), 0x3, 0x2))
        + Op.SSTORE(key=0x11000800150001, value=Op.ADDMOD(Op.ISZERO(0x2), 0x1, 0x2))
        + Op.SSTORE(key=0x11000800160000, value=Op.ADDMOD(Op.AND(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000800160001, value=Op.ADDMOD(Op.AND(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000800170000, value=Op.ADDMOD(Op.OR(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000800170001, value=Op.ADDMOD(Op.OR(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000800180000, value=Op.ADDMOD(Op.XOR(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000800180001, value=Op.ADDMOD(Op.XOR(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000800190000, value=Op.ADDMOD(Op.NOT(0x2), 0x3, 0x2))
        + Op.SSTORE(key=0x11000800190001, value=Op.ADDMOD(Op.NOT(0x2), 0x1, 0x2))
        + Op.SSTORE(key=0x110008001a0000, value=Op.ADDMOD(Op.BYTE(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x110008001a0001, value=Op.ADDMOD(Op.BYTE(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x110008001b0000, value=Op.ADDMOD(Op.SHL(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x110008001b0001, value=Op.ADDMOD(Op.SHL(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x110008001c0000, value=Op.ADDMOD(Op.SHR(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x110008001c0001, value=Op.ADDMOD(Op.SHR(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x110008001d0000, value=Op.ADDMOD(Op.SAR(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x110008001d0001, value=Op.ADDMOD(Op.SAR(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000900010000, value=Op.MULMOD(Op.ADD(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000900010001, value=Op.MULMOD(Op.ADD(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000900020000, value=Op.MULMOD(Op.MUL(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000900020001, value=Op.MULMOD(Op.MUL(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000900030000, value=Op.MULMOD(Op.SUB(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000900030001, value=Op.MULMOD(Op.SUB(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000900040000, value=Op.MULMOD(Op.DIV(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000900040001, value=Op.MULMOD(Op.DIV(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000900050000, value=Op.MULMOD(Op.SDIV(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000900050001, value=Op.MULMOD(Op.SDIV(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000900060000, value=Op.MULMOD(Op.MOD(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000900060001, value=Op.MULMOD(Op.MOD(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000900070000, value=Op.MULMOD(Op.SMOD(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000900070001, value=Op.MULMOD(Op.SMOD(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000900080000, value=Op.MULMOD(Op.ADDMOD(0x2, 0x1, 0x3), 0x3, 0x2))
        + Op.SSTORE(key=0x11000900080001, value=Op.MULMOD(Op.ADDMOD(0x2, 0x1, 0x3), 0x1, 0x2))
        + Op.SSTORE(key=0x11000900090000, value=Op.MULMOD(Op.MULMOD(0x2, 0x1, 0x3), 0x3, 0x2))
        + Op.SSTORE(key=0x11000900090001, value=Op.MULMOD(Op.MULMOD(0x2, 0x1, 0x3), 0x1, 0x2))
        + Op.SSTORE(key=0x110009000a0000, value=Op.MULMOD(Op.EXP(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x110009000a0001, value=Op.MULMOD(Op.EXP(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000900100000, value=Op.MULMOD(Op.LT(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000900100001, value=Op.MULMOD(Op.LT(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000900110000, value=Op.MULMOD(Op.GT(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000900110001, value=Op.MULMOD(Op.GT(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000900120000, value=Op.MULMOD(Op.SLT(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000900120001, value=Op.MULMOD(Op.SLT(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000900130000, value=Op.MULMOD(Op.SGT(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000900130001, value=Op.MULMOD(Op.SGT(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000900140000, value=Op.MULMOD(Op.EQ(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000900140001, value=Op.MULMOD(Op.EQ(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000900150000, value=Op.MULMOD(Op.ISZERO(0x2), 0x3, 0x2))
        + Op.SSTORE(key=0x11000900150001, value=Op.MULMOD(Op.ISZERO(0x2), 0x1, 0x2))
        + Op.SSTORE(key=0x11000900160000, value=Op.MULMOD(Op.AND(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000900160001, value=Op.MULMOD(Op.AND(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000900170000, value=Op.MULMOD(Op.OR(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000900170001, value=Op.MULMOD(Op.OR(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000900180000, value=Op.MULMOD(Op.XOR(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x11000900180001, value=Op.MULMOD(Op.XOR(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x11000900190000, value=Op.MULMOD(Op.NOT(0x2), 0x3, 0x2))
        + Op.SSTORE(key=0x11000900190001, value=Op.MULMOD(Op.NOT(0x2), 0x1, 0x2))
        + Op.SSTORE(key=0x110009001a0000, value=Op.MULMOD(Op.BYTE(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x110009001a0001, value=Op.MULMOD(Op.BYTE(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x110009001b0000, value=Op.MULMOD(Op.SHL(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x110009001b0001, value=Op.MULMOD(Op.SHL(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x110009001c0000, value=Op.MULMOD(Op.SHR(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x110009001c0001, value=Op.MULMOD(Op.SHR(0x2, 0x1), 0x1, 0x2))
        + Op.SSTORE(key=0x110009001d0000, value=Op.MULMOD(Op.SAR(0x2, 0x1), 0x3, 0x2))
        + Op.SSTORE(key=0x110009001d0001, value=Op.MULMOD(Op.SAR(0x2, 0x1), 0x1, 0x2))
        ...
        + Op.SSTORE(key=0x11000a00080000, value=Op.EXP(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11000a00080001, value=Op.EXP(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11000a00090000, value=Op.EXP(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11000a00090001, value=Op.EXP(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
        ...
        + Op.SSTORE(key=0x11001000080000, value=Op.LT(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001000080001, value=Op.LT(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11001000090000, value=Op.LT(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001000090001, value=Op.LT(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
        ...
        + Op.SSTORE(key=0x11001100080000, value=Op.GT(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001100080001, value=Op.GT(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11001100090000, value=Op.GT(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001100090001, value=Op.GT(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
        ...
        + Op.SSTORE(key=0x11001200080000, value=Op.SLT(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001200080001, value=Op.SLT(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11001200090000, value=Op.SLT(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001200090001, value=Op.SLT(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
        ...
        + Op.SSTORE(key=0x11001300080000, value=Op.SGT(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001300080001, value=Op.SGT(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11001300090000, value=Op.SGT(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001300090001, value=Op.SGT(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
        ...
        + Op.SSTORE(key=0x11001400080000, value=Op.EQ(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001400080001, value=Op.EQ(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11001400090000, value=Op.EQ(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001400090001, value=Op.EQ(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
        ...
        + Op.SSTORE(key=0x11001500080000, value=Op.ISZERO(Op.ADDMOD(0x2, 0x1, 0x3)))
        + Op.SSTORE(key=0x11001500080001, value=Op.ISZERO(Op.ADDMOD(0x2, 0x1, 0x3)))
        + Op.SSTORE(key=0x11001500090000, value=Op.ISZERO(Op.MULMOD(0x2, 0x1, 0x3)))
        + Op.SSTORE(key=0x11001500090001, value=Op.ISZERO(Op.MULMOD(0x2, 0x1, 0x3)))
        ...
        + Op.SSTORE(key=0x11001600080000, value=Op.AND(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001600080001, value=Op.AND(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11001600090000, value=Op.AND(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001600090001, value=Op.AND(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
        ...
        + Op.SSTORE(key=0x11001700080000, value=Op.OR(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001700080001, value=Op.OR(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11001700090000, value=Op.OR(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001700090001, value=Op.OR(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
        ...
        + Op.SSTORE(key=0x11001800080000, value=Op.XOR(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001800080001, value=Op.XOR(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11001800090000, value=Op.XOR(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001800090001, value=Op.XOR(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
        ...
        + Op.SSTORE(key=0x11001900080000, value=Op.NOT(Op.ADDMOD(0x2, 0x1, 0x3)))
        + Op.SSTORE(key=0x11001900080001, value=Op.NOT(Op.ADDMOD(0x2, 0x1, 0x3)))
        + Op.SSTORE(key=0x11001900090000, value=Op.NOT(Op.MULMOD(0x2, 0x1, 0x3)))
        + Op.SSTORE(key=0x11001900090001, value=Op.NOT(Op.MULMOD(0x2, 0x1, 0x3)))
        ...
        + Op.SSTORE(key=0x11001a00050000, value=Op.BYTE(Op.SDIV(0x2, 0x1), 0x3))
        + Op.SSTORE(key=0x11001a00050001, value=Op.BYTE(Op.SDIV(0x2, 0x1), 0x1))
        ...
        + Op.SSTORE(key=0x11001a00070000, value=Op.BYTE(Op.SMOD(0x2, 0x1), 0x3))
        + Op.SSTORE(key=0x11001a00070001, value=Op.BYTE(Op.SMOD(0x2, 0x1), 0x1))
        + Op.SSTORE(key=0x11001a00080000, value=Op.BYTE(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001a00080001, value=Op.BYTE(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11001a00090000, value=Op.BYTE(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001a00090001, value=Op.BYTE(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
        ...
        + Op.SSTORE(key=0x11001a001a0000, value=Op.BYTE(Op.BYTE(0x2, 0x1), 0x3))
        + Op.SSTORE(key=0x11001a001a0001, value=Op.BYTE(Op.BYTE(0x2, 0x1), 0x1))
        ...
        + Op.SSTORE(key=0x11001b00080000, value=Op.SHL(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001b00080001, value=Op.SHL(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11001b00090000, value=Op.SHL(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001b00090001, value=Op.SHL(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
        ...
        + Op.SSTORE(key=0x11001c00080000, value=Op.SHR(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001c00080001, value=Op.SHR(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11001c00090000, value=Op.SHR(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001c00090001, value=Op.SHR(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
        ...
        + Op.SSTORE(key=0x11001d00080000, value=Op.SAR(Op.ADDMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001d00080001, value=Op.SAR(Op.ADDMOD(0x2, 0x1, 0x3), 0x1))
        + Op.SSTORE(key=0x11001d00090000, value=Op.SAR(Op.MULMOD(0x2, 0x1, 0x3), 0x3))
        + Op.SSTORE(key=0x11001d00090001, value=Op.SAR(Op.MULMOD(0x2, 0x1, 0x3), 0x1))
