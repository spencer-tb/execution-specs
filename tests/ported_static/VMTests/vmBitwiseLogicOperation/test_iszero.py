...
def test_iszero(
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x0, value=Op.ISZERO(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff))
        + Op.STOP
    ),
    )
