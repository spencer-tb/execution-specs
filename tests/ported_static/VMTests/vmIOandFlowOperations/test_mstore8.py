...
def test_mstore8(
    ...
    pre[callee_1] = Account(
        ...
        nonce=0,
        code=(
        Op.MSTORE8(offset=0x1, value=0xff) + Op.MSTORE8(offset=0x2, value=0xee)
