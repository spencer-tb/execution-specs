...
def test_gas(
    ...
    pre[callee] = Account(
        ...
        + Op.MSTORE(offset=0x5a, value=0xeeee) + Op.SSTORE(key=0x0, value=Op.GAS)
        + Op.STOP
    ),
    )
