...
def test_log0(
    ...
    pre[callee] = Account(
        ...
        nonce=0,
        code=Op.LOG0(offset=0x0, size=0x0) + Op.SSTORE(key=0x0, value=0x600d) + Op.STOP,
    )
    ...
    pre[callee_3] = Account(
        ...
        code=(
        Op.MSTORE(offset=0x0, value=0xaabbffffffffffffffffffffffffffffffffffffffffffffffffffffffffccdd)
        + Op.LOG0(offset=0x1, size=0x0) + Op.SSTORE(key=0x0, value=0x600d) + Op.STOP
    ),
    )
    pre[callee_4] = Account(
        ...
        + Op.LOG0(offset=0x0, size=0x20) + Op.SSTORE(key=0x0, value=0x600d) + Op.STOP
    ),
    )
    pre[callee_5] = Account(
        ...
        code=(
        Op.MSTORE(offset=0x0, value=0xaabbffffffffffffffffffffffffffffffffffffffffffffffffffffffffccdd)
        + Op.LOG0(offset=0x0, size=0x1) + Op.SSTORE(key=0x0, value=0x600d) + Op.STOP
    ),
    )
    pre[callee_6] = Account(
        ...
        code=(
        Op.MSTORE(offset=0x0, value=0xaabbffffffffffffffffffffffffffffffffffffffffffffffffffffffffccdd)
        + Op.LOG0(offset=0x1f, size=0x1) + Op.SSTORE(key=0x0, value=0x600d) + Op.STOP
    ),
    )
