...
def test_log2(
    ...
    pre[callee_8] = Account(
        ...
        code=(
        Op.MSTORE8(offset=0x0, value=0xff)
        + Op.LOG2(offset=0x1f, size=0x1, topic_1=Op.SUB(0x0, 0x1), topic_2=Op.SUB(0x0, 0x1))
        + Op.SSTORE(key=0x0, value=0x600d) + Op.STOP
    ),
    )
