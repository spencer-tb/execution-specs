...
def test_returndatacopy_after_failing_create(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "69600260005260206000fd600052600a60166000f0503d6000556020600060003e600051"  # noqa: E501
            "60015500"
        ),
        storage={0x0: 0x1},
    )
    ...
    post = {
        contract: Account(
            storage={0: 32, 1: 2},
            code=bytes.fromhex(
                "69600260005260206000fd600052600a60166000f0503d6000556020600060003e60005160015500"  # noqa: E501
            ),
        ),
    }
