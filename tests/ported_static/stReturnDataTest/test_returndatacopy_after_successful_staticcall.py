...
def test_returndatacopy_after_successful_staticcall(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.POP(Op.STATICCALL(gas=0xea60, address=0x52fd0cbc013ee33577eec035031dbc4489a1e0bd, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))
    ...
    post = {
        contract: Account(
            ...
            code=Op.POP(Op.STATICCALL(gas=0xea60, address=0x52fd0cbc013ee33577eec035031dbc4489a1e0bd, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)) + Op.RETURNDATACOPY(dest_offset=0x0, offset=0x0, size=0x20) + Op.SSTORE(key=0x0, value=Op.MLOAD(offset=0x0)) + Op.STOP,
        ),
        callee: Account(
