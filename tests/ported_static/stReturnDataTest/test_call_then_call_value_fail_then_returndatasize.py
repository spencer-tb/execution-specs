...
def test_call_then_call_value_fail_then_returndatasize(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "60206000600060006000739898dd5e5c526b55ec49b1047e298705c13279f16409000000"  # noqa: E501
            "00f150602060006000600065ffffffffffff739898dd5e5c526b55ec49b1047e298705c1"  # noqa: E501
            "3279f1640900000000f1503d60005500"
        ),
        storage={0x0: 0x1},
    )
    pre[callee] = Account(
    ...
    post = {
        contract: Account(
            code=bytes.fromhex(
                "60206000600060006000739898dd5e5c526b55ec49b1047e298705c13279f1640900000000f150602060006000600065ffffffffffff739898dd5e5c526b55ec49b1047e298705c13279f1640900000000f1503d60005500"  # noqa: E501
            ),
        ),
        callee: Account(
            code=bytes.fromhex(
