...
def test_call_then_call_value_fail_then_returndatasize(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.POP(Op.CALL(gas=0x900000000, address=0x9898dd5e5c526b55ec49b1047e298705c13279f1, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x20))
