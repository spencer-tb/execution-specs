...
def test_returndatasize_after_failing_delegatecall(
    ...
    post = {
        ...
        contract: Account(
            code=Op.POP(Op.DELEGATECALL(gas=0x2710, address=0x665521fd750490fd880ee369c267fca44ed8a078, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)) + Op.SSTORE(key=0x0, value=Op.RETURNDATASIZE) + Op.STOP,
        ),
    }
