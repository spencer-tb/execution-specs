...
def test_returndatacopy_following_too_big_transfer(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.POP(Op.CALL(gas=0x900000000, address=0x9898dd5e5c526b55ec49b1047e298705c13279f1, value=0x989680, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0))
    ...
    post = {
        contract: Account(
            storage={0: 1},
            code=Op.POP(Op.CALL(gas=0x900000000, address=0x9898dd5e5c526b55ec49b1047e298705c13279f1, value=0x989680, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x0)) + Op.RETURNDATACOPY(dest_offset=0x0, offset=0x0, size=0x20) + Op.SSTORE(key=0x0, value=0xc8) + Op.STOP,
        ),
        callee: Account(
