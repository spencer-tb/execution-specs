"""
Ported from:
tests/static/state_tests/stReturnDataTest/call_outsize_then_create_successful_then_returndatasizeFiller.json
"""
...
def test_call_outsize_then_create_successful_then_returndatasize(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.POP(Op.CALL(gas=0x900000000, address=0x24b406508240d6f2783499d1fd65fedd0feeef37, value=0x0, args_offset=0x0, args_size=0x0, ret_offset=0x0, ret_size=0x20))
