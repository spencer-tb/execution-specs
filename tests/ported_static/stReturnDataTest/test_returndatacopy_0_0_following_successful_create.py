...
def test_returndatacopy_0_0_following_successful_create(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.PUSH1[0x7] + Op.CODECOPY(dest_offset=0x0, offset=0x1d, size=Op.DUP1)
    ...
    post = {
        contract: Account(
            code=Op.PUSH1[0x7] + Op.CODECOPY(dest_offset=0x0, offset=0x1d, size=Op.DUP1) + Op.PUSH1[0x0] + Op.PUSH1[0x0] + Op.POP(Op.CREATE) + Op.RETURNDATACOPY(dest_offset=0x0, offset=0x0, size=0x0) + Op.SSTORE(key=0x0, value=0x0) + Op.STOP + Op.STOP + Op.INVALID + Op.SSTORE(key=0x0, value=0x1) + Op.STOP + Op.STOP,
        ),
        Address("0x945304eb96065b2a98b57a48a06ae28d285a71b5"): Account(storage={0: 1}),
    }
