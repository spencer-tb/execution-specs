...
@pytest.mark.parametrize(
    "tx_data_hex",
    [
        "0000000000000000000000001000000000000000000000000000000000001400",
...
def test_call_to_suicide_then_extcodehash(
    ...
    contract = Address("0x1000000000000000000000000000000000001500")
    ...
    pre[callee_1] = Account(
        ...
        + Op.PUSH20[0x1000000000000000000000000000000000001000] + Op.PUSH3[0x28488]
        + Op.STATICCALL + Op.PUSH1[0x0] + Op.SSTORE
        + Op.PUSH20[0x1000000000000000000000000000000000001000] + Op.EXTCODEHASH
