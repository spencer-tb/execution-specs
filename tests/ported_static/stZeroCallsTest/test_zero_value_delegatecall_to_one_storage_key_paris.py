...
def test_zero_value_delegatecall_to_one_storage_key_paris(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "5a6000556000600060006000734757608f18b70777ae788dd4056eeed52f7aa68f61ea60"  # noqa: E501
    ...
    post = {
        ...
        contract: Account(
            ...
            code=bytes.fromhex(
                "5a6000556000600060006000734757608f18b70777ae788dd4056eeed52f7aa68f61ea60f4600155600160645500"  # noqa: E501
            ),
        ),
    }
