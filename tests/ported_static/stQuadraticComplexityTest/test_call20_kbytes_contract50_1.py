...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stQuadraticComplexityTest/Call20KbytesContract50_1Filler.json",  # noqa: E501
    ],
)
    ...
    [
        ...
        (
            12500000,
            {
                ...
                Address("0xae9c63d43225738de8070ce25e1be54f429da182"): Account(
                    storage={0: 3728}
                ),
            },
        ),  # noqa: E501
...
def test_call20_kbytes_contract50_1(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=Op.CALL(
                    gas=0x148C1C2280,
                    address=0xAE9C63D43225738DE8070CE25E1BE54F429DA182,
                    value=0x0,
                    args_offset=0x0,
                    args_size=0x0,
                    ret_offset=0x0,
    ...
    pre.deploy_contract(
        code=Op.PUSH1[1]
        + (Op.PUSH1[1] + Op.ADD) * 3727
        + Op.PUSH1[0]
        + Op.SSTORE,
        balance=0xFFFFFFFFFFFFF,
        nonce=0,
        address=Address("0xae9c63d43225738de8070ce25e1be54f429da182"),  # noqa: E501
    )
