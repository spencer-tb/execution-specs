...
def test_shr_1_255(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff60ff1c"  # noqa: E501
            "600055"
        ),
        storage={0x0: 0x3},
    )
    ...
    post = {
        contract: Account(
            storage={0: 1},
            code=bytes.fromhex(
                "7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff60ff1c600055"  # noqa: E501
            ),
        ),
    }
