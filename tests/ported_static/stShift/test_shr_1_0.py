...
def test_shr_1_0(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x0, value=Op.SHR(0x0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff))
    ),
        storage={0x0: 0x3},
    )
    ...
    post = {
        contract: Account(
            ...
            code=Op.SSTORE(key=0x0, value=Op.SHR(0x0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff)),
        ),
    }
