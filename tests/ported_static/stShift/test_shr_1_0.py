...
def test_shr_1_0(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=bytes.fromhex(
            "7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff60001c"  # noqa: E501
            "600055"
        ),
        storage={0x0: 0x3},
    )
    ...
    post = {
        contract: Account(
            ...
            code=bytes.fromhex(
                "7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff60001c600055"  # noqa: E501
            ),
        ),
    }
