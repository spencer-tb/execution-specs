...
def test_sar_2_256_1_256(
    ...
    pre[contract] = Account(
        ...
        nonce=0,
        code=(
        Op.SSTORE(key=0x0, value=Op.SAR(0x100, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff))
    ),
        storage={0x0: 0x3},
    )
    ...
    post = {
        contract: Account(
            ...
            code=Op.SSTORE(key=0x0, value=Op.SAR(0x100, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff)),
        ),
    }
