...
# TODO[EIP-8037]: Fix Storage.KeyValueMismatchError for contract_loop expected values.
@pytest.mark.skip(reason="EIP-8037: pointer loop storage values need fixing for state gas model")
